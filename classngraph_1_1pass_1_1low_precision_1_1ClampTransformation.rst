.. index:: pair: class; ngraph::pass::low_precision::ClampTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation:
...
:ref:`ClampTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation>` propagates dequantization operations through Clamp operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation>`
...
.. ref-code-block:: cpp
	...
	class ClampTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`ClampTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation_1acc6423c5ffe3fcba5357f37df25cdfc4>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation_1a357fc319779202076c7100508095081b>`("ClampTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation_1a5570463c9f815aca197908ba61940690>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation_1a6d44111bd4e380ffe456b551f1ae7db6>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation_1ab9c7b767c11577f4f4438f8df1f80f77>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ClampTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_clamp_transformation>` propagates dequantization operations through Clamp operation.

For more details about the transformation, refer to :ref:`ClampTransformation <doxid-openvino_docs__o_v__u_g_lpt__clamp_transformation>` page in the Inference Engine Developer Guide.
