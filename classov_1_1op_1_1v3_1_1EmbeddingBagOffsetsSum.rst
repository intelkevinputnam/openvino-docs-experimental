.. index:: pair: class; ov::op::v3::EmbeddingBagOffsetsSum
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum:
...
Returns embeddings for given indices. :ref:`More...<details-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum>`
...
.. ref-code-block:: cpp
	...
	class EmbeddingBagOffsetsSum: public :ref:`ov::op::util::EmbeddingBagOffsetsBase<doxid-classov_1_1op_1_1util_1_1_embedding_bag_offsets_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1ab8670e6f4a1a6d24cea668105dbd3fb9>`;

		// construction
	
		:ref:`EmbeddingBagOffsetsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1a0f18d80ef08dc00cfc01f88bd21441df>`();
	
		:ref:`EmbeddingBagOffsetsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1af26454e5632a3c60c19d31737aa518a1>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& emb_table,
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& default_index,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& per_sample_weights
			);
	
		:target:`EmbeddingBagOffsetsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1add2b62d7f2c2306d250708106fc854d9>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& emb_table,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& offsets,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& default_index
		...
		:target:`EmbeddingBagOffsetsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1a8b8fb77e09b0588e8a8d60bf4be1fe73>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& emb_table,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& offsets
			);
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1ac9cea6c4794ac17ed27801f0ee154c6b>`(
			"EmbeddingBagOffsetsSum",
			"opset3",
			:ref:`util::EmbeddingBagOffsetsBase<doxid-classov_1_1op_1_1util_1_1_embedding_bag_offsets_base>`,
			3
			);
	
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1aec087c694790016c1733f053c17458cc>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_embedding_bag_offsets_base_1ab210a7e57277aded08ab8e93ef6fd93c>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_embedding_bag_offsets_base_1a99f5c01d87721f4010705f95469cc25c>`("EmbeddingBagOffsetsBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_embedding_bag_offsets_base_1a660802e94f61ea5d63f7c069ebfb9dbf>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_embedding_bag_offsets_base_1a838a12f227a32d551717fe5ba83bba3e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum:
...
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1a0f18d80ef08dc00cfc01f88bd21441df:
.. index:: pair: function; EmbeddingBagOffsetsSum
...
Constructs a :ref:`EmbeddingBagOffsetsSum <doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum>` operation.

.. _doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum_1af26454e5632a3c60c19d31737aa518a1:
.. index:: pair: function; EmbeddingBagOffsetsSum
...
:ref:`EmbeddingBagOffsetsSum <doxid-classov_1_1op_1_1v3_1_1_embedding_bag_offsets_sum>` constructs an output tensor by replacing every index in a given input tensor with a row (from the weights matrix) at that index
...
.. list-table::
	...
	*
		...
		- tensor of shape [num_indices] and of type T_IND. Required
