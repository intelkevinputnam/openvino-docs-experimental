.. index:: pair: class; ngraph::pass::SplitSqueezeConcatFusion
.. _doxid-classngraph_1_1pass_1_1_split_squeeze_concat_fusion:
...
:ref:`SplitSqueezeConcatFusion <doxid-classngraph_1_1pass_1_1_split_squeeze_concat_fusion>` transformation replaces group of operations: Split -> Squeeze (multiple) -> Concat to Transpose -> Reshape ops.
...
.. ref-code-block:: cpp
	...
	class SplitSqueezeConcatFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_split_squeeze_concat_fusion_1aea3ac414152aee31fe3dfc2301a3b8ce>`("SplitSqueezeConcatFusion", "0");
	};
