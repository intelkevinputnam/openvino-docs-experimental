.. index:: pair: class; ov::op::v1::BinaryConvolution
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution:
...
.. toctree::
	...
	BinaryConvolutionMode <enumov_1_1op_1_1v1_1_1BinaryConvolution_1_1BinaryConvolutionMode.rst>

Overview
~~~~~~~~

:ref:`BinaryConvolution <doxid-classov_1_1op_1_1v1_1_1_binary_convolution>` operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_binary_convolution>`
...
.. ref-code-block:: cpp
	...
	class BinaryConvolution: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`BinaryConvolutionMode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aff500c1508ca17c80cc8c7c503aa040f>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a7aceab67c3f6f061141b4b1f686adff0>`;

		// construction
	
		:ref:`BinaryConvolution<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aa8fbbc72d9f7e25deaa11d05e392fed9>`();
	
		:ref:`BinaryConvolution<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a9d7531f2ac3a03659c9ac670f0f57508>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& kernel,
			...
			:ref:`BinaryConvolutionMode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aff500c1508ca17c80cc8c7c503aa040f>` mode,
			float pad_value,
			const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& auto_pad = PadType::EXPLICIT
			);
	
		:target:`BinaryConvolution<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a78e15b7c46965f474ba9b6de51dcdc63>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& kernel,
			const :ref:`Strides<doxid-classov_1_1_strides>`& strides,
			const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ad09f4b32948811930d8806e2e3b160bf>`("BinaryConvolution", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a9c244831e3e2860c4e8f501c0997e12f>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a8f9bc4b3d5eca179933a7c4e828ff05e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aef9c9d9229d027c8fd10d8ab2bcd919b>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_strides<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ae993927b0900be85f0265fddd91f670c>`() const;
		void :target:`set_strides<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ab1144129b85c4bafee09650b03e01eb5>`(const :ref:`Strides<doxid-classov_1_1_strides>`& strides);
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_dilations<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a6c5c0475b0456325e9d61b7e2559cdbe>`() const;
		void :target:`set_dilations<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ac402e075d927b95b58d804190bbbd35d>`(const :ref:`Strides<doxid-classov_1_1_strides>`& dilations);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_begin<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a2fa08dc65c3b5e15b58b0e25b52dd7b3>`() const;
		void :target:`set_pads_begin<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a14b4bbaa7071ba736c37f7477c164529>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_end<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ae74228f5b8660bf95d481b805ac9bd18>`() const;
		void :target:`set_adding_above<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1adfd660e01c606b80645b920a1f6ad30a>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_end);
		const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& :ref:`get_auto_pad<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ae4f08c1180a4449f1828842a56cac293>`() const;
		void :target:`set_auto_pad<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aff1cc6990008ad8aa9980970438eafbd>`(const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& auto_pad);
		const :ref:`BinaryConvolutionMode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aff500c1508ca17c80cc8c7c503aa040f>`& :ref:`get_mode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a3d57d4d79ff894567c7b634f72b9ed08>`() const;
		void :target:`set_mode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a995cf164fe7efdccd19a239f28296d0e>`(const :ref:`BinaryConvolutionMode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aff500c1508ca17c80cc8c7c503aa040f>`& mode);
		float :ref:`get_pad_value<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aad20027fbb6751ed90739a3009d058f3>`() const;
		void :target:`set_pad_value<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a8bbf73473ca8aa292892aab75cced61a>`(float pad_value);
	};
...
.. _details-classov_1_1op_1_1v1_1_1_binary_convolution:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`BinaryConvolution <doxid-classov_1_1op_1_1v1_1_1_binary_convolution>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aa8fbbc72d9f7e25deaa11d05e392fed9:
.. index:: pair: function; BinaryConvolution
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a9d7531f2ac3a03659c9ac670f0f57508:
.. index:: pair: function; BinaryConvolution
...
:ref:`Output <doxid-classov_1_1_output>` ``[N, C_OUT, R1, ... Rf]``
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a9c244831e3e2860c4e8f501c0997e12f:
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ae993927b0900be85f0265fddd91f670c:
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a6c5c0475b0456325e9d61b7e2559cdbe:
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a2fa08dc65c3b5e15b58b0e25b52dd7b3:
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ae74228f5b8660bf95d481b805ac9bd18:
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1ae4f08c1180a4449f1828842a56cac293:
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1a3d57d4d79ff894567c7b634f72b9ed08:
.. index:: pair: function; get_mode

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`BinaryConvolutionMode<doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aff500c1508ca17c80cc8c7c503aa040f>`& get_mode() const
...
.. _doxid-classov_1_1op_1_1v1_1_1_binary_convolution_1aad20027fbb6751ed90739a3009d058f3:
.. index:: pair: function; get_pad_value
