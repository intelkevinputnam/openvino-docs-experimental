.. index:: pair: class; ngraph::pass::CommonOptimizations
.. _doxid-classngraph_1_1pass_1_1_common_optimizations:

class ngraph::pass::CommonOptimizations
=======================================
...
.. ref-code-block:: cpp
	...
	class CommonOptimizations: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_common_optimizations_1a98aba7ad4c107893c913d173e4548138>`("CommonOptimizations", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_common_optimizations_1a53e53055398e0b64484792965f8b60b8>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& f);
	};
