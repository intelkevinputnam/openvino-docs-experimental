.. index:: pair: class; ov::op::v8::I420toRGB
.. _doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b:
...
Color conversion operation from I420 to RGB format. :ref:`Input <doxid-classov_1_1_input>` : :ref:`More...<details-classov_1_1op_1_1v8_1_1_i420to_r_g_b>`
...
.. ref-code-block:: cpp
	...
	class I420toRGB: public :ref:`ov::op::util::ConvertColorI420Base<doxid-classov_1_1op_1_1util_1_1_convert_color_i420_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1a2bc207b0c955c3225775f9a64ed8a7ec>`;

		// construction
	
		:target:`I420toRGB<doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1a9bff74c6c589cb3f4034c17519303915>`();
		:ref:`I420toRGB<doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1ab34676b18fe9a001ddacb0d356e5e038>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
	
		:ref:`I420toRGB<doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1af2ebfa7962aaf85bd810ba626042708c>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_y,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_u,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_v
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1a4ad284e8400096aeab18dace3441749b>`("I420toRGB", "opset8", :ref:`util::ConvertColorI420Base<doxid-classov_1_1op_1_1util_1_1_convert_color_i420_base>`);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1afc4224aef3590a8dc43bbbc1613f1bc5>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		enum :ref:`ColorConversion<doxid-classov_1_1op_1_1util_1_1_convert_color_i420_base_1a203405069101c4fe7f82e5f0d326788f>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_convert_color_i420_base_1ae9fcc20fb711e92bc824e042e7810211>`("ConvertColorI420Base", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_convert_color_i420_base_1ac079b71db88907d1973b457cfa456c12>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_convert_color_i420_base_1a638c2affefc4054bf4d062e904d1712e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v8_1_1_i420to_r_g_b:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Color conversion operation from I420 to RGB format. :ref:`Input <doxid-classov_1_1_input>` :

* :ref:`Input <doxid-classov_1_1_input>` NV12 image can be represented in two ways: a) Single plane (as it is in the file): I420 height dimension is 1.5x bigger than image height. 'C' dimension shall be 1. b) Three separate planes (used this way in many physical video sources): Y, U and V. In this case b1) Y plane has height same as image height. 'C' dimension equals to 1 b2) U plane has dimensions: 'H' = image_h / 2; 'W' = image_w / 2; 'C' = 1. b3) V plane has dimensions: 'H' = image_h / 2; 'W' = image_w / 2; 'C' = 1.
...
.. _doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1ab34676b18fe9a001ddacb0d356e5e038:
.. index:: pair: function; I420toRGB

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	I420toRGB(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v8_1_1_i420to_r_g_b_1af2ebfa7962aaf85bd810ba626042708c:
.. index:: pair: function; I420toRGB
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` that produces the input tensor for U plane (NHWC layout). 'H' is half of image height, 'W' is half of image width, 'C' dimension equals to 1.

	*
		- arg_v

		- :ref:`Node <doxid-classov_1_1_node>` that produces the input tensor for V plane (NHWC layout). 'H' is half of image height, 'W' is half of image width, 'C' dimension equals to 1.
