.. index:: pair: class; ov::pass::ConvertCompressedOnlyToLegacy
.. _doxid-classov_1_1pass_1_1_convert_compressed_only_to_legacy:
...
:ref:`ConvertCompressedOnlyToLegacy <doxid-classov_1_1pass_1_1_convert_compressed_only_to_legacy>` transformation converts compression only FP16 format to legacy FP16 format.
...
.. ref-code-block:: cpp
	...
	class ConvertCompressedOnlyToLegacy: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_convert_compressed_only_to_legacy_1ad14a8a2514c7023e0ca0199f5c8cd20d>`("ConvertCompressedOnlyToLegacy", "0");
		bool :target:`run_on_model<doxid-classov_1_1pass_1_1_convert_compressed_only_to_legacy_1a6e3deb7e9a385b29f357666475e5ccfb>`(const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& f);
	};
