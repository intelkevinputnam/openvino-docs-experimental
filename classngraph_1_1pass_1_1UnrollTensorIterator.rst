.. index:: pair: class; ngraph::pass::UnrollTensorIterator
.. _doxid-classngraph_1_1pass_1_1_unroll_tensor_iterator:
...
.. ref-code-block:: cpp
	...
	class UnrollTensorIterator: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_unroll_tensor_iterator_1a5ffa5e2a54add67186383a516014161f>`("UnrollTensorIterator", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_unroll_tensor_iterator_1a226708425a51dff28b713e4c45e65a83>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
