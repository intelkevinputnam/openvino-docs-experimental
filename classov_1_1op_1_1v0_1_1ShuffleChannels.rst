.. index:: pair: class; ov::op::v0::ShuffleChannels
.. _doxid-classov_1_1op_1_1v0_1_1_shuffle_channels:
...
Permutes data in the channel dimension of the input. :ref:`More...<details-classov_1_1op_1_1v0_1_1_shuffle_channels>`
...
.. ref-code-block:: cpp
	...
	class ShuffleChannels: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1aa973d773d1bc386dd00c30eceb539515>`;

		// construction
	
		:target:`ShuffleChannels<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a0a0d4ed140b174c1cd582d9b9b7ea081>`();
	
		:ref:`ShuffleChannels<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1aade4906382a6c8d4004c7efac515d143>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1aef6a825a416715a8e6ff6f2826722b62>`("ShuffleChannels", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a83de9726592c09fded8d379767906ef2>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		size_t :target:`get_zero_based_axis<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a9975570416bcfe09ff12031344fc957d>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1ab177333ea246a2a9b9782318de22ae71>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a2aabef760e332d7f4aba8bd4358c500b>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const int64_t& :target:`get_axis<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a2baa68c15dba84f51a47a5f7f211402e>`() const;
		const int64_t& :target:`get_group<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a8cce4e99fe7bc52a202aa2cb1fb20b36>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1af3c75cd41ad88a60261163e9162d7142>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a3e62178038208ad7948e5e2c3a1aac8b>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_shuffle_channels:
...
.. _doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1aade4906382a6c8d4004c7efac515d143:
.. index:: pair: function; ShuffleChannels
...
Constructs a :ref:`ShuffleChannels <doxid-classov_1_1op_1_1v0_1_1_shuffle_channels>` node.
...
.. list-table::
	...
	*
		...
		- Channel dimension index in the data tensor. A negative value means that the index should be calculated from the back of the input data shape.

	*
		- group

		- Number of group the channel dimension should be split into.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1ab177333ea246a2a9b9782318de22ae71:
...
.. _doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1af3c75cd41ad88a60261163e9162d7142:
...
.. _doxid-classov_1_1op_1_1v0_1_1_shuffle_channels_1a3e62178038208ad7948e5e2c3a1aac8b:
