.. index:: pair: interface; ngraph::snippets::pass::LoadMoveBroadcastToBroadcastLoad
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_load_move_broadcast_to_broadcast_load:

interface ngraph::snippets::pass::LoadMoveBroadcastToBroadcastLoad
==================================================================



Fuses consecutive Load and MoveBroadcast into a single load insctruction. The pass is used to convert model to a canonical form for code generation.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <load_movebroadcast_to_broadcastload.hpp>
	
	template LoadMoveBroadcastToBroadcastLoad: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	};
