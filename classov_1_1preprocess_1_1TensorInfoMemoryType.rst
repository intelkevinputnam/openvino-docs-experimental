.. index:: pair: class; ov::preprocess::TensorInfoMemoryType
.. _doxid-classov_1_1preprocess_1_1_tensor_info_memory_type:

class ov::preprocess::TensorInfoMemoryType
==========================================
...
.. ref-code-block:: cpp
	...
	class TensorInfoMemoryType: public :ref:`ov::RuntimeAttribute<doxid-classov_1_1_runtime_attribute>`
	{
	public:
		// fields
	
		std::string :target:`value<doxid-classov_1_1preprocess_1_1_tensor_info_memory_type_1ab62ebf13994ecd4ff29b970e30b2bc02>`;

		// construction
	
		:target:`TensorInfoMemoryType<doxid-classov_1_1preprocess_1_1_tensor_info_memory_type_1a44940d5c92decb859ebdcfff63d0f542>`();
		:target:`TensorInfoMemoryType<doxid-classov_1_1preprocess_1_1_tensor_info_memory_type_1ade01a3ffa1f875315817f0bd325c8e5e>`(const std::string& value);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1preprocess_1_1_tensor_info_memory_type_1a4c5d882b212bd9e302c103f69bf4e501>`("memory_type", "0");
		virtual bool :target:`visit_attributes<doxid-classov_1_1preprocess_1_1_tensor_info_memory_type_1ac15f79ed86b5ba27544fc71513bf5922>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
