.. index:: pair: class; ov::op::v3::ExtractImagePatches
.. _doxid-classov_1_1op_1_1v3_1_1_extract_image_patches:
...
:ref:`ExtractImagePatches <doxid-classov_1_1op_1_1v3_1_1_extract_image_patches>` operation. :ref:`More...<details-classov_1_1op_1_1v3_1_1_extract_image_patches>`
...
.. ref-code-block:: cpp
	...
	class ExtractImagePatches: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a4c773fb26e6825d4472df6ed04a3a70a>`;

		// construction
	
		:target:`ExtractImagePatches<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a6eeb0bc76805356a72bf5da67560d514>`();
	
		:ref:`ExtractImagePatches<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a5d346a66514fc6314d3ebaaa85eac086>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image,
			const :ref:`Shape<doxid-classov_1_1_shape>`& sizes,
			const :ref:`Strides<doxid-classov_1_1_strides>`& strides,
			const :ref:`Shape<doxid-classov_1_1_shape>`& rates,
			const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& auto_pad
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1acd0c6050f63b9b95533fd439fd659aa4>`("ExtractImagePatches", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1afc13d4bec21444318cdc87d083491191>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a63e2389eaaf55e7cfc644d02f2483604>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a64b970b3e2a3ded9123f97a8522b8c41>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Shape<doxid-classov_1_1_shape>`& :target:`get_sizes<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a7620a73bbd78d7d4d533cc40a65d5a11>`() const;
		void :target:`set_sizes<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a6e6f0e031b14ae5e1bb21a2d30721616>`(const :ref:`Shape<doxid-classov_1_1_shape>`& sizes);
		const :ref:`Strides<doxid-classov_1_1_strides>`& :target:`get_strides<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1ad1f97e2b27581326fb688b07e679e2f3>`() const;
		void :target:`set_strides<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1aa9e9cf00e27259d7d759394499f5ad7f>`(const :ref:`Strides<doxid-classov_1_1_strides>`& strides);
		const :ref:`Shape<doxid-classov_1_1_shape>`& :target:`get_rates<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a4941257602fbf73b112dd1ddeb5e04b5>`() const;
		void :target:`set_rates<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1aa826cb56f70308a108c56a5988922a82>`(const :ref:`Shape<doxid-classov_1_1_shape>`& rates);
		const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& :target:`get_auto_pad<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a0051c6e8a1d391b54645201b6bbee1a0>`() const;
		void :target:`set_auto_pad<doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a051856d66db6db076152313c942bbf6e>`(:ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& padding);
	};
...
.. _details-classov_1_1op_1_1v3_1_1_extract_image_patches:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ExtractImagePatches <doxid-classov_1_1op_1_1v3_1_1_extract_image_patches>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1a5d346a66514fc6314d3ebaaa85eac086:
.. index:: pair: function; ExtractImagePatches
...
Constructs a :ref:`ExtractImagePatches <doxid-classov_1_1op_1_1v3_1_1_extract_image_patches>` operation.
...
.. list-table::
	...
	*
		...
		- 4-D :ref:`Input <doxid-classov_1_1_input>` data to extract image patches

	*
		- sizes

		- Patch size in the format of [size_rows, size_cols]

	*
		- strides

		- Patch movement stride in the format of [stride_rows, stride_cols]

	*
		- rates

		- Element seleciton rate for creating a patch. in the format of [rate_rows, rate_cols]

	*
		- auto_pad

		- Padding type. it can be any value from valid, same_lower, same_upper

Methods
-------

.. _doxid-classov_1_1op_1_1v3_1_1_extract_image_patches_1afc13d4bec21444318cdc87d083491191:
