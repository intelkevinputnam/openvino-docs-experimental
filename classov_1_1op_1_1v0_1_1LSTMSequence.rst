.. index:: pair: class; ov::op::v0::LSTMSequence
.. _doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence:
...
Class for lstm sequence node. :ref:`More...<details-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence>`
...
.. ref-code-block:: cpp
	...
	class LSTMSequence: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// typedefs
	
		typedef :ref:`RecurrentSequenceDirection<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` :target:`direction<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a8a8c902333d85012f4e668f914e74050>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a771aa9d7fe254785c6362dfbbe9b84f1>`;

		// construction
	
		:target:`LSTMSequence<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a5baff65424a7d2b1210d90863e510db5>`();
	
		:target:`LSTMSequence<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a88123fe3d4f10b282bb85afa9cae38e5>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& sequence_lengths,
			...
			const :ref:`direction<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` lstm_direction,
		...
		:target:`LSTMSequence<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a0cce56a9de8efba1fed91865a519b0b8>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& X,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& initial_hidden_state,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& initial_cell_state,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& sequence_lengths,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a8c87f94d8aa8b8a1fe3fe47c37f7b295>`("LSTMSequence", "opset1");
		virtual size_t :ref:`get_default_output_index<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a1e6fe390f3422e2e9ff7305798a90632>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a5fcd18e2a4b3adadfaa5eb84312b3594>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a86fa3e571e105352789b64929e25c7bc>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a49c8697b384e6ba1047115bb8031952d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		std::vector<float> :target:`get_activations_alpha<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a31b003aa77f683fe968e716dfcb1bcb8>`() const;
		std::vector<float> :target:`get_activations_beta<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1ac0835f226bb41e59cd09fd97a88ff032>`() const;
		std::vector<std::string> :target:`get_activations<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a630bccc1ea4d8f9f5c6928c29e2f698d>`() const;
		float :target:`get_clip_threshold<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1aad02bc97323354aaa492acdae1fa0b85>`() const;
		:ref:`direction<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` :target:`get_direction<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a9512d824a9648efdc57518a21bdbab31>`() const;
		std::int64_t :target:`get_hidden_size<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1ad8cb60d27840dc86849925c93fa12863>`() const;
		bool :target:`get_input_forget<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1aedc4f171421a751482470b5756cb99da>`() const;
		:ref:`LSTMWeightsFormat<doxid-namespaceov_1_1op_1a6efe5db5f325a937a6662cd2b66e1437>` :target:`get_weights_format<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a05dc316cfb84be5964604f8e80be7bca>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence:
...
It follows notation and equations defined as in ONNX standard: `https://github.com/onnx/onnx/blob/master/docs/Operators.md#LSTM <https://github.com/onnx/onnx/blob/master/docs/Operators.md#LSTM>`__



.. rubric:: See also:

:ref:`LSTMCell <doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_cell>`, :ref:`RNNCell <doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell>`, GRUCell

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a1e6fe390f3422e2e9ff7305798a90632:
...
.. _doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence_1a5fcd18e2a4b3adadfaa5eb84312b3594:
