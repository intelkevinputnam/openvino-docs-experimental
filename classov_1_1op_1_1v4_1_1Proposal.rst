.. index:: pair: class; ov::op::v4::Proposal
.. _doxid-classov_1_1op_1_1v4_1_1_proposal:
...
:ref:`Proposal <doxid-classov_1_1op_1_1v4_1_1_proposal>` operation. :ref:`More...<details-classov_1_1op_1_1v4_1_1_proposal>`
...
.. ref-code-block:: cpp
	...
	class Proposal: public :ref:`ov::op::v0::Proposal<doxid-classov_1_1op_1_1v0_1_1_proposal>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_proposal_1acd2b66805aad428b5c6e97ac86bc0931>`;

		// construction
	
		:target:`Proposal<doxid-classov_1_1op_1_1v4_1_1_proposal_1ae523bfdc1888f9a83837bb8fc54f0183>`();
	
		:ref:`Proposal<doxid-classov_1_1op_1_1v4_1_1_proposal_1a4810c6b54652e3fb10ea3fd521306c69>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& class_probs,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& bbox_deltas,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image_shape,
			const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_proposal_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_proposal_1ab26b154309981abb09c4e0209496b762>`("Proposal", "opset4", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 4);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v4_1_1_proposal_1ab11f31fce7e63d661a9386e8d41eb08f>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_proposal_1a3dad6aeb24c3a6329a5d23ab4440d0e3>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_proposal_1_1_attributes>`& :target:`get_attrs<doxid-classov_1_1op_1_1v4_1_1_proposal_1a8484a60581aa6b8b9127e1538803f4e2>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_proposal_1_1_attributes>`;

		// fields
	
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_proposal_1ac986755807e353c07dbe9ff7d1928335>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_proposal_1aaa40067071a463367c5bf8dce3e76392>`("Proposal", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_proposal_1a7254dbeff7f230c3afc3ce160d53d0aa>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_proposal_1ac36bbf6d781c446a8dcb7e9717da6ba9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_proposal_1_1_attributes>`& :ref:`get_attrs<doxid-classov_1_1op_1_1v0_1_1_proposal_1a0ad1c3829bc1436e2b48c804cc3eee94>`() const;
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_proposal_1a4f4d4529a94756de409315c3028f09a9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v4_1_1_proposal:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Proposal <doxid-classov_1_1op_1_1v4_1_1_proposal>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v4_1_1_proposal_1a4810c6b54652e3fb10ea3fd521306c69:
.. index:: pair: function; Proposal
...
Constructs a :ref:`Proposal <doxid-classov_1_1op_1_1v4_1_1_proposal>` operation.
...
.. list-table::
	...
	*
		...
		- Prediction of bounding box deltas

	*
		- image_shape

		- :ref:`Shape <doxid-classov_1_1_shape>` of image

	*
		- attrs

		- :ref:`Proposal <doxid-classov_1_1op_1_1v4_1_1_proposal>` op attributes

Methods
-------

.. _doxid-classov_1_1op_1_1v4_1_1_proposal_1ab11f31fce7e63d661a9386e8d41eb08f:
