.. index:: pair: class; ConvertReduceBase
.. _doxid-class_convert_reduce_base:
...
.. ref-code-block:: cpp
	...
	class ConvertReduceBase: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		template <class T>
		ngraph::matcher_pass_callback :target:`convert_reduce_to_pooling<doxid-class_convert_reduce_base_1a8038b6478bf1b4fc7369543694407512>`();
	};
