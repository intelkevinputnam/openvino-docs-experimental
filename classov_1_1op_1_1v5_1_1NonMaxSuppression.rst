.. index:: pair: class; ov::op::v5::NonMaxSuppression
.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression:
...
.. toctree::
	...
	BoxEncodingType <enumov_1_1op_1_1v5_1_1NonMaxSuppression_1_1BoxEncodingType.rst>

Overview
~~~~~~~~

:ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation. :ref:`More...<details-classov_1_1op_1_1v5_1_1_non_max_suppression>`
...
.. ref-code-block:: cpp
	...
	class NonMaxSuppression: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a70cf714168b340471595abdf3c238928>`;

		// construction
	
		:target:`NonMaxSuppression<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a90a9b297b76dfe11883f6e633bf3f70e>`();
	
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a53952e2a0e9c4dc57cd64989912cb2a2>`(
			...
			const :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693>` box_encoding = :ref:`BoxEncodingType::CORNER<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693ac411afd31d32cec664d372acc12f404a>`,
		...
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a5dd25662a051e626f87fec68ddb0b304>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& boxes,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
		...
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a468d68cbddc3ffc4a0bff7360fcc2e9c>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& boxes,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& max_output_boxes_per_class,
		...
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1ab3b2320bfe4b3d2e9a0f108f030de512>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& boxes,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& max_output_boxes_per_class,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& iou_threshold,
		...
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a6671dd1d75c454faf51accca478355df>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& boxes,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& max_output_boxes_per_class,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& iou_threshold,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& score_threshold,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& soft_nms_sigma,
			const :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693>` box_encoding = :ref:`BoxEncodingType::CORNER<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693ac411afd31d32cec664d372acc12f404a>`,
			const bool sort_result_descending = true,
			const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& output_type = :ref:`ov::element::i64<doxid-group__ov__element__cpp__api_1ga6c86a9a54d44fc205ad9cbf28ca556a6>`
			);
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a2c94680d3a85701f6d7bd2cc3069e126>`("NonMaxSuppression", "opset5", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 5);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a5f110f23a0ffefadbd4c282a447629ca>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a78dcd853f42ba0518c703cd7d15429c0>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1aaa563fa3a5e116b1f98c250da58a4d39>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`BoxEncodingType<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693>` :target:`get_box_encoding<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a1b6c03225bcf89efeb82da7552fe5998>`() const;
		void :target:`set_box_encoding<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a8f144a04577a924ffe8fc1c02c2116d6>`(const :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1afad3db6910a6abd2b19d1db0fd8cb693>` box_encoding);
		bool :target:`get_sort_result_descending<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a4f0cbcbd12b53852415ee8af0323b5c0>`() const;
		void :target:`set_sort_result_descending<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1abe59809896a449f8eb3e8b6bc67ad11c>`(const bool sort_result_descending);
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_output_type<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a3f52fbd3620fa7d4fb3c8b9224b7b53b>`() const;
		void :target:`set_output_type<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1aa52de2e0128fdd08abcdf1509203988e>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type);
		int64_t :target:`max_boxes_output_from_input<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1aed5d0199edd67410b07437c7f64bbee9>`() const;
		float :target:`iou_threshold_from_input<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a3111a7ac56df06122c5bcb2cc1f68ea0>`() const;
		float :target:`score_threshold_from_input<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1ae258966696fd6678ade60898133267df>`() const;
		float :target:`soft_nms_sigma_from_input<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a7d76fdd428b21aeff4c04ba6814e9568>`() const;
		bool :target:`is_soft_nms_sigma_constant_and_default<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1ac59ba12436670689b45cdfc8a7d63431>`() const;
	
		void :target:`set_output_type<doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
...
.. _details-classov_1_1op_1_1v5_1_1_non_max_suppression:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a53952e2a0e9c4dc57cd64989912cb2a2:
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation with default values in the last 4 inputs.
...
.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a5dd25662a051e626f87fec68ddb0b304:
.. index:: pair: function; NonMaxSuppression
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation with default values in the last. 3 inputs.
...
.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a468d68cbddc3ffc4a0bff7360fcc2e9c:
.. index:: pair: function; NonMaxSuppression
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation with default values in the last. 2 inputs.
...
.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1ab3b2320bfe4b3d2e9a0f108f030de512:
.. index:: pair: function; NonMaxSuppression
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation with default value in the last. input.
...
.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a6671dd1d75c454faf51accca478355df:
.. index:: pair: function; NonMaxSuppression
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v5_1_1_non_max_suppression>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` specifying the sigma parameter for Soft-NMS
...
.. _doxid-classov_1_1op_1_1v5_1_1_non_max_suppression_1a78dcd853f42ba0518c703cd7d15429c0:
