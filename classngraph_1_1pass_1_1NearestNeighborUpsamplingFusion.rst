.. index:: pair: class; ngraph::pass::NearestNeighborUpsamplingFusion
.. _doxid-classngraph_1_1pass_1_1_nearest_neighbor_upsampling_fusion:
...
:ref:`NearestNeighborUpsamplingFusion <doxid-classngraph_1_1pass_1_1_nearest_neighbor_upsampling_fusion>` transformation fuses subgraph that uses the simpler operations, as ShapeOf, StridedSlice, Concat, Reshape, Mul to calculate Interpolate with mode='nearest'.
...
.. ref-code-block:: cpp
	...
	class NearestNeighborUpsamplingFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_nearest_neighbor_upsampling_fusion_1aade951b2c86bbb41e319b2ca92d3a729>`("NearestNeighborUpsamplingFusion", "0");
	};
