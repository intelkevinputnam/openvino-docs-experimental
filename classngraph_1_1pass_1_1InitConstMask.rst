.. index:: pair: class; ngraph::pass::InitConstMask
.. _doxid-classngraph_1_1pass_1_1_init_const_mask:
...
.. ref-code-block:: cpp
	...
	class InitConstMask: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// construction
	
		:target:`InitConstMask<doxid-classngraph_1_1pass_1_1_init_const_mask_1ac479b17706c0b8ef51c80f170d22aab6>`(
			const :ref:`ngraph::AxisSet<doxid-classov_1_1_axis_set>`& dims,
			const std::function<bool(const double&value)>& condition = [](const double&value) { return value==0;}
			);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_init_const_mask_1acfe46194b39823ccb96914921e0e09ca>`("InitConstMask", "0");
	};
