.. index:: pair: class; ngraph::op::PadIE
.. _doxid-classngraph_1_1op_1_1_pad_i_e:

class ngraph::op::PadIE
=======================
...
.. ref-code-block:: cpp
	...
	class PadIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_pad_i_e_1a61cc1b8858297670ced4062aa16b6977>`;

		// construction
	
		:target:`PadIE<doxid-classngraph_1_1op_1_1_pad_i_e_1a63880c122f531edc80ccdefa70dd139a>`(const std::shared_ptr<:ref:`op::v1::Pad<doxid-classov_1_1op_1_1v1_1_1_pad>`>& pad);
	
		:target:`PadIE<doxid-classngraph_1_1op_1_1_pad_i_e_1ab09a4258b0bc0abc1fdb7762fafbd72e>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`ngraph::Node<doxid-classov_1_1_node>`>& input,
			PadMode pad_mode,
			...
			:ref:`Shape<doxid-classov_1_1_shape>` output_shape,
			float pad_value
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_pad_i_e_1a379f728c52c99abb7fb0b7e2f7b14bd3>`("PadIE", "legacy");
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` size_t :ref:`get_version<doxid-classngraph_1_1op_1_1_pad_i_e_1ab4dd4f3bd0ab726c5f16dfc2509805aa>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_pad_i_e_1adf8a90a8a87f7297611ebb7c7ec55b19>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_pad_i_e_1a303c542bb034a217582f45ffb675f94f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_pad_i_e_1a0b65d61ffaa5bb6a4263223165560f56>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		PadMode :target:`get_pad_mode<doxid-classngraph_1_1op_1_1_pad_i_e_1a03c3786e5b76314d2196a0d016b62d31>`();
		:ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>` :target:`get_pads_begin<doxid-classngraph_1_1op_1_1_pad_i_e_1a54141fea8002c6a91cea17ab3f9ccdd2>`();
		:ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>` :target:`get_pads_end<doxid-classngraph_1_1op_1_1_pad_i_e_1a6d16fe6093e1a14a5667f3570d427ea7>`();
		float :target:`get_pad_value<doxid-classngraph_1_1op_1_1_pad_i_e_1a21352f7a00621c2234cedf74e75f317b>`();
	};
...
.. _details-classngraph_1_1op_1_1_pad_i_e:
...
.. _doxid-classngraph_1_1op_1_1_pad_i_e_1ab4dd4f3bd0ab726c5f16dfc2509805aa:
.. index:: pair: function; get_version

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` size_t get_version() const
...
.. _doxid-classngraph_1_1op_1_1_pad_i_e_1adf8a90a8a87f7297611ebb7c7ec55b19:
.. index:: pair: function; validate_and_infer_types

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` void validate_and_infer_types()
