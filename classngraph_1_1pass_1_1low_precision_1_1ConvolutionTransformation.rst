.. index:: pair: class; ngraph::pass::low_precision::ConvolutionTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation:
...
:ref:`ConvolutionTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation>` propagates dequantization operations through Convolution operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation>`
...
.. ref-code-block:: cpp
	...
	class ConvolutionTransformation: public :ref:`ngraph::pass::low_precision::WeightableLayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_weightable_layer_transformation>`
	{
	public:
		// construction
	
		:target:`ConvolutionTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation_1a6ceef147e2f75993204c3622324fe901>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation_1a4fdcdc7d3e32751e51a661a5ab313fd2>`("ConvolutionTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation_1a49f2af09c05e140089c3e27102a1d2d4>`(
		...
		virtual bool :target:`isQuantized<doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation_1a6cb1f7b7dfae9748e05f1b635b40d4d3>`(
		...
		static bool :target:`isQuantizedStatic<doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation_1ab08cc91e5889aa720994fe55c83f964f>`(
			const std::shared_ptr<const :ref:`Node<doxid-classov_1_1_node>`>& layer,
			const std::vector<:ref:`ngraph::element::Type<doxid-classov_1_1element_1_1_type>`>& defaultPrecisions
			);
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ConvolutionTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_convolution_transformation>` propagates dequantization operations through Convolution operation.

For more details about the transformation, refer to :ref:`ConvolutionTransformation <doxid-openvino_docs__o_v__u_g_lpt__convolution_transformation>` page in the Inference Engine Developer Guide.
