.. index:: pair: class; ngraph::pass::ConvertSwishToSwishIEMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_swish_to_swish_i_e_matcher:

class ngraph::pass::ConvertSwishToSwishIEMatcher
================================================
...
.. ref-code-block:: cpp
	...
	#include <convert_swish_to_swish_ie.hpp>
	
	class ConvertSwishToSwishIEMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_swish_to_swish_i_e_matcher_1aadb0dd9735d8d9a82a1c7cdb9f2e9c5e>`("ConvertSwishToSwishIEMatcher", "0");
	};
