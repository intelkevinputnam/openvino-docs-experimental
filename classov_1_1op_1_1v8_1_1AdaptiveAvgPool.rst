.. index:: pair: class; ov::op::v8::AdaptiveAvgPool
.. _doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool:
...
Adaptive average pooling operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_adaptive_avg_pool>`
...
.. ref-code-block:: cpp
	...
	class AdaptiveAvgPool: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1a4f67792663ae2e97b2b93e8d1448acf2>`;

		// construction
	
		:target:`AdaptiveAvgPool<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1abcf431c758429e5c827ae035198187a5>`();
		:ref:`AdaptiveAvgPool<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1a2278ca7221be200172adf27075b46b62>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& output_shape);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1ac00910fff1a4b20918c3333af995e94b>`("AdaptiveAvgPool", "opset8");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1ae2e4184d81978777816fa6435c97740d>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1a263ab2691ec8ccd19aa67d79bdee18cf>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1ab8707350da60f81442143e6e7ecba61a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v8_1_1_adaptive_avg_pool:
...
.. _doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1a2278ca7221be200172adf27075b46b62:
.. index:: pair: function; AdaptiveAvgPool

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	AdaptiveAvgPool(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& output_shape)
...
.. _doxid-classov_1_1op_1_1v8_1_1_adaptive_avg_pool_1ae2e4184d81978777816fa6435c97740d:
