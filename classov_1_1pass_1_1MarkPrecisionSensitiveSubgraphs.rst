.. index:: pair: class; ov::pass::MarkPrecisionSensitiveSubgraphs
.. _doxid-classov_1_1pass_1_1_mark_precision_sensitive_subgraphs:
...
:ref:`MarkPrecisionSensitiveSubgraphs <doxid-classov_1_1pass_1_1_mark_precision_sensitive_subgraphs>` transformation marks the constants inside the subgraph starting from precision-sensitive input and ending at the ShapeOf node as disabled for FP16 compression.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <mark_precision_sensitive_subgraphs.hpp>
	
	class MarkPrecisionSensitiveSubgraphs: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_mark_precision_sensitive_subgraphs_1afba155848837930c0775af250671cfff>`("MarkPrecisionSensitiveSubgraphs", "0");
		virtual bool :target:`run_on_model<doxid-classov_1_1pass_1_1_mark_precision_sensitive_subgraphs_1a469233302ef5023a7319c3664b08f285>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>& f);
	};
