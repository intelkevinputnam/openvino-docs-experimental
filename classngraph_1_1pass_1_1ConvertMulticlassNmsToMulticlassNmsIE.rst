.. index:: pair: class; ngraph::pass::ConvertMulticlassNmsToMulticlassNmsIE
.. _doxid-classngraph_1_1pass_1_1_convert_multiclass_nms_to_multiclass_nms_i_e:

class ngraph::pass::ConvertMulticlassNmsToMulticlassNmsIE
=========================================================
...
.. ref-code-block:: cpp
	...
	class ConvertMulticlassNmsToMulticlassNmsIE: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// construction
	
		:target:`ConvertMulticlassNmsToMulticlassNmsIE<doxid-classngraph_1_1pass_1_1_convert_multiclass_nms_to_multiclass_nms_i_e_1a7c0ab37327131a0caac0f3296671bd69>`(bool force_i32_output_type = true);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_multiclass_nms_to_multiclass_nms_i_e_1a878b84408e2558d4a73a5a0ac16d21e9>`("public", "0");
	};
