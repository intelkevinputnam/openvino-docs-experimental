.. index:: pair: class; ov::op::v3::Broadcast
.. _doxid-classov_1_1op_1_1v3_1_1_broadcast:
...
Operation which "adds" axes to an input tensor, replicating elements from the input as needed along the new axes. :ref:`More...<details-classov_1_1op_1_1v3_1_1_broadcast>`
...
.. ref-code-block:: cpp
	...
	class Broadcast: public :ref:`ov::op::util::BroadcastBase<doxid-classov_1_1op_1_1util_1_1_broadcast_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_broadcast_1aff6dbc8f38405544aeaf3ee06727a06a>`;

		// construction
	
		:ref:`Broadcast<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a6dc054ccaeda203f5e78a462deee92ff>`();
	
		:ref:`Broadcast<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a68436f4e9288b874daf7f122e638b9da>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& target_shape,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& axes_mapping,
			const :ref:`BroadcastModeSpec<doxid-structov_1_1op_1_1_broadcast_mode_spec>`& broadcast_spec = BroadcastType::EXPLICIT
			);
	
		:ref:`Broadcast<doxid-classov_1_1op_1_1v3_1_1_broadcast_1abd57fc47ffb8c251ecabf555d0db142c>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& target_shape,
			const :ref:`BroadcastModeSpec<doxid-structov_1_1op_1_1_broadcast_mode_spec>`& broadcast_spec = :ref:`BroadcastType::NUMPY<doxid-namespaceov_1_1op_1a6dc7edf14421aa3ec0072ef976f0bdeaad677ba7339dd3c0243cd3257b80be8f5>`
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a911ce6bf2a39f97065aa4763fe7e145f>`("Broadcast", "opset3", :ref:`op::util::BroadcastBase<doxid-classov_1_1op_1_1util_1_1_broadcast_base>`, 3);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a73563502c619ac22d0c6e196d2fb22ec>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_broadcast_1ac58527273ccfad06de66ea9c6ab71058>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`BroadcastModeSpec<doxid-structov_1_1op_1_1_broadcast_mode_spec>`& :target:`get_broadcast_spec<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a62697cfea669774d90a5117275f066d5>`() const;
		void :target:`set_broadcast_spec<doxid-classov_1_1op_1_1v3_1_1_broadcast_1ac9acc1a8c56167c16eafd846423617d8>`(const :ref:`BroadcastModeSpec<doxid-structov_1_1op_1_1_broadcast_mode_spec>`& broadcast_spec);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a0665962a4cbe82d097804e90aaba956f>`();
		virtual std::pair<bool, :ref:`AxisSet<doxid-classov_1_1_axis_set>`> :ref:`get_broadcast_axes<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a517995d8bcce6a3fc92cdab000e20bde>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_broadcast_1a4fbdccae34e6ed8598a9d6a219e424bd>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_broadcast_1acb41ed0a15bd91084619db4fd468905b>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_broadcast_base_1afa1b8f7460c3e27e9b8486a4c760a699>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_broadcast_base_1ae3154c61c311ff3ffd506b8afc9d0381>`("BroadcastBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_broadcast_base_1a3c2eb0c9f5753b23fdb0936b5abd64ed>`();
		virtual std::pair<bool, :ref:`AxisSet<doxid-classov_1_1_axis_set>`> :ref:`get_broadcast_axes<doxid-classov_1_1op_1_1util_1_1_broadcast_base_1acede1aecefe143e0b7f031db694c075a>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1util_1_1_broadcast_base_1a23d771d927bc8befe5eab475180f54d0>`(
			const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values,
			const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& input_values
			) const;
	
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` const :ref:`BroadcastModeSpec<doxid-structov_1_1op_1_1_broadcast_mode_spec>`& :ref:`get_broadcast_spec<doxid-classov_1_1op_1_1util_1_1_broadcast_base_1af44eb6d6f712fb8677d73caeaf379db1>`() const;

.. _details-classov_1_1op_1_1v3_1_1_broadcast:
...
.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1a6dc054ccaeda203f5e78a462deee92ff:
...
.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1a68436f4e9288b874daf7f122e638b9da:
.. index:: pair: function; Broadcast
...
.. list-table::
	...
	*
		...
		- The input tensor to be broadcast.
	...
	*
		...
		- The axis positions (0-based) in the result that correspond to input axes. 'Arg' tensor is broadcast along the remaining axes. E.g., :ref:`Input <doxid-classov_1_1_input>` :ref:`Shape <doxid-classov_1_1_shape>` - [3, 4], Target :ref:`Shape <doxid-classov_1_1_shape>` - [3, 5, 4, 4] axes_mapping - [0, 2] => :ref:`Broadcast <doxid-classov_1_1op_1_1v3_1_1_broadcast>` along axes 1 and 3. axes_mapping - [0, 3] => :ref:`Broadcast <doxid-classov_1_1op_1_1v3_1_1_broadcast>` along axes 1 and 2.

	*
		- broadcast_spec

		- :ref:`Broadcast <doxid-classov_1_1op_1_1v3_1_1_broadcast>` specification to use for determining broadcast axes. 'axes_mapping' should not be provided if mode other than explicit (none) is used.

.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1abd57fc47ffb8c251ecabf555d0db142c:
.. index:: pair: function; Broadcast
...
.. list-table::
	...
	*
		...
		- :ref:`Broadcast <doxid-classov_1_1op_1_1v3_1_1_broadcast>` specification to use for determining broadcast axes

Methods
-------

.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1a0665962a4cbe82d097804e90aaba956f:
...
.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1a517995d8bcce6a3fc92cdab000e20bde:
.. index:: pair: function; get_broadcast_axes

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual std::pair<bool, :ref:`AxisSet<doxid-classov_1_1_axis_set>`> get_broadcast_axes() const



.. rubric:: Returns:

true and the :ref:`AxisSet <doxid-classov_1_1_axis_set>` if broadcast axes can be fully determined.

.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1a4fbdccae34e6ed8598a9d6a219e424bd:
...
.. _doxid-classov_1_1op_1_1v3_1_1_broadcast_1acb41ed0a15bd91084619db4fd468905b:
