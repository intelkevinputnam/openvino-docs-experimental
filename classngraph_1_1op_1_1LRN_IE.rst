.. index:: pair: class; ngraph::op::LRN_IE
.. _doxid-classngraph_1_1op_1_1_l_r_n___i_e:

class ngraph::op::LRN_IE
========================
...
.. ref-code-block:: cpp
	...
	class LRN_IE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a6bdbd63d35ef1de54c0e7bb0d9a30359>`;

		// construction
	
		:target:`LRN_IE<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a5344689e54404d4c34bd83a49d733cfe>`();
	
		:target:`LRN_IE<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a48960eac584d13ec2ac66feae9f53140>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a255b959ee97ad880ae1370e867e2af51>`("LRN_IE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1af9ad0ea9c7c755cba9b2abf4a2f70d92>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a5529636e2e6509063ab33bdb63676b60>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1afba855f55e4a1532507c78f72b18ecd2>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		double :target:`get_alpha<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a1049db0e6f868475e39d3de8c997b515>`() const;
		void :target:`set_alpha<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a995487c1413f1151dc5aeee24881045e>`(double alpha);
		double :target:`get_beta<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1ae681705dc3091ff24f67a1a7674ad6d0>`() const;
		void :target:`set_beta<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a8f01b7b11187a1cced4db3681c1adeba>`(double beta);
		double :target:`get_bias<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1afa70591e752edc7518d7b2da8ed1e2c9>`() const;
		void :target:`set_bias<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a3b59dd75f686f30d477f74dcc3dd5bc5>`(double bias);
		size_t :target:`get_nsize<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a5a0340f4e89b8b934c1a5cfc599104aa>`() const;
		void :target:`set_nsize<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a9bf3aaa0c6010ff1332bc1f94eef0545>`(size_t size);
		std::string :target:`get_region<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a384f9aeb9ae251fadcb24f431ba35ee2>`() const;
		void :target:`set_region<doxid-classngraph_1_1op_1_1_l_r_n___i_e_1ad30492aed21cbe4bd5acb3d1e0ee9269>`(std::string region);
	};
...
.. _details-classngraph_1_1op_1_1_l_r_n___i_e:
...
.. _doxid-classngraph_1_1op_1_1_l_r_n___i_e_1a5529636e2e6509063ab33bdb63676b60:
