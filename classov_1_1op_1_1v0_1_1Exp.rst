.. index:: pair: class; ov::op::v0::Exp
.. _doxid-classov_1_1op_1_1v0_1_1_exp:
...
Elementwise natural exponential (exp) operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_exp>`
...
.. ref-code-block:: cpp
	...
	class Exp: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_exp_1a34d8a03de0492d7eedcbf5c7a81593cf>`;

		// construction
	
		:ref:`Exp<doxid-classov_1_1op_1_1v0_1_1_exp_1aa626f6bc66bf2a0c0058789a7f17650d>`();
		:ref:`Exp<doxid-classov_1_1op_1_1v0_1_1_exp_1a2df726b0cd635d93f34068982f5956ff>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_exp_1a2248cc84fb1854c55df51c53e8ba93ab>`("Exp", "opset1", :ref:`UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic_1a35577b8f277e3d60c4707e5dfcc14527>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_exp_1ad71e59af3b02879a24e7f9aedfd0563c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_exp_1a916928ff38518f247b3c3372c217df77>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_exp_1a09d6b52e6feefccfc67b6c0e8bb5c18a>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_exp_1ab6eccca059506739ba1d8e9c046f4069>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_exp:
...
.. _doxid-classov_1_1op_1_1v0_1_1_exp_1aa626f6bc66bf2a0c0058789a7f17650d:
...
.. _doxid-classov_1_1op_1_1v0_1_1_exp_1a2df726b0cd635d93f34068982f5956ff:
.. index:: pair: function; Exp

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Exp(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_exp_1a09d6b52e6feefccfc67b6c0e8bb5c18a:
...
.. _doxid-classov_1_1op_1_1v0_1_1_exp_1ab6eccca059506739ba1d8e9c046f4069:
