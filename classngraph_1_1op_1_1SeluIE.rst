.. index:: pair: class; ngraph::op::SeluIE
.. _doxid-classngraph_1_1op_1_1_selu_i_e:

class ngraph::op::SeluIE
========================
...
.. ref-code-block:: cpp
	...
	class SeluIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_selu_i_e_1a8dab717fb7ac797efb41251b2b2852ce>`;
		float :target:`gamma<doxid-classngraph_1_1op_1_1_selu_i_e_1abe860d797d3e4fcfae97eb39d12bf58f>`;
		float :target:`alpha<doxid-classngraph_1_1op_1_1_selu_i_e_1a5054f04b5a5049ea59c7c4af90c1282e>`;

		// construction
	
		:target:`SeluIE<doxid-classngraph_1_1op_1_1_selu_i_e_1af5fa6bdbb04949bd5da9e9c9e64184b4>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input, const float alpha, const float gamma);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_selu_i_e_1a4036d30a477293cf1bc5b224167a72fb>`("SeluIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_selu_i_e_1abe081c3b918295949af19f6e68065108>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_selu_i_e_1a862526ab6b9ff8cd4319485d1ae0d104>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_selu_i_e_1a1eb50d317ed2787c53d3499e3473d95a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_selu_i_e:
...
.. _doxid-classngraph_1_1op_1_1_selu_i_e_1abe081c3b918295949af19f6e68065108:
