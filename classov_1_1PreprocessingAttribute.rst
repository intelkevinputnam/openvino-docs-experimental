.. index:: pair: class; ov::PreprocessingAttribute
.. _doxid-classov_1_1_preprocessing_attribute:

class ov::PreprocessingAttribute
================================
...
.. ref-code-block:: cpp
	...
	class PreprocessingAttribute: public :ref:`ov::RuntimeAttribute<doxid-classov_1_1_runtime_attribute>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1_preprocessing_attribute_1ac041d4c9034290115c816e6c3455b032>`("preprocessing", "0");
		virtual bool :target:`visit_attributes<doxid-classov_1_1_preprocessing_attribute_1af88087ba0f688ef6c2846d616a09a4dc>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
