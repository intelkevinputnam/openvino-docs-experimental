.. index:: pair: class; ov::op::v1::Convolution
.. _doxid-classov_1_1op_1_1v1_1_1_convolution:
...
Batched convolution operation, with optional window dilation and stride. :ref:`More...<details-classov_1_1op_1_1v1_1_1_convolution>`
...
.. ref-code-block:: cpp
	...
	class Convolution: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_convolution_1ab3aa3eff9876f8cccd73df4d6c87cb9a>`;

		// construction
	
		:ref:`Convolution<doxid-classov_1_1op_1_1v1_1_1_convolution_1a5fc96bac664355dcc63799c0206c1cb3>`();
	
		:ref:`Convolution<doxid-classov_1_1op_1_1v1_1_1_convolution_1a9b5b533568aad7161da3d8f8fc3da2cd>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_convolution_1a408934fc2571ddcbc2bfc3feefb4a849>`("Convolution", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_convolution_1a1105ded0f8d1bacff405ffbdb37ceaff>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_convolution_1aabd8481af6a6e4722ea74c4ebcef2edc>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_convolution_1abc8dace3ea47b142d3a0bb675f2f0681>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_strides<doxid-classov_1_1op_1_1v1_1_1_convolution_1adbcb4f89c2dbc8ee164208880384f8d5>`() const;
		void :target:`set_strides<doxid-classov_1_1op_1_1v1_1_1_convolution_1a57bd0f217f4d1e9b3040be61c2a77be1>`(const :ref:`Strides<doxid-classov_1_1_strides>`& strides);
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_dilations<doxid-classov_1_1op_1_1v1_1_1_convolution_1adc04cb99c9dccda30c6eec3ea2d3e1ae>`() const;
		void :target:`set_dilations<doxid-classov_1_1op_1_1v1_1_1_convolution_1a7b55ab27cde7cb5d238a3c556e2148bd>`(const :ref:`Strides<doxid-classov_1_1_strides>`& dilations);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_begin<doxid-classov_1_1op_1_1v1_1_1_convolution_1a5dfb908e6d1e69c80090259fcbe81bf5>`() const;
		void :target:`set_pads_begin<doxid-classov_1_1op_1_1v1_1_1_convolution_1a57c44a5eb0c877564dd1d3cbdad7c0c8>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_end<doxid-classov_1_1op_1_1v1_1_1_convolution_1af558886c2cb6185777e1c5f455a20358>`() const;
		void :target:`set_adding_above<doxid-classov_1_1op_1_1v1_1_1_convolution_1a864047e1d5ed9ac6f8325296f250603b>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_end);
		const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& :ref:`get_auto_pad<doxid-classov_1_1op_1_1v1_1_1_convolution_1a3099f4e2c78229adea97f889f55122b2>`() const;
		void :target:`set_auto_pad<doxid-classov_1_1op_1_1v1_1_1_convolution_1afaadc614c66ee8284feb32ff9cd678c5>`(const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& auto_pad);
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`get_default_value<doxid-classov_1_1op_1_1v1_1_1_convolution_1a9f9a186b3eb6f2695dd0b592178333e3>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_convolution:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1a5fc96bac664355dcc63799c0206c1cb3:
.. index:: pair: function; Convolution
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1a9b5b533568aad7161da3d8f8fc3da2cd:
.. index:: pair: function; Convolution
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1a1105ded0f8d1bacff405ffbdb37ceaff:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1adbcb4f89c2dbc8ee164208880384f8d5:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1adc04cb99c9dccda30c6eec3ea2d3e1ae:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1a5dfb908e6d1e69c80090259fcbe81bf5:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1af558886c2cb6185777e1c5f455a20358:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1a3099f4e2c78229adea97f889f55122b2:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convolution_1a9f9a186b3eb6f2695dd0b592178333e3:
