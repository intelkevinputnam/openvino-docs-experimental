.. index:: pair: class; ngraph::pass::HSwishFusionWithClamp
.. _doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_clamp:
...
:ref:`HSwishFusion <doxid-classngraph_1_1pass_1_1_h_swish_fusion>` transformation replaces a sub-graph (Clamp(x + 3, 0, 6) \* x) with a HSwish \* 6.
...
.. ref-code-block:: cpp
	...
	class HSwishFusionWithClamp: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_clamp_1a60be3ee32f9b7ab1dea8250dec50682e>`("HSwishFusionWithClamp", "0");
	};
