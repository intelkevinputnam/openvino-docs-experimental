.. index:: pair: class; ov::pass::pattern::op::AnyOf
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of:
...
The graph value is added to the matched values list. :ref:`More...<details-classov_1_1pass_1_1pattern_1_1op_1_1_any_of>`
...
.. ref-code-block:: cpp
	...
	class AnyOf: public :ref:`ov::pass::pattern::op::Pattern<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_pattern>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1a7756a02fea0f1506c6c0d958ad275118>`;

		// construction
	
		:ref:`AnyOf<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1af1fd0ff5a3f6727fd1287608ca4661ee>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
			const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& s,
			:ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>` pred,
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& wrapped_values
			);
	
		:target:`AnyOf<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1a0e6d99000571db6a9a25c72f915046e1>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
			const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& s,
			:ref:`NodePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a773344323e39ff5d3e25bc79c06dac5d>` pred,
			const :ref:`NodeVector<doxid-namespaceov_1a750141ccb27d75af03e91a5295645c7f>`& wrapped_values
			);
	
		:ref:`AnyOf<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1a515a1445b7ba8b03ea3650db4e3364ae>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& node,
			:ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>` pred,
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& wrapped_values
			);
	
		:target:`AnyOf<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1a606aa0eaa8c56605ab2514efbfe5fb20>`(
		...
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1ac13cca3658c6955f00d5e878f78911b9>`("patternAnyOf");
	
		virtual bool :target:`match_value<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1a42901cc0cf5ad3ba030672a4db45db2c>`(
...
.. _details-classov_1_1pass_1_1pattern_1_1op_1_1_any_of:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

The graph value is added to the matched values list. If the predicate is true for the graph node, a submatch is performed on the input of :ref:`AnyOf <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of>` and each input of the graph node. The first match that succeeds results in a successful match. Otherwise the match fails.

:ref:`AnyOf <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of>` may be given a type and shape for use in strict mode.

Construction
------------

.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1af1fd0ff5a3f6727fd1287608ca4661ee:
.. index:: pair: function; AnyOf
...
creates a :ref:`AnyOf <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of>` node containing a sub-pattern described by
...
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of_1a515a1445b7ba8b03ea3650db4e3364ae:
.. index:: pair: function; AnyOf
...
creates a :ref:`AnyOf <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_of>` node containing a sub-pattern described by the type and shape of
