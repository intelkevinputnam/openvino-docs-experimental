.. index:: pair: class; ov::op::v0::Range
.. _doxid-classov_1_1op_1_1v0_1_1_range:
...
:ref:`Range <doxid-classov_1_1op_1_1v0_1_1_range>` operation, analogous to ``:ref:`range() <doxid-namespacengraph_1_1runtime_1_1reference_1ad4febc283556b72366456bf31e0236ac>``` in Python. :ref:`More...<details-classov_1_1op_1_1v0_1_1_range>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_range_1a742ef213c5f0f6dc43a65f9b33a6f5e7>`;

		// construction
	
		:ref:`Range<doxid-classov_1_1op_1_1v0_1_1_range_1ae5a5d87db3b9423bf80e483c10dad0fb>`();
	
		:ref:`Range<doxid-classov_1_1op_1_1v0_1_1_range_1a40e3ab0f1aa14a9a810a3087b1a9fd53>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_range_1a745c1a2f93db9b72d0a0cd330ab4f11f>`("Range", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_range_1a9d9dab09252649d31ae603c4dae949f4>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_range_1acebdaa40f363a63307642e0039bfe4cc>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_range_1aaecb32b6283b1f64e24dcbebdd2a2329>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_range_1a94216ea0fe68215d2c5f5558d97a7a5a>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_range_1a3ae5a14171dc2c8a27d9a60254f934fc>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_range:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Range <doxid-classov_1_1op_1_1v0_1_1_range>` operation, analogous to ``:ref:`range() <doxid-namespacengraph_1_1runtime_1_1reference_1ad4febc283556b72366456bf31e0236ac>``` in Python.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_range_1ae5a5d87db3b9423bf80e483c10dad0fb:
...
.. _doxid-classov_1_1op_1_1v0_1_1_range_1a40e3ab0f1aa14a9a810a3087b1a9fd53:
.. index:: pair: function; Range
...
.. list-table::
	...
	*
		...
		- The tensor producing the start value. Must be a scalar of integer element type, and same element type as ``stop`` and ``step``.

	*
		- stop

		- The tensor producing the stop value. Must be a scalar of integer element type, and same element type as ``start`` and ``step``.

	*
		- step

		- The tensor producing the step value. Must be a scalar of integer element type, and same element type as ``start`` and ``stop``.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_range_1acebdaa40f363a63307642e0039bfe4cc:
...
.. _doxid-classov_1_1op_1_1v0_1_1_range_1a94216ea0fe68215d2c5f5558d97a7a5a:
...
.. _doxid-classov_1_1op_1_1v0_1_1_range_1a3ae5a14171dc2c8a27d9a60254f934fc:
