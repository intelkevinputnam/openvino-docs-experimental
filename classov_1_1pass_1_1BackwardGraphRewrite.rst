.. index:: pair: class; ov::pass::BackwardGraphRewrite
.. _doxid-classov_1_1pass_1_1_backward_graph_rewrite:
...
.. ref-code-block:: cpp
	...
	class BackwardGraphRewrite: public :ref:`ov::pass::GraphRewrite<doxid-classov_1_1pass_1_1_graph_rewrite>`
	{
	public:
		// construction
	
		:target:`BackwardGraphRewrite<doxid-classov_1_1pass_1_1_backward_graph_rewrite_1a8ac2245bd78533ace76daae056868d4b>`();
		:target:`BackwardGraphRewrite<doxid-classov_1_1pass_1_1_backward_graph_rewrite_1a9e2a25fec572dd822362fde3ac2ba9d1>`(const std::shared_ptr<:ref:`MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`>& pass);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_backward_graph_rewrite_1a677b0cec339c8af384a77b39f7e2de70>`("ov::pass::BackwardGraphRewrite");
		virtual bool :target:`run_on_model<doxid-classov_1_1pass_1_1_backward_graph_rewrite_1a0166b72852531af8ba442b9d6a0c62c3>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>& m);
	};
