.. index:: pair: class; ov::op::v4::Interpolate
.. _doxid-classov_1_1op_1_1v4_1_1_interpolate:
...
.. toctree::
	...
	CoordinateTransformMode <enumov_1_1op_1_1v4_1_1Interpolate_1_1CoordinateTransformMode.rst>
	InterpolateMode <enumov_1_1op_1_1v4_1_1Interpolate_1_1InterpolateMode.rst>
	NearestMode <enumov_1_1op_1_1v4_1_1Interpolate_1_1NearestMode.rst>
	ShapeCalcMode <enumov_1_1op_1_1v4_1_1Interpolate_1_1ShapeCalcMode.rst>
	InterpolateAttrs <structov_1_1op_1_1v4_1_1Interpolate_1_1InterpolateAttrs.rst>

Overview
~~~~~~~~

:ref:`Interpolate <doxid-classov_1_1op_1_1v4_1_1_interpolate>` operation. :ref:`More...<details-classov_1_1op_1_1v4_1_1_interpolate>`
...
.. ref-code-block:: cpp
	...
	class Interpolate: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`CoordinateTransformMode<doxid-classov_1_1op_1_1v4_1_1_interpolate_1aa769e0059d897c8dc7187f8df8a753e5>`;
		enum :ref:`InterpolateMode<doxid-classov_1_1op_1_1v4_1_1_interpolate_1a567d8870044804dc59d6d6e3df290da7>`;
		enum :ref:`NearestMode<doxid-classov_1_1op_1_1v4_1_1_interpolate_1ad79e2d96abdf4d07b5d9f322372149c2>`;
		enum :ref:`ShapeCalcMode<doxid-classov_1_1op_1_1v4_1_1_interpolate_1aeea9e299094216009ca1d3e18c029faa>`;

		// structs
	
		struct :ref:`InterpolateAttrs<doxid-structov_1_1op_1_1v4_1_1_interpolate_1_1_interpolate_attrs>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_interpolate_1ade789d790dd38d7e6234657305ca71ff>`;

		// construction
	
		:target:`Interpolate<doxid-classov_1_1op_1_1v4_1_1_interpolate_1add8002650f78b5a111b3c5c03f1c3d31>`();
	
		:ref:`Interpolate<doxid-classov_1_1op_1_1v4_1_1_interpolate_1aced8080c5aefc662069482a173ac5749>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& output_shape,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scales,
			const :ref:`InterpolateAttrs<doxid-structov_1_1op_1_1v4_1_1_interpolate_1_1_interpolate_attrs>`& attrs
			);
	
		:ref:`Interpolate<doxid-classov_1_1op_1_1v4_1_1_interpolate_1aa517edf3437304455df4e6d70b3a6545>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& output_shape,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scales,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_interpolate_1a1e80fb65b0a09fe75c5a407e47842ea6>`("Interpolate", "opset4", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 4);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v4_1_1_interpolate_1a408a19743bbcc03c5a3cfedbc299b96d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v4_1_1_interpolate_1a1d313f019ecbaa2cf5b31525ac4f156a>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_interpolate_1a745f00ab787726585097b7e8bc1ba4c2>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v4_1_1_interpolate_1aca8834f934e0438b43de77c0bf932f59>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v4_1_1_interpolate_1a22975633cc34642afd3dfe07a0f5b12d>`() const;
		const :ref:`InterpolateAttrs<doxid-structov_1_1op_1_1v4_1_1_interpolate_1_1_interpolate_attrs>`& :target:`get_attrs<doxid-classov_1_1op_1_1v4_1_1_interpolate_1ab6c340045264856d6bbd0be5407d8d49>`() const;
	};
...
.. _details-classov_1_1op_1_1v4_1_1_interpolate:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Interpolate <doxid-classov_1_1op_1_1v4_1_1_interpolate>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v4_1_1_interpolate_1aced8080c5aefc662069482a173ac5749:
...
Constructs a :ref:`Interpolate <doxid-classov_1_1op_1_1v4_1_1_interpolate>` operation without 'axes' input.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` image

	*
		- output_shape

		- :ref:`Output <doxid-classov_1_1_output>` shape of spatial axes

	*
		- scales

		- Scales of spatial axes, i.e. output_shape / input_shape
...
.. _doxid-classov_1_1op_1_1v4_1_1_interpolate_1aa517edf3437304455df4e6d70b3a6545:
.. index:: pair: function; Interpolate
...
Constructs a :ref:`Interpolate <doxid-classov_1_1op_1_1v4_1_1_interpolate>` operation with 'axes' input.
...
.. _doxid-classov_1_1op_1_1v4_1_1_interpolate_1a1d313f019ecbaa2cf5b31525ac4f156a:
...
.. _doxid-classov_1_1op_1_1v4_1_1_interpolate_1aca8834f934e0438b43de77c0bf932f59:
...
.. _doxid-classov_1_1op_1_1v4_1_1_interpolate_1a22975633cc34642afd3dfe07a0f5b12d:
