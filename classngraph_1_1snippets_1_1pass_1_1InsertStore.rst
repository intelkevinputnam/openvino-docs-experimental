.. index:: pair: interface; ngraph::snippets::pass::InsertStore
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_insert_store:

interface ngraph::snippets::pass::InsertStore
=============================================



Inserts explicit store instruction before each result. The pass is used to convert model to a canonical form for code generation.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <insert_load_store.hpp>
	
	template InsertStore: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	};
