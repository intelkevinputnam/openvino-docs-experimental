.. index:: pair: class; ngraph::pass::ReshapeTo1D
.. _doxid-classngraph_1_1pass_1_1_reshape_to1_d:
...
:ref:`ReshapeTo1D <doxid-classngraph_1_1pass_1_1_reshape_to1_d>` transformation looks for Reshape from nD to 1D tensor and replaces its pattern to [-1].
...
.. ref-code-block:: cpp
	...
	class ReshapeTo1D: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_reshape_to1_d_1a107487eec90ef605ede89b090e32adc3>`("ReshapeTo1D", "0");
	};
