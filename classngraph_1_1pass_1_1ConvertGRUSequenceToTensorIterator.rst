.. index:: pair: class; ngraph::pass::ConvertGRUSequenceToTensorIterator
.. _doxid-classngraph_1_1pass_1_1_convert_g_r_u_sequence_to_tensor_iterator:
...
:ref:`ConvertGRUSequenceToTensorIterator <doxid-classngraph_1_1pass_1_1_convert_g_r_u_sequence_to_tensor_iterator>` transformation converts GRUSequence layer to TensorIterator \*.
...
.. ref-code-block:: cpp
	...
	class ConvertGRUSequenceToTensorIterator: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_g_r_u_sequence_to_tensor_iterator_1ae9576ef8ca11d3dbdb27f27c0d6e5cd8>`("ConvertGRUSequenceToTensorIterator", "0");
	};
