.. index:: pair: class; ngraph::pass::SoftPlusToMishFusion
.. _doxid-classngraph_1_1pass_1_1_soft_plus_to_mish_fusion:
...
:ref:`SoftPlusToMishFusion <doxid-classngraph_1_1pass_1_1_soft_plus_to_mish_fusion>` transformation replaces group of operations: x \* tanh(softplus(x)) to Mish op.
...
.. ref-code-block:: cpp
	...
	class SoftPlusToMishFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_soft_plus_to_mish_fusion_1a8100a3b771d5d8aa6acea107ee3896b0>`("SoftPlusToMishFusion", "0");
	};
