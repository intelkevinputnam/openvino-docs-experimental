.. index:: pair: class; ov::op::v7::Gelu
.. _doxid-classov_1_1op_1_1v7_1_1_gelu:
...
Gaussian Error Linear Unit f(x) = 0.5 \* x \* (1 + erf( x / sqrt(2) ) for "approximation" = "erf" f(x) = 0.5 \* x \* (1 + tanh([sqrt(2 / pi)] \* [x + 0.044715^3]) for "approximation" = "tanh". :ref:`More...<details-classov_1_1op_1_1v7_1_1_gelu>`
...
.. ref-code-block:: cpp
	...
	class Gelu: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v7_1_1_gelu_1ab4a1d290e813f8ddbf7cb751c6583c0c>`;

		// construction
	
		:target:`Gelu<doxid-classov_1_1op_1_1v7_1_1_gelu_1a38cadd041515e0479b8ad445455dc46f>`();
	
		:ref:`Gelu<doxid-classov_1_1op_1_1v7_1_1_gelu_1a1dff5733ec9c70fd217793288b0b02f8>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			:ref:`GeluApproximationMode<doxid-namespaceov_1_1op_1a1ab40a6efb6720925e3d75890dd87d63>` mode = :ref:`GeluApproximationMode::ERF<doxid-namespaceov_1_1op_1a1ab40a6efb6720925e3d75890dd87d63a143c8c6f51b9bb893ce71e38702e3cc1>`
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v7_1_1_gelu_1abbbc0c7a65f98048958a53842d03b928>`("Gelu", "opset7", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 7);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v7_1_1_gelu_1a62b4c787128322e72ee2135a9c33e730>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v7_1_1_gelu_1a8f20f303b2526f3cb60bf05fdacfb5a4>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v7_1_1_gelu_1a24fe7116ffe18a2317edd20d1b0bafb3>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v7_1_1_gelu_1a1726a41829af6d267885d1798698c338>`() const;
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v7_1_1_gelu_1a1f3a2e6cce661d1d4bf22fcf95dd803b>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`GeluApproximationMode<doxid-namespaceov_1_1op_1a1ab40a6efb6720925e3d75890dd87d63>` :target:`get_approximation_mode<doxid-classov_1_1op_1_1v7_1_1_gelu_1a6a81ebd42fe966d33553c409a6802a87>`() const;
	};
...
.. _details-classov_1_1op_1_1v7_1_1_gelu:
...
.. _doxid-classov_1_1op_1_1v7_1_1_gelu_1a1dff5733ec9c70fd217793288b0b02f8:
.. index:: pair: function; Gelu
...
Constructs a :ref:`Gelu <doxid-classov_1_1op_1_1v7_1_1_gelu>` operation.
...
.. _doxid-classov_1_1op_1_1v7_1_1_gelu_1a8f20f303b2526f3cb60bf05fdacfb5a4:
...
.. _doxid-classov_1_1op_1_1v7_1_1_gelu_1a24fe7116ffe18a2317edd20d1b0bafb3:
...
.. _doxid-classov_1_1op_1_1v7_1_1_gelu_1a1726a41829af6d267885d1798698c338:
