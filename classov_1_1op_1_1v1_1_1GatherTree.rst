.. index:: pair: class; ov::op::v1::GatherTree
.. _doxid-classov_1_1op_1_1v1_1_1_gather_tree:
...
Generates the complete beams from the ids per each step and the parent beam ids. :ref:`More...<details-classov_1_1op_1_1v1_1_1_gather_tree>`
...
.. ref-code-block:: cpp
	...
	class GatherTree: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a9ddba535ace0207e0296ff3a1a0223eb>`;

		// construction
	
		:target:`GatherTree<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a5370b66f78a48d3a5ed8487512f5d6fd>`();
	
		:ref:`GatherTree<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a2304d395fad815c7f200dffeb64df60e>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& step_ids,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& parent_idx,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& max_seq_len,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& end_token
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a6eb0a5bffaddd52ef9e47475e8069e43>`("GatherTree", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1ae655477254397673656cbfc4867618ee>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a9c4f4ba82b746e735b50763408863893>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a30f66957752e98321698c0dd8ed76f9a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_gather_tree:
...
.. _doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a2304d395fad815c7f200dffeb64df60e:
.. index:: pair: function; GatherTree
...
.. list-table::
	...
	*
		...
		- :ref:`Tensor <doxid-classov_1_1_tensor>` of shape [MAX_TIME, BATCH_SIZE, BEAM_WIDTH] with indices from per each step

	*
		- parent_idx

		- :ref:`Tensor <doxid-classov_1_1_tensor>` of shape [MAX_TIME, BATCH_SIZE, BEAM_WIDTH] with parent beam indices

	*
		- max_seq_len

		- :ref:`Tensor <doxid-classov_1_1_tensor>` of shape [BATCH_SIZE] with maximum lengths for each sequence in the batch

	*
		- end_token

		- :ref:`Tensor <doxid-classov_1_1_tensor>` of shape [MAX_TIME, BATCH_SIZE, BEAM_WIDTH]

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_gather_tree_1a9c4f4ba82b746e735b50763408863893:
