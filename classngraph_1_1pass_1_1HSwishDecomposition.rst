.. index:: pair: class; ngraph::pass::HSwishDecomposition
.. _doxid-classngraph_1_1pass_1_1_h_swish_decomposition:
...
:ref:`HSwishDecomposition <doxid-classngraph_1_1pass_1_1_h_swish_decomposition>` transformation into sub-graph x \* (min(Relu(x + 3), 6) \* const(1/6).
...
.. ref-code-block:: cpp
	...
	class HSwishDecomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_swish_decomposition_1a0256205fc95fe52b0fefc599f3895dde>`("HSwishDecomposition", "0");
	};
