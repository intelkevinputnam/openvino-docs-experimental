.. index:: pair: class; ngraph::snippets::op::Store
.. _doxid-classngraph_1_1snippets_1_1op_1_1_store:

class ngraph::snippets::op::Store
=================================
...
.. ref-code-block:: cpp
	...
	class Store: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// construction
	
		:target:`Store<doxid-classngraph_1_1snippets_1_1op_1_1_store_1a9399dc72e555c77f9f138a0760d89875>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x);
		:target:`Store<doxid-classngraph_1_1snippets_1_1op_1_1_store_1aec287d296f293a3d0005ed92be8ad34e>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_store_1afa2296c75c20e8b0a16cd3f88020b3d7>`("Store", "SnippetsOpset");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_store_1aae062a8e5241adbba4d8a7c5b3988b7a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_store_1ae036beebfec458555e6187ccc7a73df9>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1snippets_1_1op_1_1_store_1a36de11ce03b4c864791c1d09b4826c56>`();
	
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate<doxid-classngraph_1_1snippets_1_1op_1_1_store_1ae24caff49d2ee6fc66a5a132696ba872>`(
...
.. _details-classngraph_1_1snippets_1_1op_1_1_store:
...
.. _doxid-classngraph_1_1snippets_1_1op_1_1_store_1a36de11ce03b4c864791c1d09b4826c56:
