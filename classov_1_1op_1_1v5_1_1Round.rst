.. index:: pair: class; ov::op::v5::Round
.. _doxid-classov_1_1op_1_1v5_1_1_round:
...
.. toctree::
	...
	RoundMode <enumov_1_1op_1_1v5_1_1Round_1_1RoundMode.rst>

Overview
~~~~~~~~

Elementwise round operation. The output is round to the nearest integer for each value. In case of halfs, the rule is defined in attribute 'mode': 'HALF_TO_EVEN' - round halfs to the nearest even integer. 'HALF_AWAY_FROM_ZERO': - round in such a way that the result heads away from zero. :ref:`More...<details-classov_1_1op_1_1v5_1_1_round>`
...
.. ref-code-block:: cpp
	...
	class Round: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`RoundMode<doxid-classov_1_1op_1_1v5_1_1_round_1a25a2039a1e12e5aa8e612cb5bb82af7e>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_round_1ab54330b5d8239ae77dbb54d0c207dc5b>`;

		// construction
	
		:ref:`Round<doxid-classov_1_1op_1_1v5_1_1_round_1a56d6e22e416613f71797427049226c80>`();
		:ref:`Round<doxid-classov_1_1op_1_1v5_1_1_round_1ac183ce5f85e6f38b7e0e843b1b6c7f2b>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`RoundMode<doxid-classov_1_1op_1_1v5_1_1_round_1a25a2039a1e12e5aa8e612cb5bb82af7e>` mode);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_round_1a9ea9b0bbd80dd51b374587fc01c81df8>`("Round", "opset5", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 5);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_round_1a2cc6758dad74def4e2e804f0ed6ae91c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_round_1aee0d8aeb17ba81a3645aee232cac9017>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_round_1a162b565753970b800ffebd51ef153bd1>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v5_1_1_round_1a2c6864c7e9de929adbc0b0971a06eb02>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v5_1_1_round_1a5191d1e236bae72bd02c643a30ceb193>`() const;
		:ref:`RoundMode<doxid-classov_1_1op_1_1v5_1_1_round_1a25a2039a1e12e5aa8e612cb5bb82af7e>` :target:`get_mode<doxid-classov_1_1op_1_1v5_1_1_round_1a211461a8b8a6b129e1673466c0d73314>`() const;
	};
...
.. _details-classov_1_1op_1_1v5_1_1_round:
...
.. _doxid-classov_1_1op_1_1v5_1_1_round_1a56d6e22e416613f71797427049226c80:
.. index:: pair: function; Round
...
.. _doxid-classov_1_1op_1_1v5_1_1_round_1ac183ce5f85e6f38b7e0e843b1b6c7f2b:
.. index:: pair: function; Round

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Round(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`RoundMode<doxid-classov_1_1op_1_1v5_1_1_round_1a25a2039a1e12e5aa8e612cb5bb82af7e>` mode)
...
.. list-table::
	...
	*
		...
		- Rule to resolve halfs

Methods
-------

.. _doxid-classov_1_1op_1_1v5_1_1_round_1aee0d8aeb17ba81a3645aee232cac9017:
...
.. _doxid-classov_1_1op_1_1v5_1_1_round_1a2c6864c7e9de929adbc0b0971a06eb02:
...
.. _doxid-classov_1_1op_1_1v5_1_1_round_1a5191d1e236bae72bd02c643a30ceb193:
