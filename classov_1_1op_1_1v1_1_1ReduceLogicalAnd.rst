.. index:: pair: class; ov::op::v1::ReduceLogicalAnd
.. _doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and:
...
Performs a reduction using "logical and". :ref:`More...<details-classov_1_1op_1_1v1_1_1_reduce_logical_and>`
...
.. ref-code-block:: cpp
	...
	class ReduceLogicalAnd: public :ref:`ov::op::util::LogicalReductionKeepDims<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a0e055687724ec139d510627607735f86>`;

		// construction
	
		:target:`ReduceLogicalAnd<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1afc5bdec6b9ed7a4e7851174e8f69a42a>`();
	
		:ref:`ReduceLogicalAnd<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1abdd50981f777e2a9ea5305ee5c62beaa>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a2f5736538c8a023ceb1a71d148d84cbb>`("ReduceLogicalAnd", "opset1", :ref:`util::LogicalReductionKeepDims<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims>`, 1);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a94f9695c453e7d485c417ab3ca04e3c4>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a80647792624b69ef6100fb32dd8ee57a>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a007be92dfe42d8f639ae65a9b955dbb4>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_logical_reduction_1af960e1631142ac4f78577bbd2f741ab3>`;
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims_1a38a5ff83566a5581d796675029990ff7>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_logical_reduction_1aaa9a3757789ec9bcb65d425c6bfb3e37>`("LogicalReduction", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_logical_reduction_1ac50148a9a84a9cca0279159643a09726>`();
		bool :ref:`reduction_axes_constant<doxid-classov_1_1op_1_1util_1_1_logical_reduction_1ac4a37841dc6baa301736240b753aa0cc>`() const;
		const :ref:`AxisSet<doxid-classov_1_1_axis_set>` :ref:`get_reduction_axes<doxid-classov_1_1op_1_1util_1_1_logical_reduction_1a876461c2ed6695625129ed7c4a2930f4>`() const;
		void :ref:`set_reduction_axes<doxid-classov_1_1op_1_1util_1_1_logical_reduction_1a10f86b2910896f520bd6686bcd49a3e2>`(const :ref:`AxisSet<doxid-classov_1_1_axis_set>`& reduction_axes);
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims_1aef0ae790c6dc9b25201a6c91e9e21d50>`("LogicalReductionKeepDims", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims_1aeff4af1034931a1cd5caf12075641649>`();
		bool :ref:`get_keep_dims<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims_1ac122ebda5cc6e632a422a59123f6e225>`() const;
		void :ref:`set_keep_dims<doxid-classov_1_1op_1_1util_1_1_logical_reduction_keep_dims_1aba4dd4541f60d9501fe6171b596d8288>`(bool keep_dims);

.. _details-classov_1_1op_1_1v1_1_1_reduce_logical_and:
...
.. _doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1abdd50981f777e2a9ea5305ee5c62beaa:
.. index:: pair: function; ReduceLogicalAnd
...
Constructs a :ref:`ReduceLogicalAnd <doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and>` node.
...
.. list-table::
	...
	*
		...
		- - The input tensor with data to be reduced

	*
		- reduction_axes

		- - The input tensor with information about axes over which the first tensor should be sliced prior to the reduction operation

	*
		- keep_dims

		- - Indicates if the axes used for reduction should be held/kept

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a80647792624b69ef6100fb32dd8ee57a:
...
.. _doxid-classov_1_1op_1_1v1_1_1_reduce_logical_and_1a007be92dfe42d8f639ae65a9b955dbb4:
