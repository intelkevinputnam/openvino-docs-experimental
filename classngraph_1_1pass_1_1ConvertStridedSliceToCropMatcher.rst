.. index:: pair: class; ngraph::pass::ConvertStridedSliceToCropMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_strided_slice_to_crop_matcher:

class ngraph::pass::ConvertStridedSliceToCropMatcher
====================================================
...
.. ref-code-block:: cpp
	...
	#include <convert_strided_slice_to_crop.hpp>
	
	class ConvertStridedSliceToCropMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_strided_slice_to_crop_matcher_1add4fa77dbeb66857e58cc8b1cc100a1e>`("ConvertStridedSliceToCropMatcher", "0");
	};
