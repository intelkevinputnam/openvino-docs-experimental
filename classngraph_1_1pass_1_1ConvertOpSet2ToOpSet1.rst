.. index:: pair: class; ngraph::pass::ConvertOpSet2ToOpSet1
.. _doxid-classngraph_1_1pass_1_1_convert_op_set2_to_op_set1:

class ngraph::pass::ConvertOpSet2ToOpSet1
=========================================
...
.. ref-code-block:: cpp
	...
	class ConvertOpSet2ToOpSet1: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_op_set2_to_op_set1_1aeaf48a7770399f9da9ece790a3d8394c>`("ConvertOpSet2ToOpSet1", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_convert_op_set2_to_op_set1_1ac09f50cdf5342668968d57f4fe85b10f>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
