.. index:: pair: class; ngraph::pass::ConvertQuantizeDequantize
.. _doxid-classngraph_1_1pass_1_1_convert_quantize_dequantize:
...
:ref:`ConvertQuantizeDequantize <doxid-classngraph_1_1pass_1_1_convert_quantize_dequantize>` transformation replaces following graph: FakeQuantize->Convert->Convert->Subtract->Multiply with a single FakeQuantize. Restrictions: :ref:`More...<details-classngraph_1_1pass_1_1_convert_quantize_dequantize>`
...
.. ref-code-block:: cpp
	...
	class ConvertQuantizeDequantize: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_quantize_dequantize_1ab78d7d772a160d7eea7f15d2d29057aa>`("ConvertQuantizeDequantize", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_convert_quantize_dequantize:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ConvertQuantizeDequantize <doxid-classngraph_1_1pass_1_1_convert_quantize_dequantize>` transformation replaces following graph: FakeQuantize->Convert->Convert->Subtract->Multiply with a single FakeQuantize. Restrictions:
