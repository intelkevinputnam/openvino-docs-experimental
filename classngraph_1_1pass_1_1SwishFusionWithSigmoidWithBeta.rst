.. index:: pair: class; ngraph::pass::SwishFusionWithSigmoidWithBeta
.. _doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid_with_beta:
...
:ref:`SwishFusionWithSigmoid <doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid>` replaces a sub-graphs x \* Sigmoid(x \* beta) with a Swish op.
...
.. ref-code-block:: cpp
	...
	class SwishFusionWithSigmoidWithBeta: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid_with_beta_1ace4afadd69be2b4c9d4e2929263cf871>`("SwishFusionWithSigmoidWithBeta", "0");
	};
