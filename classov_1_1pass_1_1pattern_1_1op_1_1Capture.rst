.. index:: pair: class; ov::pass::pattern::op::Capture
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture:
...
Experimental for support of recurrent matches. :ref:`More...<details-classov_1_1pass_1_1pattern_1_1op_1_1_capture>`
...
.. ref-code-block:: cpp
	...
	class Capture: public :ref:`ov::pass::pattern::op::Pattern<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_pattern>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1afaeed129a123bf9b8579891543553fc2>`;

		// construction
	
		:target:`Capture<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1acee53756d9356dfd1d7edf01abce5583>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1a8db124143d83aefaaa5da34de6d2bbce>`("patternCapture");
		std::set<:ref:`Node<doxid-classov_1_1_node>` \*> :ref:`get_static_nodes<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1a361aa55b2f01d782b205db03c4ba4b68>`();
		void :target:`set_static_nodes<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1a10e5b44469893ac7ac23cb1d0787cd19>`(const std::set<:ref:`Node<doxid-classov_1_1_node>` \*>& static_nodes);
	
		virtual bool :target:`match_value<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1a862b1cf959ad453ae2d6dfa2727e70c2>`(
...
.. _details-classov_1_1pass_1_1pattern_1_1op_1_1_capture:
...
:ref:`Capture <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture>` adds the pattern value map to a list of pattern value maps and resets matches for pattern nodes not in the static node list. The match always succeeds.

Methods
-------

.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_capture_1a361aa55b2f01d782b205db03c4ba4b68:
.. index:: pair: function; get_static_nodes

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	std::set<:ref:`Node<doxid-classov_1_1_node>` \*> get_static_nodes()
