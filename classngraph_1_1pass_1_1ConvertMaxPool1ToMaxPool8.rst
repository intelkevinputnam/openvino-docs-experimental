.. index:: pair: class; ngraph::pass::ConvertMaxPool1ToMaxPool8
.. _doxid-classngraph_1_1pass_1_1_convert_max_pool1_to_max_pool8:
...
:ref:`ConvertMaxPool1ToMaxPool8 <doxid-classngraph_1_1pass_1_1_convert_max_pool1_to_max_pool8>` converts v1::MaxPool into v8::MaxPool.
...
.. ref-code-block:: cpp
	...
	class ConvertMaxPool1ToMaxPool8: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_max_pool1_to_max_pool8_1a1ea452f51e1e5f9cc87456acf358ae0b>`("ConvertMaxPool1ToMaxPool8");
	};
