.. index:: pair: class; ov::op::v5::HSigmoid
.. _doxid-classov_1_1op_1_1v5_1_1_h_sigmoid:
...
A :ref:`HSigmoid <doxid-classov_1_1op_1_1v5_1_1_h_sigmoid>` Activation Function f(x) = min(max(x + 3, 0), 6) / 6 or f(x) = min(ReLU(x + 3), 6) / 6. :ref:`More...<details-classov_1_1op_1_1v5_1_1_h_sigmoid>`
...
.. ref-code-block:: cpp
	...
	class HSigmoid: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a869da797c16293a54c903d9b76452a29>`;

		// construction
	
		:target:`HSigmoid<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a57327d58e6925f4d2d2b34a8ca678ce9>`();
		:ref:`HSigmoid<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1aa7e5d48382a1fb67a78a7d4b7bb445cd>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a119c7cb836e0787c104ede999ee258ea>`("HSigmoid", "opset5", :ref:`op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`, 5);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a4548063c6c294ef390fd4811333bf36f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a8b18ecfec65ce06f9040fb27ca1ae658>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1aac75b3c808965c9c822ea20edd4d13bf>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a6188c0cb03ba40c717a8c43100c1f57c>`() const;
	};
...
.. _details-classov_1_1op_1_1v5_1_1_h_sigmoid:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

A :ref:`HSigmoid <doxid-classov_1_1op_1_1v5_1_1_h_sigmoid>` Activation Function f(x) = min(max(x + 3, 0), 6) / 6 or f(x) = min(ReLU(x + 3), 6) / 6.

Construction
------------

.. _doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1aa7e5d48382a1fb67a78a7d4b7bb445cd:
.. index:: pair: function; HSigmoid

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	HSigmoid(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)

Constructs a :ref:`HSigmoid <doxid-classov_1_1op_1_1v5_1_1_h_sigmoid>` operation.
...
.. _doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1aac75b3c808965c9c822ea20edd4d13bf:
...
.. _doxid-classov_1_1op_1_1v5_1_1_h_sigmoid_1a6188c0cb03ba40c717a8c43100c1f57c:
