.. index:: pair: class; ngraph::pass::ConvertNormalizeL2WithMulToNormalizeIE
.. _doxid-classngraph_1_1pass_1_1_convert_normalize_l2_with_mul_to_normalize_i_e:

class ngraph::pass::ConvertNormalizeL2WithMulToNormalizeIE
==========================================================
...
.. ref-code-block:: cpp
	...
	#include <convert_normalizel2_to_normalize_ie.hpp>
	
	class ConvertNormalizeL2WithMulToNormalizeIE: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_normalize_l2_with_mul_to_normalize_i_e_1a79b82351fa54c21076708528a08b1ee4>`("ConvertNormalizeL2WithMulToNormalizeIE", "0");
	};
