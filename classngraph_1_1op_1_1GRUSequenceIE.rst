.. index:: pair: class; ngraph::op::GRUSequenceIE
.. _doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e:

class ngraph::op::GRUSequenceIE
===============================
...
.. ref-code-block:: cpp
	...
	#include <gru_sequence_ie.hpp>
	
	class GRUSequenceIE: public :ref:`ov::op::util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1a79ee8a786240a35f3f0857199f575a80>`;

		// construction
	
		:target:`GRUSequenceIE<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1aa683b6b38209fe5528fc8f07d94c7be6>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& X,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& H_t,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& seg_lengths,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& WR,
		...
		:target:`GRUSequenceIE<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1a1fcd2ae3da8ddf8e3486b4070f708873>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1a5ff1916020328d8581b1fbdcfe63465b>`("GRUSequenceIE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1abd1606c3d4f10dfc5d16b7d44d54a6c4>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1adc97894473e97d913029ca446590d1c6>`();
		std::size_t :target:`get_hidden_size<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1afcde2cbc55db9c8bb1374a87d213338f>`();
		const std::vector<std::string>& :target:`get_activations<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1a417449c3e60c6d5e983f4f0251035f81>`();
		const std::vector<float>& :target:`get_activations_alpha<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1a9281bc63e315ae373fe4e99cd59d7630>`();
		const std::vector<float>& :target:`get_activations_beta<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1af221d31d3a57666fde96d0011367e1ce>`();
		float :target:`get_clip<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1a37ce49284c83fdcfd7fe345836b439f8>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1ad5f4742294384a27307bec6de1b093a6>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_g_r_u_sequence_i_e:
...
.. _doxid-classngraph_1_1op_1_1_g_r_u_sequence_i_e_1adc97894473e97d913029ca446590d1c6:
