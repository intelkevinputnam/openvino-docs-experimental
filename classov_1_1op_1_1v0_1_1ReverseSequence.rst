.. index:: pair: class; ov::op::v0::ReverseSequence
.. _doxid-classov_1_1op_1_1v0_1_1_reverse_sequence:
...
:ref:`ReverseSequence <doxid-classov_1_1op_1_1v0_1_1_reverse_sequence>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_reverse_sequence>`
...
.. ref-code-block:: cpp
	...
	class ReverseSequence: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a8d7f82acfe9e09e8a24d045b05fca917>`;

		// construction
	
		:target:`ReverseSequence<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a636f772b5c0cb174d477e52ecc39bd45>`();
	
		:ref:`ReverseSequence<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1aaea760f6dd097ff54ccdc341571146c1>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& seq_lengths,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a5fc6e47f6187c6add724dce2f094187c>`("ReverseSequence", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a22392bb556c5380265b68ce4fb1a8694>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1ad5048caf7cdc9945e3450adc9794d289>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a56af9ecbbf37995f1410bc558133998f>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		size_t :target:`get_batch_axis<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a3b3855a1545720f52af46b6cbe489fd2>`() const;
		int64_t :target:`get_origin_batch_axis<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1ad3f4b3a9473641583edb15661ee47153>`() const;
		void :target:`set_batch_axis<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1ac6f86f8ae74726c21b0403eb51eb55fa>`(int64_t batch_axis);
		size_t :target:`get_sequence_axis<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a361ef24961c45909f9c1047a22ab2cee>`() const;
		int64_t :target:`get_origin_sequence_axis<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a111962c957735d766d5f02c501170e8c>`() const;
		void :target:`set_sequence_axis<doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1a605f6bee71bafb8aeb58d2a40318441b>`(int64_t sequence_axis);
	};
...
.. _details-classov_1_1op_1_1v0_1_1_reverse_sequence:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReverseSequence <doxid-classov_1_1op_1_1v0_1_1_reverse_sequence>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1aaea760f6dd097ff54ccdc341571146c1:
.. index:: pair: function; ReverseSequence
...
Constructs a :ref:`ReverseSequence <doxid-classov_1_1op_1_1v0_1_1_reverse_sequence>` operation.
...
.. list-table::
	...
	*
		...
		- tensor with input data to reverse

	*
		- seq_lengths

		- 1D tensor of integers with sequence lengths in the input tensor.

	*
		- batch_axis

		- index of the batch dimension.

	*
		- seq_axis

		- index of the sequence dimension.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_reverse_sequence_1ad5048caf7cdc9945e3450adc9794d289:
