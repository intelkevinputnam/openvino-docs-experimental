.. index:: pair: class; ov::pass::DisableDecompressionConvertConstantFolding
.. _doxid-classov_1_1pass_1_1_disable_decompression_convert_constant_folding:
...
Disables :ref:`ConstantFolding <doxid-classov_1_1pass_1_1_constant_folding>` for Convert operation in compressed function.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <disable_decompression_convert_constant_folding.hpp>
	
	class DisableDecompressionConvertConstantFolding: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_disable_decompression_convert_constant_folding_1a1f2b02aa3ecec8bef5d212fdab81211a>`("DisableDecompressionConvertConstantFolding", "0");
	};
