.. index:: pair: class; ov::op::v1::Power
.. _doxid-classov_1_1op_1_1v1_1_1_power:
...
Elementwise exponentiation operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_power>`
...
.. ref-code-block:: cpp
	...
	class Power: public :ref:`ov::op::util::BinaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_power_1acb2129e3d3cb67d0a2fdb05543da70a7>`;

		// construction
	
		:target:`Power<doxid-classov_1_1op_1_1v1_1_1_power_1a9db6fb07388c94eb532bfdc5aec0366c>`();
	
		:ref:`Power<doxid-classov_1_1op_1_1v1_1_1_power_1ae059096ea0263b18c96eeb4dfc1eb0a8>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_power_1a10d5a33d8835c5c6877abf00efb8ab83>`("Power", "opset1", :ref:`op::util::BinaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_arithmetic>`, 1);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_power_1a294258aa89d586b8126df3ec16e13139>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_power_1acaf9a939d83ef5043b75aa9908ba0eaf>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_power_1a0d839c33702863a81a903e743f2c36fb>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_power:
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`N[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \texttt{arg0}[i_1,\dots,i_n]^{\texttt{arg1}[i_1,\dots,i_n]}`

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_power_1ae059096ea0263b18c96eeb4dfc1eb0a8:
.. index:: pair: function; Power
...
.. _doxid-classov_1_1op_1_1v1_1_1_power_1acaf9a939d83ef5043b75aa9908ba0eaf:
...
.. _doxid-classov_1_1op_1_1v1_1_1_power_1a0d839c33702863a81a903e743f2c36fb:
