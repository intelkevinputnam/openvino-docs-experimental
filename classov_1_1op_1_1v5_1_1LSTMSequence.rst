.. index:: pair: class; ov::op::v5::LSTMSequence
.. _doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence:
...
Class for lstm sequence node. :ref:`More...<details-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence>`
...
.. ref-code-block:: cpp
	...
	class LSTMSequence: public :ref:`ov::op::util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
	{
	public:
		// typedefs
	
		typedef :ref:`RecurrentSequenceDirection<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` :target:`direction<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a72d01589eade26ee9f3a9814f5c242bb>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a12067d1d7d57ea22b4a79cf218defbac>`;

		// construction
	
		:target:`LSTMSequence<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a57e6ce443907a5d0c9e97d994560fbde>`();
	
		:target:`LSTMSequence<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1aacbdc23b55978a4320b8e54a656ec5ba>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a85e8e87888900f572dd49b479d1601bb>`("LSTMSequence", "opset5", :ref:`util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`, 5);
		virtual size_t :ref:`get_default_output_index<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1abd68ac60a80af2637ebd096c0b0e6e6b>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a01df5cea96ee6cc6febadbac918b22db>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1ae6db12bdb8fb0d2ba457b0d09d8d99bf>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a0b95cd00075df9800fe388dbe695e848>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`direction<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` :target:`get_direction<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a76932cefcb90087f720feb94de0cc9aa>`() const;
	};
...
.. _details-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence:
...
.. _doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1abd68ac60a80af2637ebd096c0b0e6e6b:
...
.. _doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence_1a01df5cea96ee6cc6febadbac918b22db:
