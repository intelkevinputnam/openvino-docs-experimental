.. index:: pair: class; ov::op::v3::TopK
.. _doxid-classov_1_1op_1_1v3_1_1_top_k:
...
Computes indices and values of the k maximum/minimum values for each slice along specified axis. :ref:`More...<details-classov_1_1op_1_1v3_1_1_top_k>`
...
.. ref-code-block:: cpp
	...
	class TopK: public :ref:`ov::op::v1::TopK<doxid-classov_1_1op_1_1v1_1_1_top_k>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_top_k_1a642a49f36bf3ecf95ffd7d8490a6e16c>`;

		// construction
	
		:ref:`TopK<doxid-classov_1_1op_1_1v3_1_1_top_k_1a3777e291907fbc928f0f909ed97c36b2>`();
	
		:ref:`TopK<doxid-classov_1_1op_1_1v3_1_1_top_k_1a20a12cc4f79eacdda621e9454a0ed880>`(
		...
		:target:`TopK<doxid-classov_1_1op_1_1v3_1_1_top_k_1a47749f7c54f7cca0a115990d0744e3d9>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& k,
			const int64_t axis,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_top_k_1a65eb5348af6f152158edd24426b7e56e>`("TopK", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_top_k_1a4df5b04064f8568da6c2c1d3042b313e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_top_k_1aa9e8bb66e869c36650a2ef3016c8d616>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_top_k_1a8ddcc32f91931ce740733fe55f46c41f>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_top_k_1afaa31799e74ce7577f2d10a32b3f3163>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_top_k_1a672a4f4617fe0840f9fe89c2e4ea22d7>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		typedef :ref:`TopKSortType<doxid-namespaceov_1_1op_1adb25710a58c013466ba8b371156e09cb>` :ref:`SortType<doxid-classov_1_1op_1_1v1_1_1_top_k_1a0bfaa93c606e1cca659abfa0cb25d9f5>`;
		typedef :ref:`TopKMode<doxid-namespaceov_1_1op_1a1b4a5e596b7b28cc8a8746fda9ee1a97>` :ref:`Mode<doxid-classov_1_1op_1_1v1_1_1_top_k_1a60328793dde0f6bcba1e7ae6415b6547>`;

		// fields
	
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_top_k_1a1a8899209839070af524bd3a393e4538>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_top_k_1acd87fc92595f094d5966e9b4048fc1f0>`("TopK", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_top_k_1abb568ed77f040ca25b86c1635f95d980>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_top_k_1a3d5b5ad17891ddc7bda961d85411680d>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_top_k_1a9c4ae17031784413ab471c36be8cdae2>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		...
		void :ref:`set_axis<doxid-classov_1_1op_1_1v1_1_1_top_k_1ab88fecf00b4ae44586a8ccb790921d98>`(const int64_t axis);
		:ref:`Mode<doxid-namespaceov_1_1op_1a1b4a5e596b7b28cc8a8746fda9ee1a97>` :ref:`get_mode<doxid-classov_1_1op_1_1v1_1_1_top_k_1adfa042d97b658c676c4df509da251385>`() const;
		void :ref:`set_mode<doxid-classov_1_1op_1_1v1_1_1_top_k_1a34379fd47b5ebadf6896f597eb3dfde7>`(const :ref:`Mode<doxid-namespaceov_1_1op_1a1b4a5e596b7b28cc8a8746fda9ee1a97>` mode);
		:ref:`SortType<doxid-namespaceov_1_1op_1adb25710a58c013466ba8b371156e09cb>` :ref:`get_sort_type<doxid-classov_1_1op_1_1v1_1_1_top_k_1a883683ac0a774bccb1b414dc2e16d34a>`() const;
		void :ref:`set_sort_type<doxid-classov_1_1op_1_1v1_1_1_top_k_1ae0bcc030e3a26ba237c2fab77de0791c>`(const :ref:`SortType<doxid-namespaceov_1_1op_1adb25710a58c013466ba8b371156e09cb>` sort);
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :ref:`get_index_element_type<doxid-classov_1_1op_1_1v1_1_1_top_k_1a9a78ba17777d92fed909a07fa256cea9>`() const;
		void :ref:`set_index_element_type<doxid-classov_1_1op_1_1v1_1_1_top_k_1a42fb5cfdae1493c554b3ddf9f79235c6>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& index_element_type);
		size_t :ref:`get_k<doxid-classov_1_1op_1_1v1_1_1_top_k_1ae17373d2e9ae250669ab00ae821e6aa8>`() const;
		void :ref:`set_k<doxid-classov_1_1op_1_1v1_1_1_top_k_1aac72c0a386be0aace414b1b9ac2ae517>`(size_t k);
...
.. _details-classov_1_1op_1_1v3_1_1_top_k:
...
.. _doxid-classov_1_1op_1_1v3_1_1_top_k_1a3777e291907fbc928f0f909ed97c36b2:
...
Constructs a :ref:`TopK <doxid-classov_1_1op_1_1v3_1_1_top_k>` operation.

.. _doxid-classov_1_1op_1_1v3_1_1_top_k_1a20a12cc4f79eacdda621e9454a0ed880:
.. index:: pair: function; TopK
...
Constructs a :ref:`TopK <doxid-classov_1_1op_1_1v3_1_1_top_k>` operation with two outputs: values and indices. By default the indices output is described by i32 data type.
...
.. _doxid-classov_1_1op_1_1v3_1_1_top_k_1aa9e8bb66e869c36650a2ef3016c8d616:
...
.. _doxid-classov_1_1op_1_1v3_1_1_top_k_1afaa31799e74ce7577f2d10a32b3f3163:
...
.. _doxid-classov_1_1op_1_1v3_1_1_top_k_1a672a4f4617fe0840f9fe89c2e4ea22d7:
