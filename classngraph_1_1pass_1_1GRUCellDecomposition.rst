.. index:: pair: class; ngraph::pass::GRUCellDecomposition
.. _doxid-classngraph_1_1pass_1_1_g_r_u_cell_decomposition:
...
:ref:`GRUCellDecomposition <doxid-classngraph_1_1pass_1_1_g_r_u_cell_decomposition>` transformation decomposes GRUCell layer with inputs X, H, W, R, B to Add, Split, MatMul, Multiply and Subtract ops according to the formula: (.) - Denotes element-wise multiplication. :ref:`More...<details-classngraph_1_1pass_1_1_g_r_u_cell_decomposition>`
...
.. ref-code-block:: cpp
	...
	class GRUCellDecomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_g_r_u_cell_decomposition_1a8d2ec6439339aa784bccc83a090d9fda>`("GRUCellDecomposition", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_g_r_u_cell_decomposition:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`GRUCellDecomposition <doxid-classngraph_1_1pass_1_1_g_r_u_cell_decomposition>` transformation decomposes GRUCell layer with inputs X, H, W, R, B to Add, Split, MatMul, Multiply and Subtract ops according to the formula: (.) - Denotes element-wise multiplication.
