.. index:: pair: class; ov::op::v5::LogSoftmax
.. _doxid-classov_1_1op_1_1v5_1_1_log_softmax:
...
:ref:`LogSoftmax <doxid-classov_1_1op_1_1v5_1_1_log_softmax>` operation. :ref:`More...<details-classov_1_1op_1_1v5_1_1_log_softmax>`
...
.. ref-code-block:: cpp
	...
	class LogSoftmax: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a89e79fca304e4bc8dadd97ca2941e046>`;

		// construction
	
		:target:`LogSoftmax<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a55aaef2491778fb60a1e059ed33a63a6>`();
		:ref:`LogSoftmax<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a19e40702dc468dd6681479d59e14ff15>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const int64_t axis);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1ad19cf27476f2570734ccb07866d7d3e0>`("LogSoftmax", "opset5", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 5);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a0a3ca096611283db462aac4c4659ace5>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a1fdbe107ae4bca62deafc68a3e0a0274>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1af7ab7c61ee8de85f0590a82c72c71cd7>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		int64_t :target:`get_axis<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a3a389dfdf82244d504f3505b9332770d>`() const;
		void :target:`set_axis<doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a37e3d5c9d2a94d74a95ac64edfb5366f>`(const int64_t axis);
	};
...
.. _details-classov_1_1op_1_1v5_1_1_log_softmax:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`LogSoftmax <doxid-classov_1_1op_1_1v5_1_1_log_softmax>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a19e40702dc468dd6681479d59e14ff15:
.. index:: pair: function; LogSoftmax

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	LogSoftmax(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const int64_t axis)

Constructs a :ref:`LogSoftmax <doxid-classov_1_1op_1_1v5_1_1_log_softmax>` operation.
...
.. list-table::
	...
	*
		...
		- The axis position (0-based) on which to calculate the :ref:`LogSoftmax <doxid-classov_1_1op_1_1v5_1_1_log_softmax>`.

Methods
-------

.. _doxid-classov_1_1op_1_1v5_1_1_log_softmax_1a1fdbe107ae4bca62deafc68a3e0a0274:
