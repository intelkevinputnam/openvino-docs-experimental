.. index:: pair: class; ov::StridesPropagation
.. _doxid-classov_1_1_strides_propagation:

class ov::StridesPropagation
============================
...
.. ref-code-block:: cpp
	...
	class StridesPropagation: public :ref:`ov::RuntimeAttribute<doxid-classov_1_1_runtime_attribute>`
	{
	public:
		// fields
	
		:ref:`ngraph::Strides<doxid-classov_1_1_strides>` :target:`value<doxid-classov_1_1_strides_propagation_1ac72fdf95d4e8d8c9213038ca5c1a6ff9>`;

		// construction
	
		:target:`StridesPropagation<doxid-classov_1_1_strides_propagation_1ad5e86d38a5b3a15cf59c4c3cf69c49b8>`();
		:target:`StridesPropagation<doxid-classov_1_1_strides_propagation_1a83e27c6054ea929666cf16e76058ce7d>`(const :ref:`ngraph::Strides<doxid-classov_1_1_strides>`& value);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1_strides_propagation_1a4aebada6e9a67b665fef701cab580f5a>`("strides_propagation", "0");
	};
