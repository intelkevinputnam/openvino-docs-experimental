.. index:: pair: class; ov::op::v0::LRN
.. _doxid-classov_1_1op_1_1v0_1_1_l_r_n:
...
Elementwise Local Response Normalization (:ref:`LRN <doxid-classov_1_1op_1_1v0_1_1_l_r_n>`) operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_l_r_n>`
...
.. ref-code-block:: cpp
	...
	class LRN: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a4bc4f09fe08fc3ef5bf111c129ea1f17>`;

		// construction
	
		:ref:`LRN<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a0277a506e4bcee10dfa262e6bc758a91>`();
	
		:ref:`LRN<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a963f38f1deb8e169f03194ca8cc028d9>`(
		...
		:target:`LRN<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a26493ea7b3f8ce081842390a5c691c34>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1af422ee2e8233e49917ba05ec4981a2b4>`("LRN", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1afcda6c9389f15beaa2afa584210b2653>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a3da44976498adaa8f00b749f6f4308eb>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a1b625ec3005d277029ff0d69602ad32c>`();
		double :target:`get_alpha<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a0ffcc72ce3cc7a0396bcb87ec58380a0>`() const;
		void :target:`set_alpha<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1aafa05092749aac4c275bc202c7231eac>`(double alpha);
		double :target:`get_beta<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a4029348220152b290d2181b0eac7a760>`() const;
		void :target:`set_beta<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a26e6954bdb1fcc7872aabb13883479d6>`(double beta);
		double :target:`get_bias<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a07577da5118bde9704d9ab237cbac7e0>`() const;
		void :target:`set_bias<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a8f7a0570d9e51b0466d811ca44b5300c>`(double bias);
		size_t :target:`get_nsize<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1acef23aa43d6bc27ae69fda3f6807ac40>`() const;
		void :target:`set_nsize<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a57f43837a7c35acd4bf7708d33ce166b>`(size_t size);
		:ref:`AxisSet<doxid-classov_1_1_axis_set>` :target:`get_reduction_axes<doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a33d7aeb1e5f5e5d6c5ac2eda8082574f>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_l_r_n:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Elementwise Local Response Normalization (:ref:`LRN <doxid-classov_1_1op_1_1v0_1_1_l_r_n>`) operation.
...
.. list-table::
    ...
    * - 
      ...
      - Description
    * - ``arg``
      - :math:`N[n, c, d_1,\dots,d_n]~(n \geq 0)`
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`N[n, c, d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[n, c, d_1,\dots,d_n] = \frac{N[n,i,d_1,\dots,d_n]}{ (bias + alpha \* (\sum_{i=max(0,(nsize-1)/2)}^{min(C, (nsize-1)/2)+1} N[n,i,d_1,\dots,d_n]^{2}) ^ {2})}`

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a0277a506e4bcee10dfa262e6bc758a91:
.. index:: pair: function; LRN
...
Constructs a :ref:`LRN <doxid-classov_1_1op_1_1v0_1_1_l_r_n>` operation.

.. _doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a963f38f1deb8e169f03194ca8cc028d9:
.. index:: pair: function; LRN
...
.. _doxid-classov_1_1op_1_1v0_1_1_l_r_n_1a1b625ec3005d277029ff0d69602ad32c:
