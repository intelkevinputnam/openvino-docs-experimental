.. index:: pair: class; ngraph::pass::ReshapeSequenceFusion
.. _doxid-classngraph_1_1pass_1_1_reshape_sequence_fusion:
...
:ref:`ReshapeSequenceFusion <doxid-classngraph_1_1pass_1_1_reshape_sequence_fusion>` fuses sequence of Reshape operation into single Reshape or eliminates full redundant sequence.
...
.. ref-code-block:: cpp
	...
	class ReshapeSequenceFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// construction
	
		:target:`ReshapeSequenceFusion<doxid-classngraph_1_1pass_1_1_reshape_sequence_fusion_1acdee27af146b8138944305a17daf90f7>`(bool use_shape_for_elimination = true);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_reshape_sequence_fusion_1a8fbc6f0242a6d1c437c7d4625b9f24f1>`("ReshapeSequenceFusion", "0");
	};
