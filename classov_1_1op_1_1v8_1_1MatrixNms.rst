.. index:: pair: class; ov::op::v8::MatrixNms
.. _doxid-classov_1_1op_1_1v8_1_1_matrix_nms:
...
.. toctree::
	...
	DecayFunction <enumov_1_1op_1_1v8_1_1MatrixNms_1_1DecayFunction.rst>
	Attributes <structov_1_1op_1_1v8_1_1MatrixNms_1_1Attributes.rst>

Overview
~~~~~~~~

:ref:`MatrixNms <doxid-classov_1_1op_1_1v8_1_1_matrix_nms>` operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_matrix_nms>`
...
.. ref-code-block:: cpp
	...
	class MatrixNms: public :ref:`ov::op::util::NmsBase<doxid-classov_1_1op_1_1util_1_1_nms_base>`
	{
	public:
		// enums
	
		enum :ref:`DecayFunction<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a152a686a5c925bf06d99743101a1a01b>`;

		// structs
	
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_matrix_nms_1_1_attributes>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a0b03a9902bd7364668c82940507684e8>`;

		// construction
	
		:target:`MatrixNms<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1ac4f0e18b4afea497c1793b2edc7d859c>`();
	
		:ref:`MatrixNms<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a41c842792233bdee8246f62ea7248b2f>`(
			...
			const :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_matrix_nms_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a48c4a347b93e5bc1f32d53a7e2cbf785>`("MatrixNms", "opset8", :ref:`op::util::NmsBase<doxid-classov_1_1op_1_1util_1_1_nms_base>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1afebf5b3bcffc893b8b7afad41a3c1dd6>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a027af0166183ce3239ebb2dcb102fe7c>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_matrix_nms_1_1_attributes>`& :ref:`get_attrs<doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a2900575def6c290e55c66a0bbd5b20f8>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		enum :ref:`SortResultType<doxid-classov_1_1op_1_1util_1_1_nms_base_1a2bd5a4283198ccea241f81235c1b7bc2>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_nms_base_1a1fd95a01648a2ed6fcef3519a7cbacad>`("NmsBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_nms_base_1a2bfa92d6910fc70f30da6582d0972d8e>`();
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :ref:`get_output_type<doxid-classov_1_1op_1_1util_1_1_nms_base_1ad11f6159bcc44bdac127ead6765112cc>`() const;
		void :ref:`set_output_type<doxid-classov_1_1op_1_1util_1_1_nms_base_1a267d478253cff6749e9a0e423a272657>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type);
		int :ref:`get_nms_top_k<doxid-classov_1_1op_1_1util_1_1_nms_base_1a8f74f2e5f932b7e45f73ff1dda78991f>`() const;
		int :ref:`get_keep_top_k<doxid-classov_1_1op_1_1util_1_1_nms_base_1a0ce53ec386aba31b8fcbcf22aab1b99e>`() const;
	
		void :ref:`set_output_type<doxid-classov_1_1op_1_1util_1_1_nms_base_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& element_type,
			const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& pshape
			);

.. _details-classov_1_1op_1_1v8_1_1_matrix_nms:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`MatrixNms <doxid-classov_1_1op_1_1v8_1_1_matrix_nms>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a41c842792233bdee8246f62ea7248b2f:
.. index:: pair: function; MatrixNms
...
Constructs a :ref:`MatrixNms <doxid-classov_1_1op_1_1v8_1_1_matrix_nms>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Attributes <doxid-structov_1_1op_1_1v8_1_1_matrix_nms_1_1_attributes>` of the operation

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_matrix_nms_1a2900575def6c290e55c66a0bbd5b20f8:
.. index:: pair: function; get_attrs

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_matrix_nms_1_1_attributes>`& get_attrs() const

Returns attributes of the operation :ref:`MatrixNms <doxid-classov_1_1op_1_1v8_1_1_matrix_nms>`.
