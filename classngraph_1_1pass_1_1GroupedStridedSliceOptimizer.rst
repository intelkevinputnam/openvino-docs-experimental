.. index:: pair: class; ngraph::pass::GroupedStridedSliceOptimizer
.. _doxid-classngraph_1_1pass_1_1_grouped_strided_slice_optimizer:
...
:ref:`GroupedStridedSliceOptimizer <doxid-classngraph_1_1pass_1_1_grouped_strided_slice_optimizer>` transformation replaces group of StridedSlice operations with VariadicSplit. All StridedSlice operations must slice data with the same axis and stride = 1.
...
.. ref-code-block:: cpp
	...
	class GroupedStridedSliceOptimizer: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_grouped_strided_slice_optimizer_1a6d2b9fbc8ee689664ad53ccfbab73554>`("GroupedStridedSliceOptimizer", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_grouped_strided_slice_optimizer_1a8aefa4f214f31aa79b7ae0823082d22b>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
