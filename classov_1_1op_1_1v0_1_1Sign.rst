.. index:: pair: class; ov::op::v0::Sign
.. _doxid-classov_1_1op_1_1v0_1_1_sign:
...
Elementwise sign operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_sign>`
...
.. ref-code-block:: cpp
	...
	class Sign: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_sign_1abef7f5c1ac7319f4f5163b6f572d6a4a>`;

		// construction
	
		:target:`Sign<doxid-classov_1_1op_1_1v0_1_1_sign_1aab8a14de6cd2f24fe63b18c26ccaa902>`();
		:ref:`Sign<doxid-classov_1_1op_1_1v0_1_1_sign_1a2ef58b7a2df321c93b4c5f910366c73a>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_sign_1aeb9039cec839161cbabdfa9515c6e493>`("Sign", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_sign_1ac92c48339bbc0a74055774c41db00812>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_sign_1a4af60c55368780671a621052b1028093>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_sign_1aac5d4ab4cef3d4981606c08563a904fb>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_sign_1ad2bf92cc5e5b3400184909c7a9a71e86>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_sign:
...
.. _doxid-classov_1_1op_1_1v0_1_1_sign_1a2ef58b7a2df321c93b4c5f910366c73a:
.. index:: pair: function; Sign

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Sign(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_sign_1aac5d4ab4cef3d4981606c08563a904fb:
...
.. _doxid-classov_1_1op_1_1v0_1_1_sign_1ad2bf92cc5e5b3400184909c7a9a71e86:
