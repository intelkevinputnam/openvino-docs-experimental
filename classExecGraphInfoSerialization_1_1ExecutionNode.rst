.. index:: pair: class; ExecGraphInfoSerialization::ExecutionNode
.. _doxid-class_exec_graph_info_serialization_1_1_execution_node:
...
The Execution node which is used to represent node in execution graph. :ref:`More...<details-class_exec_graph_info_serialization_1_1_execution_node>`
...
.. ref-code-block:: cpp
	...
	class ExecutionNode: public :ref:`ov::Node<doxid-classov_1_1_node>`
	{
	public:
		// fields
	
		static constexpr :ref:`ngraph::NodeTypeInfo<doxid-classngraph_1a8f207b9a789594d326c5adbfc49ccc71>` :target:`type_info<doxid-class_exec_graph_info_serialization_1_1_execution_node_1a3da650f3ab94af8b54772c7e4d392668>` {"ExecutionNode", static_cast<uint64_t>(0)};

		// construction
	
		:ref:`ExecutionNode<doxid-class_exec_graph_info_serialization_1_1_execution_node_1aac5e3f33a231db9448150473af8139e5>`();
		:ref:`ExecutionNode<doxid-class_exec_graph_info_serialization_1_1_execution_node_1ad543a55741496a63901c9f10a6421a98>`(const :ref:`ngraph::OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& arguments, size_t output_size = 1);

		// methods
	
		virtual const :ref:`ngraph::NodeTypeInfo<doxid-classngraph_1a8f207b9a789594d326c5adbfc49ccc71>`& :ref:`get_type_info<doxid-class_exec_graph_info_serialization_1_1_execution_node_1ac259d4c16c4f6b85f35aa3081655b15c>`() const;
		std::shared_ptr<:ref:`ngraph::Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-class_exec_graph_info_serialization_1_1_execution_node_1af5a6ac504cda7ac00e6371d49be6b779>`(const :ref:`ngraph::OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& inputs) const;
		virtual bool :ref:`visit_attributes<doxid-class_exec_graph_info_serialization_1_1_execution_node_1a29aa8775972574c27073ad4f840d010e>`(:ref:`ngraph::AttributeVisitor<doxid-classov_1_1_attribute_visitor>`&);
	};
...
.. _details-class_exec_graph_info_serialization_1_1_execution_node:
...
* :ref:`ExecGraphInfoSerialization::ORIGINAL_NAMES <doxid-group__ie__dev__exec__graph_1gaf81db1d9eb4732d48ab5dbfa78d9e238>`

* :ref:`ExecGraphInfoSerialization::IMPL_TYPE <doxid-group__ie__dev__exec__graph_1ga9e563af5a735a50f00db6aaf0b637f20>`

* :ref:`ExecGraphInfoSerialization::OUTPUT_PRECISIONS <doxid-group__ie__dev__exec__graph_1ga9404c4010efbba1234c898d83539326a>`

* :ref:`ExecGraphInfoSerialization::PERF_COUNTER <doxid-group__ie__dev__exec__graph_1ga94fe83ba1c48c33804219b0f5a4303f0>`

* :ref:`ExecGraphInfoSerialization::OUTPUT_LAYOUTS <doxid-group__ie__dev__exec__graph_1ga7e9a63a77266338179a131f290a291be>`

* :ref:`ExecGraphInfoSerialization::EXECUTION_ORDER <doxid-group__ie__dev__exec__graph_1ga68ee1085f7ce85d6fdb4a7b3570bbeac>`

* :ref:`ExecGraphInfoSerialization::LAYER_TYPE <doxid-group__ie__dev__exec__graph_1ga10c7fd3a4016b25f347391aa4fe589e9>`

* :ref:`ExecGraphInfoSerialization::RUNTIME_PRECISION <doxid-group__ie__dev__exec__graph_1ga56b675ce34cb7a58a79a21694fa63896>`

Construction
------------

.. _doxid-class_exec_graph_info_serialization_1_1_execution_node_1aac5e3f33a231db9448150473af8139e5:
.. index:: pair: function; ExecutionNode
...
.. _doxid-class_exec_graph_info_serialization_1_1_execution_node_1ad543a55741496a63901c9f10a6421a98:
.. index:: pair: function; ExecutionNode

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	ExecutionNode(const :ref:`ngraph::OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& arguments, size_t output_size = 1)
...
.. _doxid-class_exec_graph_info_serialization_1_1_execution_node_1ac259d4c16c4f6b85f35aa3081655b15c:
.. index:: pair: function; get_type_info

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual const :ref:`ngraph::NodeTypeInfo<doxid-classngraph_1a8f207b9a789594d326c5adbfc49ccc71>`& get_type_info() const
...
.. _doxid-class_exec_graph_info_serialization_1_1_execution_node_1af5a6ac504cda7ac00e6371d49be6b779:
.. index:: pair: function; clone_with_new_inputs

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	std::shared_ptr<:ref:`ngraph::Node<doxid-classov_1_1_node>`> clone_with_new_inputs(const :ref:`ngraph::OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& inputs) const
...
.. _doxid-class_exec_graph_info_serialization_1_1_execution_node_1a29aa8775972574c27073ad4f840d010e:
.. index:: pair: function; visit_attributes

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual bool visit_attributes(:ref:`ngraph::AttributeVisitor<doxid-classov_1_1_attribute_visitor>`&)
