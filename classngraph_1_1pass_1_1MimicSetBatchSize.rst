.. index:: pair: class; ngraph::pass::MimicSetBatchSize
.. _doxid-classngraph_1_1pass_1_1_mimic_set_batch_size:
...
:ref:`MimicSetBatchSize <doxid-classngraph_1_1pass_1_1_mimic_set_batch_size>` transformation relaxes hard-coded output batch dimension of Reshape operation. For Reshape with input shape [in_batch, ...] and pattern value [out_batch, ...] it generates a sub-graph which basically keeps ratio of input and output batch size and performs the following calculation: :ref:`More...<details-classngraph_1_1pass_1_1_mimic_set_batch_size>`
...
.. ref-code-block:: cpp
	...
	class MimicSetBatchSize: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_mimic_set_batch_size_1aa9938b38dcfc2a9766ae8e21ff60fea9>`("MimicSetBatchSize", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_mimic_set_batch_size_1a1d77b2a791ca206eaa86e65dda4cf2f1>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
...
.. _details-classngraph_1_1pass_1_1_mimic_set_batch_size:
