.. index:: pair: class; ngraph::pass::low_precision::TransposeTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation:
...
:ref:`TransposeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation>` propagates dequantization operations through Transpose operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation>`
...
.. ref-code-block:: cpp
	...
	class TransposeTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`TransposeTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation_1a5e0a91f608d651e31f5553001a05e127>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation_1a77ab8e2b35b0fa57c7c4bbc32d0e066b>`("TransposeTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation_1a48c9593e7cfba307752c27d27ecd0fe8>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation_1a34145bb1556d0786311b4bf536b1d202>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation_1a6d3d7199a8249230dacc2bec690a3dc3>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`TransposeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_transpose_transformation>` propagates dequantization operations through Transpose operation.

For more details about the transformation, refer to :ref:`TransposeTransformation <doxid-openvino_docs__o_v__u_g_lpt__transpose_transformation>` page in the Inference Engine Developer Guide.
