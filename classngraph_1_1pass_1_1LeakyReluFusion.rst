.. index:: pair: class; ngraph::pass::LeakyReluFusion
.. _doxid-classngraph_1_1pass_1_1_leaky_relu_fusion:
...
:ref:`LeakyReluFusion <doxid-classngraph_1_1pass_1_1_leaky_relu_fusion>` transformation replaces following graph: Multiply->Maximum to LeakyRelu.
...
.. ref-code-block:: cpp
	...
	class LeakyReluFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_leaky_relu_fusion_1ad6f6e6af3fa081c212b364dec925de99>`("LeakyReluFusion", "0");
	};
