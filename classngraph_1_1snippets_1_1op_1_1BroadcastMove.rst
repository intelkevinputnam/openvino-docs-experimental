.. index:: pair: interface; ngraph::snippets::op::BroadcastMove
.. _doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move:

interface ngraph::snippets::op::BroadcastMove
=============================================
...
Added to a subgraph if explicit broadcast instruction should be generated. :ref:`More...<details-classngraph_1_1snippets_1_1op_1_1_broadcast_move>`


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <broadcastmove.hpp>
	
	template BroadcastMove: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
		// construction
	
		:target:`BroadcastMove<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a2a232919f073767efd026fa99c199bc5>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x, :ref:`Shape<doxid-classov_1_1_shape>` output_shape);
		:target:`BroadcastMove<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1aaeae5593e3e004223c8f704e8e79b078>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a1f4eb59790a130dc468c40ee7856a735>`("BroadcastMove", "SnippetsOpset");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a436504fa04de71275e9e459dcde1297a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1aa531e750b923f972418a14b0cf516eaf>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		...
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a1ffed14875d7ef0ed2eeb8ab5153308e>`(
...
.. _details-classngraph_1_1snippets_1_1op_1_1_broadcast_move:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Added to a subgraph if explicit broadcast instruction should be generated.

Methods
-------

.. _doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a96849d5ba53f43cb1d5532b34527598b:
