.. index:: pair: class; ov::op::v5::GatherND
.. _doxid-classov_1_1op_1_1v5_1_1_gather_n_d:
...
:ref:`GatherND <doxid-classov_1_1op_1_1v5_1_1_gather_n_d>` operation. :ref:`More...<details-classov_1_1op_1_1v5_1_1_gather_n_d>`
...
.. ref-code-block:: cpp
	...
	class GatherND: public :ref:`ov::op::util::GatherNDBase<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1aa5a1cab99c3a63e9b27b14c454aa6553>`;

		// construction
	
		:target:`GatherND<doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a4baed3e40602fef5629ec583cf5c96a9>`();
	
		:ref:`GatherND<doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a9283bdde494493e45d1e13bb1e3f515c>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a01edc494c2ae6cd8750e065398ccd3c2>`("GatherND", "opset5", :ref:`op::util::GatherNDBase<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base>`, 5);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a4b18d91441db94901498a1f810e20e4c>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a40e1553758e54c6e04371b140d9d6637>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a9ca460c5bff5bbb0cbb1c5acc63da868>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a3d6afe4836fdfcc95606665791a7f0d0>`("GatherNDBase", "util");
		size_t :ref:`get_batch_dims<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1ac38bb7ee9ef410672705899c1c093cf7>`() const;
		void :ref:`validate_inputs_and_infer_shape<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1ac587c3827d0a162b5ad6a6823722170f>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a3cc75e314cc554b455ba718edadf29c9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v5_1_1_gather_n_d:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`GatherND <doxid-classov_1_1op_1_1v5_1_1_gather_n_d>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a9283bdde494493e45d1e13bb1e3f515c:
.. index:: pair: function; GatherND
...
Constructs a :ref:`GatherND <doxid-classov_1_1op_1_1v5_1_1_gather_n_d>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing data that are gathered

	*
		- indices

		- :ref:`Node <doxid-classov_1_1_node>` producing indices by which the operation gathers elements or slices from data

	*
		- batch_dims

		- Specifies a number of batch dimensions

Methods
-------

.. _doxid-classov_1_1op_1_1v5_1_1_gather_n_d_1a4b18d91441db94901498a1f810e20e4c:
