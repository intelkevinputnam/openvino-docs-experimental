.. index:: pair: class; ngraph::pass::LogSoftmaxDecomposition
.. _doxid-classngraph_1_1pass_1_1_log_softmax_decomposition:
...
:ref:`LogSoftmaxDecomposition <doxid-classngraph_1_1pass_1_1_log_softmax_decomposition>` transformation into sub-graph x - log(reduce_sum(exp(x), axis)).
...
.. ref-code-block:: cpp
	...
	class LogSoftmaxDecomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_log_softmax_decomposition_1aedddd12fb228041be70b381b9b380f9b>`("LogSoftmaxDecomposition", "0");
	};
