.. index:: pair: class; ov::op::v3::ROIAlign
.. _doxid-classov_1_1op_1_1v3_1_1_r_o_i_align:
...
.. toctree::
	...
	PoolingMode <enumov_1_1op_1_1v3_1_1ROIAlign_1_1PoolingMode.rst>

Overview
~~~~~~~~

:ref:`ROIAlign <doxid-classov_1_1op_1_1v3_1_1_r_o_i_align>` operation. :ref:`More...<details-classov_1_1op_1_1v3_1_1_r_o_i_align>`
...
.. ref-code-block:: cpp
	...
	class ROIAlign: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`PoolingMode<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a7ef654649e9fe953a81a3cf7a30c85d7>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a20e1974cd169ebce849760d0560f0d2b>`;

		// construction
	
		:target:`ROIAlign<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1ae8bf5f47a188030808841b6d616d4da4>`();
	
		:ref:`ROIAlign<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a7a8164dca3c9d65b7f4323d5644f68a4>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& rois,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& batch_indices,
			const int pooled_h,
			const int pooled_w,
		...
		:target:`ROIAlign<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1aca211dbb9fd14c3b3d41e4fe5f617fd2>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& rois,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& batch_indices,
			const int pooled_h,
			...
			const int sampling_ratio,
			const float spatial_scale,
			const :ref:`PoolingMode<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a7ef654649e9fe953a81a3cf7a30c85d7>` mode
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a6f12aaf7380bd769751389edcad7bf43>`("ROIAlign", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1af56e25a8d01caa56903223681b7084ba>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a0e6d594fafc3287080d21c1c97fc402a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a600a5c6647a6a777c868c1dab173eae0>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		int :target:`get_pooled_h<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a4fdc7354dc9aa8ad8f1a46fa9bdfe10d>`() const;
		int :target:`get_pooled_w<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a255fd469806ec99419f45531ce45b559>`() const;
		int :target:`get_sampling_ratio<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a145a3181615dc29c0c0de74f0a55af81>`() const;
		float :target:`get_spatial_scale<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a89fd183fa499879ca4e28a7fce4ee3b7>`() const;
		:ref:`PoolingMode<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a7ef654649e9fe953a81a3cf7a30c85d7>` :target:`get_mode<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a390326b344fc19fd75d46caba6f78cb1>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1aed7051dbabeac5e0e4f098f46cd8c549>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a6b55a37c1e7914f6ec3fbe2acc79276d>`() const;
	};
...
.. _details-classov_1_1op_1_1v3_1_1_r_o_i_align:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ROIAlign <doxid-classov_1_1op_1_1v3_1_1_r_o_i_align>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a7a8164dca3c9d65b7f4323d5644f68a4:
.. index:: pair: function; ROIAlign
...
Constructs a :ref:`ROIAlign <doxid-classov_1_1op_1_1v3_1_1_r_o_i_align>` node matching the ONNX :ref:`ROIAlign <doxid-classov_1_1op_1_1v3_1_1_r_o_i_align>` specification.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` feature map {N, C, H, W}

	*
		- rois

		- Regions of interest to pool over

	*
		- batch_indices

		- Indices of images in the batch matching the number or ROIs

	*
		- pooled_h

		- Height of the ROI output features

	*
		- pooled_w

		- Width of the ROI output features

	*
		- sampling_ratio

		- Number of sampling points used to compute an output element

	*
		- spatial_scale

		- Spatial scale factor used to translate ROI coordinates

	*
		- mode

		- Method of pooling - 'avg' or 'max'

Methods
-------

.. _doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1af56e25a8d01caa56903223681b7084ba:
...
.. _doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1aed7051dbabeac5e0e4f098f46cd8c549:
...
.. _doxid-classov_1_1op_1_1v3_1_1_r_o_i_align_1a6b55a37c1e7914f6ec3fbe2acc79276d:
