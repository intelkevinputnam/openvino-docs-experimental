.. index:: pair: class; ngraph::pass::ConvertLRNToLegacyMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_l_r_n_to_legacy_matcher:

class ngraph::pass::ConvertLRNToLegacyMatcher
=============================================
...
.. ref-code-block:: cpp
	...
	#include <convert_lrn_to_lrn_ie.hpp>
	
	class ConvertLRNToLegacyMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_l_r_n_to_legacy_matcher_1aa7855c44ca61876f6e06bb4047cb4e2a>`("ConvertLRNToLegacyMatcher", "0");
	};
