.. index:: pair: class; ngraph::pass::BatchToSpaceFusion
.. _doxid-classngraph_1_1pass_1_1_batch_to_space_fusion:
...
:ref:`BatchToSpaceFusion <doxid-classngraph_1_1pass_1_1_batch_to_space_fusion>` transformation replaces following graph: Transpose (or Reshape) -> DepthToSpace -> StridedSlice -> Transpose (or Reshape) to BatchToSpace Restrictions: :ref:`More...<details-classngraph_1_1pass_1_1_batch_to_space_fusion>`
...
.. ref-code-block:: cpp
	...
	class BatchToSpaceFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_batch_to_space_fusion_1a64bd03c9aba18e65aa129cabbb577909>`("BatchToSpaceFusion", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_batch_to_space_fusion:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`BatchToSpaceFusion <doxid-classngraph_1_1pass_1_1_batch_to_space_fusion>` transformation replaces following graph: Transpose (or Reshape) -> DepthToSpace -> StridedSlice -> Transpose (or Reshape) to BatchToSpace Restrictions:
