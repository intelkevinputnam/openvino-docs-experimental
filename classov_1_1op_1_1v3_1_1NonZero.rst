.. index:: pair: class; ov::op::v3::NonZero
.. _doxid-classov_1_1op_1_1v3_1_1_non_zero:
...
:ref:`NonZero <doxid-classov_1_1op_1_1v3_1_1_non_zero>` operation returning indices of non-zero elements in the input tensor. :ref:`More...<details-classov_1_1op_1_1v3_1_1_non_zero>`
...
.. ref-code-block:: cpp
	...
	class NonZero: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a26ea41c0bdbef5b336f0a28e56d42800>`;

		// construction
	
		:ref:`NonZero<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a826b61f979a943b23427dc798219562a>`();
		:ref:`NonZero<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a4c0ce3c67ca15df8cecde0f631437b91>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:ref:`NonZero<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a3e0c511b38ea1dd18dda197ff640a579>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const std::string& output_type);
		:ref:`NonZero<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a18f3d34a67b53ef6d0ab6f923acbcab9>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a84c6fe275c0f9925c9b58a9ec40e1730>`("NonZero", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_non_zero_1aae4aa5f9bd7d58c7e428b38abe0ecdb7>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_non_zero_1aed1d854060b7110688769e3ca1a9aee7>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_non_zero_1ac5de7b1e268da7d2f1d9d2a4d0527d1e>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_output_type<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a9f4f437655dc2648f38d944a29eeb900>`() const;
		void :target:`set_output_type<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a3e009760f22632d92206cbd6386967d7>`(:ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_non_zero_1a50e3fb6daa0fcb17cc289cdae4461779>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_non_zero_1ae4aa9e58b8f9964fa8160a6d5cec2460>`() const;
	
		void :target:`set_output_type<doxid-classov_1_1op_1_1v3_1_1_non_zero_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
...
.. _details-classov_1_1op_1_1v3_1_1_non_zero:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`NonZero <doxid-classov_1_1op_1_1v3_1_1_non_zero>` operation returning indices of non-zero elements in the input tensor.
...
.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1a826b61f979a943b23427dc798219562a:
.. index:: pair: function; NonZero
...
Constructs a :ref:`NonZero <doxid-classov_1_1op_1_1v3_1_1_non_zero>` operation.

.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1a4c0ce3c67ca15df8cecde0f631437b91:
.. index:: pair: function; NonZero

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	NonZero(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1a3e0c511b38ea1dd18dda197ff640a579:
.. index:: pair: function; NonZero

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	NonZero(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const std::string& output_type)
...
.. list-table::
	...
	*
		...
		- produce indices. Currently, only 'int64' or 'int32' are supported

.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1a18f3d34a67b53ef6d0ab6f923acbcab9:
.. index:: pair: function; NonZero

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	NonZero(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type)
...
.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1aed1d854060b7110688769e3ca1a9aee7:
...
.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1a50e3fb6daa0fcb17cc289cdae4461779:
...
.. _doxid-classov_1_1op_1_1v3_1_1_non_zero_1ae4aa9e58b8f9964fa8160a6d5cec2460:
