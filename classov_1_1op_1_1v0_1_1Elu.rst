.. index:: pair: class; ov::op::v0::Elu
.. _doxid-classov_1_1op_1_1v0_1_1_elu:
...
Exponential Linear Unit x < 0 => f(x) = alpha \* (exp(x) - 1.) x >= 0 => f(x) = x. :ref:`More...<details-classov_1_1op_1_1v0_1_1_elu>`
...
.. ref-code-block:: cpp
	...
	class Elu: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_elu_1ac95c3175d692330921d336f5cbb8a4ec>`;

		// construction
	
		:target:`Elu<doxid-classov_1_1op_1_1v0_1_1_elu_1af7f2234fc179027bb28dfa9ae26ff626>`();
		:ref:`Elu<doxid-classov_1_1op_1_1v0_1_1_elu_1ad9d0324026331e7a02b452dfbe0577ad>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const double alpha);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_elu_1aa91fddf8b5b7d2a392964b55854477eb>`("Elu", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_elu_1a7587d8fec2d1b97f0543bb34ad06b5ba>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_elu_1aa863dd6d1f059f21b2748bcc4ce7348a>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_elu_1a7601ab73f795af04a6ccadd1f44e00d0>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		double :target:`get_alpha<doxid-classov_1_1op_1_1v0_1_1_elu_1ab3080b1713c041c5a870b10b8cce05da>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_elu:
...
.. _doxid-classov_1_1op_1_1v0_1_1_elu_1ad9d0324026331e7a02b452dfbe0577ad:
.. index:: pair: function; Elu

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Elu(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const double alpha)

Constructs an :ref:`Elu <doxid-classov_1_1op_1_1v0_1_1_elu>` operation.
...
.. list-table::
	...
	*
		...
		- Multiplier for negative values

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_elu_1aa863dd6d1f059f21b2748bcc4ce7348a:
