.. index:: pair: class; ov::op::v6::ExperimentalDetectronGenerateProposalsSingleImage
.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image:
...
.. toctree::
	...
	Attributes <structov_1_1op_1_1v6_1_1ExperimentalDetectronGenerateProposalsSingleImage_1_1Attributes.rst>

Overview
~~~~~~~~

An operation :ref:`ExperimentalDetectronGenerateProposalsSingleImage <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image>` computes ROIs and their scores based on input data. :ref:`More...<details-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image>`
...
.. ref-code-block:: cpp
	...
	class ExperimentalDetectronGenerateProposalsSingleImage: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// structs
	
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1_1_attributes>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a1ad9c49faf139da260d071833f8a8711>`;

		// construction
	
		:target:`ExperimentalDetectronGenerateProposalsSingleImage<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a2cf5d5b41816bf6ccc19432b06adab88>`();
	
		:ref:`ExperimentalDetectronGenerateProposalsSingleImage<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a7d262e754db626b67ebd68018dde3f2b>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& im_info,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& anchors,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& deltas,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
			const :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1ac40dcca9834a07d1019d944d8c7e1b0b>`(
			"ExperimentalDetectronGenerateProposalsSingleImage",
			"opset6",
			:ref:`op::Op<doxid-classov_1_1op_1_1_op>`,
			6
			);
	
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a7e9660d9acb2b9fd0262cb2ccce59f8f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a6b83a04b9ef4829ac9807ed667438ff6>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1adc408f7e33378805c9d88a7516c903e9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1_1_attributes>`& :target:`get_attrs<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1aefb19fda0e758620070ef8929ced66b0>`() const;
	};
...
.. _details-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

An operation :ref:`ExperimentalDetectronGenerateProposalsSingleImage <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image>` computes ROIs and their scores based on input data.

Construction
------------

.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a7d262e754db626b67ebd68018dde3f2b:
.. index:: pair: function; ExperimentalDetectronGenerateProposalsSingleImage
...
Constructs a :ref:`ExperimentalDetectronGenerateProposalsSingleImage <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` anchors
...
.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_generate_proposals_single_image_1a6b83a04b9ef4829ac9807ed667438ff6:
