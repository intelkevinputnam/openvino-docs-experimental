.. index:: pair: class; ngraph::op::internal::NonMaxSuppressionIEInternal
.. _doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal:

class ngraph::op::internal::NonMaxSuppressionIEInternal
=======================================================
...
.. ref-code-block:: cpp
	...
	class NonMaxSuppressionIEInternal: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a2ad538d3b4e3f429104695af0d7bdb6c>`;
		int :target:`m_center_point_box<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1acecc25441b398eec5d5a2d0563c57879>`;
		bool :target:`m_sort_result_descending<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a4a01081cabe32a75dbbf6a350f0c621f>` = true;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`m_output_type<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1acbb0363565ee4bd8886db20dfebd6421>`;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`m_scores_output_type<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a5620f98dee2bbf3d36f28a746e202d71>`;

		// construction
	
		:target:`NonMaxSuppressionIEInternal<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1aae930086bcb343c272b129d1925da86f>`();
	
		:target:`NonMaxSuppressionIEInternal<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1ace951cdce3a248198b5e8e624d13b425>`(
			...
			const :ref:`ngraph::element::Type<doxid-classov_1_1element_1_1_type>`& output_type = ngraph::element::i64,
			const :ref:`ngraph::element::Type<doxid-classov_1_1element_1_1_type>`& score_output_type = ngraph::element::f32
			);
	
		:target:`NonMaxSuppressionIEInternal<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a0b402d7d172325278f788003b174e7e2>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& boxes,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& max_output_boxes_per_class,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& iou_threshold,
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1aa431fd0a2c5573f583b36a7071438bc3>`("NonMaxSuppressionIEInternal", "ie_internal_opset");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a4eaf9f38894c13f8ee1dedb921d472c9>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a6fe3741d83b8abed0d04023da9128731>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1ab812aa868049415f3a5a0bdca2e98241>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal:
...
.. _doxid-classngraph_1_1op_1_1internal_1_1_non_max_suppression_i_e_internal_1a4eaf9f38894c13f8ee1dedb921d472c9:
