.. index:: pair: class; ngraph::pass::SwishFusionWithSigmoid
.. _doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid:
...
:ref:`SwishFusionWithSigmoid <doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid>` replaces a sub-graphs x \* Sigmoid(x) with a Swish op.
...
.. ref-code-block:: cpp
	...
	class SwishFusionWithSigmoid: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid_1a5850f184985c21bf284d43cd9ef1302b>`("SwishFusionWithSigmoid", "0");
	};
