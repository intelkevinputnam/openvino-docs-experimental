.. index:: pair: class; ov::op::v8::AdaptiveMaxPool
.. _doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool:
...
Adaptive max pooling operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_adaptive_max_pool>`
...
.. ref-code-block:: cpp
	...
	class AdaptiveMaxPool: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1a03c718d6ed14c842cf556e83fd9b8273>`;

		// construction
	
		:target:`AdaptiveMaxPool<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1ad9f0af2eaef95990bd16d0065d6f2632>`();
	
		:ref:`AdaptiveMaxPool<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1a6ed9fdd9a3c1827a10ab06a476428fb9>`(
			...
			const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& index_element_type = :ref:`ov::element::i64<doxid-group__ov__element__cpp__api_1ga6c86a9a54d44fc205ad9cbf28ca556a6>`
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1a677978d45e8eedb7e90c2352b4a7b0cd>`("AdaptiveMaxPool", "opset8");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1aa78a8d43078448833116a797c1e70c7e>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1a62232b68f3ff54f3981605c5996688be>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1a2e4863e54ae8be534328521726c1e92b>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_index_element_type<doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1af5915ef0dba1f89898bfb8a148ccdd1c>`() const;
	};
...
.. _details-classov_1_1op_1_1v8_1_1_adaptive_max_pool:
...
.. _doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1a6ed9fdd9a3c1827a10ab06a476428fb9:
.. index:: pair: function; AdaptiveMaxPool
...
.. list-table::
	...
	*
		...
		- 1D tensor describing output shape for spatial dimensions.

	*
		- index_element_type

		- Specifies the output tensor type for indices output

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_adaptive_max_pool_1aa78a8d43078448833116a797c1e70c7e:
