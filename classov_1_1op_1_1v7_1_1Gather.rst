.. index:: pair: class; ov::op::v7::Gather
.. _doxid-classov_1_1op_1_1v7_1_1_gather:
...
:ref:`Gather <doxid-classov_1_1op_1_1v7_1_1_gather>` slices from axis of data according to indices. :ref:`More...<details-classov_1_1op_1_1v7_1_1_gather>`
...
.. ref-code-block:: cpp
	...
	class Gather: public :ref:`ov::op::util::GatherBase<doxid-classov_1_1op_1_1util_1_1_gather_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v7_1_1_gather_1a33d9a448faae2e46b63b7d0f39120616>`;

		// construction
	
		:target:`Gather<doxid-classov_1_1op_1_1v7_1_1_gather_1a0f839fdfe8a07ed7d6e105091651fd5c>`();
	
		:ref:`Gather<doxid-classov_1_1op_1_1v7_1_1_gather_1ac4103614abe53892de79fa6a1cd2e80a>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& axis,
			const int64_t batch_dims = 0
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v7_1_1_gather_1ab54cd1dd79935795cd105fa90d655c1a>`("Gather", "opset7", :ref:`op::util::GatherBase<doxid-classov_1_1op_1_1util_1_1_gather_base>`, 7);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v7_1_1_gather_1ac3b3a00c7a20702bd0e320b29935a035>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v7_1_1_gather_1a4ea77a8b2a0344e898bbc6d3a823ba46>`();
		int64_t :target:`get_batch_dims<doxid-classov_1_1op_1_1v7_1_1_gather_1ac2971ba54650f1cf0508b072eb0d70b3>`() const;
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v7_1_1_gather_1a569c849f34f14e7f492a34a122c3286c>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_gather_base_1a0f9d750a1b482c6b862b184a1d70aba1>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_gather_base_1a0d8fb5abdad3d62562dbe51843526009>`("GatherBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_gather_base_1abf51895771d2ac597e5101de63eba823>`();
		virtual int64_t :ref:`get_axis<doxid-classov_1_1op_1_1util_1_1_gather_base_1a66a365202e54bfb4558618229332054e>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1util_1_1_gather_base_1ac328f7e4e2f247aaec8d007191cf2b43>`(
		...
		virtual bool :ref:`evaluate_lower<doxid-classov_1_1op_1_1util_1_1_gather_base_1aa897f153c863386f3101ddbbf46f3bee>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :ref:`evaluate_upper<doxid-classov_1_1op_1_1util_1_1_gather_base_1ad94e9ed738fc1fa5daebb998b731a916>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`evaluate_label<doxid-classov_1_1op_1_1util_1_1_gather_base_1ab33dab8f2f687d85eae3f3784af1ff94>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :ref:`constant_fold<doxid-classov_1_1op_1_1util_1_1_gather_base_1a07159cd5a99d52551f50371d2393f100>`(
			:ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& output_values,
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& inputs_values
			);
	
		const int64_t& :ref:`get_batch_dims<doxid-classov_1_1op_1_1util_1_1_gather_base_1a2cc84eb01e9280c2d240107729cff638>`() const;

.. _details-classov_1_1op_1_1v7_1_1_gather:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Gather <doxid-classov_1_1op_1_1v7_1_1_gather>` slices from axis of data according to indices.

Construction
------------

.. _doxid-classov_1_1op_1_1v7_1_1_gather_1ac4103614abe53892de79fa6a1cd2e80a:
.. index:: pair: function; Gather
...
.. list-table::
	...
	*
		...
		- :ref:`Tensor <doxid-classov_1_1_tensor>` with indexes to gather

	*
		- axis

		- The tensor is a dimension index to gather data from

	*
		- batch_dims

		- The number of batch dimension in data and indices tensors. If batch_dims = 0 :ref:`Gather <doxid-classov_1_1op_1_1v7_1_1_gather>` :ref:`v7 <doxid-namespaceov_1_1op_1_1v7>` is identical to :ref:`Gather <doxid-classov_1_1op_1_1v7_1_1_gather>` :ref:`v1 <doxid-namespaceov_1_1op_1_1v1>`.

Methods
-------

.. _doxid-classov_1_1op_1_1v7_1_1_gather_1a4ea77a8b2a0344e898bbc6d3a823ba46:
