.. index:: pair: class; ov::op::v8::DeformableConvolution
.. _doxid-classov_1_1op_1_1v8_1_1_deformable_convolution:
...
:ref:`DeformableConvolution <doxid-classov_1_1op_1_1v8_1_1_deformable_convolution>` operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_deformable_convolution>`
...
.. ref-code-block:: cpp
	...
	class DeformableConvolution: public :ref:`ov::op::util::DeformableConvolutionBase<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1aa61e8ac73c3746feda5f9af49d7a263f>`;

		// construction
	
		:ref:`DeformableConvolution<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a662af3b1bd1c1b1ea4b4fd121fff4142>`();
	
		:ref:`DeformableConvolution<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a5855cdfaa15c887a4cdaa0631f5b2466>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& offsets,
		...
		:ref:`DeformableConvolution<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a3219e78408a8195a31df7ae7240af761>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& offsets,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& filters,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& mask,
			const :ref:`Strides<doxid-classov_1_1_strides>`& strides,
			const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin,
			const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_end,
			const :ref:`Strides<doxid-classov_1_1_strides>`& dilations,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a58d06b437abf43750a392cc4c7f6988d>`(
			"DeformableConvolution",
			"opset8",
			:ref:`op::util::DeformableConvolutionBase<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base>`
			);
	
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1ad3dc30419a5d60b9ca22c4e5cdf26f5b>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a2fdacf3f85cfdc6b1385267095530516>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a3bb44e71f2162a7eb3ab5bf4da413fb5>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		bool :target:`get_bilinear_interpolation_pad<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a477ccdb303fd7889fb5951370b4b3995>`() const;
		void :target:`set_bilinear_interpolation_pad<doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a3c38fbb884aa4ce99b252996e6a3d184>`(const bool bilinear_interpolation_pad);
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1adb7ff4e38c7ac14ef8d27c057914825d>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a8b60b3b39afeae83c191df19a868b91a>`("DeformableConvolutionBase", "util");
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a8036d698271b7ed96a2891408cee467a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ac7b4d39f3a55aae3da250ec633ccdead>`();
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_strides<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1aceb3750e47c4112ddd36a14d8b15383f>`() const;
		void :ref:`set_strides<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1aa84f1d5080e721bb1197b27b7e911cd3>`(const :ref:`Strides<doxid-classov_1_1_strides>`& strides);
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_dilations<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1adf04daed3f9841e99cb68f656ba85c3a>`() const;
		void :ref:`set_dilations<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a20efae81190ef069a3ae4671f5186422>`(const :ref:`Strides<doxid-classov_1_1_strides>`& dilations);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_begin<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a80b733c07ca2384f26b7a3c3e342ab92>`() const;
		void :ref:`set_pads_begin<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a9966f3ef2a0a98d9f19930314b10813c>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_end<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a96019bd26c1d0a63d34eb1874b9da8d4>`() const;
		void :ref:`set_pads_end<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a78e95974d91b6401c920cfecef88a172>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_end);
		const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& :ref:`get_auto_pad<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ad1153a28704f8cfbfe282ea32bbba60a>`() const;
		void :ref:`set_auto_pad<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ade732cb979bc776373d45c07ab6f8291>`(const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& auto_pad);
		int64_t :ref:`get_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a58e52a9ea08c4b71620f071ccf308399>`() const;
		void :ref:`set_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ae783a6525d82fed72c44a1010b8c6e38>`(const int64_t group);
		int64_t :ref:`get_deformable_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a066a91e31c04c032df7444d901959fe8>`() const;
		void :ref:`set_deformable_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1aa84fd973ad123eb3bfde482e157b8a15>`(const int64_t deformable_group);

.. _details-classov_1_1op_1_1v8_1_1_deformable_convolution:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`DeformableConvolution <doxid-classov_1_1op_1_1v8_1_1_deformable_convolution>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a662af3b1bd1c1b1ea4b4fd121fff4142:
.. index:: pair: function; DeformableConvolution
...
.. _doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a5855cdfaa15c887a4cdaa0631f5b2466:
.. index:: pair: function; DeformableConvolution
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` that produces the input tensor.

	*
		- offsets

		- :ref:`Node <doxid-classov_1_1_node>` producing the deformable values tensor.

	*
		- filters

		- :ref:`Node <doxid-classov_1_1_node>` producing the filters(kernels) tensor with OIZYX layout.
	...
	*
		...
		- The flag that determines the mode of bilinear interpolation execution. :ref:`If <doxid-classov_1_1op_1_1v8_1_1_if>` the flag is ``true`` and the sampling location is within one pixel outside of the feature map boundary, then bilinear interpolation is performed on the zero padded feature map. :ref:`If <doxid-classov_1_1op_1_1v8_1_1_if>` the flag is ``false`` and the sampling location is within one pixel outside of the feature map boundary, then the sampling location shifts to the inner boundary of the feature map.`

.. _doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a3219e78408a8195a31df7ae7240af761:
.. index:: pair: function; DeformableConvolution
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the mask(mask) tensor.
...
.. _doxid-classov_1_1op_1_1v8_1_1_deformable_convolution_1a2fdacf3f85cfdc6b1385267095530516:
