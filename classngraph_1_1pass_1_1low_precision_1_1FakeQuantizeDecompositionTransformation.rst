.. index:: pair: class; ngraph::pass::low_precision::FakeQuantizeDecompositionTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation:
...
:ref:`FakeQuantizeDecompositionTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation>` decomposes FakeQuantize operations to quantize (FakeQuantize with changes output intervals and low precision output type) and dequantize operations. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation>`
...
.. ref-code-block:: cpp
	...
	class FakeQuantizeDecompositionTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`FakeQuantizeDecompositionTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation_1a33ecc232f9abd612b407f44fccd5acde>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation_1ae0c6b667bee2341b871afe542c1b39e1>`("FakeQuantizeDecompositionTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation_1aff4163368b6b799cc2bf94158eb441f6>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation_1ad6448c82f668c3523d3248599b520dc0>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`FakeQuantizeDecompositionTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_decomposition_transformation>` decomposes FakeQuantize operations to quantize (FakeQuantize with changes output intervals and low precision output type) and dequantize operations.

For more details about the transformation, refer to :ref:`FakeQuantizeDecompositionTransformation <doxid-openvino_docs__o_v__u_g_lpt__fake_quantize_decomposition_transformation>` page in the Inference Engine Developer Guide.
