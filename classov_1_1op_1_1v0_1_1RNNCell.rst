.. index:: pair: class; ov::op::v0::RNNCell
.. _doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell:
...
Class for single RNN cell node. :ref:`More...<details-classov_1_1op_1_1v0_1_1_r_n_n_cell>`
...
.. ref-code-block:: cpp
	...
	class RNNCell: public :ref:`ov::op::util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a2f64f73185c7541034725c7fbb70816c>`;

		// construction
	
		:target:`RNNCell<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1ae593c8bfe753de4473fc78f14c825997>`();
	
		:ref:`RNNCell<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a979bab934708a84c97e96905b12aa003>`(
		...
		:ref:`RNNCell<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a0a60e724e1e81ca18a9a2da619f619c9>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& X,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& initial_hidden_state,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& W,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& R,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1ae25681ce127b56261c132cece8093d00>`("RNNCell", "opset1", :ref:`util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1af15d25c5ca8d180b6cd304ad5a244602>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a16cf18cb977b6f18562400ecbbd0f17c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a6c1258f318367e300d270e730f160de2>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_r_n_n_cell:
...
It follows notation and equations defined as in ONNX standard: `https://github.com/onnx/onnx/blob/master/docs/Operators.md#RNN <https://github.com/onnx/onnx/blob/master/docs/Operators.md#RNN>`__
...
:ref:`LSTMSequence <doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_sequence>`, :ref:`LSTMCell <doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_cell>`, GRUCell

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a979bab934708a84c97e96905b12aa003:
.. index:: pair: function; RNNCell
...
Constructs :ref:`RNNCell <doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell>` node.
...
.. list-table::
	...
	*
		...
		- The weight tensor with shape: [hidden_size, input_size].

	*
		- R

		- The recurrence weight tensor with shape: [hidden_size, hidden_size].
...
.. _doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1a0a60e724e1e81ca18a9a2da619f619c9:
.. index:: pair: function; RNNCell
...
.. list-table::
	...
	*
		...
		- The bias tensor for input gate with shape: [hidden_size].
...
.. _doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell_1af15d25c5ca8d180b6cd304ad5a244602:
