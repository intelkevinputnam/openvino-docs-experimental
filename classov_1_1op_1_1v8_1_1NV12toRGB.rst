.. index:: pair: class; ov::op::v8::NV12toRGB
.. _doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b:
...
Color conversion operation from NV12 to RGB format. :ref:`Input <doxid-classov_1_1_input>` : :ref:`More...<details-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b>`
...
.. ref-code-block:: cpp
	...
	class NV12toRGB: public :ref:`ov::op::util::ConvertColorNV12Base<doxid-classov_1_1op_1_1util_1_1_convert_color_n_v12_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1af5a3e2e0c78b68de2a71ab8239b7ab35>`;

		// construction
	
		:target:`NV12toRGB<doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1ac41caf168a35ebce6cf7d6722581c3dc>`();
		:ref:`NV12toRGB<doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1a5a77b3f9fde4612c0753327aed803656>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:ref:`NV12toRGB<doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1a17513521c7efd298398d477e9fe6d0b5>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_y, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_uv);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1ac0dcb182a095ee4a046b1c2d261a2faf>`("NV12toRGB", "opset8", :ref:`util::ConvertColorNV12Base<doxid-classov_1_1op_1_1util_1_1_convert_color_n_v12_base>`);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1a661475697dfe3de132b4cd5ddb4740cc>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		enum :ref:`ColorConversion<doxid-classov_1_1op_1_1util_1_1_convert_color_n_v12_base_1afbdb3631faab232fb42d01ff83c5573b>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_convert_color_n_v12_base_1a3aacce5941bb170ab79a6b5003a21f3d>`("ConvertColorNV12Base", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_convert_color_n_v12_base_1a95f2541c7e4c0041f9de62e523058530>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_convert_color_n_v12_base_1a811534be1585d81ed486cb90d6bfe8b1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Color conversion operation from NV12 to RGB format. :ref:`Input <doxid-classov_1_1_input>` :

* :ref:`Input <doxid-classov_1_1_input>` NV12 image can be represented in two ways: a) Single plane (as it is in the file): NV12 height dimension is 1.5x bigger than image height. 'C' dimension shall be 1. b) Two separate planes (used this way in many physical video sources): Y and UV. In this case b1) Y plane has height same as image height. 'C' dimension equals to 1 b2) UV plane has dimensions: 'H' = image_h / 2; 'W' = image_w / 2; 'C' = 2.

* Supported element types: u8 or any supported floating-point type. :ref:`Output <doxid-classov_1_1_output>` :

* :ref:`Output <doxid-classov_1_1_output>` node will have NHWC layout and shape HxW same as image spatial dimensions.
...
.. _doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1a5a77b3f9fde4612c0753327aed803656:
.. index:: pair: function; NV12toRGB

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	NV12toRGB(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` that produces the input tensor. :ref:`Input <doxid-classov_1_1_input>` tensor represents image in NV12 format (YUV).

.. _doxid-classov_1_1op_1_1v8_1_1_n_v12to_r_g_b_1a17513521c7efd298398d477e9fe6d0b5:
.. index:: pair: function; NV12toRGB

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	NV12toRGB(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_y, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_uv)
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` that produces the input tensor for Y plane (NHWC layout). Shall have WxH dimensions equal to image dimensions. 'C' dimension equals to 1.

	*
		- arg_uv

		- :ref:`Node <doxid-classov_1_1_node>` that produces the input tensor for UV plane (NHWC layout). 'H' is half of image height, 'W' is half of image width, 'C' dimension equals to 2. Channel 0 represents 'U', channel 1 represents 'V' channel
