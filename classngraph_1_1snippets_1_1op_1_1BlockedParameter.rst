.. index:: pair: interface; ngraph::snippets::op::BlockedParameter
.. _doxid-classngraph_1_1snippets_1_1op_1_1_blocked_parameter:

interface ngraph::snippets::op::BlockedParameter
================================================



Represents blocked input (NCHW<X>c) for a subgraph.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <blockedparameter.hpp>
	
	template BlockedParameter: public :ref:`ov::op::v0::Parameter<doxid-classov_1_1op_1_1v0_1_1_parameter>`
	{
		// construction
	
		:target:`BlockedParameter<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_parameter_1a608c46b9aec63a6061e1efe7b4106712>`();
	
		:target:`BlockedParameter<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_parameter_1a3b08ccd52a35f5fa1817150f62c88fff>`(
			const :ref:`ngraph::element::Type<doxid-classov_1_1element_1_1_type>`& element_type,
			const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& pshape
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_parameter_1a8aeaaf6937d38e6ccae8d7b503dd8b66>`("BlockedParameter", "SnippetsOpset", :ref:`ngraph::op::Parameter<doxid-classov_1_1op_1_1v0_1_1_parameter>`);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_parameter_1a4e692bd67c0ef931289cd91a1f4c8423>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_parameter_1a0267aaa654df9d653f52a6f7a909c945>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_parameter_1a7cc443a68bdbefc1f1535f73f00a847d>`("Parameter", "opset1");
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_parameter_1af16b6f58b730e705a7129c70a44fc00a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_parameter_1a58128cf8629d204c2f3f37ee9e48a36b>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_parameter_1a8856d573ff12ecd9dcdc73253b868b95>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		bool :ref:`is_relevant_to_shapes<doxid-classov_1_1op_1_1v0_1_1_parameter_1a486766f6fa29ad18a8c9214fc902f758>`() const;
		void :ref:`set_is_relevant_to_shapes<doxid-classov_1_1op_1_1v0_1_1_parameter_1a77253a95629cf67a9debe0efac35c8a9>`(bool is_relevant);
		const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& :ref:`get_partial_shape<doxid-classov_1_1op_1_1v0_1_1_parameter_1ab93cb809b127294cef2cd94838604362>`() const;
		:ref:`PartialShape<doxid-classov_1_1_partial_shape>`& :ref:`get_partial_shape<doxid-classov_1_1op_1_1v0_1_1_parameter_1a456fe561666db5ed21a603df26732078>`();
		void :ref:`set_partial_shape<doxid-classov_1_1op_1_1v0_1_1_parameter_1a262abdfb1d5a76f5f8b2c87344b2aa87>`(const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& partial_shape);
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :ref:`get_element_type<doxid-classov_1_1op_1_1v0_1_1_parameter_1a51aa72aeabacf3a92da9d1e6917083da>`() const;
		void :ref:`set_element_type<doxid-classov_1_1op_1_1v0_1_1_parameter_1a8cd76c6c04c63279df55b77ff4fd3534>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& element_type);
