.. index:: pair: class; ov::pass::pattern::op::Or
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or:

class ov::pass::pattern::op::Or
===============================
...
A submatch on the graph value is performed on each input to the :ref:`Or <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or>`; the match succeeds on the first match. :ref:`More...<details-classov_1_1pass_1_1pattern_1_1op_1_1_or>`
...
.. ref-code-block:: cpp
	...
	class Or: public :ref:`ov::pass::pattern::op::Pattern<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_pattern>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or_1a3a095c1d9f72817e8bf670ba4a57d3ca>`;

		// construction
	
		:ref:`Or<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or_1a24a0f6189e8ec336a2271be989865a9d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& patterns);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or_1a8bd4ba50c62a22418a6af5f4c9c3cb68>`("patternOr");
	
		virtual bool :target:`match_value<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or_1a0bf36a7b43dd29fe5096c63bf30d282b>`(
...
.. _details-classov_1_1pass_1_1pattern_1_1op_1_1_or:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

A submatch on the graph value is performed on each input to the :ref:`Or <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or>`; the match succeeds on the first match. Otherwise the match fails.

Construction
------------

.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or_1a24a0f6189e8ec336a2271be989865a9d:
.. index:: pair: function; Or

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Or(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& patterns)

creates an :ref:`Or <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_or>` node matching one of several sub-patterns in order. Does not add node to match list.
...
.. list-table::
	...
	*
		...
		- The patterns to try for matching
