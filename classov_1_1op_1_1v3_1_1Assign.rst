.. index:: pair: class; ov::op::v3::Assign
.. _doxid-classov_1_1op_1_1v3_1_1_assign:
...
:ref:`Assign <doxid-classov_1_1op_1_1v3_1_1_assign>` operation sets an input value to the variable with ``variable_id`` :ref:`More...<details-classov_1_1op_1_1v3_1_1_assign>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_assign_1a7497156170aa9982115192c3e3eee3d2>`;

		// construction
	
		:target:`Assign<doxid-classov_1_1op_1_1v3_1_1_assign_1a7e5d54b6d469e1d9b8cc5545e3f73cd0>`();
		:ref:`Assign<doxid-classov_1_1op_1_1v3_1_1_assign_1a4b6b5beecadc891e0340b07a4ae5ab7e>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& new_value, const std::string& variable_id);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_assign_1a40381a63738fce5c29167ff822af64d6>`("Assign", "opset3", :ref:`op::Sink<doxid-classov_1_1op_1_1_sink>`, 3);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_assign_1adccd5565864e4b105aee6ec8763112cb>`();
		virtual std::string :ref:`get_variable_id<doxid-classov_1_1op_1_1v3_1_1_assign_1a2ef3e57aedda6e2288414e69d8ae5512>`() const;
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_assign_1a473e4cf3c14df07e9581b9a224e534ee>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_assign_1ab31a57d263f3f87e39ce90f2d0f89be4>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classov_1_1op_1_1v3_1_1_assign:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Assign <doxid-classov_1_1op_1_1v3_1_1_assign>` operation sets an input value to the variable with ``variable_id``

Construction
------------

.. _doxid-classov_1_1op_1_1v3_1_1_assign_1a4b6b5beecadc891e0340b07a4ae5ab7e:
.. index:: pair: function; Assign

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Assign(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& new_value, const std::string& variable_id)

Constructs an :ref:`Assign <doxid-classov_1_1op_1_1v3_1_1_assign>` operation.
...
.. _doxid-classov_1_1op_1_1v3_1_1_assign_1adccd5565864e4b105aee6ec8763112cb:
...
.. _doxid-classov_1_1op_1_1v3_1_1_assign_1a2ef3e57aedda6e2288414e69d8ae5512:
