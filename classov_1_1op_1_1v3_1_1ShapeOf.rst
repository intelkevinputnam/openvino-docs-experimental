.. index:: pair: class; ov::op::v3::ShapeOf
.. _doxid-classov_1_1op_1_1v3_1_1_shape_of:
...
Operation that returns the shape of its input argument as a tensor. :ref:`More...<details-classov_1_1op_1_1v3_1_1_shape_of>`
...
.. ref-code-block:: cpp
	...
	class ShapeOf: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a4743a78d8baa3c183198651a5cf490c9>`;

		// construction
	
		:target:`ShapeOf<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a6d890c06c43a12d71f1351173b026fa4>`();
		:ref:`ShapeOf<doxid-classov_1_1op_1_1v3_1_1_shape_of_1ac6d4473284fa49567687dd0b8b3033ca>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type = :ref:`element::i64<doxid-group__ov__element__cpp__api_1ga6c86a9a54d44fc205ad9cbf28ca556a6>`);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_shape_of_1ab2faf3719f9d7919cd2c85f23e3456f0>`("ShapeOf", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_shape_of_1aa9aa0347134375d254cc2831d4e02f32>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a52b605b20e849515cb290d17ea8dd6f4>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a7147ea4e83709df6aed6a6f71486b6fa>`();
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_output_type<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a3bae9b841c46659fc9ca32b84c48c9ac>`() const;
		void :target:`set_output_type<doxid-classov_1_1op_1_1v3_1_1_shape_of_1ade272b47930aee3682d05c5f6667e1b4>`(:ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_shape_of_1ae9d90da1eeec06f57dbe9382373edeea>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_shape_of_1af84b26ecebd595000a6d0e0417ceb298>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v3_1_1_shape_of_1afe890641208349076d707cc3c224c344>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a5259c8cbeedb34fd802208b96e611d4f>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a7239afa1a747a761e4af03549dcbedc9>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v3_1_1_shape_of_1a3ff256c5c6affc3c4aac6b011b2c260c>`(
			:ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& output_values,
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& input_values
			);
	
		void :target:`set_output_type<doxid-classov_1_1op_1_1v3_1_1_shape_of_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
...
.. _details-classov_1_1op_1_1v3_1_1_shape_of:
...
.. _doxid-classov_1_1op_1_1v3_1_1_shape_of_1ac6d4473284fa49567687dd0b8b3033ca:
.. index:: pair: function; ShapeOf

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	ShapeOf(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type = :ref:`element::i64<doxid-group__ov__element__cpp__api_1ga6c86a9a54d44fc205ad9cbf28ca556a6>`)
...
.. _doxid-classov_1_1op_1_1v3_1_1_shape_of_1a7147ea4e83709df6aed6a6f71486b6fa:
...
.. _doxid-classov_1_1op_1_1v3_1_1_shape_of_1ae9d90da1eeec06f57dbe9382373edeea:
...
.. _doxid-classov_1_1op_1_1v3_1_1_shape_of_1af84b26ecebd595000a6d0e0417ceb298:
