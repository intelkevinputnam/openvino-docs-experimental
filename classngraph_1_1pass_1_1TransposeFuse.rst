.. index:: pair: class; ngraph::pass::TransposeFuse
.. _doxid-classngraph_1_1pass_1_1_transpose_fuse:
...
:ref:`TransposeFuse <doxid-classngraph_1_1pass_1_1_transpose_fuse>` transformation eliminates 2 consequtive Transposes if they result in no changes to input or fuses them to single Transpose if input gets changed.
...
.. ref-code-block:: cpp
	...
	class TransposeFuse: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_transpose_fuse_1a485ece673801a599777628ed24cd1566>`("TransposeFuse", "0");
	};
