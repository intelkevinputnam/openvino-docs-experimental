.. index:: pair: class; ngraph::pass::ConvertOpSet3ToOpSet2
.. _doxid-classngraph_1_1pass_1_1_convert_op_set3_to_op_set2:

class ngraph::pass::ConvertOpSet3ToOpSet2
=========================================
...
.. ref-code-block:: cpp
	...
	class ConvertOpSet3ToOpSet2: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_op_set3_to_op_set2_1afe6ce8fd435563428060edd2e722db29>`("ConvertOpSet3ToOpSet2", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_convert_op_set3_to_op_set2_1a7c0c55ba225b546c7ac28486fdede231>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
