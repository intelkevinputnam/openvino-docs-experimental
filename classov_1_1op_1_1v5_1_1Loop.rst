.. index:: pair: class; ov::op::v5::Loop
.. _doxid-classov_1_1op_1_1v5_1_1_loop:
...
.. toctree::
	...
	SpecialBodyPorts <structov_1_1op_1_1v5_1_1Loop_1_1SpecialBodyPorts.rst>

Overview
~~~~~~~~

Iterate a body over tensors, accumulating into tensors. :ref:`More...<details-classov_1_1op_1_1v5_1_1_loop>`
...
.. ref-code-block:: cpp
	...
	class Loop: public :ref:`ov::op::util::SubGraphOp<doxid-classov_1_1op_1_1util_1_1_sub_graph_op>`
	{
	public:
		// structs
	
		struct :ref:`SpecialBodyPorts<doxid-structov_1_1op_1_1v5_1_1_loop_1_1_special_body_ports>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_loop_1a51d9ddd5954ab2aa98cd4b868a6b799a>`;

		// construction
	
		:ref:`Loop<doxid-classov_1_1op_1_1v5_1_1_loop_1a32868d808c892e8dc004c8faaae8f501>`();
		:ref:`Loop<doxid-classov_1_1op_1_1v5_1_1_loop_1ab05b65dad28e84562e48d5db6d459245>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& trip_count, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& execution_condition);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_loop_1a993c60eeba3f6ac249dfea9e9c94fbe4>`("Loop", "opset5", :ref:`op::util::SubGraphOp<doxid-classov_1_1op_1_1util_1_1_sub_graph_op>`, 5);
	
		virtual :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`> :ref:`get_concatenated_slices<doxid-classov_1_1op_1_1v5_1_1_loop_1a6c865b299daf8dfd59e9fab34eba6e94>`(
		...
		void :target:`set_special_body_ports<doxid-classov_1_1op_1_1v5_1_1_loop_1af2ec4a55952426b7e6c0cde673355a36>`(const :ref:`SpecialBodyPorts<doxid-structov_1_1op_1_1v5_1_1_loop_1_1_special_body_ports>`& special_body_ports);
		:ref:`SpecialBodyPorts<doxid-structov_1_1op_1_1v5_1_1_loop_1_1_special_body_ports>` :target:`get_special_body_ports<doxid-classov_1_1op_1_1v5_1_1_loop_1af650391e194a92aaabb5da4a4fd029de>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_loop_1a6f870d4d467f4530f2da4b8690f34600>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_loop_1a32fed2062466200ee93c635696e58608>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_loop_1af40464f6b38cfe10820f01ec4c1883ff>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v5_1_1_loop_1adaf4f69db8dd58ab23dafe0f35b4b35d>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v5_1_1_loop_1aa819e6e8b5edac8c6cb6ddef840770c9>`() const;
	};
...
.. _details-classov_1_1op_1_1v5_1_1_loop:
...
.. _doxid-classov_1_1op_1_1v5_1_1_loop_1a32868d808c892e8dc004c8faaae8f501:
.. index:: pair: function; Loop
...
Constructs a :ref:`Loop <doxid-classov_1_1op_1_1v5_1_1_loop>` operation.

.. _doxid-classov_1_1op_1_1v5_1_1_loop_1ab05b65dad28e84562e48d5db6d459245:
.. index:: pair: function; Loop

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Loop(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& trip_count, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& execution_condition)
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` specifies the maximum number of iterations.

	*
		- execution_condition

		- :ref:`Node <doxid-classov_1_1_node>` determines whether to execute the first iteration or not.

Methods
-------

.. _doxid-classov_1_1op_1_1v5_1_1_loop_1a6c865b299daf8dfd59e9fab34eba6e94:
...
.. _doxid-classov_1_1op_1_1v5_1_1_loop_1a6f870d4d467f4530f2da4b8690f34600:
...
.. _doxid-classov_1_1op_1_1v5_1_1_loop_1adaf4f69db8dd58ab23dafe0f35b4b35d:
...
.. _doxid-classov_1_1op_1_1v5_1_1_loop_1aa819e6e8b5edac8c6cb6ddef840770c9:
