.. index:: pair: class; ngraph::pass::SmartReshape
.. _doxid-classngraph_1_1pass_1_1_smart_reshape:

class ngraph::pass::SmartReshape
================================
...
.. ref-code-block:: cpp
	...
	class SmartReshape: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_smart_reshape_1a692f7c56067dcd4e264ce82c2bc748a2>`("SmartReshape", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_smart_reshape_1a2560bf12150d54eb548bf26d670d5b44>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
