.. index:: pair: class; ov::op::v1::Pad
.. _doxid-classov_1_1op_1_1v1_1_1_pad:
...
Generic padding operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_pad>`
...
.. ref-code-block:: cpp
	...
	class Pad: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_pad_1af96f5dfd4ff867bc26f365a7e99d2323>`;

		// construction
	
		:ref:`Pad<doxid-classov_1_1op_1_1v1_1_1_pad_1a4aad7095cd62118672af0c1e2a4d335f>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& pads_begin,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& pads_end,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg_pad_value,
			:ref:`PadMode<doxid-namespaceov_1_1op_1aff39ecf8a8a3110216bfe131cc8b9ae0>` pad_mode
			);
	
		:ref:`Pad<doxid-classov_1_1op_1_1v1_1_1_pad_1a6907ce03ec40299332724f0afce98e98>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& pads_begin,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& pads_end,
			:ref:`PadMode<doxid-namespaceov_1_1op_1aff39ecf8a8a3110216bfe131cc8b9ae0>` pad_mode
		...
		:ref:`Pad<doxid-classov_1_1op_1_1v1_1_1_pad_1a89909997a83d3a5334e2668367e14593>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_pad_1a1b97ca4a595c8be6a3d0b35aba3a79b6>`("Pad", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_pad_1a257b4e8dcf8016c423a223058005a4ed>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_pad_1a4f4eab47a2df7b8a5fb7f62c96b42e60>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_pad_1a66c727b664ba57782b255fe96764b18e>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>` :ref:`get_pads_begin<doxid-classov_1_1op_1_1v1_1_1_pad_1aedefa8558cd5007c2ef9c2aba3dc0346>`() const;
		:ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>` :ref:`get_pads_end<doxid-classov_1_1op_1_1v1_1_1_pad_1a597fbca037faa08d73253dad4959c299>`() const;
		:ref:`PadMode<doxid-namespaceov_1_1op_1aff39ecf8a8a3110216bfe131cc8b9ae0>` :ref:`get_pad_mode<doxid-classov_1_1op_1_1v1_1_1_pad_1a2e760f37805a08aec2c62b62c9907355>`() const;
		void :target:`set_pad_mode<doxid-classov_1_1op_1_1v1_1_1_pad_1abe4818d8f10f37428f681c428a703df9>`(:ref:`PadMode<doxid-namespaceov_1_1op_1aff39ecf8a8a3110216bfe131cc8b9ae0>` pad_mode);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_pad_1a400e4c86f7b16f1bf421d9af5bc37664>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_pad_1a0a2e9dd2f798a5299ade277e29037ee1>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_pad:
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a4aad7095cd62118672af0c1e2a4d335f:
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a6907ce03ec40299332724f0afce98e98:
.. index:: pair: function; Pad
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a89909997a83d3a5334e2668367e14593:
.. index:: pair: function; Pad
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a4f4eab47a2df7b8a5fb7f62c96b42e60:
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1aedefa8558cd5007c2ef9c2aba3dc0346:
.. index:: pair: function; get_pads_begin

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>` get_pads_begin() const

return The node which specifies the number of padding elements added at the beginning of each axis

.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a597fbca037faa08d73253dad4959c299:
.. index:: pair: function; get_pads_end

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>` get_pads_end() const

return The node which specifies the number of padding elements added at the end of each axis

.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a2e760f37805a08aec2c62b62c9907355:
.. index:: pair: function; get_pad_mode

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`PadMode<doxid-namespaceov_1_1op_1aff39ecf8a8a3110216bfe131cc8b9ae0>` get_pad_mode() const
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a400e4c86f7b16f1bf421d9af5bc37664:
...
.. _doxid-classov_1_1op_1_1v1_1_1_pad_1a0a2e9dd2f798a5299ade277e29037ee1:
