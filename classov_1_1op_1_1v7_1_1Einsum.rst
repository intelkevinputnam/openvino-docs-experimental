.. index:: pair: class; ov::op::v7::Einsum
.. _doxid-classov_1_1op_1_1v7_1_1_einsum:
...
:ref:`Einsum <doxid-classov_1_1op_1_1v7_1_1_einsum>` operation. :ref:`More...<details-classov_1_1op_1_1v7_1_1_einsum>`
...
.. ref-code-block:: cpp
	...
	class Einsum: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v7_1_1_einsum_1abb03a2c1935d7ddc219d8cb4733c4b4d>`;

		// construction
	
		:target:`Einsum<doxid-classov_1_1op_1_1v7_1_1_einsum_1a92148c90ab9de778d5af628aa77ca1d1>`();
		:ref:`Einsum<doxid-classov_1_1op_1_1v7_1_1_einsum_1af1a68cab65529cef34c75dbbf2ead633>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& inputs, const std::string& equation);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v7_1_1_einsum_1a0052bfd3a454cb2d02783405add581fa>`("Einsum", "opset7", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 7);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v7_1_1_einsum_1af8a988d41d143821c7080250a914b21b>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v7_1_1_einsum_1a93924702974dee50ab12415fccb54ed1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v7_1_1_einsum_1ababbcfe8b7f6afea96bb30dac5755e40>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const std::string& :ref:`get_equation<doxid-classov_1_1op_1_1v7_1_1_einsum_1a05aaff9eb6edaddc5ee85c2a7fb8745f>`() const;
	
		static void :ref:`parse_equation<doxid-classov_1_1op_1_1v7_1_1_einsum_1a36196e76ad9458d00cdb136b09bb8f32>`(
			const std::string& equation,
			std::vector<std::string>& input_subscripts,
			std::string& output_subscript
			);
	
		static std::vector<std::string> :ref:`extract_labels<doxid-classov_1_1op_1_1v7_1_1_einsum_1a3e2d2dcc9a5305a0e5c65bb097780be8>`(const std::string& subscript);
	};
...
.. _details-classov_1_1op_1_1v7_1_1_einsum:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Einsum <doxid-classov_1_1op_1_1v7_1_1_einsum>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v7_1_1_einsum_1af1a68cab65529cef34c75dbbf2ead633:
.. index:: pair: function; Einsum

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Einsum(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& inputs, const std::string& equation)

Constructs :ref:`Einsum <doxid-classov_1_1op_1_1v7_1_1_einsum>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` nodes on which :ref:`Einsum <doxid-classov_1_1op_1_1v7_1_1_einsum>` operation performs contraction
...
.. _doxid-classov_1_1op_1_1v7_1_1_einsum_1af8a988d41d143821c7080250a914b21b:
...
.. _doxid-classov_1_1op_1_1v7_1_1_einsum_1a05aaff9eb6edaddc5ee85c2a7fb8745f:
.. index:: pair: function; get_equation
...
Get an equation of :ref:`Einsum <doxid-classov_1_1op_1_1v7_1_1_einsum>` operation.



.. rubric:: Returns:

:ref:`Einsum <doxid-classov_1_1op_1_1v7_1_1_einsum>` equation

.. _doxid-classov_1_1op_1_1v7_1_1_einsum_1a36196e76ad9458d00cdb136b09bb8f32:
.. index:: pair: function; parse_equation

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	static void parse_equation(
		const std::string& equation,
		std::vector<std::string>& input_subscripts,
		std::string& output_subscript
		)
...
.. list-table::
	...
	*
		...
		- Equation to be parsed and checked

	*
		- input_subscripts

		- A vector of extracted input subscripts
...
.. _doxid-classov_1_1op_1_1v7_1_1_einsum_1a3e2d2dcc9a5305a0e5c65bb097780be8:
.. index:: pair: function; extract_labels
