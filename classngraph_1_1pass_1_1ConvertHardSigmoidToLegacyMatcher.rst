.. index:: pair: class; ngraph::pass::ConvertHardSigmoidToLegacyMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_hard_sigmoid_to_legacy_matcher:

class ngraph::pass::ConvertHardSigmoidToLegacyMatcher
=====================================================
...
.. ref-code-block:: cpp
	...
	#include <convert_hard_sigmoid_to_hard_sigmoid_ie.hpp>
	
	class ConvertHardSigmoidToLegacyMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_hard_sigmoid_to_legacy_matcher_1ade0db8821a17fc235549ab2687f1151a>`("ConvertHardSigmoidToLegacyMatcher", "0");
	};
