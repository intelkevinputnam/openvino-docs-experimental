.. index:: pair: class; ov::op::v1::StridedSlice
.. _doxid-classov_1_1op_1_1v1_1_1_strided_slice:
...
Takes a slice of an input tensor, i.e., the sub-tensor that resides within a bounding box, optionally with stride. :ref:`More...<details-classov_1_1op_1_1v1_1_1_strided_slice>`
...
.. ref-code-block:: cpp
	...
	class StridedSlice: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a6af343c9b20a20d808f09165443a05c7>`;

		// construction
	
		:target:`StridedSlice<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a6feb2699c4c95c70ba49c0c59db64089>`();
	
		:ref:`StridedSlice<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a8e2a89fb2f1f4f70390846d05c8478a3>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& begin,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& end,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& strides,
		...
		:ref:`StridedSlice<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1ac469638d73932b9e03af129828a5ec37>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& begin,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& end,
			const std::vector<int64_t>& begin_mask,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a9364727b3fe452711e58de97b4d7dfe2>`("StridedSlice", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1ab26d6919388f5513ead74d222131382a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		const std::vector<int64_t>& :target:`get_begin_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a1792458542113bbb21ae0af0f1d13501>`() const;
		void :target:`set_begin_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1acd833d7a4bc68f9729eae04b7b0227bf>`(const std::vector<int64_t>& vec);
		const std::vector<int64_t>& :target:`get_end_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a25c5733f51d2fb66bc54fdb0c2d8eb55>`() const;
		void :target:`set_end_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a8d98e3401cc813ada9544121691f9fb9>`(const std::vector<int64_t>& vec);
		const std::vector<int64_t>& :target:`get_new_axis_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1abe993ff2ad15d14830066e2e6ecb386b>`() const;
		void :target:`set_new_axis_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a9d793c1915f9559decab38f6c5e4e2a0>`(const std::vector<int64_t>& vec);
		const std::vector<int64_t>& :target:`get_shrink_axis_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a7736ca262154e58249977ae07a3e68df>`() const;
		void :target:`set_shrink_axis_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1afcc795cb59c76a138f768df88a1d2908>`(const std::vector<int64_t>& vec);
		const std::vector<int64_t>& :target:`get_ellipsis_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a69e3d968f6460084c1632a9af0b7258a>`() const;
		void :target:`set_ellipsis_mask_mask<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a738b76fa4c731eef74f8847ad5b323e5>`(const std::vector<int64_t>& vec);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1aaff19f1bc26b042f8a0522f7f03d0296>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a148741efa482eb379897ed6382880cbf>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1afe74dfe96b671d1d4d56aa0f8acb633a>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1ab8673d54ad7bf97f7b9a46b174142a05>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1aedec3c4bd1a1c50f57c6f747000d46cf>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a0dca3ca1869e7bc96ba49fe21e5ceb1f>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v1_1_1_strided_slice_1ae0a29f00dd345924ac47f7ce63d47931>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_strided_slice:
...
.. _doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a8e2a89fb2f1f4f70390846d05c8478a3:
.. index:: pair: function; StridedSlice
...
.. list-table::
	...
	*
		...
		- 1D tensor with begin indexes for input blob slicing.

	*
		- end

		- 1D tensor with end indexes for input blob slicing.
	...
	*
		...
		- When begin_mask[i] equal to 1 means that the corresponding dimension of the begin input is ignored.

	*
		- end_mask

		- When end_mask[i] is 1, the corresponding dimension of the end input is ignored.

	*
		- new_axis_mask

		- If new_axis_mask[i] is 1, a length 1 dimension is inserted on the i-th position.

	*
		- shrink_axis_mask

		- If shrink_axis_mask[i] is 1, the dimension on the i-th position is deleted.

	*
		- ellipsis_mask

		- It inserts missing dimensions on a position of a non-zero bit.

.. _doxid-classov_1_1op_1_1v1_1_1_strided_slice_1ac469638d73932b9e03af129828a5ec37:
.. index:: pair: function; StridedSlice
...
.. _doxid-classov_1_1op_1_1v1_1_1_strided_slice_1a148741efa482eb379897ed6382880cbf:
...
.. _doxid-classov_1_1op_1_1v1_1_1_strided_slice_1afe74dfe96b671d1d4d56aa0f8acb633a:
...
.. _doxid-classov_1_1op_1_1v1_1_1_strided_slice_1ab8673d54ad7bf97f7b9a46b174142a05:
