.. index:: pair: class; ngraph::pass::SetBatchSize
.. _doxid-classngraph_1_1pass_1_1_set_batch_size:
...
.. ref-code-block:: cpp
	...
	class SetBatchSize: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_set_batch_size_1a0afb8a7aa39e6542e8a4e3039cf4aa1a>`("SetBatchSize", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_set_batch_size_1a9af1835398e804e47afb58351a0efefa>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
