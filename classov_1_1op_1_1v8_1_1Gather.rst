.. index:: pair: class; ov::op::v8::Gather
.. _doxid-classov_1_1op_1_1v8_1_1_gather:
...
:ref:`Gather <doxid-classov_1_1op_1_1v8_1_1_gather>` slices from axis of data according to indices. Negative indices are supported and indicate reverse indexing from the end. :ref:`More...<details-classov_1_1op_1_1v8_1_1_gather>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_gather_1aeffaf6cd8ff64e037304f421b22d6556>`;

		// construction
	
		:target:`Gather<doxid-classov_1_1op_1_1v8_1_1_gather_1a0829995a7196bb829be714a32a580191>`();
	
		:ref:`Gather<doxid-classov_1_1op_1_1v8_1_1_gather_1aeea937de51a79cf22b6057337f65a397>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_gather_1a1b59973360548be8295606a961d4e239>`("Gather", "opset8", :ref:`op::util::GatherBase<doxid-classov_1_1op_1_1util_1_1_gather_base>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_gather_1a47105c092f5fc8ec47be13272c78e2bd>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_gather_1ab64b48f78ff5ac1f0405d1722f65c00f>`();
		int64_t :target:`get_batch_dims<doxid-classov_1_1op_1_1v8_1_1_gather_1aefa626f10593b31eecf7fc32a719a795>`() const;
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_gather_1a3928cbb9df1b5eca19885a7bf4f5c86e>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v8_1_1_gather:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Gather <doxid-classov_1_1op_1_1v8_1_1_gather>` slices from axis of data according to indices. Negative indices are supported and indicate reverse indexing from the end.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_gather_1aeea937de51a79cf22b6057337f65a397:
...
.. list-table::
	...
	*
		...
		- The number of batch dimension in data and indices tensors.

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_gather_1ab64b48f78ff5ac1f0405d1722f65c00f:
