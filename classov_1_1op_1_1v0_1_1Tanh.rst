.. index:: pair: class; ov::op::v0::Tanh
.. _doxid-classov_1_1op_1_1v0_1_1_tanh:
...
Elementwise hyperbolic tangent operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_tanh>`
...
.. ref-code-block:: cpp
	...
	class Tanh: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_tanh_1aaad74cd588732b1d5005d42645e72fdf>`;

		// construction
	
		:ref:`Tanh<doxid-classov_1_1op_1_1v0_1_1_tanh_1a351bd36be7f063ff55197f9591013279>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:target:`Tanh<doxid-classov_1_1op_1_1v0_1_1_tanh_1a519f34c90fd67091a2e801ed1c557b54>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_tanh_1a530c52c5695173235ef086687a26dc73>`("Tanh", "opset1", :ref:`op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_tanh_1aa935a5c916a69b2c63b74b51557e26a0>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_tanh_1ab7670f5d0a857f5b2eb90ba3d7fb31a9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_tanh_1a6e09898a44311599974e2f72d5c3d5f0>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_tanh_1a849c02328f05046408e77dde021860df>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_tanh:
...
.. _doxid-classov_1_1op_1_1v0_1_1_tanh_1a351bd36be7f063ff55197f9591013279:
.. index:: pair: function; Tanh

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Tanh(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_tanh_1a6e09898a44311599974e2f72d5c3d5f0:
...
.. _doxid-classov_1_1op_1_1v0_1_1_tanh_1a849c02328f05046408e77dde021860df:
