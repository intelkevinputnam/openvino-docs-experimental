.. index:: pair: interface; ngraph::snippets::op::BlockedLoad
.. _doxid-classngraph_1_1snippets_1_1op_1_1_blocked_load:

interface ngraph::snippets::op::BlockedLoad
===========================================



Generated by Canonicalization step for blocked data (NCHW<X>c) to be loaded.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <blockedload.hpp>
	
	template BlockedLoad: public :ref:`ngraph::snippets::op::Load<doxid-classngraph_1_1snippets_1_1op_1_1_load>`
	{
		// construction
	
		:target:`BlockedLoad<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_load_1a1a6ca13400da6db32a9073eb7e60ff17>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x);
		:target:`BlockedLoad<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_load_1ad2af2773724719c47cacef0f88f689f2>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_load_1a26a5021888fe79e54d85c1ae791e7e5a>`("BlockedLoad", "SnippetsOpset", :ref:`ngraph::snippets::op::Load<doxid-classngraph_1_1snippets_1_1op_1_1_load>`);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_blocked_load_1a1c4e78da39ba4a02e4d9d5bbb48097ad>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		:ref:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_load_1acfbf5c79366ddc88fdc8a4d95ec57ea2>`("Load", "SnippetsOpset");
		virtual bool :ref:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_load_1ab4c48efb6697573ecb219d1baa66326b>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_load_1ad5e04d6df832e2e5007a5180497c83c0>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		...
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classngraph_1_1snippets_1_1op_1_1_load_1a8838cb9c28d6226488424e3b33c3ab30>`(
