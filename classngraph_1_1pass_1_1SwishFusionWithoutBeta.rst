.. index:: pair: class; ngraph::pass::SwishFusionWithoutBeta
.. _doxid-classngraph_1_1pass_1_1_swish_fusion_without_beta:
...
:ref:`SwishFusionWithSigmoid <doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid>` replaces a sub-graphs x / (1.0 + exp(-x)) with a Swish op.
...
.. ref-code-block:: cpp
	...
	class SwishFusionWithoutBeta: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_swish_fusion_without_beta_1af42a4c8ca209bb317b315379ce6a6a19>`("SwishFusionWithoutBeta", "0");
	};
