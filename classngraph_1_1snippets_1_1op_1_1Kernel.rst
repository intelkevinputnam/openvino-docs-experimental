.. index:: pair: interface; ngraph::snippets::op::Kernel
.. _doxid-classngraph_1_1snippets_1_1op_1_1_kernel:

interface ngraph::snippets::op::Kernel
======================================



Generated by Canonicalization and represents compute kernel legal for scheduling.
...
.. ref-code-block:: cpp
	...
	template Kernel: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
		// fields
	
		std::vector<std::pair<std::shared_ptr<:ref:`ngraph::snippets::Emitter<doxid-classngraph_1_1snippets_1_1_emitter>`>, :ref:`ngraph::snippets::RegInfo<doxid-namespacengraph_1_1snippets_1a3d2700d6955f8b1f9e2fffa540cd5556>`>> :target:`region<doxid-classngraph_1_1snippets_1_1op_1_1_kernel_1a094e67ba21af226c5702eaf77833f182>`;
		const void \* :target:`compile_params<doxid-classngraph_1_1snippets_1_1op_1_1_kernel_1ae85b0988f5433fa8aa44752a73c439fd>` = nullptr;

		// construction
	
		:target:`Kernel<doxid-classngraph_1_1snippets_1_1op_1_1_kernel_1ab6a1ab094cd6331b3c76388e4e285530>`(const std::vector<std::pair<std::shared_ptr<:ref:`ngraph::snippets::Emitter<doxid-classngraph_1_1snippets_1_1_emitter>`>, :ref:`ngraph::snippets::RegInfo<doxid-namespacengraph_1_1snippets_1a3d2700d6955f8b1f9e2fffa540cd5556>`>>& region);
		:target:`Kernel<doxid-classngraph_1_1snippets_1_1op_1_1_kernel_1aa42d3a0ff68456789de4e8033196e8b0>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_kernel_1a9f8d8cbd3dd92c0f0b48ab12640b948a>`("Kernel", "SnippetsOpset");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_kernel_1a4947e430ae394996be776c43a0330e64>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& inputs) const;
	};
