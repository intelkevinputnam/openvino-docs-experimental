.. index:: pair: class; ngraph::pass::low_precision::UnsqueezeTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation:
...
:ref:`UnsqueezeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation>` propagates dequantization operations through Unsqueeze operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation>`
...
.. ref-code-block:: cpp
	...
	class UnsqueezeTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`UnsqueezeTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation_1acd57323a6395f1c64b1146c9abe8ae90>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation_1ac7eb70b168c895f71141105db5350a49>`("UnsqueezeTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation_1aeaa2fc3d4c0de0eb88a3870140cbe9ee>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation_1a9159eaab986414c2c58c154ed46d0fd1>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation_1a103366330aab0bf217be3691fdb08cb5>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`UnsqueezeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_unsqueeze_transformation>` propagates dequantization operations through Unsqueeze operation.

For more details about the transformation, refer to :ref:`UnsqueezeTransformation <doxid-openvino_docs__o_v__u_g_lpt__unsqueeze_transformation>` page in the Inference Engine Developer Guide.
