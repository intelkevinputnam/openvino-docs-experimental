.. index:: pair: class; ngraph::pass::SqueezeStridedSlice
.. _doxid-classngraph_1_1pass_1_1_squeeze_strided_slice:
...
:ref:`StridedSliceSqueeze <doxid-classngraph_1_1pass_1_1_strided_slice_squeeze>` transformation looks for Squeeze -> SSe and corrects SS inputs and attributes for SS output to be squeeze-able.
...
.. ref-code-block:: cpp
	...
	class SqueezeStridedSlice: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_squeeze_strided_slice_1ada74879d891d11136bb188cc66bcad33>`("SqueezeStridedSlice", "0");
	};
