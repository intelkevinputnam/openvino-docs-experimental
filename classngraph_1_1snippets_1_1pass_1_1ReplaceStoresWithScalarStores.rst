.. index:: pair: interface; ngraph::snippets::pass::ReplaceStoresWithScalarStores
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_replace_stores_with_scalar_stores:

interface ngraph::snippets::pass::ReplaceStoresWithScalarStores
===============================================================



Replaces vector stores with scalar versions. The pass is used to cange element type of model in a canonical form vector to scalar. Used for tail generation.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <vector_to_scalar.hpp>
	
	template ReplaceStoresWithScalarStores: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	};
