.. index:: pair: class; ov::op::v3::Bucketize
.. _doxid-classov_1_1op_1_1v3_1_1_bucketize:
...
Operation that bucketizes the input based on boundaries. :ref:`More...<details-classov_1_1op_1_1v3_1_1_bucketize>`
...
.. ref-code-block:: cpp
	...
	class Bucketize: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a3fc78afb80784a8517af608be4266fb8>`;

		// construction
	
		:target:`Bucketize<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a608b8ef58437e9f59d719826bf4f8ea1>`();
	
		:ref:`Bucketize<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a198074d76ade0b25de46976e9f13dd69>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& buckets,
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type = :ref:`element::i64<doxid-group__ov__element__cpp__api_1ga6c86a9a54d44fc205ad9cbf28ca556a6>`,
			const bool with_right_bound = true
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a2e91981ceb232b7b0293e89f3dfd3606>`("Bucketize", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a421e40834ddb8e92f9b10b3ef24446b3>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a51da9a9f0adc051a7be60f699868fff1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_bucketize_1af9fd706d27dce9ae7922134543c37ccd>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& inputs) const;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_output_type<doxid-classov_1_1op_1_1v3_1_1_bucketize_1ac62b5ce58ee343836042884963d94a81>`() const;
		void :target:`set_output_type<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a79b9b371598017627dbfaaab6eafca55>`(:ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type);
		bool :target:`get_with_right_bound<doxid-classov_1_1op_1_1v3_1_1_bucketize_1adcde17bf8a345762c0cf4ba471eeee54>`() const;
		void :target:`set_with_right_bound<doxid-classov_1_1op_1_1v3_1_1_bucketize_1a55aacd508ae1fc7e1c1c8c235b7ac28e>`(bool with_right_bound);
	
		void :target:`set_output_type<doxid-classov_1_1op_1_1v3_1_1_bucketize_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
...
.. _details-classov_1_1op_1_1v3_1_1_bucketize:
...
.. _doxid-classov_1_1op_1_1v3_1_1_bucketize_1a198074d76ade0b25de46976e9f13dd69:
.. index:: pair: function; Bucketize
...
Constructs a :ref:`Bucketize <doxid-classov_1_1op_1_1v3_1_1_bucketize>` node.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` data to bucketize
	...
	*
		...
		- :ref:`Output <doxid-classov_1_1_output>` tensor type, "i64" or "i32", defaults to i64
...
.. _doxid-classov_1_1op_1_1v3_1_1_bucketize_1a421e40834ddb8e92f9b10b3ef24446b3:
