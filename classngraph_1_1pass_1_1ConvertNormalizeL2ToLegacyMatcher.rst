.. index:: pair: class; ngraph::pass::ConvertNormalizeL2ToLegacyMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_normalize_l2_to_legacy_matcher:

class ngraph::pass::ConvertNormalizeL2ToLegacyMatcher
=====================================================
...
.. ref-code-block:: cpp
	...
	class ConvertNormalizeL2ToLegacyMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_normalize_l2_to_legacy_matcher_1ae80b8341bb71ccfb996aa80d4cd87d40>`("ConvertNormalizeL2ToLegacyMatcher", "0");
	};
