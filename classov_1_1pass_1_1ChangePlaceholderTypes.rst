.. index:: pair: class; ov::pass::ChangePlaceholderTypes
.. _doxid-classov_1_1pass_1_1_change_placeholder_types:

class ov::pass::ChangePlaceholderTypes
======================================
...
.. ref-code-block:: cpp
	...
	class ChangePlaceholderTypes: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// construction
	
		:target:`ChangePlaceholderTypes<doxid-classov_1_1pass_1_1_change_placeholder_types_1a5db284e21f6f93432ef2bd03542af39d>`(const std::vector<std::string>& params_with_custom_types);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_change_placeholder_types_1af6c674cb0aa22992f686898fad640228>`("ChangePlaceholderTypes", "0");
		virtual bool :target:`run_on_model<doxid-classov_1_1pass_1_1_change_placeholder_types_1abff68672a3bf7b7d98db29dc019aebc6>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>& model);
	};
