.. index:: pair: class; ngraph::op::NonMaxSuppressionIE
.. _doxid-classngraph_1_1op_1_1_non_max_suppression_i_e:

class ngraph::op::NonMaxSuppressionIE
=====================================
...
.. ref-code-block:: cpp
	...
	class NonMaxSuppressionIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ab030b1dc0a58adc29ea08051faf309d4>`;
		int :target:`m_center_point_box<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ab959eed56f760892dd12cfacf57ec9fb>`;
		bool :target:`m_sort_result_descending<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a64132405feeffe128bf8a48f77aacf14>` = true;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`m_output_type<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ac197a2e6f9a208ee54531aa7de71f628>`;

		// construction
	
		:target:`NonMaxSuppressionIE<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a01ec9d95a127a576d3c383c5f35cd5e7>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a8fd5c128eb428813b58f75e81c622776>`("NonMaxSuppressionIE", "legacy");
		...
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1aad304b27c49ad1af27f0a205db12caf8>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ab223e54081f6d09091c10c7f35614a3b>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_non_max_suppression_i_e:
...
.. _doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a4511071085f18e2fb8013b442ea5bba2:
