.. index:: pair: class; ngraph::pass::UnsupportedNodesStridesPropagation
.. _doxid-classngraph_1_1pass_1_1_unsupported_nodes_strides_propagation:
...
:ref:`UnsupportedNodesStridesPropagation <doxid-classngraph_1_1pass_1_1_unsupported_nodes_strides_propagation>` inserts pooling between current node and its consumers if the consumers have different StridesProp attributes.
...
.. ref-code-block:: cpp
	...
	class UnsupportedNodesStridesPropagation: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_unsupported_nodes_strides_propagation_1aed0abb47b2283937cb6bcd4d8cb557d3>`("UnsupportedNodesStridesPropagation", "0");
	};
