.. index:: pair: class; ov::op::v1::Gather
.. _doxid-classov_1_1op_1_1v1_1_1_gather:
...
:ref:`Gather <doxid-classov_1_1op_1_1v1_1_1_gather>` slices from axis of data according to indices. :ref:`More...<details-classov_1_1op_1_1v1_1_1_gather>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_gather_1a3f5e6e3b3cc40b14c703711dd45310a1>`;
		static constexpr int64_t :target:`AXIS_NOT_SET_VALUE<doxid-classov_1_1op_1_1v1_1_1_gather_1a9b9333c254b00f3df0400c26411d322b>` = std::numeric_limits<int64_t>::max();

		// construction
	
		:target:`Gather<doxid-classov_1_1op_1_1v1_1_1_gather_1a4d1c220a39db72520225bef13ca0f377>`();
	
		:ref:`Gather<doxid-classov_1_1op_1_1v1_1_1_gather_1aa4ed9340fe177f503a300654c5b4b346>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& params,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_gather_1a7ea30bdb31932d9b3e50f17428e3aa94>`("Gather", "opset1", :ref:`op::util::GatherBase<doxid-classov_1_1op_1_1util_1_1_gather_base>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_gather_1a0c620750da2c01ac323a286d9714318b>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual int64_t :target:`get_axis<doxid-classov_1_1op_1_1v1_1_1_gather_1a1cbe5cda0c182a074aac909302e20e25>`() const;
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_gather_1a981c44d52e9cbf21bcbaf8c526a534e9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_gather:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Gather <doxid-classov_1_1op_1_1v1_1_1_gather>` slices from axis of data according to indices.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_gather_1aa4ed9340fe177f503a300654c5b4b346:
