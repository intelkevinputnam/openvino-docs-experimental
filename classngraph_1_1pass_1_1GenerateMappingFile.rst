.. index:: pair: class; ngraph::pass::GenerateMappingFile
.. _doxid-classngraph_1_1pass_1_1_generate_mapping_file:

class ngraph::pass::GenerateMappingFile
=======================================



Generate mapping file based on output tensor names.
...
.. ref-code-block:: cpp
	...
	class GenerateMappingFile: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// construction
	
		:target:`GenerateMappingFile<doxid-classngraph_1_1pass_1_1_generate_mapping_file_1ac5941da939f253c8221ff0aff4ce0b32>`(const std::string& path, bool extract_name = true);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_generate_mapping_file_1af33bdca3119204e9cf2906ae4661d7ad>`("GenerateMappingFile", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_generate_mapping_file_1a7255a3519ff208cf6547b3a6b1f23b0b>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>&);
	};
