.. index:: pair: class; ov::op::v0::Sqrt
.. _doxid-classov_1_1op_1_1v0_1_1_sqrt:
...
Elementwise square root operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_sqrt>`
...
.. ref-code-block:: cpp
	...
	class Sqrt: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_sqrt_1a67273a518409d89b70aacf7f266aacd3>`;

		// construction
	
		:ref:`Sqrt<doxid-classov_1_1op_1_1v0_1_1_sqrt_1af9a2fc15a637861374307b2710ffe2da>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:target:`Sqrt<doxid-classov_1_1op_1_1v0_1_1_sqrt_1a44cb0d31414b8dcb58203b8b551d5803>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_sqrt_1a8451dc828c9adb72688976aceffbe352>`("Sqrt", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_sqrt_1ac8444fc2bcd4352957faf18af87e529c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_sqrt_1ac81fc21533633fd37b99657d8432c438>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_sqrt_1ac42429ebc2351872ca1450ba4b9e1c07>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_sqrt_1aded8bfa829af4b6eb54c48e871f2bc8f>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_sqrt:
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`N[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \sqrt{\texttt{arg}[i_1,\dots,i_n]}`

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_sqrt_1af9a2fc15a637861374307b2710ffe2da:
.. index:: pair: function; Sqrt

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Sqrt(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_sqrt_1ac42429ebc2351872ca1450ba4b9e1c07:
...
.. _doxid-classov_1_1op_1_1v0_1_1_sqrt_1aded8bfa829af4b6eb54c48e871f2bc8f:
