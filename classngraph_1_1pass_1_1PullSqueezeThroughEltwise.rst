.. index:: pair: class; ngraph::pass::PullSqueezeThroughEltwise
.. _doxid-classngraph_1_1pass_1_1_pull_squeeze_through_eltwise:
...
:ref:`PullSqueezeThroughEltwise <doxid-classngraph_1_1pass_1_1_pull_squeeze_through_eltwise>` transformation propagates Squeeze up through binary elementwise operations:
...
.. ref-code-block:: cpp
	...
	class PullSqueezeThroughEltwise: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_pull_squeeze_through_eltwise_1abe28d2d9794076e42ca4ec84679f852c>`("PullSqueezeThroughEltwise", "0");
	};
