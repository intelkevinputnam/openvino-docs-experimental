.. index:: pair: interface; ngraph::snippets::op::VectorStore
.. _doxid-classngraph_1_1snippets_1_1op_1_1_vector_store:

interface ngraph::snippets::op::VectorStore
===========================================



Generated by Canonicalization for a vector value store from vector register.
...
.. ref-code-block:: cpp
	...
	template VectorStore: public :ref:`ngraph::snippets::op::Store<doxid-classngraph_1_1snippets_1_1op_1_1_store>`
	{
		// construction
	
		:target:`VectorStore<doxid-classngraph_1_1snippets_1_1op_1_1_vector_store_1a616ed220ff4f7ab01c9c56ba3585071e>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x);
		:target:`VectorStore<doxid-classngraph_1_1snippets_1_1op_1_1_vector_store_1a1e8018602c59a6f4a8b4988e222a5f49>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_vector_store_1a4b73285377925fc3decf7cc9a6b4f8e2>`("VectorStore", "SnippetsOpset", :ref:`ngraph::snippets::op::Store<doxid-classngraph_1_1snippets_1_1op_1_1_store>`);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_vector_store_1ac292fa48d561ab5f431faa6921ab93d4>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
