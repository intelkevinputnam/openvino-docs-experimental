.. index:: pair: interface; ngraph::snippets::op::BroadcastLoad
.. _doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load:

interface ngraph::snippets::op::BroadcastLoad
=============================================
...
Is generated for broadcasting by least varying dimension for non-blocked cases and the second varying dimension for blocked. :ref:`More...<details-classngraph_1_1snippets_1_1op_1_1_broadcast_load>`
...
.. ref-code-block:: cpp
	...
	template BroadcastLoad: public :ref:`ngraph::snippets::op::BroadcastMove<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move>`
	{
		// construction
	
		:target:`BroadcastLoad<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a75776dd05ca6d00d8981c1e57ab805b7>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x, :ref:`Shape<doxid-classov_1_1_shape>` output_shape);
		:target:`BroadcastLoad<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a15f448a566c3d30c0d93696b13caead8>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1aaf49dea2e8bbb1bea0586f750eaf21e0>`(
			"BroadcastLoad",
			"SnippetsOpset",
			:ref:`ngraph::snippets::op::BroadcastMove<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move>`
			);
	
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a9e9fe2d8658510f9907abfe5cba37cf5>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a762ab41b381754e3878ed7323d9ee01c>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a7b51c359fea0371093d1f0986444dc52>`();
		void :target:`set_broadcast_info<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a028ac5e7046cf631d41fec5ddbc55148>`(const :ref:`Shape<doxid-classov_1_1_shape>`& bct);
		bool :target:`is_broadcast<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1afc3d2ef20fa6f46025dfa01b295cb661>`(size_t idx);
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		:ref:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a1f4eb59790a130dc468c40ee7856a735>`("BroadcastMove", "SnippetsOpset");
		virtual bool :ref:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a436504fa04de71275e9e459dcde1297a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1aa531e750b923f972418a14b0cf516eaf>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a96849d5ba53f43cb1d5532b34527598b>`();
	
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_move_1a1ffed14875d7ef0ed2eeb8ab5153308e>`(
			const :ref:`HostTensorVector<doxid-classngraph_1a4c69b1e96e984658be3a087d0610e67b>`& output_values,
			const :ref:`HostTensorVector<doxid-classngraph_1a4c69b1e96e984658be3a087d0610e67b>`& input_values
			) const;

.. _details-classngraph_1_1snippets_1_1op_1_1_broadcast_load:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Is generated for broadcasting by least varying dimension for non-blocked cases and the second varying dimension for blocked.

Methods
-------

.. _doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load_1a7b51c359fea0371093d1f0986444dc52:
