.. index:: pair: class; ngraph::pass::low_precision::ReduceMinTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation:
...
:ref:`ReduceMinTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation>` propagates dequantization operations through ReduceMin operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation>`
...
.. ref-code-block:: cpp
	...
	class ReduceMinTransformation: public :ref:`ngraph::pass::low_precision::ReduceBaseTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_base_transformation>`
	{
	public:
		// construction
	
		:target:`ReduceMinTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation_1aa3558a7aa387d544fa42fa0af75b3b89>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation_1a4a300bed70fd81a14b0ca8b7152e2b27>`("ReduceMinTransformation", "0");
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation_1abd58f08e2d026e7eaeb2d26fec37479f>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> reduce) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation_1a2e3e7624efe11423c3264f6994e6bed8>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReduceMinTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_min_transformation>` propagates dequantization operations through ReduceMin operation.

For more details about the transformation, refer to :ref:`ReduceMinTransformation <doxid-openvino_docs__o_v__u_g_lpt__reduce_min_transformation>` page in the Inference Engine Developer Guide.
