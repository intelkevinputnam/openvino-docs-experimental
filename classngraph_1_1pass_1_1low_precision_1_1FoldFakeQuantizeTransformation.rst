.. index:: pair: class; ngraph::pass::low_precision::FoldFakeQuantizeTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation:
...
:ref:`FoldFakeQuantizeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation>` evaluate FakeQuantize operations. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation>`
...
.. ref-code-block:: cpp
	...
	class FoldFakeQuantizeTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`FoldFakeQuantizeTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation_1abcaf14a9291e80373fdaeb3157b7aa8d>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation_1ae6d165b6d717f7cb79c1165e60a9e47f>`("FoldFakeQuantizeTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation_1aa70ebcf84273d05417fe722408cb9da7>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation_1a49b3ee15454ea7ac42ba24bcd7e66ed1>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation_1a89179713265ae06440e1c6337638c0f1>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`FoldFakeQuantizeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_fake_quantize_transformation>` evaluate FakeQuantize operations.

For more details about the transformation, refer to :ref:`FoldFakeQuantizeTransformation <doxid-openvino_docs__o_v__u_g_lpt__fold_fake_quantize_transformation>` page in the Inference Engine Developer Guide.
