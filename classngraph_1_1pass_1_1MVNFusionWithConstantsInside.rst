.. index:: pair: class; ngraph::pass::MVNFusionWithConstantsInside
.. _doxid-classngraph_1_1pass_1_1_m_v_n_fusion_with_constants_inside:
...
:ref:`MVNFusion <doxid-classngraph_1_1pass_1_1_m_v_n_fusion>` transformation replaces group of operations: gamma \* (x - ReduceMean(x, axes)) / (Sqrt(ReduceMean((x - ReduceMean(x, axes)) ^ 2)) + eps) + beta to MVN op.
...
.. ref-code-block:: cpp
	...
	class MVNFusionWithConstantsInside: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_m_v_n_fusion_with_constants_inside_1a84954f0cb78a34f5e43bb20289c17f21>`("MVNFusionWithConstantsInside", "0");
	};
