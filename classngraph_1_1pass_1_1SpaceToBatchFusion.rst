.. index:: pair: class; ngraph::pass::SpaceToBatchFusion
.. _doxid-classngraph_1_1pass_1_1_space_to_batch_fusion:
...
:ref:`SpaceToBatchFusion <doxid-classngraph_1_1pass_1_1_space_to_batch_fusion>` transformation replaces following graph: Transpose (or Reshape) -> Pad -> SpaceToDepth -> Transpose (or Reshape) to SpaceToBatch Restrictions: :ref:`More...<details-classngraph_1_1pass_1_1_space_to_batch_fusion>`
...
.. ref-code-block:: cpp
	...
	class SpaceToBatchFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_space_to_batch_fusion_1aa30ede46ab16db081198c5be5833c884>`("SpaceToBatchFusion", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_space_to_batch_fusion:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`SpaceToBatchFusion <doxid-classngraph_1_1pass_1_1_space_to_batch_fusion>` transformation replaces following graph: Transpose (or Reshape) -> Pad -> SpaceToDepth -> Transpose (or Reshape) to SpaceToBatch Restrictions:
