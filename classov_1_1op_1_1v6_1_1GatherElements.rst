.. index:: pair: class; ov::op::v6::GatherElements
.. _doxid-classov_1_1op_1_1v6_1_1_gather_elements:
...
:ref:`GatherElements <doxid-classov_1_1op_1_1v6_1_1_gather_elements>` operation. :ref:`More...<details-classov_1_1op_1_1v6_1_1_gather_elements>`
...
.. ref-code-block:: cpp
	...
	class GatherElements: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1aa5a87089f2bc2fcf973d9b652f2ff322>`;

		// construction
	
		:target:`GatherElements<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1a1e5c14f9424dc4a432b2947a4da5a64c>`();
	
		:ref:`GatherElements<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1a31d71e31320f16799b5fbb5cd3b8f70a>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1a7984937187bc44e24a8538259f3933fa>`("GatherElements", "opset6", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 6);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1aa952efe7294e7d81464d92f9783ed9ba>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1a5aa28742039bf291fc270f29e9840e3d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1af8493b1282bb828fcf18feb542176d57>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		int64_t :target:`get_axis<doxid-classov_1_1op_1_1v6_1_1_gather_elements_1ac0dc625e1dd7dc24cda07150fa407f4b>`() const;
	};
...
.. _details-classov_1_1op_1_1v6_1_1_gather_elements:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`GatherElements <doxid-classov_1_1op_1_1v6_1_1_gather_elements>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v6_1_1_gather_elements_1a31d71e31320f16799b5fbb5cd3b8f70a:
.. index:: pair: function; GatherElements
...
Constructs a :ref:`GatherElements <doxid-classov_1_1op_1_1v6_1_1_gather_elements>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing indices by which the operation gathers elements

	*
		- axis

		- specifies axis along which indices are specified

Methods
-------

.. _doxid-classov_1_1op_1_1v6_1_1_gather_elements_1aa952efe7294e7d81464d92f9783ed9ba:
