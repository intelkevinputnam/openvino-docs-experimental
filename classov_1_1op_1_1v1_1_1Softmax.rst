.. index:: pair: class; ov::op::v1::Softmax
.. _doxid-classov_1_1op_1_1v1_1_1_softmax:
...
:ref:`Softmax <doxid-classov_1_1op_1_1v1_1_1_softmax>` operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_softmax>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_softmax_1a295dcd4a6fb6443133c7507fe8101a5b>`;

		// construction
	
		:target:`Softmax<doxid-classov_1_1op_1_1v1_1_1_softmax_1a14572571467ab9772586f1b57c0dbae3>`();
		:ref:`Softmax<doxid-classov_1_1op_1_1v1_1_1_softmax_1a37e54799dead614cdbd30d086b858aee>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const size_t axis = 1);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_softmax_1a6a6066dd7128f678f2ad39d2b7771e68>`("Softmax", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_softmax_1acc1182c9cc0231dab074818b9b4027f9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_softmax_1a83f37ea2fa7c2e0b426358e16e991081>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_softmax_1a00f5812659e3e63a46eb10bdc7177cde>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		size_t :target:`get_axis<doxid-classov_1_1op_1_1v1_1_1_softmax_1a24f83ed5f11a86e9a004193346350666>`() const;
		void :target:`set_axis<doxid-classov_1_1op_1_1v1_1_1_softmax_1a36064a695327fed55e87c0d6ff3336be>`(const size_t axis);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_softmax_1aac20a92fc505da7a80cd4848f7c24543>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_softmax_1a0eb547630ba2e8344ae071040f6cd850>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_softmax:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Softmax <doxid-classov_1_1op_1_1v1_1_1_softmax>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_softmax_1a37e54799dead614cdbd30d086b858aee:
.. index:: pair: function; Softmax

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Softmax(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const size_t axis = 1)
...
.. list-table::
	...
	*
		...
		- The axis position (0-based) on which to calculate the softmax.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_softmax_1a83f37ea2fa7c2e0b426358e16e991081:
...
.. _doxid-classov_1_1op_1_1v1_1_1_softmax_1aac20a92fc505da7a80cd4848f7c24543:
...
.. _doxid-classov_1_1op_1_1v1_1_1_softmax_1a0eb547630ba2e8344ae071040f6cd850:
