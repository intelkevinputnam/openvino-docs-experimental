.. index:: pair: class; ngraph::pass::TransposeToReshape
.. _doxid-classngraph_1_1pass_1_1_transpose_to_reshape:
...
:ref:`TransposeToReshape <doxid-classngraph_1_1pass_1_1_transpose_to_reshape>` transformation replaces suitable Transposes with Reshape operation or optimizes them out.
...
.. ref-code-block:: cpp
	...
	class TransposeToReshape: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_transpose_to_reshape_1a7d8181018a147f8e84abe5d3b2e5fd34>`("TransposeToReshape", "0");
	};
