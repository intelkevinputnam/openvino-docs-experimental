.. index:: pair: class; ov::op::v1::Transpose
.. _doxid-classov_1_1op_1_1v1_1_1_transpose:
...
:ref:`Tensor <doxid-classov_1_1_tensor>` transpose operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_transpose>`
...
.. ref-code-block:: cpp
	...
	class Transpose: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_transpose_1adfabb7d36f739b25c5a6067f4be2c3b1>`;

		// construction
	
		:target:`Transpose<doxid-classov_1_1op_1_1v1_1_1_transpose_1a66a941c719292bc7d54b44dd2f632b84>`();
		:ref:`Transpose<doxid-classov_1_1op_1_1v1_1_1_transpose_1a02fa3d1225eb7cc11a124c95fc7cb1fd>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_order);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_transpose_1a51a2451472ed1fbda894f9d93d682cd5>`("Transpose", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_transpose_1ac7732b0cb4d474da651f608ada0a6f47>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_transpose_1aa017aef4d573fa2bc768c9165f03e1d4>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_transpose_1a7deb077765e96fd591e67f7162eeb5c9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_transpose_1aaa768473f177812816c7cdfbe2ccb9d7>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_transpose_1a08233e49fc78843e0a0b2aef557cc17e>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_transpose:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Tensor <doxid-classov_1_1_tensor>` transpose operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_transpose_1a02fa3d1225eb7cc11a124c95fc7cb1fd:
.. index:: pair: function; Transpose

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Transpose(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_order)
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor to be transposed.

	*
		- input_order

		- :ref:`Node <doxid-classov_1_1_node>` producing the permutation to apply to the axes of the input shape. Must be a vector with shape [n], where n is the rank of arg. The tensor's value must contain every integer in the range [0, n-1].

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_transpose_1aa017aef4d573fa2bc768c9165f03e1d4:
...
.. _doxid-classov_1_1op_1_1v1_1_1_transpose_1aaa768473f177812816c7cdfbe2ccb9d7:
...
.. _doxid-classov_1_1op_1_1v1_1_1_transpose_1a08233e49fc78843e0a0b2aef557cc17e:
