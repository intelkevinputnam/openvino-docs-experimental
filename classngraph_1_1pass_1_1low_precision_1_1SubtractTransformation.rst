.. index:: pair: class; ngraph::pass::low_precision::SubtractTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation:
...
:ref:`SubtractTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation>` propagates dequantization operations through Subtract operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation>`
...
.. ref-code-block:: cpp
	...
	class SubtractTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`SubtractTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation_1afe1fa5d3d128022b58b424b6dd6efb0c>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation_1a94b48dbd2df12306cda841311a17a1c6>`("SubtractTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation_1a5239a3bb4d0188f294d1bbb67812234d>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`SubtractTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_subtract_transformation>` propagates dequantization operations through Subtract operation.

For more details about the transformation, refer to :ref:`SubtractTransformation <doxid-openvino_docs__o_v__u_g_lpt__subtract_transformation>` page in the Inference Engine Developer Guide.
