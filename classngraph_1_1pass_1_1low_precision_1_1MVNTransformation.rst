.. index:: pair: class; ngraph::pass::low_precision::MVNTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation:
...
:ref:`MVNTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation>` propagates dequantization operations through MVN operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation>`
...
.. ref-code-block:: cpp
	...
	class MVNTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`MVNTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation_1ad4def576ff406b278e217d0d18caea2b>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation_1a03a96a2b81dbc7ea6093566e1acda606>`("MVNTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation_1a9b564b67daa2a649261c20088672edcc>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation_1abb5cb4a969ba070a6313d04e399550d7>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation_1aa179fd41d8af5daf875fcebc7c054449>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`MVNTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_m_v_n_transformation>` propagates dequantization operations through MVN operation.

For more details about the transformation, refer to :ref:`MVNTransformation <doxid-openvino_docs__o_v__u_g_lpt__m_v_n_transformation>` page in the Inference Engine Developer Guide.
