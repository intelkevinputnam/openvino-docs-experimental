.. index:: pair: class; ngraph::pass::ReshapeAMatMul
.. _doxid-classngraph_1_1pass_1_1_reshape_a_mat_mul:
...
:ref:`ReshapeAMatMul <doxid-classngraph_1_1pass_1_1_reshape_a_mat_mul>` and :ref:`ReshapeBMatMul <doxid-classngraph_1_1pass_1_1_reshape_b_mat_mul>` transformations relax hard-coded Reshape followed by MatMul operation For 2D Reshape search patterns are: :ref:`More...<details-classngraph_1_1pass_1_1_reshape_a_mat_mul>`
...
.. ref-code-block:: cpp
	...
	class ReshapeAMatMul: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_reshape_a_mat_mul_1aff2f63c456bee5d0147d2fcc759a9625>`("ReshapeAMatMul", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_reshape_a_mat_mul:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReshapeAMatMul <doxid-classngraph_1_1pass_1_1_reshape_a_mat_mul>` and :ref:`ReshapeBMatMul <doxid-classngraph_1_1pass_1_1_reshape_b_mat_mul>` transformations relax hard-coded Reshape followed by MatMul operation For 2D Reshape search patterns are:
