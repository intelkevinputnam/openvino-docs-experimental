.. index:: pair: class; ngraph::pass::HSigmoidDecomposition
.. _doxid-classngraph_1_1pass_1_1_h_sigmoid_decomposition:
...
:ref:`HSigmoidDecomposition <doxid-classngraph_1_1pass_1_1_h_sigmoid_decomposition>` transformation into sub-graph (min(Relu(x + 3), 6) \* const(1/6).
...
.. ref-code-block:: cpp
	...
	class HSigmoidDecomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_sigmoid_decomposition_1a7f7d58f92653b0300324f5c3eb78e138>`("HSigmoidDecomposition", "0");
	};
