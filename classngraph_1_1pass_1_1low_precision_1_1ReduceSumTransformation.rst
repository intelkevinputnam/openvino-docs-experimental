.. index:: pair: class; ngraph::pass::low_precision::ReduceSumTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation:
...
:ref:`ReduceSumTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation>` propagates dequantization operations through ReduceSum operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation>`
...
.. ref-code-block:: cpp
	...
	class ReduceSumTransformation: public :ref:`ngraph::pass::low_precision::ReduceBaseTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_base_transformation>`
	{
	public:
		// construction
	
		:target:`ReduceSumTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation_1abc6c968ec403f0d6958a2e4c78df297e>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation_1ac25131411f611e2487be6dcd70b28fab>`("ReduceSumTransformation", "0");
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation_1af56d2a240351d4155d754099560f2839>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> reduce) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation_1a1b940505b478d3e26ea868c87c948201>`(
			const :ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context,
			std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> reduce
			) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		virtual bool :ref:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_base_transformation_1a7a2d194d853e30200314648d70392f34>`(
			:ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context,
			:ref:`ngraph::pattern::Matcher<doxid-classov_1_1pass_1_1pattern_1_1_matcher>`& m
			);
	
		virtual bool :ref:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_base_transformation_1a1e0005ab2e792bc1b495dcecc21c9f7e>`(
			const :ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context,
			std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> reduce
			) const;

.. _details-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReduceSumTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_sum_transformation>` propagates dequantization operations through ReduceSum operation.

For more details about the transformation, refer to :ref:`ReduceSumTransformation <doxid-openvino_docs__o_v__u_g_lpt__reduce_sum_transformation>` page in the Inference Engine Developer Guide.
