.. index:: pair: class; ov::op::v3::ScatterUpdate
.. _doxid-classov_1_1op_1_1v3_1_1_scatter_update:
...
Set new values to slices from data addressed by indices. :ref:`More...<details-classov_1_1op_1_1v3_1_1_scatter_update>`
...
.. ref-code-block:: cpp
	...
	class ScatterUpdate: public :ref:`ov::op::util::ScatterBase<doxid-classov_1_1op_1_1util_1_1_scatter_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1ad2130ae03d71f5e4e5cb54d561f1f899>`;

		// construction
	
		:target:`ScatterUpdate<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1abbb7951df96b15bb9a7049fe1a819b90>`();
	
		:ref:`ScatterUpdate<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1a88e05b4ab03fad10cb4ab79b45a3d08c>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1a5b6a98c2d527eeb6d54a2671041f979c>`("ScatterUpdate", "opset3", :ref:`util::ScatterBase<doxid-classov_1_1op_1_1util_1_1_scatter_base>`, 3);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1aeda32ec5a3dc5a8316a72c1fabd832a9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& inputs) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1a825c3cf3b81889334861e2c52373f2aa>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_scatter_update_1ad36ccd0b8d7d76dc52712fdb10601d54>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_scatter_base_1a526d3eb5396e02827541c86f8244d459>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_scatter_base_1a7b6fc8bd621f524e8e854a91849aa000>`("ScatterBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_scatter_base_1a971b3955cb85fe3ed2852d11409bffe1>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_scatter_base_1a0bc696bc6814ec3ef5619c17aced7e85>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v3_1_1_scatter_update:
...
.. _doxid-classov_1_1op_1_1v3_1_1_scatter_update_1a88e05b4ab03fad10cb4ab79b45a3d08c:
.. index:: pair: function; ScatterUpdate
...
Constructs :ref:`ScatterUpdate <doxid-classov_1_1op_1_1v3_1_1_scatter_update>` operator object.
...
.. list-table::
	...
	*
		...
		- The tensor with indexes which will be updated.

	*
		- updates

		- The tensor with update values.

	*
		- axis

		- The axis at which elements will be updated.

Methods
-------

.. _doxid-classov_1_1op_1_1v3_1_1_scatter_update_1a825c3cf3b81889334861e2c52373f2aa:
...
.. _doxid-classov_1_1op_1_1v3_1_1_scatter_update_1ad36ccd0b8d7d76dc52712fdb10601d54:
