.. index:: pair: interface; ngraph::snippets::op::ScalarStore
.. _doxid-classngraph_1_1snippets_1_1op_1_1_scalar_store:

interface ngraph::snippets::op::ScalarStore
===========================================



Generated by Canonicalization for a scalar value store from vector register.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <scalarstore.hpp>
	
	template ScalarStore: public :ref:`ngraph::snippets::op::Store<doxid-classngraph_1_1snippets_1_1op_1_1_store>`
	{
		// construction
	
		:target:`ScalarStore<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_store_1a4c736f41227fee409e80033dd014f520>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x);
		:target:`ScalarStore<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_store_1a19a65bd38b2ce2b707859fd716860d72>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_store_1a75f50e4382b5bb42da312b3cf3622658>`("ScalarStore", "SnippetsOpset", :ref:`ngraph::snippets::op::Store<doxid-classngraph_1_1snippets_1_1op_1_1_store>`);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_store_1a1c6d2fe14947c8392daf0bfe167694ab>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		:ref:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_store_1afa2296c75c20e8b0a16cd3f88020b3d7>`("Store", "SnippetsOpset");
		virtual bool :ref:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_store_1aae062a8e5241adbba4d8a7c5b3988b7a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_store_1ae036beebfec458555e6187ccc7a73df9>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		...
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classngraph_1_1snippets_1_1op_1_1_store_1ae24caff49d2ee6fc66a5a132696ba872>`(
