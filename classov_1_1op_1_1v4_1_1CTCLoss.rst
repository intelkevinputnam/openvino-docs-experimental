.. index:: pair: class; ov::op::v4::CTCLoss
.. _doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss:
...
:ref:`CTCLoss <doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss>` operation. :ref:`More...<details-classov_1_1op_1_1v4_1_1_c_t_c_loss>`
...
.. ref-code-block:: cpp
	...
	class CTCLoss: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a02ad0f725b10c66ca94fd2a4132bc9ca>`;

		// construction
	
		:target:`CTCLoss<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1ab08c306af68ff8647700fcd7e95fdcc5>`();
	
		:ref:`CTCLoss<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1add496e41dc9fe4aa3b3d39199a59d386>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& logits,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& logit_length,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& labels,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& label_length,
			const bool preprocess_collapse_repeated = false,
			const bool ctc_merge_repeated = true,
			const bool unique = false
			);
	
		:target:`CTCLoss<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1ac7a1d637eb645a13ea4e0a4da1847227>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& logits,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& logit_length,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& labels,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& label_length,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a34a1a85e996b0027659fccfafa888a24>`("CTCLoss", "opset4", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 4);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1af7b23f29d102de289097da687b4a8dc0>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a6a3361c1c45589f71542cadfc7630fa1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a0d4d738013d0e6eacfded1c9c1488fae>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		bool :target:`get_preprocess_collapse_repeated<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a4152b5ab5727fbf2ada85efd50a03d38>`() const;
		bool :target:`get_ctc_merge_repeated<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a3accbbd6e699a3ccbb7648c6bfa4d4ef>`() const;
		bool :target:`get_unique<doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1a852bb8266d95d290efd9acca5fc05463>`() const;
	};
...
.. _details-classov_1_1op_1_1v4_1_1_c_t_c_loss:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`CTCLoss <doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1add496e41dc9fe4aa3b3d39199a59d386:
.. index:: pair: function; CTCLoss
...
Constructs a :ref:`CTCLoss <doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss>` operation.
...
.. list-table::
	...
	*
		...
		- 3-D tensor of logits

	*
		- logit_length

		- 1-D tensor of length for each object from a batch

	*
		- labels

		- 2-D tensor of labels for which likelyhood is estimated using logist

	*
		- label_length

		- 1-D tensor of length for each label sequence

	*
		- blank_index

		- Scalar used to mark a blank index

	*
		- preprocess_collapse_repeated

		- Flag for preprocessing labels before loss calculation

	*
		- ctc_merge_repeated

		- Flag for merging repeated characters in a potential alignment

	*
		- unique

		- Flag to find unique elements in a target before matching with alignment

Methods
-------

.. _doxid-classov_1_1op_1_1v4_1_1_c_t_c_loss_1af7b23f29d102de289097da687b4a8dc0:
