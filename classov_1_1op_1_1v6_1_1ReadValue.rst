.. index:: pair: class; ov::op::v6::ReadValue
.. _doxid-classov_1_1op_1_1v6_1_1_read_value:
...
:ref:`ReadValue <doxid-classov_1_1op_1_1v6_1_1_read_value>` operation gets an input value from the variable with ``variable_id`` and returns it as an output. :ref:`More...<details-classov_1_1op_1_1v6_1_1_read_value>`
...
.. ref-code-block:: cpp
	...
	class ReadValue: public :ref:`ov::op::util::ReadValueBase<doxid-classov_1_1op_1_1util_1_1_read_value_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v6_1_1_read_value_1a1ecc0e3088c44b909e502c9107b4a93d>`;

		// construction
	
		:target:`ReadValue<doxid-classov_1_1op_1_1v6_1_1_read_value_1a60c72ab1f5ab3a3b2e3597778f7f1750>`();
	
		:ref:`ReadValue<doxid-classov_1_1op_1_1v6_1_1_read_value_1af43f8c8bdd01acfc311ebf3622ca24ee>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& init_value,
			const std::shared_ptr<:ref:`util::Variable<doxid-classov_1_1op_1_1util_1_1_variable>`>& variable
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v6_1_1_read_value_1a1adcf30d0a9693cce6be2a38430e37a0>`("ReadValue", "opset6", :ref:`util::ReadValueBase<doxid-classov_1_1op_1_1util_1_1_read_value_base>`, 6);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v6_1_1_read_value_1a7217d229100652de481075fd5218caf3>`();
		virtual void :target:`revalidate_and_infer_types<doxid-classov_1_1op_1_1v6_1_1_read_value_1a2ef93741da53db16f049028dd10c33ad>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v6_1_1_read_value_1a57a1f334b1a2ad7752937bfc6787c73e>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v6_1_1_read_value_1a89b6af9f01b9e8409b0dd79f7349ec55>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::string :ref:`get_variable_id<doxid-classov_1_1op_1_1v6_1_1_read_value_1ae0396a30039c993d76c22616fe0d3abd>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v6_1_1_read_value_1a6aa5d1e4e4a2a011f542fd5b6811ef8b>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v6_1_1_read_value_1a0d4849aae113aac90c88397f00225eee>`() const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v6_1_1_read_value_1a72dc3606b3f7c55371806123f56c7ec7>`(
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_read_value_base_1a2efb9a2977df1d0286c38bf9a525b339>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_read_value_base_1af49317ce36c59e7890a451081895b611>`("ReadValueBase", "util");

.. _details-classov_1_1op_1_1v6_1_1_read_value:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReadValue <doxid-classov_1_1op_1_1v6_1_1_read_value>` operation gets an input value from the variable with ``variable_id`` and returns it as an output.

Construction
------------

.. _doxid-classov_1_1op_1_1v6_1_1_read_value_1af43f8c8bdd01acfc311ebf3622ca24ee:
.. index:: pair: function; ReadValue
...
Constructs a :ref:`ReadValue <doxid-classov_1_1op_1_1v6_1_1_read_value>` operation.
...
.. list-table::
	...
	*
		...
		- Class for storing and synchronizing element types, shapes and identifiers between pairs of Assign/ReadValue nodes.

Methods
-------

.. _doxid-classov_1_1op_1_1v6_1_1_read_value_1a7217d229100652de481075fd5218caf3:
...
.. _doxid-classov_1_1op_1_1v6_1_1_read_value_1ae0396a30039c993d76c22616fe0d3abd:
.. index:: pair: function; get_variable_id

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual std::string get_variable_id() const

Returns the identifier of corresponding variable.

.. _doxid-classov_1_1op_1_1v6_1_1_read_value_1a6aa5d1e4e4a2a011f542fd5b6811ef8b:
...
.. _doxid-classov_1_1op_1_1v6_1_1_read_value_1a0d4849aae113aac90c88397f00225eee:
