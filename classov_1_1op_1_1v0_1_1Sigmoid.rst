.. index:: pair: class; ov::op::v0::Sigmoid
.. _doxid-classov_1_1op_1_1v0_1_1_sigmoid:
...
:ref:`Sigmoid <doxid-classov_1_1op_1_1v0_1_1_sigmoid>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_sigmoid>`
...
.. ref-code-block:: cpp
	...
	class Sigmoid: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a09ba0ec81b08470f5b298355565606c7>`;

		// construction
	
		:target:`Sigmoid<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a1437089287a0e3a601e137c18d3339a0>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:target:`Sigmoid<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a839867f07cb783616348d5366cc1ca6d>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a3dfeb3a2d61266f326e2c4d0bdd07483>`("Sigmoid", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a896fac36851abeb5784df49a61730373>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a5705dbfe9ab0ddad473d47d1407746b7>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a283a571a7d498797c8d4830d113a4627>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_sigmoid:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Sigmoid <doxid-classov_1_1op_1_1v0_1_1_sigmoid>` operation.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a5705dbfe9ab0ddad473d47d1407746b7:
...
.. _doxid-classov_1_1op_1_1v0_1_1_sigmoid_1a283a571a7d498797c8d4830d113a4627:
