.. index:: pair: class; ov::op::v0::Abs
.. _doxid-classov_1_1op_1_1v0_1_1_abs:
...
Elementwise absolute value operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_abs>`
...
.. ref-code-block:: cpp
	...
	class Abs: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_abs_1a5baa15ef8b06abeb14c7e7153d469923>`;

		// construction
	
		:ref:`Abs<doxid-classov_1_1op_1_1v0_1_1_abs_1ae76e1f27ce7200d8b48036d96f39ca64>`();
		:ref:`Abs<doxid-classov_1_1op_1_1v0_1_1_abs_1a4afbb656a0a234a6f8f4fc47e82894d7>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_abs_1afe0d6e0ace66b23a5180a05edf840ac2>`("Abs", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_abs_1a3158da364f158ee651d3420e8e3a839d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`&);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_abs_1a97164ffef991c017deab2d86f045bcfa>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_abs_1a7ece9ec6d157be7cb272c2c318e54f1c>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_abs_1aba7a89a028397fb498cffb3066e033f2>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_abs:
...
.. _doxid-classov_1_1op_1_1v0_1_1_abs_1ae76e1f27ce7200d8b48036d96f39ca64:
...
.. _doxid-classov_1_1op_1_1v0_1_1_abs_1a4afbb656a0a234a6f8f4fc47e82894d7:
.. index:: pair: function; Abs

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Abs(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_abs_1a7ece9ec6d157be7cb272c2c318e54f1c:
...
.. _doxid-classov_1_1op_1_1v0_1_1_abs_1aba7a89a028397fb498cffb3066e033f2:
