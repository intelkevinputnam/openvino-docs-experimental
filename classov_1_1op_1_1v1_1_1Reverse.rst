.. index:: pair: class; ov::op::v1::Reverse
.. _doxid-classov_1_1op_1_1v1_1_1_reverse:
...
.. toctree::
	...
	Mode <enumov_1_1op_1_1v1_1_1Reverse_1_1Mode.rst>

Overview
~~~~~~~~

:ref:`Reverse <doxid-classov_1_1op_1_1v1_1_1_reverse>` operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_reverse>`
...
.. ref-code-block:: cpp
	...
	class Reverse: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`Mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1ad4489cd12a59c950fe16f88ccd88a4f6>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_reverse_1a2d4a1eb95cc74b81887e619818022023>`;

		// construction
	
		:target:`Reverse<doxid-classov_1_1op_1_1v1_1_1_reverse_1acc7a019b124e836d9dd818bcef6d5a34>`();
	
		:ref:`Reverse<doxid-classov_1_1op_1_1v1_1_1_reverse_1af70760b7cf48f6f9be04b800797e33e1>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& reversed_axes,
			const std::string& mode
			);
	
		:target:`Reverse<doxid-classov_1_1op_1_1v1_1_1_reverse_1a971388128c5bc45a5e126445a052fa69>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& reversed_axes,
			const :ref:`Mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1ad4489cd12a59c950fe16f88ccd88a4f6>` mode
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_reverse_1ac074bad011b4e620bc5aae29828ab84b>`("Reverse", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_reverse_1a4d7c5cdf71f41a05851091e7ea4bf9bc>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_reverse_1a5e79ab3bcabdac7dec033199228045d1>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_reverse_1a56c3569134efb0d3ba633935aaff7ec3>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`Mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1ad4489cd12a59c950fe16f88ccd88a4f6>` :ref:`get_mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1ab7383973e632644765ec2f91a3130c76>`() const;
		void :target:`set_mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1af6d679c22c03921bf00a124ece2e4b68>`(const :ref:`Mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1ad4489cd12a59c950fe16f88ccd88a4f6>` mode);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_reverse_1a464e589837e027300c18b3e1e8383412>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_reverse_1aac1f0198f30cbe7f0cac7c49146c206c>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_reverse:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Reverse <doxid-classov_1_1op_1_1v1_1_1_reverse>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_reverse_1af70760b7cf48f6f9be04b800797e33e1:
...
.. list-table::
	...
	*
		...
		- The input tensor, some of whose axes are to be reversed.

	*
		- reversed_axes

		- The axes to reverse in a form of a set of indices or boolean mask.

	*
		- mode

		- The way reversed_axes should be interpreted - a set or a mask.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_reverse_1a5e79ab3bcabdac7dec033199228045d1:
...
.. _doxid-classov_1_1op_1_1v1_1_1_reverse_1ab7383973e632644765ec2f91a3130c76:
.. index:: pair: function; get_mode

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`Mode<doxid-classov_1_1op_1_1v1_1_1_reverse_1ad4489cd12a59c950fe16f88ccd88a4f6>` get_mode() const
...
.. _doxid-classov_1_1op_1_1v1_1_1_reverse_1a464e589837e027300c18b3e1e8383412:
...
.. _doxid-classov_1_1op_1_1v1_1_1_reverse_1aac1f0198f30cbe7f0cac7c49146c206c:
