.. index:: pair: class; ngraph::pass::low_precision::ConcatTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation:
...
:ref:`ConcatTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation>` propagates dequantization operations through Concat operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation>`
...
.. ref-code-block:: cpp
	...
	class ConcatTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`ConcatTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation_1a4318835d83047b5fd1735b1490de197c>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation_1a682480afda0e211825a36b6dbac7d50c>`("ConcatTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation_1a2533a4a04169532c328f394fe4216af6>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation_1a4ca4998770977c17baa1f21c1ae542ad>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation_1a507d59473a64b0a2c5879b932c904f5a>`(
		...
		static bool :target:`isQuantizedStatic<doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation_1a2d1b394738b2185f9308030db3a9699a>`(const std::shared_ptr<const :ref:`Node<doxid-classov_1_1_node>`>& layer);
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ConcatTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_concat_transformation>` propagates dequantization operations through Concat operation.

For more details about the transformation, refer to :ref:`ConcatTransformation <doxid-openvino_docs__o_v__u_g_lpt__concat_transformation>` page in the Inference Engine Developer Guide.
