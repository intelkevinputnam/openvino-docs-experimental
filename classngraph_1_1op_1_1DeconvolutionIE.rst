.. index:: pair: class; ngraph::op::DeconvolutionIE
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e:

class ngraph::op::DeconvolutionIE
=================================
...
.. ref-code-block:: cpp
	...
	class DeconvolutionIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1ad8e5b609be532e7a165a4cb03d4235ac>`;

		// construction
	
		:target:`DeconvolutionIE<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1acfd45ca8658ee16c5821e5670f830b98>`();
	
		:target:`DeconvolutionIE<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a120280fc660bfef43897de0d551058bf>`(
			...
			const std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`>& output_shape = nullptr
			);
	
		:target:`DeconvolutionIE<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a766f9af5c54633d3968fc861fbb80811>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& filters,
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1aca000fbef595a7d3494c07e4b3096e8d>`("DeconvolutionIE", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1ab016bfda1555364c946a96b275e5fb9a>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1adb4b88667aa6903aff335480aeb31bbd>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_strides<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1aebb4c670db83d9e45fd95835331b0050>`() const;
		void :target:`set_strides<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a7d91a12b151eb6b1744d55a028249450>`(const :ref:`Strides<doxid-classov_1_1_strides>`& strides);
		const :ref:`Strides<doxid-classov_1_1_strides>`& :ref:`get_dilations<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1af2c09ddc8ae81e786a496c92ed59993e>`() const;
		void :target:`set_dilations<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a62d9af9f50b56910b452de58f4aa15c9>`(const :ref:`Strides<doxid-classov_1_1_strides>`& dilations);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_begin<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a4971d901c26ed1bb0c5f89e5a4741419>`() const;
		void :target:`set_pads_begin<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a694d23c36cbc638b4c371501c973cb09>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :ref:`get_pads_end<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1abf8c10f1ecfa888877d58db3d0e6c859>`() const;
		void :target:`set_pads_end<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1acf6fd40a61b5b46d5d796b4c024e4db3>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_end);
		const PadType& :ref:`get_auto_pad<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a2e800e6eba5878007c5e21366a3a3d3a>`() const;
		void :target:`set_auto_pad<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1af2a372865f0b0bde3b547819337572fd>`(const PadType& auto_pad);
		const size_t& :ref:`get_group<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1accb0c30fcfb9430a10e7756bc3689603>`() const;
		void :target:`set_group<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a2dd5d097d57f63ecc17254bbbba89e1d>`(const size_t& group);
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_deconvolution_i_e_1acd8df5edab1b284c9771460438472a97>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_deconvolution_i_e:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1ab016bfda1555364c946a96b275e5fb9a:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1aebb4c670db83d9e45fd95835331b0050:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1af2c09ddc8ae81e786a496c92ed59993e:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a4971d901c26ed1bb0c5f89e5a4741419:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1abf8c10f1ecfa888877d58db3d0e6c859:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1a2e800e6eba5878007c5e21366a3a3d3a:
...
.. _doxid-classngraph_1_1op_1_1_deconvolution_i_e_1accb0c30fcfb9430a10e7756bc3689603:
