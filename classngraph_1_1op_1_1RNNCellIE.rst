.. index:: pair: class; ngraph::op::RNNCellIE
.. _doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e:

class ngraph::op::RNNCellIE
===========================
...
.. ref-code-block:: cpp
	...
	#include <rnn_cell_ie.hpp>
	
	class RNNCellIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1aa2afef60e548f689b50335232d8ebedf>`;

		// construction
	
		:target:`RNNCellIE<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a686106061cf7e25dd37b55a1e05177ba>`(
		...
		:target:`RNNCellIE<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a7fb7960030929667b397820431d048c6>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1aa1754d89e9e5dcbc33fdd939a8a8b80f>`("RNNCellIE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a215ab544c2a2411f657cf05a3f467f7e>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a021809c5536d36fc9a271c3d9d7d80f3>`();
		std::size_t :target:`get_hidden_size<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a41ddf357aee757995d065af7d8f04d0b>`();
		const std::vector<std::string>& :target:`get_activations<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a3cbd6ece1ed8066f3f6adf23a2eae098>`();
		const std::vector<float>& :target:`get_activations_alpha<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a97fa7953f60ee461f623b68125bd8de6>`();
		const std::vector<float>& :target:`get_activations_beta<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a5a23688d06b9bbd57fb5362f817018e8>`();
		float :target:`get_clip<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a87ff66a5e47ac8cbff488e42910b79cf>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a1481bc77423e7728b3ce458d4c5a7b6e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_r_n_n_cell_i_e:
...
.. _doxid-classngraph_1_1op_1_1_r_n_n_cell_i_e_1a021809c5536d36fc9a271c3d9d7d80f3:
