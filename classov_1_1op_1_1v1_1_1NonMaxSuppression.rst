.. index:: pair: class; ov::op::v1::NonMaxSuppression
.. _doxid-classov_1_1op_1_1v1_1_1_non_max_suppression:
...
.. toctree::
	...
	BoxEncodingType <enumov_1_1op_1_1v1_1_1NonMaxSuppression_1_1BoxEncodingType.rst>

Overview
~~~~~~~~

Elementwise addition operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_non_max_suppression>`
...
.. ref-code-block:: cpp
	...
	public:
		...
		enum :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1ab6bbf2a5f7bb4b8ccf8d465177331bd0>`;

		// construction
	
		:target:`NonMaxSuppression<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1ad2d9c8a773db2baaec095556cbbf90c3>`();
	
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a834594884be45f536c06f4d5b7f4de25>`(
			...
			const :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0>` box_encoding = :ref:`BoxEncodingType::CORNER<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0ac411afd31d32cec664d372acc12f404a>`,
			const bool sort_result_descending = true
			);
	
		:ref:`NonMaxSuppression<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a8c19ccbfcaea6544c70530bbb2ac0aab>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& boxes,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& scores,
			const :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0>` box_encoding = :ref:`BoxEncodingType::CORNER<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0ac411afd31d32cec664d372acc12f404a>`,
			const bool sort_result_descending = true
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a470335781530f0afa963c2e0c0012025>`("NonMaxSuppression", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a5eda9ccb9c0c2beb1db25fcf8301fab6>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1aa1712512d910fe01ff3bbae1324e8efa>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a2b282df82b1d871f6591dd1e2e22396a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		:ref:`BoxEncodingType<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0>` :target:`get_box_encoding<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a156e32c8cf1f1ca76049826bbf603581>`() const;
		void :target:`set_box_encoding<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a226dba2ae181cd75f62b3f83ceb4bc1c>`(const :ref:`BoxEncodingType<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a9a64fb28f8bc647fbd016619a5fbdda0>` box_encoding);
		bool :target:`get_sort_result_descending<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a81eeffeaf6837ee2b866c2991069f282>`() const;
		void :target:`set_sort_result_descending<doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a4b25355de42daf154aa24f05f9a8631b>`(const bool sort_result_descending);
	};
...
.. _details-classov_1_1op_1_1v1_1_1_non_max_suppression:
...
.. _doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a834594884be45f536c06f4d5b7f4de25:
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v1_1_1_non_max_suppression>` operation.
...
.. _doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1a8c19ccbfcaea6544c70530bbb2ac0aab:
.. index:: pair: function; NonMaxSuppression
...
Constructs a :ref:`NonMaxSuppression <doxid-classov_1_1op_1_1v1_1_1_non_max_suppression>` operation with default values for the last 3 inputs.
...
.. _doxid-classov_1_1op_1_1v1_1_1_non_max_suppression_1aa1712512d910fe01ff3bbae1324e8efa:
