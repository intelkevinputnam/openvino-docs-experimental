.. index:: pair: class; ngraph::pass::ConvertLSTMCellMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_l_s_t_m_cell_matcher:

class ngraph::pass::ConvertLSTMCellMatcher
==========================================
...
.. ref-code-block:: cpp
	...
	#include <convert_cells_to_cells_ie.hpp>
	
	class ConvertLSTMCellMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_l_s_t_m_cell_matcher_1a76daaa7da8676113de8b4143f81f806b>`("ConvertLSTMCellMatcher", "0");
	};
