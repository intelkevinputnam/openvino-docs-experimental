.. index:: pair: class; ov::op::v5::GRUSequence
.. _doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence:
...
:ref:`GRUSequence <doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence>` operation. :ref:`More...<details-classov_1_1op_1_1v5_1_1_g_r_u_sequence>`
...
.. ref-code-block:: cpp
	...
	class GRUSequence: public :ref:`ov::op::util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a5b355747aa2d11717f9d6fc72c8c13cf>`;

		// construction
	
		:target:`GRUSequence<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1ae78581e25b081257fdd193c56220cec7>`();
	
		:target:`GRUSequence<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a3a22ac970f08aafa3e651f239aa2726d>`(
			...
			size_t hidden_size,
			:ref:`op::RecurrentSequenceDirection<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` direction,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a5bbac3ea082c9ebb5a971c3eb61ce8d4>`("GRUSequence", "opset5", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 5);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a75596dfb9a148dbe1e35f411ee84268d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1aa9082fae277a8f3180c0566a4a63f186>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a7caef5824bd340481c7ba1b4e29f5842>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		bool :target:`get_linear_before_reset<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a5024dcb590437c4ef7a146cbbc81eb03>`() const;
		:ref:`op::RecurrentSequenceDirection<doxid-namespaceov_1_1op_1a9ea79d465e912e768d0ac8fe24d6f0cc>` :target:`get_direction<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1a4de0ce45484c43f38adbc2d1e40b432b>`() const;
	};
...
.. _details-classov_1_1op_1_1v5_1_1_g_r_u_sequence:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`GRUSequence <doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence>` operation.

Methods
-------

.. _doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence_1aa9082fae277a8f3180c0566a4a63f186:
