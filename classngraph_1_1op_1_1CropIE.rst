.. index:: pair: class; ngraph::op::CropIE
.. _doxid-classngraph_1_1op_1_1_crop_i_e:

class ngraph::op::CropIE
========================
...
.. ref-code-block:: cpp
	...
	class CropIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_crop_i_e_1a10b9b6ca55a76c79361735d8cc03d834>`;
		std::vector<int64_t> :target:`axes<doxid-classngraph_1_1op_1_1_crop_i_e_1aedc1e2fd3b7fec8d77c8abafdc3467c2>`;
		std::vector<int64_t> :target:`dim<doxid-classngraph_1_1op_1_1_crop_i_e_1a0fc25f26d99973a7a7c7e83d40145c06>`;
		std::vector<int64_t> :target:`offset<doxid-classngraph_1_1op_1_1_crop_i_e_1a171de4ef937cf8297545ba41cb3f8be3>`;

		// construction
	
		:target:`CropIE<doxid-classngraph_1_1op_1_1_crop_i_e_1a37d4d47e6ea7f8051993dd99e3c9e258>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_crop_i_e_1a91aaede96583e430f47ceb33a26a4a16>`("CropIE", "legacy");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_crop_i_e_1ab05e9339a196ec3ececfd239b600bb42>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_crop_i_e_1a359c4ebaf9f1187ada38a1ce994f59c2>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_crop_i_e_1aa1b93a2f2b3dcb7868b67aae848ec63f>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_crop_i_e:
...
.. _doxid-classngraph_1_1op_1_1_crop_i_e_1a359c4ebaf9f1187ada38a1ce994f59c2:
