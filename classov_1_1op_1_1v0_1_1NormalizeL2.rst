.. index:: pair: class; ov::op::v0::NormalizeL2
.. _doxid-classov_1_1op_1_1v0_1_1_normalize_l2:
...
Normalization with L2 norm. :ref:`More...<details-classov_1_1op_1_1v0_1_1_normalize_l2>`
...
.. ref-code-block:: cpp
	...
	class NormalizeL2: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a7aba1d9a4aa6a0b4a095ff6f7e8cf28e>`;

		// construction
	
		:target:`NormalizeL2<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1aed0d935b0bec2969c6237d2f701f8597>`();
	
		:ref:`NormalizeL2<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a341426dac6fc5aa87aa42c3334653b22>`(
			...
			float eps,
			:ref:`EpsMode<doxid-namespaceov_1_1op_1abde68b9f95937807257f2be0a05165b3>` eps_mode
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a2b1993529bec03504f70c185f28f0f96>`("NormalizeL2", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a468abcde975567255bdeb6c2ba346580>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a45a146411e99692e5712bc591202d356>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a989c526fbfc81d4b7339cfa3c42f945b>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		float :target:`get_eps<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a3170758d474438ccd542e67033c2f5d9>`() const;
		:ref:`EpsMode<doxid-namespaceov_1_1op_1abde68b9f95937807257f2be0a05165b3>` :target:`get_eps_mode<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a166a025744042654feedab617e7d01de>`() const;
		:ref:`AxisSet<doxid-classov_1_1_axis_set>` :target:`get_reduction_axes<doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1ae9e55c2daaf7c5a333abf8355c05b702>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_normalize_l2:
...
.. _doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a341426dac6fc5aa87aa42c3334653b22:
.. index:: pair: function; NormalizeL2
...
Constructs a :ref:`NormalizeL2 <doxid-classov_1_1op_1_1v0_1_1_normalize_l2>` operation.
...
.. list-table::
	...
	*
		...
		- - :ref:`Node <doxid-classov_1_1_node>` indicating axes along which reduction is calculated
...
.. _doxid-classov_1_1op_1_1v0_1_1_normalize_l2_1a468abcde975567255bdeb6c2ba346580:
