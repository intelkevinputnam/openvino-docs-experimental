.. index:: pair: class; ov::op::v3::ReadValue
.. _doxid-classov_1_1op_1_1v3_1_1_read_value:
...
:ref:`ReadValue <doxid-classov_1_1op_1_1v3_1_1_read_value>` operation creates the variable with ``variable_id`` and returns value of this variable. :ref:`More...<details-classov_1_1op_1_1v3_1_1_read_value>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_read_value_1aafc6f4de61771f3aeefcbc0123fd01ad>`;

		// construction
	
		:target:`ReadValue<doxid-classov_1_1op_1_1v3_1_1_read_value_1ade0c3e8e8857d098e672ac77929368c7>`();
		:ref:`ReadValue<doxid-classov_1_1op_1_1v3_1_1_read_value_1a3da1c0eeae1af467bca5df552b26961c>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& init_value, const std::string& variable_id);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_read_value_1aa3af6a715bde9f06d75c536982e542fb>`("ReadValue", "opset3", :ref:`util::ReadValueBase<doxid-classov_1_1op_1_1util_1_1_read_value_base>`, 3);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_read_value_1af22fe36ed48785fb41e7bb637615ca81>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_read_value_1ae9caed2d2e911a11c6bec3ef7723ee6c>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_read_value_1a2a7b12fa7bee29a2e5849eeabab1c522>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::string :ref:`get_variable_id<doxid-classov_1_1op_1_1v3_1_1_read_value_1adaa010752c4905e09f4a88cc37c60383>`() const;
	};
...
.. _details-classov_1_1op_1_1v3_1_1_read_value:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReadValue <doxid-classov_1_1op_1_1v3_1_1_read_value>` operation creates the variable with ``variable_id`` and returns value of this variable.

Construction
------------

.. _doxid-classov_1_1op_1_1v3_1_1_read_value_1a3da1c0eeae1af467bca5df552b26961c:
.. index:: pair: function; ReadValue

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	ReadValue(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& init_value, const std::string& variable_id)

Constructs a :ref:`ReadValue <doxid-classov_1_1op_1_1v3_1_1_read_value>` operation.
...
.. list-table::
	...
	*
		...
		- identificator of the variable to create.

Methods
-------

.. _doxid-classov_1_1op_1_1v3_1_1_read_value_1af22fe36ed48785fb41e7bb637615ca81:
...
.. _doxid-classov_1_1op_1_1v3_1_1_read_value_1adaa010752c4905e09f4a88cc37c60383:
