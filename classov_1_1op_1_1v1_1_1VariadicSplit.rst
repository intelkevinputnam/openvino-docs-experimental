.. index:: pair: class; ov::op::v1::VariadicSplit
.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split:
...
:ref:`VariadicSplit <doxid-classov_1_1op_1_1v1_1_1_variadic_split>` operation splits an input tensor into pieces along some axis. The pieces may have variadic lengths depending on "split_lengths" attribute. :ref:`More...<details-classov_1_1op_1_1v1_1_1_variadic_split>`
...
.. ref-code-block:: cpp
	...
	class VariadicSplit: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a579bb2c3e35120b2abadac22988cf0fa>`;

		// construction
	
		:ref:`VariadicSplit<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a5517e4c96d02a190a83ec926728d9e30>`();
	
		:ref:`VariadicSplit<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1add49827e7094167baa6ccd6dc0a6821e>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& split_lengths
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1af1c4b764582d80b3d1f68958ce4e2133>`("VariadicSplit", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a80e1b049c20d760c5dacf12f6b56d4d1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1ace5452b057bda01a2dfe27a5a35ef7fd>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1af1660cda6958e7fe5e25481042773bff>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual size_t :ref:`get_default_output_index<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a9f68ae7a93e06aa3eac99d57fe0d176c>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a4cb79f0d218a5e7c1aabd4cc9cef0ac7>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_variadic_split_1ad0b2a26d913e7999338ea501ddd80bd4>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_variadic_split:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`VariadicSplit <doxid-classov_1_1op_1_1v1_1_1_variadic_split>` operation splits an input tensor into pieces along some axis. The pieces may have variadic lengths depending on "split_lengths" attribute.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a5517e4c96d02a190a83ec926728d9e30:
.. index:: pair: function; VariadicSplit
...
.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split_1add49827e7094167baa6ccd6dc0a6821e:
.. index:: pair: function; VariadicSplit
...
.. list-table::
	...
	*
		...
		- The index of an axis in "data" along which to perform the split.

	*
		- split_lengths

		- A list containing the sizes of each output tensor along the split "axis". Size of "split_lengths" should be equal to the number of

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split_1ace5452b057bda01a2dfe27a5a35ef7fd:
...
.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a9f68ae7a93e06aa3eac99d57fe0d176c:
...
.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split_1a4cb79f0d218a5e7c1aabd4cc9cef0ac7:
...
.. _doxid-classov_1_1op_1_1v1_1_1_variadic_split_1ad0b2a26d913e7999338ea501ddd80bd4:
