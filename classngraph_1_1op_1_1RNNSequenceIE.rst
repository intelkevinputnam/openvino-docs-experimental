.. index:: pair: class; ngraph::op::RNNSequenceIE
.. _doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e:

class ngraph::op::RNNSequenceIE
===============================
...
.. ref-code-block:: cpp
	...
	#include <rnn_sequence_ie.hpp>
	
	class RNNSequenceIE: public :ref:`ov::op::util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a22422a1b5162a96cef40f7845a2e6c69>`;

		// construction
	
		:target:`RNNSequenceIE<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a17de6f0d10d229c036df27f9ffa6c58d>`(
		...
		:target:`RNNSequenceIE<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a30ad4d25e3125388d3322f19dfc8f408>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a6f1458e807a680bed1a6e08f733d0f72>`("RNNSequenceIE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a527ca21a8cd1a450af72b593f1f7070d>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1abb04d8196ab01d7f213f2288f2caa555>`();
		std::size_t :target:`get_hidden_size<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a91272eee93fc9904232d587162738807>`();
		const std::vector<std::string>& :target:`get_activations<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a221861329947630e95f81ca37a4630f8>`();
		const std::vector<float>& :target:`get_activations_alpha<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a9961814cccdf58b94c2d8399352e87d1>`();
		const std::vector<float>& :target:`get_activations_beta<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1a68250e1ef6532569d40603e9f4837533>`();
		float :target:`get_clip<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1ae8faf2216f43b6a4a096aaf8d18bb609>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1aebccc389b2ad81740008965c73d7aa13>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_r_n_n_sequence_i_e:
...
.. _doxid-classngraph_1_1op_1_1_r_n_n_sequence_i_e_1abb04d8196ab01d7f213f2288f2caa555:
