.. index:: pair: class; ngraph::pass::low_precision::EltwiseBaseTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_eltwise_base_transformation:
...
:ref:`EltwiseBaseTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_eltwise_base_transformation>` is base class for element-wise LPT transformations.
...
.. ref-code-block:: cpp
	...
	class EltwiseBaseTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`EltwiseBaseTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_eltwise_base_transformation_1a68b64a9f0103348d2c6db6b4558a9fde>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params);

		// methods
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_eltwise_base_transformation_1ad9812d3c841216d844127005a273e80e>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_eltwise_base_transformation_1a6c624e13d5530649ff778aab2dbbb109>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
		static bool :target:`isBroadcasted<doxid-classngraph_1_1pass_1_1low__precision_1_1_eltwise_base_transformation_1afbd48d74d3f6fa95a408af1c7f500402>`(const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& shape);
	};
