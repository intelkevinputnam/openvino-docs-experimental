.. index:: pair: class; ngraph::pass::low_precision::PReluTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation:
...
:ref:`PReluTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation>` propagates dequantization operations through PRelu operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation>`
...
.. ref-code-block:: cpp
	...
	class PReluTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`PReluTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation_1a53ded5dc0d63a2c4975a4b1f68d40037>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation_1ae2d6bb47d48590f71e1691eefe03ceb5>`("PReluTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation_1a78ba9cf349c7848f78463f361aa4184e>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation_1a730805315bd9d0b422660efe9a827b1d>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation_1a3f202daf80d60127e11f58d0a3ccefe4>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`PReluTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_p_relu_transformation>` propagates dequantization operations through PRelu operation.

For more details about the transformation, refer to :ref:`PReluTransformation <doxid-openvino_docs__o_v__u_g_lpt__p_relu_transformation>` page in the Inference Engine Developer Guide.
