.. index:: pair: class; InferenceEngine::BatchToSpaceLayer
.. _doxid-class_inference_engine_1_1_batch_to_space_layer:
...
This class represents a standard Batch To Space layer. :ref:`More...<details-class_inference_engine_1_1_batch_to_space_layer>`
...
.. ref-code-block:: cpp
	...
	class BatchToSpaceLayer: public :ref:`InferenceEngine::CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`
	{
	public:
		// fields
	
		std::vector<size_t> :ref:`_block_shape<doxid-class_inference_engine_1_1_batch_to_space_layer_1aeee44cbee03e680c83c4be4175b4966e>`;
		std::vector<size_t> :ref:`_crops_begin<doxid-class_inference_engine_1_1_batch_to_space_layer_1acb88981483cd0c895d5d32103b5f28d4>`;
		std::vector<size_t> :ref:`_crops_end<doxid-class_inference_engine_1_1_batch_to_space_layer_1a3f297e56733fdd828a4a30fe8ee3ed7f>`;

		// methods
	
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_batch_to_space_layer_1a49576b4ff390822c0aa474cf7f542724>`(const :ref:`LayerParams<doxid-struct_inference_engine_1_1_layer_params>`& prms);
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_batch_to_space_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa>`(const :ref:`CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`& other);
	};
...
.. _details-class_inference_engine_1_1_batch_to_space_layer:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

This class represents a standard Batch To Space layer.
...
.. _doxid-class_inference_engine_1_1_batch_to_space_layer_1aeee44cbee03e680c83c4be4175b4966e:
.. index:: pair: variable; _block_shape
...
.. _doxid-class_inference_engine_1_1_batch_to_space_layer_1acb88981483cd0c895d5d32103b5f28d4:
.. index:: pair: variable; _crops_begin
...
.. _doxid-class_inference_engine_1_1_batch_to_space_layer_1a3f297e56733fdd828a4a30fe8ee3ed7f:
.. index:: pair: variable; _crops_end
...
.. _doxid-class_inference_engine_1_1_batch_to_space_layer_1a49576b4ff390822c0aa474cf7f542724:
...
Creates a new :ref:`BatchToSpaceLayer <doxid-class_inference_engine_1_1_batch_to_space_layer>` instance.

.. _doxid-class_inference_engine_1_1_batch_to_space_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa:
.. index:: pair: function; CNNLayer
