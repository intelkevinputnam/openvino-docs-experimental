.. index:: pair: class; ngraph::op::Eltwise
.. _doxid-classngraph_1_1op_1_1_eltwise:

class ngraph::op::Eltwise
=========================
...
.. ref-code-block:: cpp
	...
	class Eltwise: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_eltwise_1a5dda62218cdc21ee974545113538d986>`;
		:ref:`ELTWISE_TYPE<doxid-eltwise_8hpp_1aca2b664f1fd62f182b07693d53c56611>` :target:`eltwise_type<doxid-classngraph_1_1op_1_1_eltwise_1a3bce05d1013b6a3167b5793093d6e0c2>`;

		// construction
	
		:target:`Eltwise<doxid-classngraph_1_1op_1_1_eltwise_1ad9aebad4930e79d7d1ef9a1bf86e4b38>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data1,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data2,
			const :ref:`ELTWISE_TYPE<doxid-eltwise_8hpp_1aca2b664f1fd62f182b07693d53c56611>` eltwise_type,
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type = element::undefined
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_eltwise_1a9da4d42fea9be9775916db3c1901931a>`("Eltwise", "legacy");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_eltwise_1ac6ba346874b56a8e2ad7ff3de4ead199>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_eltwise_1ab6c25911c06c8e600f4a2932459772e6>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_eltwise_1a0c2ac29e8151158e6917a5c1c6d87cbd>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_eltwise:
...
.. _doxid-classngraph_1_1op_1_1_eltwise_1ab6c25911c06c8e600f4a2932459772e6:
