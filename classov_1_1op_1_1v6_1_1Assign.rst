.. index:: pair: class; ov::op::v6::Assign
.. _doxid-classov_1_1op_1_1v6_1_1_assign:
...
:ref:`Assign <doxid-classov_1_1op_1_1v6_1_1_assign>` operation sets an input value to the variable with ``variable_id`` :ref:`More...<details-classov_1_1op_1_1v6_1_1_assign>`
...
.. ref-code-block:: cpp
	...
	class Assign: public :ref:`ov::op::util::AssignBase<doxid-classov_1_1op_1_1util_1_1_assign_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v6_1_1_assign_1af25bef1e01bcea77507605b7445377c2>`;

		// construction
	
		:target:`Assign<doxid-classov_1_1op_1_1v6_1_1_assign_1a6404b189f3651c728c44e563ab4d8cee>`();
	
		:ref:`Assign<doxid-classov_1_1op_1_1v6_1_1_assign_1aa3b58f25f168df883162f5dc67f02313>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& new_value,
			const std::shared_ptr<:ref:`util::Variable<doxid-classov_1_1op_1_1util_1_1_variable>`>& variable
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v6_1_1_assign_1ab1eefe68dd53c608047dc78f1d695e59>`("Assign", "opset6", :ref:`op::Sink<doxid-classov_1_1op_1_1_sink>`, 6);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v6_1_1_assign_1a95f42d9b62b10a31832b2bf8799aa766>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v6_1_1_assign_1a8d08f0bb5db31cef1abdd22342c14939>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v6_1_1_assign_1aa3acc77b0c53ec309040be78ffd6341d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::string :ref:`get_variable_id<doxid-classov_1_1op_1_1v6_1_1_assign_1ad76567134ff7a7604f649b700426e644>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v6_1_1_assign_1ab7dbbf54888cc6af36f06d12687792e6>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v6_1_1_assign_1a033729d8610ff84624e4c165943fb54b>`() const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v6_1_1_assign_1ad794b47debed82fb3efae0ac77324397>`(
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1_sink_1a61421cbb3dcee733a0fdf2888d34f9d8>`;
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_assign_base_1af16b2b521472b1149a43c33bd3709914>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1_sink_1a952f328f5933d620205cde87353caf50>`("Sink");
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_assign_base_1ade5bedd0c1b66601224a3a0a31138ac0>`("AssignBase", "util", :ref:`ov::op::Sink<doxid-classov_1_1op_1_1_sink>`);

.. _details-classov_1_1op_1_1v6_1_1_assign:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Assign <doxid-classov_1_1op_1_1v6_1_1_assign>` operation sets an input value to the variable with ``variable_id``

Construction
------------

.. _doxid-classov_1_1op_1_1v6_1_1_assign_1aa3b58f25f168df883162f5dc67f02313:
...
Constructs an :ref:`Assign <doxid-classov_1_1op_1_1v6_1_1_assign>` operation.
...
.. _doxid-classov_1_1op_1_1v6_1_1_assign_1a95f42d9b62b10a31832b2bf8799aa766:
...
.. _doxid-classov_1_1op_1_1v6_1_1_assign_1ad76567134ff7a7604f649b700426e644:
...
.. _doxid-classov_1_1op_1_1v6_1_1_assign_1ab7dbbf54888cc6af36f06d12687792e6:
...
.. _doxid-classov_1_1op_1_1v6_1_1_assign_1a033729d8610ff84624e4c165943fb54b:
