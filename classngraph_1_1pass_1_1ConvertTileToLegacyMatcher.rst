.. index:: pair: class; ngraph::pass::ConvertTileToLegacyMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_tile_to_legacy_matcher:

class ngraph::pass::ConvertTileToLegacyMatcher
==============================================
...
.. ref-code-block:: cpp
	...
	#include <convert_tile_to_ie_tile.hpp>
	
	class ConvertTileToLegacyMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_tile_to_legacy_matcher_1ae8b394478de979b3b11a5af7f6fe8e8e>`("ConvertTileToLegacyMatcher", "0");
	};
