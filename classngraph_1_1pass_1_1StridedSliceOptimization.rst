.. index:: pair: class; ngraph::pass::StridedSliceOptimization
.. _doxid-classngraph_1_1pass_1_1_strided_slice_optimization:
...
:ref:`StridedSliceOptimization <doxid-classngraph_1_1pass_1_1_strided_slice_optimization>` transformation executes all transformations related to StridedSlice optimizations.
...
.. ref-code-block:: cpp
	...
	class StridedSliceOptimization: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// construction
	
		:target:`StridedSliceOptimization<doxid-classngraph_1_1pass_1_1_strided_slice_optimization_1aa84ba58fa874f5732aa3165488ff301e>`(bool use_shapes = true);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_strided_slice_optimization_1a8918a6031fd7700779d6adc2ddf19c32>`("StridedSliceOptimization", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_strided_slice_optimization_1a334c727a027bd79bef49a330d25cfa5f>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
