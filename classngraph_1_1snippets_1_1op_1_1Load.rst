.. index:: pair: interface; ngraph::snippets::op::Load
.. _doxid-classngraph_1_1snippets_1_1op_1_1_load:

interface ngraph::snippets::op::Load
====================================
...
Generated by Canonicalization step where explicit load instruction should be emmiteed :ref:`ScalarLoad <doxid-classngraph_1_1snippets_1_1op_1_1_scalar_load>` == scalar instruction + post increment :ref:`Load <doxid-classngraph_1_1snippets_1_1op_1_1_load>` (:ref:`VectorLoad <doxid-classngraph_1_1snippets_1_1op_1_1_vector_load>`) == vector instruction + post increment :ref:`BroadcastLoad <doxid-classngraph_1_1snippets_1_1op_1_1_broadcast_load>` == scalar instruction - post increment :ref:`BlockedLoad <doxid-classngraph_1_1snippets_1_1op_1_1_blocked_load>` == vector instruction - post increment. :ref:`More...<details-classngraph_1_1snippets_1_1op_1_1_load>`
...
.. ref-code-block:: cpp
	...
	template Load: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
		// construction
	
		:target:`Load<doxid-classngraph_1_1snippets_1_1op_1_1_load_1acefd73dcc72f949755f1fd52cd178dfa>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x);
		:target:`Load<doxid-classngraph_1_1snippets_1_1op_1_1_load_1a6282b5539821e080bc5f56f3b6421cb1>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_load_1acfbf5c79366ddc88fdc8a4d95ec57ea2>`("Load", "SnippetsOpset");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_load_1ab4c48efb6697573ecb219d1baa66326b>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_load_1ad5e04d6df832e2e5007a5180497c83c0>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1snippets_1_1op_1_1_load_1a78d2744b3178010ad2e4e505f85778ac>`();
	
		:ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate<doxid-classngraph_1_1snippets_1_1op_1_1_load_1a8838cb9c28d6226488424e3b33c3ab30>`(
...
.. _details-classngraph_1_1snippets_1_1op_1_1_load:
...
Generated by Canonicalization step where explicit store instruction should be emmiteed.

Methods
-------

.. _doxid-classngraph_1_1snippets_1_1op_1_1_load_1a78d2744b3178010ad2e4e505f85778ac:
