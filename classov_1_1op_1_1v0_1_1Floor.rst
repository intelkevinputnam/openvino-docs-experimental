.. index:: pair: class; ov::op::v0::Floor
.. _doxid-classov_1_1op_1_1v0_1_1_floor:
...
Elementwise floor operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_floor>`
...
.. ref-code-block:: cpp
	...
	class Floor: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_floor_1a028988298aa49feef7c8294742da0022>`;

		// construction
	
		:ref:`Floor<doxid-classov_1_1op_1_1v0_1_1_floor_1a7617845d38beeb9111fc311c09f3a25c>`();
		:ref:`Floor<doxid-classov_1_1op_1_1v0_1_1_floor_1a2ce45cf358218a61eea3284db36a88bf>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_floor_1ab2d3f638351cded46962f90c4946c90f>`("Floor", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_floor_1a9e409918bfea508e89e705464e8388d9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_floor_1aaf5a51ce25ad9926136c57511ecd5e9f>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_floor_1a2f7ab56e3c1e48e9a61a77c1d7d983b3>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_floor_1a3c6f70b71eaeb9ec40de5a6b985c6f2d>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_floor:
...
.. _doxid-classov_1_1op_1_1v0_1_1_floor_1a7617845d38beeb9111fc311c09f3a25c:
...
.. _doxid-classov_1_1op_1_1v0_1_1_floor_1a2ce45cf358218a61eea3284db36a88bf:
.. index:: pair: function; Floor

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Floor(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_floor_1a2f7ab56e3c1e48e9a61a77c1d7d983b3:
...
.. _doxid-classov_1_1op_1_1v0_1_1_floor_1a3c6f70b71eaeb9ec40de5a6b985c6f2d:
