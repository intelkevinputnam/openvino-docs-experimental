.. index:: pair: class; ngraph::op::Interp
.. _doxid-classngraph_1_1op_1_1_interp:

class ngraph::op::Interp
========================
...
.. ref-code-block:: cpp
	...
	class Interp: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_interp_1a4ee4a3738ba655f048f4860817b2f45c>`;

		// construction
	
		:target:`Interp<doxid-classngraph_1_1op_1_1_interp_1afc3ec4960b05366d61675515d0da99b6>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image, const :ref:`InterpolateIEAttrs<doxid-structngraph_1_1op_1_1_interpolate_i_e_attrs>`& attrs);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_interp_1a3cff078178b53750eeefb400e66d5a6b>`("Interp", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_interp_1a1560459243e5415938c135816655bf5e>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_interp_1aa4120a71dd016c4c57230a22921a3db2>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_interp_1aa5bbd263461f3e146c9cc8457f6b6288>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		:ref:`InterpolateIEAttrs<doxid-structngraph_1_1op_1_1_interpolate_i_e_attrs>` :target:`get_attrs<doxid-classngraph_1_1op_1_1_interp_1a4b8904262ea37c660f696a808779af6d>`();
	};
...
.. _details-classngraph_1_1op_1_1_interp:
...
.. _doxid-classngraph_1_1op_1_1_interp_1a1560459243e5415938c135816655bf5e:
