.. index:: pair: class; ngraph::pass::low_precision::ReluTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation:
...
:ref:`ReluTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation>` propagates dequantization operations through Relu operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation>`
...
.. ref-code-block:: cpp
	...
	class ReluTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`ReluTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation_1ae9218e4404bd63c48c97c60c3b612471>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation_1a7cf1920a6398d736340a743d8415d6b9>`("ReluTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation_1a780b4767c1b31035360b25106936088f>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation_1a2e4113a600d13275f04850bd37114ee3>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation_1a74d7e702bd5144e8f6d5e2c872acc478>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReluTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_relu_transformation>` propagates dequantization operations through Relu operation.

For more details about the transformation, refer to :ref:`ReluTransformation <doxid-openvino_docs__o_v__u_g_lpt__relu_transformation>` page in the Inference Engine Developer Guide.
