.. index:: pair: class; ov::PrecisionSensitive
.. _doxid-classov_1_1_precision_sensitive:
...
:ref:`PrecisionSensitive <doxid-classov_1_1_precision_sensitive>` class represents runtime info attribute that marks input to an operation as a precision sensitive and disables compression to FP16 of the subgraph before this input.
...
.. ref-code-block:: cpp
	...
	class PrecisionSensitive: public :ref:`ov::RuntimeAttribute<doxid-classov_1_1_runtime_attribute>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1_precision_sensitive_1a9bbcb5d7b385ad7d81bb2d6edf3072f5>`("precision_sensitive", "0");
		virtual bool :target:`is_copyable<doxid-classov_1_1_precision_sensitive_1af6d297c6b75632ac7d2a5aa7aea6693f>`() const;
	};
