.. index:: pair: class; ov::op::v0::FakeQuantize
.. _doxid-classov_1_1op_1_1v0_1_1_fake_quantize:
...
Class performing element-wise linear quantization. :ref:`More...<details-classov_1_1op_1_1v0_1_1_fake_quantize>`
...
.. ref-code-block:: cpp
	...
	class FakeQuantize: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a602832c3f31a671a9355d90a51dcdc24>`;

		// construction
	
		:target:`FakeQuantize<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a238c8d46cdc059b87655d65e72f555ec>`();
	
		:ref:`FakeQuantize<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1ac9dce5b5395e2c4cf2fa49adf71db285>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_low,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_high,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& output_low,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& output_high,
			std::size_t levels,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1ae54ae0ac4b4c4178f11a3e4510188819>`("FakeQuantize", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a9a32eb1240d53af2658e3146d971e34c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a61b608f92c820a48bf7b6ae18934d199>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a911e6c8d0433c0e804a567377b9b2ac1>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		std::size_t :target:`get_levels<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1abe5c836f7378427f89733a83a747eb9f>`() const;
		void :target:`set_levels<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a1e61c01ec2699da40a58ca6f8eae7391>`(std::size_t levels);
		const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& :target:`get_auto_broadcast<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1afef1aaccc8aee3c2eae4f2c9906c4e78>`() const;
		void :target:`set_auto_broadcast<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1ad230d02fd2e339404716c3b6a0abcbca>`(const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& auto_broadcast);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1ab09241c51ce0f175d865a98606328d7c>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1aa76bad46bee58a2fe690953745343c04>`() const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a1ffbe7371ed736672f8abb1700254b1d>`(
...
.. _details-classov_1_1op_1_1v0_1_1_fake_quantize:
...
:ref:`Input <doxid-classov_1_1_input>` floating point values are quantized into a discrete set of floating point values.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1ac9dce5b5395e2c4cf2fa49adf71db285:
.. index:: pair: function; FakeQuantize
...
Constructs a :ref:`FakeQuantize <doxid-classov_1_1op_1_1v0_1_1_fake_quantize>` operation node.
...
.. list-table::
	...
	*
		...
		- The maximum limit for input values.

	*
		- output_low

		- The minimum quantized value.

	*
		- output_high

		- The maximum quantized value.
	...
	*
		...
		- AutoBroadcast mode to be used for broadcasting limit values

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1a61b608f92c820a48bf7b6ae18934d199:
...
.. _doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1ab09241c51ce0f175d865a98606328d7c:
...
.. _doxid-classov_1_1op_1_1v0_1_1_fake_quantize_1aa76bad46bee58a2fe690953745343c04:
