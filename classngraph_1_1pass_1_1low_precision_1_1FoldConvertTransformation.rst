.. index:: pair: class; ngraph::pass::low_precision::FoldConvertTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation:
...
:ref:`FoldConvertTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation>` evaluates Convert operation on Subtract constant subgraph. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation>`
...
.. ref-code-block:: cpp
	...
	class FoldConvertTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`FoldConvertTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation_1aef30f5bb9999c264b31ebc3b7ed15f92>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation_1a537684a4b97861a8ccff1b863311465b>`("FoldConvertTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation_1aa1e3e758d4a03f42a83315bf40c3beae>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation_1ab0d040686adeeb4e004ad61ca5debd95>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation_1ab72057a54250723c2ea8eca810c08416>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`FoldConvertTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fold_convert_transformation>` evaluates Convert operation on Subtract constant subgraph.

For more details about the transformation, refer to :ref:`FoldConvertTransformation <doxid-openvino_docs__o_v__u_g_lpt__fold_convert_transformation>` page in the Inference Engine Developer Guide.
