.. index:: pair: class; ngraph::pass::HSwishFusionWithReluDiv
.. _doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_relu_div:
...
:ref:`HSwishFusion <doxid-classngraph_1_1pass_1_1_h_swish_fusion>` transformation replaces a sub-graph (x \* (min(Relu(x + 3), 6))) / 6 with a HSwish op.
...
.. ref-code-block:: cpp
	...
	class HSwishFusionWithReluDiv: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_relu_div_1ae2d7da73759681aa88bf0aa71721dbbe>`("HSwishFusionWithReluDiv", "0");
	};
