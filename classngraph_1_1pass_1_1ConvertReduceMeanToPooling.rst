.. index:: pair: class; ngraph::pass::ConvertReduceMeanToPooling
.. _doxid-classngraph_1_1pass_1_1_convert_reduce_mean_to_pooling:

class ngraph::pass::ConvertReduceMeanToPooling
==============================================
...
.. ref-code-block:: cpp
	...
	class ConvertReduceMeanToPooling: public :ref:`ConvertReduceBase<doxid-class_convert_reduce_base>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_reduce_mean_to_pooling_1ae8a10034a8b82b901a42a5cc00f4ead5>`("ConvertReduceMeanToPooling", "0");
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		template <class T>
		ngraph::matcher_pass_callback :ref:`convert_reduce_to_pooling<doxid-class_convert_reduce_base_1a8038b6478bf1b4fc7369543694407512>`();
