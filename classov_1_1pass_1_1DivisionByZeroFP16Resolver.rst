.. index:: pair: class; ov::pass::DivisionByZeroFP16Resolver
.. _doxid-classov_1_1pass_1_1_division_by_zero_f_p16_resolver:
...
: clamps eps into fp16 minimal normalized value in input_1/Maximum(input_2, eps); input_1/Add(input_2, eps); and input_1\*Pow(Maximum[Add](input_2, eps), -z) patterns to prevent division by zero. :ref:`More...<details-classov_1_1pass_1_1_division_by_zero_f_p16_resolver>`
...
.. ref-code-block:: cpp
	...
	class DivisionByZeroFP16Resolver: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_division_by_zero_f_p16_resolver_1a1291d1f531d16abbe1f0a89698758c7c>`("DivisionByZeroFP16Resolver", "0");
	};
...
.. _details-classov_1_1pass_1_1_division_by_zero_f_p16_resolver:
...
eps must be always nonzero to prevent from NaNs in such expressions if input_1 and input_2 simultaneously happened to be zero. We should keep in such patterns eps >= fp16 minimal normalized value so that :ref:`CompressFloatConstants <doxid-classov_1_1pass_1_1_compress_float_constants>` should not cast them into zero during compression into f16.
