.. index:: pair: class; ngraph::pass::ConvertOpSet1ToLegacy
.. _doxid-classngraph_1_1pass_1_1_convert_op_set1_to_legacy:

class ngraph::pass::ConvertOpSet1ToLegacy
=========================================
...
.. ref-code-block:: cpp
	...
	#include <convert_opset1_to_legacy.hpp>
	
	class ConvertOpSet1ToLegacy: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_op_set1_to_legacy_1a73b167795c8b4303bf0693cae5d39dcf>`("ConvertOpSet1ToLegacy", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_convert_op_set1_to_legacy_1a738b7b34ceadd846ceec2d5c2409a1ff>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
