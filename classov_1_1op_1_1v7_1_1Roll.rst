.. index:: pair: class; ov::op::v7::Roll
.. _doxid-classov_1_1op_1_1v7_1_1_roll:
...
:ref:`Tensor <doxid-classov_1_1_tensor>` roll operation. :ref:`More...<details-classov_1_1op_1_1v7_1_1_roll>`
...
.. ref-code-block:: cpp
	...
	class Roll: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v7_1_1_roll_1a81a6177cb18ab355f5b1ea246186065c>`;

		// construction
	
		:target:`Roll<doxid-classov_1_1op_1_1v7_1_1_roll_1a35c539866d03b8cf9882c7b778477a7d>`();
	
		:ref:`Roll<doxid-classov_1_1op_1_1v7_1_1_roll_1afa617f0c6ae95dd45fb853495da8e377>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& shift,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& axes
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v7_1_1_roll_1a7bb648c5e8e212c698253617f462b4e4>`("Roll", "opset7", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 7);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v7_1_1_roll_1a95651b8dff4d572dac8424e293ecfe51>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v7_1_1_roll_1aa20c0bd38ff599fb65dd1d250ef287cc>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v7_1_1_roll_1aa5257a1b0b5408e5de477b9bb3bdd735>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v7_1_1_roll:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Tensor <doxid-classov_1_1_tensor>` roll operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v7_1_1_roll_1afa617f0c6ae95dd45fb853495da8e377:
.. index:: pair: function; Roll
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor to be shifted.

	*
		- shift

		- :ref:`Node <doxid-classov_1_1_node>` producing the 0D or 1D tensor which specifies the number of places by which the elements are shifted.

	*
		- axes

		- :ref:`Node <doxid-classov_1_1_node>` producing the 0D or 1D tensor which specifies axes along which elements are shifted.

Methods
-------

.. _doxid-classov_1_1op_1_1v7_1_1_roll_1a95651b8dff4d572dac8424e293ecfe51:
