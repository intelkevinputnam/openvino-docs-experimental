.. index:: pair: class; ngraph::pass::DilatedConvolutionConverter
.. _doxid-classngraph_1_1pass_1_1_dilated_convolution_converter:
...
:ref:`DilatedConvolutionConverter <doxid-classngraph_1_1pass_1_1_dilated_convolution_converter>` transformation replaces following graph: SpaceToBatch -> Convolution -> BatchToSpace to a single Convolution node with updated pads and dilations Restrictions: :ref:`More...<details-classngraph_1_1pass_1_1_dilated_convolution_converter>`
...
.. ref-code-block:: cpp
	...
	class DilatedConvolutionConverter: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_dilated_convolution_converter_1a2ad8a4ce94ca375b35d105c5442f72e6>`("DilatedConvolutionConverter", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_dilated_convolution_converter:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`DilatedConvolutionConverter <doxid-classngraph_1_1pass_1_1_dilated_convolution_converter>` transformation replaces following graph: SpaceToBatch -> Convolution -> BatchToSpace to a single Convolution node with updated pads and dilations Restrictions:
