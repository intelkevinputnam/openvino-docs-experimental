.. index:: pair: class; ngraph::op::LSTMCellIE
.. _doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e:

class ngraph::op::LSTMCellIE
============================
...
.. ref-code-block:: cpp
	...
	class LSTMCellIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a8617fc7d0dadc1e11b53bdae9c0d1457>`;

		// construction
	
		:target:`LSTMCellIE<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a25bc1ef58fd01931032ea79344b252f0>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& C_t,
		...
		:target:`LSTMCellIE<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a36d49c54b2864c3f5798163690372491>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a53ebfd85284af9c36f45a5e626aa0ebc>`("LSTMCellIE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a22622d759e6b65f81586844760c63085>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a92adaf6c5b8db180827fece3238c25d3>`();
		std::size_t :target:`get_hidden_size<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1ad577498213fae78c392d7e46749243a6>`();
		const std::vector<std::string>& :target:`get_activations<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a3cb262b450012e4b06f9e601863b1bd1>`();
		const std::vector<float>& :target:`get_activations_alpha<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a6aed224bbf22348a32da2b47c25bb8e4>`();
		const std::vector<float>& :target:`get_activations_beta<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a8478366a463538e85800157d64355534>`();
		float :target:`get_clip<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a77edc09e90585617f2106eb99fe74e06>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a165fd3bf594c2c0bfacc1b3350fc8023>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_l_s_t_m_cell_i_e:
...
.. _doxid-classngraph_1_1op_1_1_l_s_t_m_cell_i_e_1a92adaf6c5b8db180827fece3238c25d3:
