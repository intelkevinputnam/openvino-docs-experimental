.. index:: pair: class; ov::op::util::DetectionOutputBase
.. _doxid-classov_1_1op_1_1util_1_1_detection_output_base:

class ov::op::util::DetectionOutputBase
=======================================

.. toctree::
	:hidden:

	AttributesBase <structov_1_1op_1_1util_1_1DetectionOutputBase_1_1AttributesBase.rst>

:ref:`DetectionOutputBase <doxid-classov_1_1op_1_1util_1_1_detection_output_base>` basic class for DetectionOutput :ref:`v0 <doxid-namespaceov_1_1op_1_1v0>` and :ref:`v8 <doxid-namespaceov_1_1op_1_1v8>`.
...
.. ref-code-block:: cpp
	...
	class DetectionOutputBase: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// structs
		...
		:target:`DetectionOutputBase<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1aced7c8e226c1e686c87d96d2216d0f98>`();
		:target:`DetectionOutputBase<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1a8c81f34262007b3db91da288d2fea2aa>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& args);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1ad97a5eb4e6d0fff91dea3cd9237fa176>`("DetectionOutputBase", "util");
		void :target:`validate_base<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1ac6cc378ce1dde9a9096c8cbc955f1645>`(const :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`& attrs);
		bool :target:`visit_attributes_base<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1a8147970e59cccbe71ff988f0c9913234>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor, :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`& attrs);
		:ref:`Dimension<doxid-classov_1_1_dimension>` :target:`compute_num_classes<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1af5d77cd19842ebe68de5ec3d3c737d51>`(const :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`& attrs);
	};

	// direct descendants

	class :ref:`DetectionOutput<doxid-classov_1_1op_1_1v0_1_1_detection_output>`;
