.. index:: pair: class; ov::op::v0::Squeeze
.. _doxid-classov_1_1op_1_1v0_1_1_squeeze:
...
:ref:`Squeeze <doxid-classov_1_1op_1_1v0_1_1_squeeze>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_squeeze>`
...
.. ref-code-block:: cpp
	...
	class Squeeze: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a045bf178013e868689c23400f9c7f0c8>`;

		// construction
	
		:target:`Squeeze<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a41fad19b442e7d7e7c8f55580f605182>`();
		:target:`Squeeze<doxid-classov_1_1op_1_1v0_1_1_squeeze_1adbc1f4ce7db24633fa25608ad5b5bfb4>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& axes);
		:target:`Squeeze<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a856e4637abab14a7c8a656f4139eef9c>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_squeeze_1abad16b0e6916e4e3b721c93e0b69de8e>`("Squeeze", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a9beb367c0485c9485c5bb7fa64471ee6>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a47c51c59fb45e2c44de6df988c0b5e44>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a8a858fdf9548672b9b2d3c47007a7dbb>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a4b230d8e4b890338a3da8a1f0a5078ab>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v0_1_1_squeeze_1ab75e734f93beacc24fd193ebbb8cfa3f>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a932f9326ff8522e1dc35dc891258c239>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a0a0e1f028bfc2232678263aced6a660e>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a35574228e44875f4cf3c1d70d7dcb502>`(
		...
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a122f365cb92ec02826d7b4b92b3e5d8a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`is_dynamic<doxid-classov_1_1op_1_1v0_1_1_squeeze_1a3b962bc9c29b696635860bb52cfb0b5b>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_squeeze:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Squeeze <doxid-classov_1_1op_1_1v0_1_1_squeeze>` operation.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_squeeze_1a47c51c59fb45e2c44de6df988c0b5e44:
...
.. _doxid-classov_1_1op_1_1v0_1_1_squeeze_1a8a858fdf9548672b9b2d3c47007a7dbb:
...
.. _doxid-classov_1_1op_1_1v0_1_1_squeeze_1a4b230d8e4b890338a3da8a1f0a5078ab:
