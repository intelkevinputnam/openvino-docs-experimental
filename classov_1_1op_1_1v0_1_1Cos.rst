.. index:: pair: class; ov::op::v0::Cos
.. _doxid-classov_1_1op_1_1v0_1_1_cos:
...
Elementwise cosine operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_cos>`
...
.. ref-code-block:: cpp
	...
	class Cos: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_cos_1a10590a4fb70b65db27f59543b164f29f>`;

		// construction
	
		:ref:`Cos<doxid-classov_1_1op_1_1v0_1_1_cos_1a81077021006507a80f3b0fd329c29814>`();
		:ref:`Cos<doxid-classov_1_1op_1_1v0_1_1_cos_1ab499340d5ff1889123c05558332884d0>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_cos_1a4d4856da5499d1dc1c53eb914a4cffd4>`("Cos", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_cos_1a957b0a0599d32459d48ffcc58f931ec7>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_cos_1aa728f6dbc6c036530d4218596dac57a6>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_cos_1a2f2e599b3a38a8275bd5c6be1120681e>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_cos_1a3d981a9a1908e9a169b680a3dbd9652b>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_cos:
...
.. _doxid-classov_1_1op_1_1v0_1_1_cos_1a81077021006507a80f3b0fd329c29814:
...
.. _doxid-classov_1_1op_1_1v0_1_1_cos_1ab499340d5ff1889123c05558332884d0:
.. index:: pair: function; Cos

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Cos(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_cos_1a2f2e599b3a38a8275bd5c6be1120681e:
...
.. _doxid-classov_1_1op_1_1v0_1_1_cos_1a3d981a9a1908e9a169b680a3dbd9652b:
