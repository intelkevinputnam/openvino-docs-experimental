.. index:: pair: class; ov::op::v8::If
.. _doxid-classov_1_1op_1_1v8_1_1_if:
...
.. toctree::
	...
	BodyIndexes <enumov_1_1op_1_1v8_1_1If_1_1BodyIndexes.rst>

Overview
~~~~~~~~

:ref:`If <doxid-classov_1_1op_1_1v8_1_1_if>` operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_if>`
...
.. ref-code-block:: cpp
	...
	class If: public :ref:`ov::op::util::MultiSubGraphOp<doxid-classov_1_1op_1_1util_1_1_multi_sub_graph_op>`
	{
	public:
		// enums
	
		enum :ref:`BodyIndexes<doxid-classov_1_1op_1_1v8_1_1_if_1a90c18a99ebaafa5b808918a8c2c7d963>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_if_1ab77636afd05a63d2e8fcb980abd034e6>`;

		// construction
	
		:ref:`If<doxid-classov_1_1op_1_1v8_1_1_if_1a75ae15bd8f3cfd06b035424303159a64>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& execution_condition);
		:target:`If<doxid-classov_1_1op_1_1v8_1_1_if_1ab16fce121da3f6de97fe7b3eaabdaf5a>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_if_1ae465accb2e2bae05a33455a4fea4398b>`("If", "opset8", :ref:`util::MultiSubGraphOp<doxid-classov_1_1op_1_1util_1_1_multi_sub_graph_op>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_if_1af7fb6826400fe7716c8646f84605c74c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_if_1a89ae59660c54a29fded2460d74486092>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& :ref:`get_then_body<doxid-classov_1_1op_1_1v8_1_1_if_1a34a3d8b73a5c779e18b8621e348c6ccd>`() const;
		const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& :ref:`get_else_body<doxid-classov_1_1op_1_1v8_1_1_if_1ab684a2a3162609fbedf2831ea348e3ac>`() const;
		void :ref:`set_then_body<doxid-classov_1_1op_1_1v8_1_1_if_1a58f4083d33229403d7ebfb18d5b5023c>`(const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& body);
		void :ref:`set_else_body<doxid-classov_1_1op_1_1v8_1_1_if_1a76b08529dc71b6f892fd094f021abddf>`(const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& body);
	
		void :ref:`set_input<doxid-classov_1_1op_1_1v8_1_1_if_1a40b9fa6eb6788234004652b71fbdde17>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& value,
			const std::shared_ptr<:ref:`v0::Parameter<doxid-classov_1_1op_1_1v0_1_1_parameter>`>& then_parameter,
			const std::shared_ptr<:ref:`v0::Parameter<doxid-classov_1_1op_1_1v0_1_1_parameter>`>& else_parameter
			);
	
		:ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`> :ref:`set_output<doxid-classov_1_1op_1_1v8_1_1_if_1a02887ef13a0a469facac5a0e3d110903>`(
			const std::shared_ptr<:ref:`v0::Result<doxid-classov_1_1op_1_1v0_1_1_result>`>& then_result,
			const std::shared_ptr<:ref:`v0::Result<doxid-classov_1_1op_1_1v0_1_1_result>`>& else_result
			);
	
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_if_1a1d1839e020b5588405784acf95e59c93>`();
	};
...
.. _details-classov_1_1op_1_1v8_1_1_if:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`If <doxid-classov_1_1op_1_1v8_1_1_if>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_if_1a75ae15bd8f3cfd06b035424303159a64:
.. index:: pair: function; If

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	If(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& execution_condition)

Constructs :ref:`If <doxid-classov_1_1op_1_1v8_1_1_if>` with condition.
...
.. _doxid-classov_1_1op_1_1v8_1_1_if_1a34a3d8b73a5c779e18b8621e348c6ccd:
.. index:: pair: function; get_then_body

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& get_then_body() const

gets then_body as :ref:`ov::Model <doxid-classov_1_1_model>`.



.. rubric:: Returns:

then_body as :ref:`ov::Model <doxid-classov_1_1_model>`.

.. _doxid-classov_1_1op_1_1v8_1_1_if_1ab684a2a3162609fbedf2831ea348e3ac:
.. index:: pair: function; get_else_body

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& get_else_body() const

gets else_body as :ref:`ov::Model <doxid-classov_1_1_model>`.



.. rubric:: Returns:

else_body as :ref:`ov::Model <doxid-classov_1_1_model>`.

.. _doxid-classov_1_1op_1_1v8_1_1_if_1a58f4083d33229403d7ebfb18d5b5023c:
.. index:: pair: function; set_then_body

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void set_then_body(const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& body)

sets new :ref:`ov::Model <doxid-classov_1_1_model>` as new then_body.
...
.. _doxid-classov_1_1op_1_1v8_1_1_if_1a76b08529dc71b6f892fd094f021abddf:
.. index:: pair: function; set_else_body

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void set_else_body(const std::shared_ptr<:ref:`Model<doxid-classov_1_1_model>`>& body)

sets new :ref:`ov::Model <doxid-classov_1_1_model>` as new else_body.
...
.. _doxid-classov_1_1op_1_1v8_1_1_if_1a40b9fa6eb6788234004652b71fbdde17:
.. index:: pair: function; set_input
...
.. _doxid-classov_1_1op_1_1v8_1_1_if_1a02887ef13a0a469facac5a0e3d110903:
.. index:: pair: function; set_output

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`> set_output(
		const std::shared_ptr<:ref:`v0::Result<doxid-classov_1_1op_1_1v0_1_1_result>`>& then_result,
		const std::shared_ptr<:ref:`v0::Result<doxid-classov_1_1op_1_1v0_1_1_result>`>& else_result
		)
...
.. _doxid-classov_1_1op_1_1v8_1_1_if_1a1d1839e020b5588405784acf95e59c93:
