.. index:: pair: interface; ngraph::snippets::op::Nop
.. _doxid-classngraph_1_1snippets_1_1op_1_1_nop:

interface ngraph::snippets::op::Nop
===================================



Generated by Canonicalization and represents not-an-operation.
...
.. ref-code-block:: cpp
	...
	template Nop: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
		// construction
	
		:target:`Nop<doxid-classngraph_1_1snippets_1_1op_1_1_nop_1ad97cc305b8b58645569283e3ad2ffc2e>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& arguments, const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& results);
		:target:`Nop<doxid-classngraph_1_1snippets_1_1op_1_1_nop_1a68131526d47dbc90ebd1b24c1d371203>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_nop_1a8957d87ce8c7dc957aa0f3a5b33b4ac2>`("Nop", "SnippetsOpset");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_nop_1a83c223070be76dad74b1e7971ed7d113>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& inputs) const;
	};
