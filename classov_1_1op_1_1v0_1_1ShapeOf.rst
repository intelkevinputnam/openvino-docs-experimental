.. index:: pair: class; ov::op::v0::ShapeOf
.. _doxid-classov_1_1op_1_1v0_1_1_shape_of:
...
Operation that returns the shape of its input argument as a tensor. :ref:`More...<details-classov_1_1op_1_1v0_1_1_shape_of>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a8fdad2c1850afea5d0284073f52ef02a>`;

		// construction
	
		:target:`ShapeOf<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a7159940b04a4b9854318f88e57a3e7ac>`();
		:ref:`ShapeOf<doxid-classov_1_1op_1_1v0_1_1_shape_of_1abf68596c4bca80c359cfb238ce08bb8c>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_shape_of_1ae9ce204468d889a70f592c374bcd8153>`("ShapeOf", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a74181452fcf26d2848d72e4b139b5757>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a00947932831506510f03278801726545>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_shape_of_1ae45aace2b23b6ad51a87544f76dd8d93>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a3267d2a6fdf0287c28f96c119ada3671>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_shape_of_1afbd88f554b41c38de4fe863de085e192>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a85646c3a40dd6b460b9e477e46bec0ef>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v0_1_1_shape_of_1aa8230f9aac398db458203ab5fc27fb45>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v0_1_1_shape_of_1a861d8ef2396f700290ed926078333e62>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v0_1_1_shape_of_1aac3baea55a14873bd5ae95ae7e652d79>`(
...
.. _details-classov_1_1op_1_1v0_1_1_shape_of:
...
.. _doxid-classov_1_1op_1_1v0_1_1_shape_of_1abf68596c4bca80c359cfb238ce08bb8c:
.. index:: pair: function; ShapeOf

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	ShapeOf(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_shape_of_1ae45aace2b23b6ad51a87544f76dd8d93:
...
.. _doxid-classov_1_1op_1_1v0_1_1_shape_of_1a3267d2a6fdf0287c28f96c119ada3671:
...
.. _doxid-classov_1_1op_1_1v0_1_1_shape_of_1afbd88f554b41c38de4fe863de085e192:
