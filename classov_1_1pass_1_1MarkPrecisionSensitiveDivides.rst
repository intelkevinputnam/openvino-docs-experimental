.. index:: pair: class; ov::pass::MarkPrecisionSensitiveDivides
.. _doxid-classov_1_1pass_1_1_mark_precision_sensitive_divides:
...
:ref:`MarkPrecisionSensitiveDivides <doxid-classov_1_1pass_1_1_mark_precision_sensitive_divides>` transformation marks the Divide fp16 layers inside the subgraph starting from precision-sensitive input and ending at the ShapeOf node as disabled for ConvertDivide transformation.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <mark_precision_sensitive_divides.hpp>
	
	class MarkPrecisionSensitiveDivides: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_mark_precision_sensitive_divides_1a4a0d9e33e8c7ee4dce7e808d223769df>`("MarkPrecisionSensitiveDivides", "0");
		virtual bool :target:`run_on_model<doxid-classov_1_1pass_1_1_mark_precision_sensitive_divides_1a2d59a6bebb600a82997cbca9ab11cb5f>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>& m);
	};
