.. index:: pair: class; ov::op::v1::Broadcast
.. _doxid-classov_1_1op_1_1v1_1_1_broadcast:
...
Operation which "adds" axes to an input tensor, replicating elements from the input as needed along the new axes. :ref:`More...<details-classov_1_1op_1_1v1_1_1_broadcast>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a02274ae139d01c8c63ec3ccc639bc47b>`;

		// construction
	
		:ref:`Broadcast<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a7cfa1b0f5bca47b0ab1e8009557c366b>`();
	
		:ref:`Broadcast<doxid-classov_1_1op_1_1v1_1_1_broadcast_1ab08a5a15eed3ccf4397efea967b160a0>`(
			...
			const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& broadcast_spec = :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`()
			);
	
		:ref:`Broadcast<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a40dd45512d8c6774103d62c966995ffb>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& target_shape,
			const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& broadcast_spec = :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`(:ref:`AutoBroadcastType::NUMPY<doxid-namespaceov_1_1op_1a8712da46ddf6f14ef5a6f46a82219acead677ba7339dd3c0243cd3257b80be8f5>`)
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_broadcast_1aa9cd78f3bda402c96dfd3457255900ad>`("Broadcast", "opset1", :ref:`op::util::BroadcastBase<doxid-classov_1_1op_1_1util_1_1_broadcast_base>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a4e1b60ecbfc30b48acb0fd5d497b53a1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_broadcast_1ad3b0f7287cb83dfe0c8030b6ed5e23e9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& :ref:`get_broadcast_spec<doxid-classov_1_1op_1_1v1_1_1_broadcast_1ad8b5c7842d8fa2ef428e5d6c37e11cc2>`() const;
		void :target:`set_broadcast_spec<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a9ce32fbc9ca52970f832141dd34f0560>`(const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& broadcast_spec);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_broadcast_1ad950bc38a17c204f4f70eb71b0da799c>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a54742e6e725b0acd59ad3c20e560b84d>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_broadcast_1a6c60838c475f67cbfd17b30d6f5599a8>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_broadcast:
...
.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1a7cfa1b0f5bca47b0ab1e8009557c366b:
...
.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1ab08a5a15eed3ccf4397efea967b160a0:
.. index:: pair: function; Broadcast
...
.. list-table::
	...
	*
		...
		- The axis positions (0-based) in the result that correspond to input axes. 'Arg' tensor is broadcast along the remaining axes. E.g., :ref:`Input <doxid-classov_1_1_input>` :ref:`Shape <doxid-classov_1_1_shape>` - [3, 4], Target :ref:`Shape <doxid-classov_1_1_shape>` - [3, 5, 4, 4] axes_mapping - [0, 2] => :ref:`Broadcast <doxid-classov_1_1op_1_1v1_1_1_broadcast>` along axes 1 and 3. axes_mapping - [0, 3] => :ref:`Broadcast <doxid-classov_1_1op_1_1v1_1_1_broadcast>` along axes 1 and 2.

	*
		- broadcast_spec

		- :ref:`Broadcast <doxid-classov_1_1op_1_1v1_1_1_broadcast>` specification to use for determining broadcast axes. 'axes_mapping' is ignored if broadcast_spec is not NONE

.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1a40dd45512d8c6774103d62c966995ffb:
.. index:: pair: function; Broadcast
...
.. list-table::
	...
	*
		...
		- :ref:`Broadcast <doxid-classov_1_1op_1_1v1_1_1_broadcast>` specification to use for determining broadcast axes

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1ad8b5c7842d8fa2ef428e5d6c37e11cc2:
.. index:: pair: function; get_broadcast_spec

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& get_broadcast_spec() const



.. rubric:: Returns:

:ref:`Broadcast <doxid-classov_1_1op_1_1v1_1_1_broadcast>` Specification.

.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1ad950bc38a17c204f4f70eb71b0da799c:
...
.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1a54742e6e725b0acd59ad3c20e560b84d:
...
.. _doxid-classov_1_1op_1_1v1_1_1_broadcast_1a6c60838c475f67cbfd17b30d6f5599a8:
