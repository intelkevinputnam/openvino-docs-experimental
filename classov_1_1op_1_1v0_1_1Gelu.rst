.. index:: pair: class; ov::op::v0::Gelu
.. _doxid-classov_1_1op_1_1v0_1_1_gelu:
...
Gaussian Error Linear Unit f(x) = 0.5 \* x \* (1 + erf( x / sqrt(2) ) :ref:`More...<details-classov_1_1op_1_1v0_1_1_gelu>`
...
.. ref-code-block:: cpp
	...
	class Gelu: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_gelu_1a3cd794d90c69b306d0b9cfcef90934fc>`;

		// construction
	
		:target:`Gelu<doxid-classov_1_1op_1_1v0_1_1_gelu_1aee17e9d37bfd1b3784667ee6240ef6f2>`();
		:ref:`Gelu<doxid-classov_1_1op_1_1v0_1_1_gelu_1a5c6ba27cd3cdf0ceecc9c6b6a0a974c7>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_gelu_1a363f59142dffbebb3eb3b6abb1620ac5>`("Gelu", "opset2", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 0);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_gelu_1a0c874fa2fa59888b67a26c476e05c705>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_gelu_1a3d68320a02e5b0a73ca023ad0ec82d2a>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_gelu_1a6fad08b37d44854dc511629c29f02e2c>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_gelu:
...
.. _doxid-classov_1_1op_1_1v0_1_1_gelu_1a5c6ba27cd3cdf0ceecc9c6b6a0a974c7:
.. index:: pair: function; Gelu

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Gelu(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data)

Constructs a :ref:`Gelu <doxid-classov_1_1op_1_1v0_1_1_gelu>` operation.
...
.. _doxid-classov_1_1op_1_1v0_1_1_gelu_1a3d68320a02e5b0a73ca023ad0ec82d2a:
