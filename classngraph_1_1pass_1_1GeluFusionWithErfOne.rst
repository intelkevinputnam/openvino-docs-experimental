.. index:: pair: class; ngraph::pass::GeluFusionWithErfOne
.. _doxid-classngraph_1_1pass_1_1_gelu_fusion_with_erf_one:
...
:ref:`GeluFusion <doxid-classngraph_1_1pass_1_1_gelu_fusion>` transformation replaces a sub-graph (0.5 \* x) \* (1 + erf(x / sqrt(2))) with a Gelu op.
...
.. ref-code-block:: cpp
	...
	class GeluFusionWithErfOne: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_gelu_fusion_with_erf_one_1aeb0f7cbe7e2f83ab392c70ae7b5d40c9>`("GeluFusionWithErfOne", "0");
	};
