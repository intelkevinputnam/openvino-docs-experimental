.. index:: pair: class; ngraph::pass::low_precision::ReduceMaxTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation:
...
:ref:`ReduceMaxTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation>` propagates dequantization operations through ReduceMax operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation>`
...
.. ref-code-block:: cpp
	...
	class ReduceMaxTransformation: public :ref:`ngraph::pass::low_precision::ReduceBaseTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_base_transformation>`
	{
	public:
		// construction
	
		:target:`ReduceMaxTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation_1a40ecd5efda75fcc41b6edad28f4631a0>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation_1a4a2f6d34e2558df0843415abbd8dd0be>`("ReduceMaxTransformation", "0");
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation_1ad1ddd91f1649f69a00661e1abbbf929a>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> reduce) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation_1a5cec5521e8d21453650b3aaed522a21b>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReduceMaxTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reduce_max_transformation>` propagates dequantization operations through ReduceMax operation.

For more details about the transformation, refer to :ref:`ReduceMaxTransformation <doxid-openvino_docs__o_v__u_g_lpt__reduce_max_transformation>` page in the Inference Engine Developer Guide.
