.. index:: pair: class; ngraph::op::FullyConnected
.. _doxid-classngraph_1_1op_1_1_fully_connected:

class ngraph::op::FullyConnected
================================
...
Operator performing Matrix Multiplication. :ref:`More...<details-classngraph_1_1op_1_1_fully_connected>`
...
.. ref-code-block:: cpp
	...
	class FullyConnected: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_fully_connected_1ae061564341180352888ca1e8d0af2a4f>`;

		// construction
	
		:target:`FullyConnected<doxid-classngraph_1_1op_1_1_fully_connected_1a66e2048fe82880853ab39d5c378d516b>`();
	
		:ref:`FullyConnected<doxid-classngraph_1_1op_1_1_fully_connected_1ab623009e951d8dc8e5777898a6d02808>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& C,
			const :ref:`Shape<doxid-classov_1_1_shape>`& output_shape,
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type = element::undefined
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_fully_connected_1ae6a157075d0e32173c071ec60b266bf6>`("FullyConnected", "legacy");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_fully_connected_1acdda640d02bfe63b5fde8b51dcd0229f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_fully_connected_1ab36065a81a0e8cfb737a44d041622ddd>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_fully_connected_1a9342976678d5032261871c6fe10fa72b>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		size_t :target:`get_out_size<doxid-classngraph_1_1op_1_1_fully_connected_1a8e3b214e0e4fcaefb869137acc791210>`() const;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_output_type<doxid-classngraph_1_1op_1_1_fully_connected_1a2dcdda76f9761cda342c7c7c673f5669>`() const;
	};
...
.. _details-classngraph_1_1op_1_1_fully_connected:
...
.. _doxid-classngraph_1_1op_1_1_fully_connected_1ab623009e951d8dc8e5777898a6d02808:
.. index:: pair: function; FullyConnected
...
Constructs an :ref:`FullyConnected <doxid-classngraph_1_1op_1_1_fully_connected>` operation.
...
.. _doxid-classngraph_1_1op_1_1_fully_connected_1ab36065a81a0e8cfb737a44d041622ddd:
