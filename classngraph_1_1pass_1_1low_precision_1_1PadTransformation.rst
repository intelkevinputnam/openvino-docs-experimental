.. index:: pair: class; ngraph::pass::low_precision::PadTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation:
...
:ref:`PadTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation>` propagates dequantization operations through Pad operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation>`
...
.. ref-code-block:: cpp
	...
	class PadTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`PadTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation_1a74671d4b6fd06dae42fd537da57a8788>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation_1ad378aa077bbf50f6a9392b68ada532c3>`("PadTransformation", "0");
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation_1a8d58989576c5218a816342f2cd439254>`(:ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context, :ref:`pattern::Matcher<doxid-classov_1_1pass_1_1pattern_1_1_matcher>`& m);
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation_1a936bf685182f8c4b65a916498134a82c>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation_1a64e60cab60ee843546f505bde6c753d7>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`PadTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_pad_transformation>` propagates dequantization operations through Pad operation.

For more details about the transformation, refer to :ref:`PadTransformation <doxid-openvino_docs__o_v__u_g_lpt__pad_transformation>` page in the Inference Engine Developer Guide.
