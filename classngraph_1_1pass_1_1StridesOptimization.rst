.. index:: pair: class; ngraph::pass::StridesOptimization
.. _doxid-classngraph_1_1pass_1_1_strides_optimization:
...
:ref:`StridesOptimization <doxid-classngraph_1_1pass_1_1_strides_optimization>` transformation works backward on function and propagates strides up through the graph if possible.
...
.. ref-code-block:: cpp
	...
	class StridesOptimization: public :ref:`ov::pass::BackwardGraphRewrite<doxid-classov_1_1pass_1_1_backward_graph_rewrite>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_strides_optimization_1a85cf7e76dc07b55edcb022324051cd1c>`("StridesOptimization", "0");
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		:ref:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_backward_graph_rewrite_1a677b0cec339c8af384a77b39f7e2de70>`("ov::pass::BackwardGraphRewrite");
		virtual bool :ref:`run_on_model<doxid-classov_1_1pass_1_1_backward_graph_rewrite_1a0166b72852531af8ba442b9d6a0c62c3>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>& m);
