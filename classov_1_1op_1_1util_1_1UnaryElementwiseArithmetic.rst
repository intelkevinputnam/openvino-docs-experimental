.. index:: pair: class; ov::op::util::UnaryElementwiseArithmetic
.. _doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic:
...
Abstract base class for elementwise unary arithmetic operations, i.e., operations where the same scalar arithmetic operation is applied to each element. :ref:`More...<details-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
...
.. ref-code-block:: cpp
	...
	class UnaryElementwiseArithmetic: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic_1a4d213ed93b1b06c2126e007afa86f883>`;

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic_1a6497b446e474121562be3126583d2a1a>`("UnaryElementwiseArithmetic", "util");
		...
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic_1a6b78dc2baa1616ab5cfaa87673738095>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};

	// direct descendants

	template :ref:`PowerStatic<doxid-classngraph_1_1snippets_1_1op_1_1_power_static>`;
	class :ref:`Abs<doxid-classov_1_1op_1_1v0_1_1_abs>`;
	class :ref:`Acos<doxid-classov_1_1op_1_1v0_1_1_acos>`;
	class :ref:`Asin<doxid-classov_1_1op_1_1v0_1_1_asin>`;
	class :ref:`Atan<doxid-classov_1_1op_1_1v0_1_1_atan>`;
	class :ref:`Ceiling<doxid-classov_1_1op_1_1v0_1_1_ceiling>`;
	class :ref:`Cos<doxid-classov_1_1op_1_1v0_1_1_cos>`;
	class :ref:`Cosh<doxid-classov_1_1op_1_1v0_1_1_cosh>`;
	class :ref:`Erf<doxid-classov_1_1op_1_1v0_1_1_erf>`;
	class :ref:`Exp<doxid-classov_1_1op_1_1v0_1_1_exp>`;
	class :ref:`Floor<doxid-classov_1_1op_1_1v0_1_1_floor>`;
	class :ref:`Log<doxid-classov_1_1op_1_1v0_1_1_log>`;
	class :ref:`Negative<doxid-classov_1_1op_1_1v0_1_1_negative>`;
	class :ref:`Relu<doxid-classov_1_1op_1_1v0_1_1_relu>`;
	class :ref:`Sigmoid<doxid-classov_1_1op_1_1v0_1_1_sigmoid>`;
	class :ref:`Sign<doxid-classov_1_1op_1_1v0_1_1_sign>`;
	class :ref:`Sin<doxid-classov_1_1op_1_1v0_1_1_sin>`;
	class :ref:`Sinh<doxid-classov_1_1op_1_1v0_1_1_sinh>`;
	class :ref:`Sqrt<doxid-classov_1_1op_1_1v0_1_1_sqrt>`;
	class :ref:`Tan<doxid-classov_1_1op_1_1v0_1_1_tan>`;
	class :ref:`Tanh<doxid-classov_1_1op_1_1v0_1_1_tanh>`;
	...
	class :ref:`HSigmoid<doxid-classov_1_1op_1_1v5_1_1_h_sigmoid>`;
...
.. _details-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic:
...
For example, if the underlying operation (determined by the subclass) is :math:`\mathit{op}(x)`, the input tensor :math:`[[x,y],[z,w]]` will be mapped to :math:`[[\mathit{op}(x),\mathit{op}(y)],[\mathit{op}(z),\mathit{op}(w)]]`.
...
.. list-table::
    ...
    * - ``arg``
      ...
      - A tensor of any shape. The element type :math:`N` may be any numeric type.
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`N[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \mathit{op}(\texttt{arg}[i_1,\dots,i_n])` . This will always have the same shape and element type as the input tensor.

Methods
-------

.. _doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic_1a63098a4ba71eea661e7a78e6f9d07664:
