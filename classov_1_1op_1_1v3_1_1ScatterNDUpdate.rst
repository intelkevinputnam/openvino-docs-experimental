.. index:: pair: class; ov::op::v3::ScatterNDUpdate
.. _doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update:
...
Add updates to slices from inputs addressed by indices. :ref:`More...<details-classov_1_1op_1_1v3_1_1_scatter_n_d_update>`
...
.. ref-code-block:: cpp
	...
	class ScatterNDUpdate: public :ref:`ov::op::util::ScatterNDBase<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a325aa3b1fdd7cb04de796e64ef006b9f>`;

		// construction
	
		:target:`ScatterNDUpdate<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a6e57dd461ec1abfca56a5d26f2f41f9b>`();
	
		:ref:`ScatterNDUpdate<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a5d9825ea3a32d8670f87e84399b83bde>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& inputs,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& updates
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a223de2a278aa339cc5a6d7605268ea45>`("ScatterNDUpdate", "opset4", :ref:`util::ScatterNDBase<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base>`, 3);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a246d95a67e54121a544f7707e9a70c9d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a3fe77e9aca6b3e23d089292b738b931c>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a0378a3a4fde0fc2ff5329602c2e4ee87>`() const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1a04edbeb4312bf96f676f0cbb4218c9d8>`;
		static constexpr int :ref:`INPUTS<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1a3bc99c829779d6cc6c71de2194127fa4>` = 0;
		static constexpr int :ref:`INDICES<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1a63148fc588d034f6fef7ec1cb1f85ef0>` = 1;
		static constexpr int :ref:`UPDATES<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1ad474ad932572c336cbe9ffad48a63eaa>` = 2;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1a772627db47f10096bd45928d666f9a9c>`("ScatterNDBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1a680079223c5c072299dc93501e54c8bd>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_scatter_n_d_base_1ae2bfeb9a45c92a769586394878ec90d9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v3_1_1_scatter_n_d_update:
...
.. _doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a5d9825ea3a32d8670f87e84399b83bde:
.. index:: pair: function; ScatterNDUpdate
...
.. list-table::
	...
	*
		...
		- :ref:`Tensor <doxid-classov_1_1_tensor>`

	*
		- indices

		- Index tensor: Data type must be ``:ref:`element::i32 <doxid-group__ov__element__cpp__api_1ga53dd97bfbd724cee3266cc80d758f323>``` or ``:ref:`element::i64 <doxid-group__ov__element__cpp__api_1ga6c86a9a54d44fc205ad9cbf28ca556a6>```

	*
		- updates

		- :ref:`Tensor <doxid-classov_1_1_tensor>` : Must have same type as inputs

Methods
-------

.. _doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a3fe77e9aca6b3e23d089292b738b931c:
...
.. _doxid-classov_1_1op_1_1v3_1_1_scatter_n_d_update_1a0378a3a4fde0fc2ff5329602c2e4ee87:
