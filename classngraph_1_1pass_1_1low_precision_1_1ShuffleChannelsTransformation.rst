.. index:: pair: class; ngraph::pass::low_precision::ShuffleChannelsTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation:
...
:ref:`ShuffleChannelsTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation>` propagates dequantization operations through ShuffleChannels operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation>`
...
.. ref-code-block:: cpp
	...
	class ShuffleChannelsTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`ShuffleChannelsTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation_1a98d7d8cd96bb1155ca9bf4ece9575995>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation_1a2509366fec5c6334625fdaf54a5cf7c7>`("ShuffleChannelsTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation_1a4ad482c56661134752478ee434eb3e13>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation_1a369ffaba21002c9adf5547a9b7dead2a>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation_1aad0bd418b410241406f0082aec9ce958>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ShuffleChannelsTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_shuffle_channels_transformation>` propagates dequantization operations through ShuffleChannels operation.

For more details about the transformation, refer to :ref:`ShuffleChannelsTransformation <doxid-openvino_docs__o_v__u_g_lpt__shuffle_channels_transformation>` page in the Inference Engine Developer Guide.
