.. index:: pair: class; ngraph::pass::HSigmoidFusionWithReluDiv
.. _doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_relu_div:
...
:ref:`HSigmoidFusion <doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion>` transformation replaces a sub-graph ((min(Relu(x + 3), 6)) / 6) with a HSigmoid op.
...
.. ref-code-block:: cpp
	...
	class HSigmoidFusionWithReluDiv: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_relu_div_1af7ce5ee2c2bac50f9cad38e26e2d75e7>`("HSigmoidFusionWithReluDiv", "0");
	};
