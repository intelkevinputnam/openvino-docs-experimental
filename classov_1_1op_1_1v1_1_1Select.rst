.. index:: pair: class; ov::op::v1::Select
.. _doxid-classov_1_1op_1_1v1_1_1_select:
...
Elementwise selection operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_select>`
...
.. ref-code-block:: cpp
	...
	class Select: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_select_1a3a05da808ae4f3b4f6b72e44df373ac4>`;

		// construction
	
		:ref:`Select<doxid-classov_1_1op_1_1v1_1_1_select_1a83f05c73d11953bcb946d55ecc2c8121>`();
	
		:ref:`Select<doxid-classov_1_1op_1_1v1_1_1_select_1af3c4b6c8134389486da19bafe4016327>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg2,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_select_1a2e95d0b492b989e2b4d769b87969eb95>`("Select", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_select_1af4ea84e8083a95f7d4e487412c34bf72>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_select_1ae0cc7563c5a489795cab491a74d91203>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_select_1a1ad9ec72968a597e17cb6da3b61eabee>`();
		const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& :target:`get_auto_broadcast<doxid-classov_1_1op_1_1v1_1_1_select_1a8b47979bb8a7fe395ac082cf697ae386>`() const;
		void :target:`set_auto_broadcast<doxid-classov_1_1op_1_1v1_1_1_select_1a66e7bd801c9faa188fcb766ec6638e8d>`(const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& auto_broadcast);
		virtual const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& :ref:`get_autob<doxid-classov_1_1op_1_1v1_1_1_select_1ad4782ff4bc538b72326db7e961d63e97>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_select_1a85a0be7abbf595d5237008054c9dfc9a>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_select_1a2e4815639844b5845c7faeec6c60ddd5>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_select:
...
.. list-table::
    ...
    * - 
      ...
      - Description
    * - ``arg0``
      - :math:`\texttt{bool}[d_1,\dots,d_n]~(n \geq 0)`
      - A tensor of any shape, with element ``bool`` .
    * - ``arg1``
      - :math:`E[d_1,\dots,d_n]~(n \geq 0)`
    ...
    * - ``auto_broadcast``
      - :ref:`AutoBroadcastSpec <doxid-structov_1_1op_1_1_auto_broadcast_spec>`
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`E[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \texttt{arg1}[i_1,\dots,i_n]\text{ if }\texttt{arg0}[i_1,\dots,i_n] \neq 0\text{, else }\texttt{arg2}[i_1,\dots,i_n]`

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_select_1a83f05c73d11953bcb946d55ecc2c8121:
...
.. _doxid-classov_1_1op_1_1v1_1_1_select_1af3c4b6c8134389486da19bafe4016327:
.. index:: pair: function; Select
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` that produces the third input tensor.

	*
		- auto_broadcast

		- Auto broadcast specification. Default is Numpy-style implicit broadcasting.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_select_1a1ad9ec72968a597e17cb6da3b61eabee:
...
.. _doxid-classov_1_1op_1_1v1_1_1_select_1ad4782ff4bc538b72326db7e961d63e97:
.. index:: pair: function; get_autob

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& get_autob() const
...
.. _doxid-classov_1_1op_1_1v1_1_1_select_1a85a0be7abbf595d5237008054c9dfc9a:
...
.. _doxid-classov_1_1op_1_1v1_1_1_select_1a2e4815639844b5845c7faeec6c60ddd5:
