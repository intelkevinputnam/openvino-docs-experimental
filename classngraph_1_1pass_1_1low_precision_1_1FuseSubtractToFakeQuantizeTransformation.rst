.. index:: pair: class; ngraph::pass::low_precision::FuseSubtractToFakeQuantizeTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation:
...
:ref:`FuseSubtractToFakeQuantizeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation>` fuses Subtract operation to FakeQuantize. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation>`
...
.. ref-code-block:: cpp
	...
	class FuseSubtractToFakeQuantizeTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`FuseSubtractToFakeQuantizeTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation_1aed52a0a84146caf4bc11661377c2b585>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation_1a1d01bcf8ce4b0698fcbb5f9e2b852b8f>`("FuseSubtractToFakeQuantizeTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation_1ab7ab4059941c35725acca83e2beeb9e3>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation_1a96ea0e4715ec97027cc19399b7b1089d>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation_1a429fec2616afc9b4d45db5c9aef5d052>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`FuseSubtractToFakeQuantizeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_subtract_to_fake_quantize_transformation>` fuses Subtract operation to FakeQuantize.

For more details about the transformation, refer to :ref:`FuseSubtractToFakeQuantizeTransformation <doxid-openvino_docs__o_v__u_g_lpt__fuse_subtract_to_fake_quantize_transformation>` page in the Inference Engine Developer Guide.
