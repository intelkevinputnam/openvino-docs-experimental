.. index:: pair: class; ov::op::v4::Swish
.. _doxid-classov_1_1op_1_1v4_1_1_swish:
...
A :ref:`Swish <doxid-classov_1_1op_1_1v4_1_1_swish>` Activation Function f(x) = x / (1.0 + exp(-beta \* x)) or f(x) = x \* sigmoid(beta \* x) :ref:`More...<details-classov_1_1op_1_1v4_1_1_swish>`
...
.. ref-code-block:: cpp
	...
	class Swish: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_swish_1a8c4a267be79df1ab2bcaf4a8a5cb420d>`;

		// construction
	
		:target:`Swish<doxid-classov_1_1op_1_1v4_1_1_swish_1ab082b0c3312ade7d3d1039fffd6ec354>`();
		:ref:`Swish<doxid-classov_1_1op_1_1v4_1_1_swish_1a80e4e715492978576a90756253264af5>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& beta);
		:target:`Swish<doxid-classov_1_1op_1_1v4_1_1_swish_1a312a2b488c1d098789a4c11ced05a3a7>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_swish_1a6ed19b31dbb34c9fad5b593bd43f6679>`("Swish", "opset4", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 4);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v4_1_1_swish_1a408789bbb1e503a214cbe1d158c03bcd>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v4_1_1_swish_1adb7af70a897b9e7a35bffe62abc940b5>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_swish_1a37ff9f2f67e438fa8da4d711003d5752>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v4_1_1_swish_1a4e26302fe106747153c20898104e52fe>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v4_1_1_swish_1a321e818ccfbd12f4c6e695f8aeeaf53e>`() const;
	};
...
.. _details-classov_1_1op_1_1v4_1_1_swish:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

A :ref:`Swish <doxid-classov_1_1op_1_1v4_1_1_swish>` Activation Function f(x) = x / (1.0 + exp(-beta \* x)) or f(x) = x \* sigmoid(beta \* x)

Construction
------------

.. _doxid-classov_1_1op_1_1v4_1_1_swish_1a80e4e715492978576a90756253264af5:
.. index:: pair: function; Swish

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Swish(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& beta)

Constructs an :ref:`Swish <doxid-classov_1_1op_1_1v4_1_1_swish>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` tensor

	*
		- beta

		- Scalar with beta value. If the argument is not specified then use the default value 1.0

Methods
-------

.. _doxid-classov_1_1op_1_1v4_1_1_swish_1adb7af70a897b9e7a35bffe62abc940b5:
...
.. _doxid-classov_1_1op_1_1v4_1_1_swish_1a4e26302fe106747153c20898104e52fe:
...
.. _doxid-classov_1_1op_1_1v4_1_1_swish_1a321e818ccfbd12f4c6e695f8aeeaf53e:
