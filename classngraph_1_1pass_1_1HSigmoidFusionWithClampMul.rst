.. index:: pair: class; ngraph::pass::HSigmoidFusionWithClampMul
.. _doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_clamp_mul:
...
:ref:`HSigmoidFusion <doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion>` transformation replaces a sub-graph (Clamp(x + 3, 0, 6) \* const(1/6)) with a HSigmoid op.
...
.. ref-code-block:: cpp
	...
	class HSigmoidFusionWithClampMul: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_clamp_mul_1a8ffcd165f686581f3bc4dca6a7556d4f>`("HSigmoidFusionWithClampMul", "0");
	};
