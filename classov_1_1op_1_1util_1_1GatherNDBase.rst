.. index:: pair: class; ov::op::util::GatherNDBase
.. _doxid-classov_1_1op_1_1util_1_1_gather_n_d_base:
...
:ref:`GatherNDBase <doxid-classov_1_1op_1_1util_1_1_gather_n_d_base>` basic class for GatherND :ref:`v5 <doxid-namespaceov_1_1op_1_1v5>` and :ref:`v8 <doxid-namespaceov_1_1op_1_1v8>`. :ref:`More...<details-classov_1_1op_1_1util_1_1_gather_n_d_base>`
...
.. ref-code-block:: cpp
	...
	class GatherNDBase: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a9ca460c5bff5bbb0cbb1c5acc63da868>`;

		// construction
	
		:target:`GatherNDBase<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a8a0041dbde83ba85d1925fb469df8358>`();
	
		:ref:`GatherNDBase<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1af2cba5c568cdef269c569a88a632d4e7>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a3d6afe4836fdfcc95606665791a7f0d0>`("GatherNDBase", "util");
		size_t :target:`get_batch_dims<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1ac38bb7ee9ef410672705899c1c093cf7>`() const;
		void :target:`validate_inputs_and_infer_shape<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1ac587c3827d0a162b5ad6a6823722170f>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1a3cc75e314cc554b455ba718edadf29c9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};

	// direct descendants

	class :ref:`GatherND<doxid-classov_1_1op_1_1v5_1_1_gather_n_d>`;
...
.. _details-classov_1_1op_1_1util_1_1_gather_n_d_base:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`GatherNDBase <doxid-classov_1_1op_1_1util_1_1_gather_n_d_base>` basic class for GatherND :ref:`v5 <doxid-namespaceov_1_1op_1_1v5>` and :ref:`v8 <doxid-namespaceov_1_1op_1_1v8>`.

Construction
------------

.. _doxid-classov_1_1op_1_1util_1_1_gather_n_d_base_1af2cba5c568cdef269c569a88a632d4e7:
.. index:: pair: function; GatherNDBase
...
.. list-table::
	...
	*
		...
		- Specifies a leading number of dimensions representing the batches
