.. index:: pair: class; ngraph::pass::low_precision::TransparentBaseTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation:
...
:ref:`TransparentBaseTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation>` is base type for precision preserved operation transformation.
...
.. ref-code-block:: cpp
	...
	class TransparentBaseTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`TransparentBaseTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1a8e9bb79e156b3bc8158a7a6e0d166fd6>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params);

		// methods
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1a24337ef218d2b131044f6bc31963c010>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1aaa6a526f978db199bda48f3a47d51eb5>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1a1a8bbc92aeb03f8e4b003599c924f5f4>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
