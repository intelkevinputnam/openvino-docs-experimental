.. index:: pair: interface; ngraph::snippets::op::ScalarLoad
.. _doxid-classngraph_1_1snippets_1_1op_1_1_scalar_load:

interface ngraph::snippets::op::ScalarLoad
==========================================



Generated by Canonicalization for a scalar value load to vector register.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <scalarload.hpp>
	
	template ScalarLoad: public :ref:`ngraph::snippets::op::Load<doxid-classngraph_1_1snippets_1_1op_1_1_load>`
	{
		// construction
	
		:target:`ScalarLoad<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_load_1afc704b8f45f97fc92fe7cd9f6e9fd366>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& x);
		:target:`ScalarLoad<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_load_1ad05943b7a2b789a5768535622e1975ee>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_load_1ad69c3d7e09703321d60d1775c46676be>`("ScalarLoad", "SnippetsOpset", :ref:`ngraph::snippets::op::Load<doxid-classngraph_1_1snippets_1_1op_1_1_load>`);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_load_1a7bf7353838a4af7cc7b2562292eaccd9>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
