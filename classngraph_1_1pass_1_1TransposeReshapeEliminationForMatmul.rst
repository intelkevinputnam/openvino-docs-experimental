.. index:: pair: class; ngraph::pass::TransposeReshapeEliminationForMatmul
.. _doxid-classngraph_1_1pass_1_1_transpose_reshape_elimination_for_matmul:
...
:ref:`TransposeReshapeEliminationForMatmul <doxid-classngraph_1_1pass_1_1_transpose_reshape_elimination_for_matmul>` transformation eliminates Transpose and Reshape which were created to align input and output dimension ranks before second MatMul input and after MatMul output (for example, after Einsum Decomposition inside TensorFlow 1 and nGraph :ref:`EinsumDecomposition <doxid-classngraph_1_1pass_1_1_einsum_decomposition>` transformation)
...
.. ref-code-block:: cpp
	...
	class TransposeReshapeEliminationForMatmul: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_transpose_reshape_elimination_for_matmul_1ad51ad5da0f5bd427854df141ca0f9509>`("TransposeReshapeEliminationForMatmul", "0");
	};
