.. index:: pair: class; ov::op::util::RNNCellBase
.. _doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base:
...
Base class for all recurrent network cells. :ref:`More...<details-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
...
.. ref-code-block:: cpp
	...
	class RNNCellBase: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a1133e0e5d98ff40b8a8df52256391799>`;

		// construction
	
		:ref:`RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a86138516c7688ef5d8f1f8496e8c430a>`(
		...
		:target:`RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a6875ed3f0f7f0fc5d98066bc21d37086>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1af3a6343457f700d13ad6a4761905cb97>`("RNNCellBase", "util");
		...
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1abde73dec85f8954166a05e2fa08bba7e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::size_t :target:`get_hidden_size<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1aa10c893d3fe5a27217c8482ab09dda51>`() const;
		float :target:`get_clip<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a6ac99482e831b9edc8054a86e65b1a77>`() const;
		const std::vector<std::string>& :target:`get_activations<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a01ef87a8543c46102fc00a31c992e94d>`() const;
		const std::vector<float>& :target:`get_activations_alpha<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a060d3f94bf2df0643259af616881318b>`() const;
		const std::vector<float>& :target:`get_activations_beta<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1aed0963dca55f0c129a3fd7add4703fba>`() const;
	};
	...
	class :ref:`LSTMCell<doxid-classov_1_1op_1_1v0_1_1_l_s_t_m_cell>`;
	class :ref:`RNNCell<doxid-classov_1_1op_1_1v0_1_1_r_n_n_cell>`;
	class :ref:`GRUCell<doxid-classov_1_1op_1_1v3_1_1_g_r_u_cell>`;
	class :ref:`LSTMCell<doxid-classov_1_1op_1_1v4_1_1_l_s_t_m_cell>`;
	class :ref:`GRUSequence<doxid-classov_1_1op_1_1v5_1_1_g_r_u_sequence>`;
	class :ref:`LSTMSequence<doxid-classov_1_1op_1_1v5_1_1_l_s_t_m_sequence>`;
	class :ref:`RNNSequence<doxid-classov_1_1op_1_1v5_1_1_r_n_n_sequence>`;
...
.. _details-classov_1_1op_1_1util_1_1_r_n_n_cell_base:
...
.. _doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1a86138516c7688ef5d8f1f8496e8c430a:
.. index:: pair: function; RNNCellBase
...
Constructs a :ref:`RNNCellBase <doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>` class.
...
.. _doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base_1ac65584e9f97021b27cd3490810647fd6:
.. index:: pair: function; validate_input_rank_dimension

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void validate_input_rank_dimension(const std::vector<:ref:`PartialShape<doxid-classov_1_1_partial_shape>`>& input)
