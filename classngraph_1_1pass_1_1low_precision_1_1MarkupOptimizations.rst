.. index:: pair: class; ngraph::pass::low_precision::MarkupOptimizations
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_optimizations:

class ngraph::pass::low_precision::MarkupOptimizations
======================================================
...
.. ref-code-block:: cpp
	...
	class MarkupOptimizations: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// construction
	
		:target:`MarkupOptimizations<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_optimizations_1a39edd865ae182e046447b1d8cecc7d70>`(
		...
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_optimizations_1a1743c52f9a18468f83e824925b159421>`("MarkupOptimizations", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_optimizations_1a7fdd691ffeedf45e9e8bead62d1145f2>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
