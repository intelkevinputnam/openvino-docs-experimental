.. index:: pair: class; ngraph::pass::low_precision::MultiplyToGroupConvolutionTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation:
...
:ref:`MultiplyToGroupConvolutionTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation>` replace quantized Multiply operations to GroupConvolution to speed up inference. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation>`
...
.. ref-code-block:: cpp
	...
	class MultiplyToGroupConvolutionTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`MultiplyToGroupConvolutionTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a83923ab9cb742cd09d4466d31bd5ec7c>`(
			...
			const :ref:`PrecisionsRestriction::PrecisionsByPort<doxid-classngraph_1_1pass_1_1low__precision_1_1_precisions_restriction_1a69e177ca8f1f5c74962c20d6b92c6608>`& restrictions = {}
			);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1ab1e5961207347f7072eeaed44aea842c>`("MultiplyToGroupConvolutionTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a35ed32e4ee83fc8ede4c397d931b1f11>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a9b3b288f724a9a845153bd5d1b7e6f1e>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a06af51bf5127e9af8934dc814f671ad7>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`isQuantized<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1af0cbcf645d15c04b6012f882661dbcc0>`(
		...
		void :target:`setGroupSize<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a870019139ce868fb07b96ed88cb66fe7>`(const size_t groupSize);
		size_t :target:`getGroupSize<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1adcedcb7bf4739d40cf0898932887f5ec>`() const;
		static bool :target:`canBeTransformedToGroupConvolution<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a0a5b80d6d2721ab4dac0714fa31367ec>`(const std::shared_ptr<const :ref:`Node<doxid-classov_1_1_node>`>& layer);
		static bool :target:`isDynamicOrScalar<doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation_1a1d72f3597ecdad823d4eba0570c479cd>`(const std::shared_ptr<const :ref:`Node<doxid-classov_1_1_node>`>& node);
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`MultiplyToGroupConvolutionTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_multiply_to_group_convolution_transformation>` replace quantized Multiply operations to GroupConvolution to speed up inference.

For more details about the transformation, refer to :ref:`MultiplyToGroupConvolutionTransformation <doxid-openvino_docs__o_v__u_g_lpt__multiply_to_group_convolution_transformation>` page in the Inference Engine Developer Guide.
