.. index:: pair: class; InferenceEngine::ConcatLayer
.. _doxid-class_inference_engine_1_1_concat_layer:
...
This class represents concatenation layer. :ref:`More...<details-class_inference_engine_1_1_concat_layer>`
...
.. ref-code-block:: cpp
	...
	class ConcatLayer: public :ref:`InferenceEngine::CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`
	{
	public:
		// fields
	
		unsigned int :ref:`_axis<doxid-class_inference_engine_1_1_concat_layer_1affb573a899b3d20b883c04099933ad07>` = 1;

		// methods
	
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_concat_layer_1a49576b4ff390822c0aa474cf7f542724>`(const :ref:`LayerParams<doxid-struct_inference_engine_1_1_layer_params>`& prms);
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_concat_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa>`(const :ref:`CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`& other);
	};
...
.. _details-class_inference_engine_1_1_concat_layer:
...
.. _doxid-class_inference_engine_1_1_concat_layer_1affb573a899b3d20b883c04099933ad07:
.. index:: pair: variable; _axis
...
.. _doxid-class_inference_engine_1_1_concat_layer_1a49576b4ff390822c0aa474cf7f542724:
...
Creates a new :ref:`ConcatLayer <doxid-class_inference_engine_1_1_concat_layer>` instance and initializes layer parameters with the given values.

If batch is used, then batch needs to be specified as an input dimension also In current implementation 1 means channels, 0 - batch

.. _doxid-class_inference_engine_1_1_concat_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa:
.. index:: pair: function; CNNLayer
