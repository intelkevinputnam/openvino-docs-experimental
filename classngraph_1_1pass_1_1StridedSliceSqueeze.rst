.. index:: pair: class; ngraph::pass::StridedSliceSqueeze
.. _doxid-classngraph_1_1pass_1_1_strided_slice_squeeze:
...
:ref:`StridedSliceSqueeze <doxid-classngraph_1_1pass_1_1_strided_slice_squeeze>` transformation looks for SS -> Squeeze and corrects SS inputs and attributes for SS output to be squeeze-able.
...
.. ref-code-block:: cpp
	...
	class StridedSliceSqueeze: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_strided_slice_squeeze_1aaaa8d9508665d4ecc02abf888b6eb5f5>`("StridedSliceSqueeze", "0");
	};
