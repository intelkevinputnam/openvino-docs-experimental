.. index:: pair: class; ov::op::v1::FloorMod
.. _doxid-classov_1_1op_1_1v1_1_1_floor_mod:
...
Elementwise :ref:`FloorMod <doxid-classov_1_1op_1_1v1_1_1_floor_mod>` operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_floor_mod>`
...
.. ref-code-block:: cpp
	...
	class FloorMod: public :ref:`ov::op::util::BinaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1aef208be9a778e14c618ecb6523b29617>`;

		// construction
	
		:ref:`FloorMod<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a8703da87036728decf751dabfe243dd2>`();
	
		:ref:`FloorMod<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1ad63b35e65bbb6c136ff293c8a56f27af>`(
			...
			const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& auto_broadcast = :ref:`AutoBroadcastType::NUMPY<doxid-namespaceov_1_1op_1a8712da46ddf6f14ef5a6f46a82219acead677ba7339dd3c0243cd3257b80be8f5>`
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a279cf08299e21c45ce2f12d1a982a46b>`("FloorMod", "opset1", :ref:`op::util::BinaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_arithmetic>`, 1);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a06686cc4f9752084210b08789e01c999>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a52be5eb94910b2b965151aaddba8455b>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a0a8c374e06e75c278f8ecb386e44dbe4>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a5ed5c7e6e42c7b56404da6cd0135a704>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_floor_mod:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Elementwise :ref:`FloorMod <doxid-classov_1_1op_1_1v1_1_1_floor_mod>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a8703da87036728decf751dabfe243dd2:
.. index:: pair: function; FloorMod
...
.. _doxid-classov_1_1op_1_1v1_1_1_floor_mod_1ad63b35e65bbb6c136ff293c8a56f27af:
.. index:: pair: function; FloorMod
...
Constructs an Floor :ref:`Mod <doxid-classov_1_1op_1_1v1_1_1_mod>` operation.
...
.. list-table::
	...
	*
		...
		- 
		  :ref:`Output <doxid-classov_1_1_output>` that produces the first input tensor.
	...
	*
		...
		- 
		  :ref:`Output <doxid-classov_1_1_output>` that produces the second input tensor.
...
.. _doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a0a8c374e06e75c278f8ecb386e44dbe4:
...
.. _doxid-classov_1_1op_1_1v1_1_1_floor_mod_1a5ed5c7e6e42c7b56404da6cd0135a704:
