.. index:: pair: class; ov::pass::DisableConstantFolding
.. _doxid-classov_1_1pass_1_1_disable_constant_folding:

class ov::pass::DisableConstantFolding
======================================
...
.. ref-code-block:: cpp
	...
	class DisableConstantFolding: public :ref:`ov::RuntimeAttribute<doxid-classov_1_1_runtime_attribute>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_disable_constant_folding_1a1162ef26ae81052d3eceb12c2ca59c7a>`("DisableConstantFolding");
		virtual bool :target:`is_copyable<doxid-classov_1_1pass_1_1_disable_constant_folding_1a9a624bb4b53106bd5bb81a5174b7eaa0>`() const;
	};
