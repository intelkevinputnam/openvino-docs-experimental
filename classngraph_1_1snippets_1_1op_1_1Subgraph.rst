.. index:: pair: interface; ngraph::snippets::op::Subgraph
.. _doxid-classngraph_1_1snippets_1_1op_1_1_subgraph:
...
An operation that is implemented by a model. :ref:`More...<details-classngraph_1_1snippets_1_1op_1_1_subgraph>`
...
.. ref-code-block:: cpp
	...
	template Subgraph: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
		// typedefs
	
		typedef std::tuple<:ref:`ngraph::Shape<doxid-classov_1_1_shape>`, :ref:`ngraph::AxisVector<doxid-classov_1_1_axis_vector>`, :ref:`ngraph::element::Type<doxid-classov_1_1element_1_1_type>`> :target:`BlockedShape<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a7e97415e53465bb9cc47301198a87bb3>`;
		typedef std::vector<:ref:`BlockedShape<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a7e97415e53465bb9cc47301198a87bb3>`> :target:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`;

		// construction
	
		:target:`Subgraph<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a2b4a614c82681898b0489e15fcbeb485>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& args, std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`> body);
		:target:`Subgraph<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1aab2bd08299dfe1a2a723a5fd0d8ab78c>`(const :ref:`NodeVector<doxid-classngraph_1a7b4a05064df831b05909c6535f6874c5>`& args, std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`> body);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1adab1654ccbe46e22e4c04fb3db0bbff7>`("Subgraph", "SnippetsOpset");
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a6d0b173fc87582d808c1f641d496193b>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a094c8c74111ae57430796e06afd16bb1>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a8bb90f67aa215a2016345a15c4a35da7>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& inputs) const;
		std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`> :target:`get_body<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1aa4a406181124dad67b41d7aae3920f72>`() const;
		std::shared_ptr<:ref:`ngraph::snippets::Generator<doxid-classngraph_1_1snippets_1_1_generator>`> :target:`get_generator<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1adb4add21b2e0885f5c9d26ce26e4b73b>`() const;
	
		:ref:`snippets::Schedule<doxid-classngraph_1_1snippets_1_1_schedule>` :target:`generate<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a475015d42eac6d7295a812c1d9fa590c>`(
			const :ref:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`& output_shapes,
			const :ref:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`& input_shapes,
			:ref:`ngraph::pass::Manager<doxid-classov_1_1pass_1_1_manager>`& opt,
			const void \* compile_params = nullptr
			);
	
		:ref:`snippets::Schedule<doxid-classngraph_1_1snippets_1_1_schedule>` :target:`generate<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1abc11fbcab4dcad734da9b18548b09369>`(
			const :ref:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`& output_shapes,
			const :ref:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`& input_shapes,
			const void \* compile_params = nullptr
			);
	
		:ref:`snippets::Schedule<doxid-classngraph_1_1snippets_1_1_schedule>` :target:`generate<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a0be5edc4dd844b829192b24e75d4f8cf>`(
			:ref:`ngraph::pass::Manager<doxid-classov_1_1pass_1_1_manager>`& opt,
			const void \* compile_params = nullptr
			);
	
		:ref:`snippets::Schedule<doxid-classngraph_1_1snippets_1_1_schedule>` :target:`generate<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1ad66d25e9da9dce88e72db5aa93d8f639>`(const void \* compile_params = nullptr);
	
		:ref:`Shape<doxid-classov_1_1_shape>` :target:`canonicalize<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a402cfe9ee1656f934121ee0227df130c>`(
			const :ref:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`& output_shapes,
			const :ref:`BlockedShapeVector<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a217cd5be88991e7d82bffd96fdb94879>`& input_shapes
			);
	
		void :target:`set_generator<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a91e2cbfed4cf1674a1bb6bd5bc839453>`(std::shared_ptr<:ref:`ngraph::snippets::Generator<doxid-classngraph_1_1snippets_1_1_generator>`> generator);
		void :target:`print<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a3b6cb2d403a950524d4324858c5cb6be>`() const;
		void :target:`print_statistics<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1ad9e0253343b67e7a5e099ecc366cd1ef>`(bool verbose);
		void :target:`serialize<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a5441d12d6968040ce22c0de5e585a1c6>`() const;
		static auto :target:`wrap_node_as_subgraph<doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1ae3a01b702cf6708da5584390fe1cf53c>`(const std::shared_ptr<:ref:`ngraph::Node<doxid-classov_1_1_node>`>& node);
	};
...
.. _details-classngraph_1_1snippets_1_1op_1_1_subgraph:
...
.. _doxid-classngraph_1_1snippets_1_1op_1_1_subgraph_1a094c8c74111ae57430796e06afd16bb1:
