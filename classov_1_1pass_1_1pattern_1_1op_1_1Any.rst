.. index:: pair: class; ov::pass::pattern::op::Any
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any:
...
The graph value is to the matched value list. :ref:`More...<details-classov_1_1pass_1_1pattern_1_1op_1_1_any>`
...
.. ref-code-block:: cpp
	...
	class Any: public :ref:`ov::pass::pattern::op::Pattern<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_pattern>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1aad8d88f14e464bfcdf206fb126fb2458>`;

		// construction
	
		:ref:`Any<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1a641bb0e3b43f4ed7280fe7c27ed42bbc>`(
		...
		:target:`Any<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1a507d3fb85b24087fd9efa6c8d56aa840>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
			const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& s,
		...
		:ref:`Any<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1abc44252f091901d60f7ae4694c09c659>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& node,
			:ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>` pred,
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& wrapped_values
			);
	
		:target:`Any<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1a5a22f6e006002eb49d56ec1ffc4d12f4>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& node,
			:ref:`NodePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a773344323e39ff5d3e25bc79c06dac5d>` pred,
			const :ref:`NodeVector<doxid-namespaceov_1a750141ccb27d75af03e91a5295645c7f>`& wrapped_values
			);
		...
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1abc48bb7ab5a1b91cdfeb5ec5ae2d5eec>`("patternAny");
	
		virtual bool :target:`match_value<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1a2da2cd048da8df1d60c7fcc60178e3d0>`(
...
.. _details-classov_1_1pass_1_1pattern_1_1op_1_1_any:
...
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1a641bb0e3b43f4ed7280fe7c27ed42bbc:
...
creates a :ref:`Any <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any>` node containing a sub-pattern described by
...
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any_1abc44252f091901d60f7ae4694c09c659:
.. index:: pair: function; Any
...
creates a :ref:`Any <doxid-classov_1_1pass_1_1pattern_1_1op_1_1_any>` node containing a sub-pattern described by the type and shape of
