.. index:: pair: class; ov::op::v0::ROIPooling
.. _doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling:
...
:ref:`ROIPooling <doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_r_o_i_pooling>`
...
.. ref-code-block:: cpp
	...
	class ROIPooling: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a4c4ba6c57b09aaa3e1a4c1813f55a254>`;

		// construction
	
		:target:`ROIPooling<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1ad063a810f9f54601128d1a22c03353b8>`();
	
		:ref:`ROIPooling<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1affb75dd32725392e6a56813aac123dee>`(
			...
			const :ref:`Shape<doxid-classov_1_1_shape>`& output_size,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a89525f834866062c9fe5ea89b0be387d>`("ROIPooling", "opset2");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a6367675e1da78e8d05c5da060716e9e0>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a358108af2aad5e7c31ff9fe955a5112a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Shape<doxid-classov_1_1_shape>`& :target:`get_output_size<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a79bc7706adfd9456d507603c4e497077>`() const;
		float :target:`get_spatial_scale<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1abb377230bda865c664bd3be931c83560>`() const;
		const std::string& :target:`get_method<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a672cd34de216af6e5edbb0217cb3f1b7>`() const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a6033b08729207e7f3c64ddaf7e302efe>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classov_1_1op_1_1v0_1_1_r_o_i_pooling:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ROIPooling <doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1affb75dd32725392e6a56813aac123dee:
.. index:: pair: function; ROIPooling
...
Constructs a :ref:`ROIPooling <doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling>` operation.
...
.. list-table::
	...
	*
		...
		- Height/Width of ROI output features
	...
	*
		...
		- Method of pooling - Max or Bilinear

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_r_o_i_pooling_1a6367675e1da78e8d05c5da060716e9e0:
