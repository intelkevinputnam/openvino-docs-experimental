.. index:: pair: class; ov::op::v3::EmbeddingSegmentsSum
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum:
...
Returns embeddings for given indices. :ref:`More...<details-classov_1_1op_1_1v3_1_1_embedding_segments_sum>`
...
.. ref-code-block:: cpp
	...
	class EmbeddingSegmentsSum: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1ac0605a3ce2a0b2d4bbd59cb2ee18cf72>`;

		// construction
	
		:ref:`EmbeddingSegmentsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a1395951b164f88080e38468651394465>`();
	
		:ref:`EmbeddingSegmentsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a26e1a4e5dda6751cac7fc2d83cf10ff3>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& segment_ids,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_segments,
		...
		:target:`EmbeddingSegmentsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a152f75f6fe6b79828930e2c6df4f2d1b>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& emb_table,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& segment_ids,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_segments,
		...
		:target:`EmbeddingSegmentsSum<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a7537c777a570425c5010dc342279a00c>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& emb_table,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& segment_ids,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_segments
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1ab4bf65f2e48b23f9317b658b1ce1b3d1>`("EmbeddingSegmentsSum", "opset3", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 3);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a168871ad272f2b9897e1640414b439eb>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a64a8ee30499089661a58fc3049e6fd0a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a150dfa73e460590faa9d3ab3a4b04b1d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`&);
	};
...
.. _details-classov_1_1op_1_1v3_1_1_embedding_segments_sum:
...
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a1395951b164f88080e38468651394465:
.. index:: pair: function; EmbeddingSegmentsSum
...
Constructs a :ref:`EmbeddingSegmentsSum <doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum>` operation.

.. _doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a26e1a4e5dda6751cac7fc2d83cf10ff3:
.. index:: pair: function; EmbeddingSegmentsSum
...
:ref:`EmbeddingSegmentsSum <doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum>` constructs an output tensor by replacing every index in a given input tensor with a row (from the weights matrix) at that index
...
.. list-table::
	...
	*
		...
		- tensor of shape ``[num_indices]`` and of type *T_IND* with indices into the output :ref:`Tensor <doxid-classov_1_1_tensor>`. Values should be sorted and can be repeated. Required.

	*
		- <tt>num_segments</tt>

		- scalar of type *T_IND* indicating the number of segments. Required.
...
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_segments_sum_1a168871ad272f2b9897e1640414b439eb:
