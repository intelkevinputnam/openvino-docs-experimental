.. index:: pair: class; ngraph::pass::HSigmoidFusionWithReluMul
.. _doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_relu_mul:
...
:ref:`HSigmoidFusion <doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion>` transformation replaces a sub-graph ((min(Relu(x + 3), 6)) \* const(1/6)) with a HSigmoid op.
...
.. ref-code-block:: cpp
	...
	class HSigmoidFusionWithReluMul: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_relu_mul_1a1ee2621c4e3a5298de3fd39492890dbb>`("HSigmoidFusionWithReluMul", "0");
	};
