.. index:: pair: class; ngraph::pass::low_precision::FakeQuantizeTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation:
...
:ref:`FakeQuantizeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation>` fuses dequantization operations into FakeQuantize operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation>`
...
.. ref-code-block:: cpp
	...
	class FakeQuantizeTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`FakeQuantizeTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation_1a34f44b733a8486aaac6a80f3ff62064c>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation_1a540f5f677e4febe39c54d4e3170bcd32>`("FakeQuantizeTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation_1a8023ff677259d6020e58f515f7581dc6>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation_1a85722f8bec868d7ad897dee07dc0222c>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
		static bool :target:`checkElementwise<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation_1a94f97f6a36e528410bdfe6108a405a72>`(const std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`>& eltwise);
	
		static std::shared_ptr<opset1::FakeQuantize> :target:`fuseElementwise<doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation_1afbe4d849b99f8f00cbcaf47f7b9d6320>`(
			:ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context,
			:ref:`MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>` \* matcherPass,
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`FakeQuantizeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fake_quantize_transformation>` fuses dequantization operations into FakeQuantize operation.

For more details about the transformation, refer to :ref:`FakeQuantizeTransformation <doxid-openvino_docs__o_v__u_g_lpt__fake_quantize_transformation>` page in the Inference Engine Developer Guide.
