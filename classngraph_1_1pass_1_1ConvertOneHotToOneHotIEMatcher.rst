.. index:: pair: class; ngraph::pass::ConvertOneHotToOneHotIEMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_one_hot_to_one_hot_i_e_matcher:
...
.. ref-code-block:: cpp
	...
	#include <convert_one_hot_to_one_hot_ie.hpp>
	
	class ConvertOneHotToOneHotIEMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_one_hot_to_one_hot_i_e_matcher_1a242fd0c0bc3bf49efe0fa3bff02c3a11>`("ConvertOneHotToOneHotIEMatcher", "0");
		void :target:`detect_output_type<doxid-classngraph_1_1pass_1_1_convert_one_hot_to_one_hot_i_e_matcher_1abd79add723f3a4590b0986016f8cb7d2>`(const std::shared_ptr<:ref:`Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& f);
	};
