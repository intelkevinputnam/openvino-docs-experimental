.. index:: pair: class; ngraph::op::ReLUIE
.. _doxid-classngraph_1_1op_1_1_re_l_u_i_e:

class ngraph::op::ReLUIE
========================
...
.. ref-code-block:: cpp
	...
	class ReLUIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1aba4019951771a98bdc5b369e86c45fc4>`;

		// construction
	
		:target:`ReLUIE<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1a6d6731bb237b825032449709f7b18058>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1ab378b31e399bc900c307b97db32ebef8>`("ReLUIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1a3af2fa29a1a6e9e0a4695cad84d83c5d>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1a9c214c2cd55de55261fc91557a7c76f8>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1abf28abb191d0f1d11bf026b517b84e38>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		float :target:`get_slope<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1a0c1763ccd0e28c8158499b2a6aa3f994>`();
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :target:`get_output_type<doxid-classngraph_1_1op_1_1_re_l_u_i_e_1a064575b53db0e37fa50f20efdf7adc0f>`() const;
	};
...
.. _details-classngraph_1_1op_1_1_re_l_u_i_e:
...
.. _doxid-classngraph_1_1op_1_1_re_l_u_i_e_1a3af2fa29a1a6e9e0a4695cad84d83c5d:
