.. index:: pair: class; ov::op::v0::PriorBoxClustered
.. _doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered:
...
.. toctree::
	...
	Attributes <structov_1_1op_1_1v0_1_1PriorBoxClustered_1_1Attributes.rst>

Overview
~~~~~~~~

Layer which generates prior boxes of specified sizes normalized to input image size. :ref:`More...<details-classov_1_1op_1_1v0_1_1_prior_box_clustered>`
...
.. ref-code-block:: cpp
	...
	class PriorBoxClustered: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// structs
	
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_prior_box_clustered_1_1_attributes>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a01a4563c162aa4f1dfe67111cbe7d7ed>`;

		// construction
	
		:target:`PriorBoxClustered<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a32cb069c12027c94fa9eacb2667185fb>`();
	
		:ref:`PriorBoxClustered<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a764408fbe4d00b826880206ed404cd24>`(
			...
			const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_prior_box_clustered_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a5e08f69bfdd056294c62f77c078831b2>`("PriorBoxClustered", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a78de2c73698fb7ec96b363c5e3fc7d28>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1ab4fbfa06db3a7ab5663275e5e38319f7>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_prior_box_clustered_1_1_attributes>`& :target:`get_attrs<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a9269e9595dc0b0f5c0db4a608e31c671>`() const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1af1d28ccc46ed705f6f232ab8c7475191>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1aa3a24ac288fbef2e9bed0ae6c2658fbb>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a3de14e70ef7a50e3663d55d7c4e1f2cb>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_prior_box_clustered:
...
.. _doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a764408fbe4d00b826880206ed404cd24:
.. index:: pair: function; PriorBoxClustered
...
Constructs a :ref:`PriorBoxClustered <doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`PriorBoxClustered <doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered>` attributes

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a78de2c73698fb7ec96b363c5e3fc7d28:
...
.. _doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1aa3a24ac288fbef2e9bed0ae6c2658fbb:
...
.. _doxid-classov_1_1op_1_1v0_1_1_prior_box_clustered_1a3de14e70ef7a50e3663d55d7c4e1f2cb:
