.. index:: pair: class; ngraph::pass::SwishFusionWithBeta
.. _doxid-classngraph_1_1pass_1_1_swish_fusion_with_beta:
...
:ref:`SwishFusionWithSigmoid <doxid-classngraph_1_1pass_1_1_swish_fusion_with_sigmoid>` replaces a sub-graphs x / (1.0 + exp(-x \* beta)) with a Swish op.
...
.. ref-code-block:: cpp
	...
	class SwishFusionWithBeta: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_swish_fusion_with_beta_1aa742fa95c70cdee142a2090e5e1792c3>`("SwishFusionWithBeta", "0");
	};
