.. index:: pair: class; ov::op::v1::Equal
.. _doxid-classov_1_1op_1_1v1_1_1_equal:
...
Elementwise is-equal operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_equal>`
...
.. ref-code-block:: cpp
	...
	class Equal: public :ref:`ov::op::util::BinaryElementwiseComparison<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_equal_1a8895e8857ca457a6f77d62a7982f0bc0>`;

		// construction
	
		:ref:`Equal<doxid-classov_1_1op_1_1v1_1_1_equal_1a45818370a1f841ce04e291c0d192f65f>`();
	
		:ref:`Equal<doxid-classov_1_1op_1_1v1_1_1_equal_1a0bc26ae8996ec754069b452ba21d9407>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_equal_1a420e24f78b2b1f0af340aac7ac2ff24d>`("Equal", "opset1", :ref:`op::util::BinaryElementwiseComparison<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_equal_1afa2c3eecdc4f6624783872aecd429bee>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_equal_1aa630066abdc081d10b97963aae5945aa>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_equal_1a00b0518b03be6881c179d9d8bb9123f6>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_equal_1a4c9f85b50b9114cbc9731a1f28f12a64>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_equal:
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`\texttt{bool}[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = 1\text{ if }\texttt{arg0}[i_1,\dots,i_n] = \texttt{arg1}[i_1,\dots,i_n]\text{, else } 0`

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_equal_1a45818370a1f841ce04e291c0d192f65f:
.. index:: pair: function; Equal
...
.. _doxid-classov_1_1op_1_1v1_1_1_equal_1a0bc26ae8996ec754069b452ba21d9407:
.. index:: pair: function; Equal
...
.. _doxid-classov_1_1op_1_1v1_1_1_equal_1a00b0518b03be6881c179d9d8bb9123f6:
...
.. _doxid-classov_1_1op_1_1v1_1_1_equal_1a4c9f85b50b9114cbc9731a1f28f12a64:
