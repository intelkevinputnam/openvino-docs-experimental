.. index:: pair: class; ngraph::pass::low_precision::NormalizeL2Transformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation:
...
:ref:`NormalizeL2Transformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation>` propagates dequantization operations through NormalizeL2 operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation>`
...
.. ref-code-block:: cpp
	...
	class NormalizeL2Transformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`NormalizeL2Transformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation_1abf3d6144a9d836953a48bca70b484b4a>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation_1a9c9136c216c175932efd8dc661bea25a>`("NormalizeL2Transformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation_1ae09a267725105c75bbb7d84a11d5472b>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation_1a31ce669162b65a320c2598c6097e6ce2>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation_1acb444b8c40b816eefe1db487dbe6a8a9>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`NormalizeL2Transformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_normalize_l2_transformation>` propagates dequantization operations through NormalizeL2 operation.

For more details about the transformation, refer to :ref:`NormalizeL2Transformation <doxid-openvino_docs__o_v__u_g_lpt__normalize_l2_transformation>` page in the Inference Engine Developer Guide.
