.. index:: pair: class; ngraph::pass::low_precision::AvgPoolTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation:
...
:ref:`AvgPoolTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation>` propagates dequantization operations through AvgPool operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation>`
...
.. ref-code-block:: cpp
	...
	class AvgPoolTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`AvgPoolTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation_1a061074df068d6d915094ec8e41d32ed1>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation_1adc23c0b426fe6b1f917915ece3dccf22>`("AvgPoolTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation_1a06777b613417fffd2fa578c099db2ccb>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation_1aa37d4fed47aded9f8b109a02cf834d97>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation_1a216323e7edc9908d66d7c439b048854c>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`AvgPoolTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_avg_pool_transformation>` propagates dequantization operations through AvgPool operation.

For more details about the transformation, refer to :ref:`AvgPoolTransformation <doxid-openvino_docs__o_v__u_g_lpt__avg_pool_transformation>` page in the Inference Engine Developer Guide.
