.. index:: pair: class; ngraph::pass::HSwishFusionWithHSigmoid
.. _doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_h_sigmoid:
...
:ref:`HSwishFusion <doxid-classngraph_1_1pass_1_1_h_swish_fusion>` transformation replaces a sub-graph x \* HSigmoid(x) with a HSwish op.
...
.. ref-code-block:: cpp
	...
	class HSwishFusionWithHSigmoid: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_h_sigmoid_1a2b23d5f3699458f9126696665848f627>`("HSwishFusionWithHSigmoid", "0");
	};
