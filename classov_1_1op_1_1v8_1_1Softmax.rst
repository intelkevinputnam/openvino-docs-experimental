.. index:: pair: class; ov::op::v8::Softmax
.. _doxid-classov_1_1op_1_1v8_1_1_softmax:
...
:ref:`Softmax <doxid-classov_1_1op_1_1v8_1_1_softmax>` operation with negative axis values. :ref:`More...<details-classov_1_1op_1_1v8_1_1_softmax>`
...
.. ref-code-block:: cpp
	...
	class Softmax: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_softmax_1ac83c15cf02eeae31e0b404475487d391>`;

		// construction
	
		:target:`Softmax<doxid-classov_1_1op_1_1v8_1_1_softmax_1a74e6308d50c25b85feed8f36aade6352>`();
		:ref:`Softmax<doxid-classov_1_1op_1_1v8_1_1_softmax_1a766ded17731307fe1179bbdb326eaa43>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const int64_t axis = 1);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_softmax_1abbecb2ec1df61f31235e847bf82c1736>`("Softmax", "opset8");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_softmax_1af65c3bb4211c825e05b5fb647bae4e45>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_softmax_1a275b8ef91e4969d74e9332e693f37738>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_softmax_1a5f529974843ad762de52bfccf7c6d10d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const int64_t& :target:`get_axis<doxid-classov_1_1op_1_1v8_1_1_softmax_1a4bdfad2b8dbc28a43c658f53d8c8451f>`() const;
		void :target:`set_axis<doxid-classov_1_1op_1_1v8_1_1_softmax_1a8d52f3a8c1f2f7e69244a705eae8a423>`(const int64_t& axis);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v8_1_1_softmax_1a1ff013728f23d3fa9611e59be9d19aa2>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v8_1_1_softmax_1ac4e6802dab3b0c88a1ac875ff269544a>`() const;
	};
...
.. _details-classov_1_1op_1_1v8_1_1_softmax:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Softmax <doxid-classov_1_1op_1_1v8_1_1_softmax>` operation with negative axis values.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_softmax_1a766ded17731307fe1179bbdb326eaa43:
.. index:: pair: function; Softmax

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Softmax(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const int64_t axis = 1)
...
.. list-table::
	...
	*
		...
		- The axis position (0-based) in range [-rank(arg), rank(arg) - 1] on which to calculate the softmax.

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_softmax_1a275b8ef91e4969d74e9332e693f37738:
...
.. _doxid-classov_1_1op_1_1v8_1_1_softmax_1a1ff013728f23d3fa9611e59be9d19aa2:
...
.. _doxid-classov_1_1op_1_1v8_1_1_softmax_1ac4e6802dab3b0c88a1ac875ff269544a:
