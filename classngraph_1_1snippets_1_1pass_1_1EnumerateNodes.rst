.. index:: pair: interface; ngraph::snippets::pass::EnumerateNodes
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_enumerate_nodes:

interface ngraph::snippets::pass::EnumerateNodes
================================================



Snippets rely on topological order to avoid creating cyclic dependencies. This transformation sets the order.
...
.. ref-code-block:: cpp
	...
	template EnumerateNodes: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1snippets_1_1pass_1_1_enumerate_nodes_1a3055b232deeb0b0c94878d9fc7a4e293>`("EnumerateNodes", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1snippets_1_1pass_1_1_enumerate_nodes_1a5d11df5f78be71e7ebdacda2684b20d8>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>&);
	};
