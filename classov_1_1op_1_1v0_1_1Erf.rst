.. index:: pair: class; ov::op::v0::Erf
.. _doxid-classov_1_1op_1_1v0_1_1_erf:
...
Elementwise erf operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_erf>`
...
.. ref-code-block:: cpp
	...
	class Erf: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_erf_1a183b8f8ed02575204ee812b9a28d94c1>`;

		// construction
	
		:ref:`Erf<doxid-classov_1_1op_1_1v0_1_1_erf_1a8ebec2cf0ac4ab2dc343895587e26fff>`();
		:ref:`Erf<doxid-classov_1_1op_1_1v0_1_1_erf_1ae1ef83db65c174af208322b044adee32>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_erf_1a862a3fca52dfc75188d17bd73692b044>`("Erf", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_erf_1af88be22fd6e5aaf34c69fcb5f70602a7>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_erf_1a4094d043978faead0a46fc99885cc2b5>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_erf_1abf617adb0ca25fac056dd4106d9b282f>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_erf_1a361533e032072ff3344456e7899df95f>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_erf:
...
.. _doxid-classov_1_1op_1_1v0_1_1_erf_1a8ebec2cf0ac4ab2dc343895587e26fff:
...
.. _doxid-classov_1_1op_1_1v0_1_1_erf_1ae1ef83db65c174af208322b044adee32:
.. index:: pair: function; Erf

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Erf(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_erf_1abf617adb0ca25fac056dd4106d9b282f:
...
.. _doxid-classov_1_1op_1_1v0_1_1_erf_1a361533e032072ff3344456e7899df95f:
