.. index:: pair: class; ov::op::v8::DetectionOutput
.. _doxid-classov_1_1op_1_1v8_1_1_detection_output:
...
Layer which performs non-max suppression to generate detection output using location and confidence predictions. :ref:`More...<details-classov_1_1op_1_1v8_1_1_detection_output>`
...
.. ref-code-block:: cpp
	...
	class DetectionOutput: public :ref:`ov::op::util::DetectionOutputBase<doxid-classov_1_1op_1_1util_1_1_detection_output_base>`
	{
	public:
		// typedefs
	
		typedef :ref:`op::util::DetectionOutputBase::AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>` :target:`Attributes<doxid-classov_1_1op_1_1v8_1_1_detection_output_1adf090af90fa382fa70503d8d11d0e58a>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_detection_output_1a8a2d690a9cad640a9af8ab2176f440df>`;

		// construction
	
		:target:`DetectionOutput<doxid-classov_1_1op_1_1v8_1_1_detection_output_1ad1312578a38f3373d71375bc9ccc2a05>`();
	
		:ref:`DetectionOutput<doxid-classov_1_1op_1_1v8_1_1_detection_output_1a813a3224186402d211340190203f43da>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& box_logits,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& class_preds,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& proposals,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& aux_class_preds,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& aux_box_preds,
			const :ref:`Attributes<doxid-classov_1_1op_1_1v8_1_1_detection_output_1adf090af90fa382fa70503d8d11d0e58a>`& attrs
			);
	
		:ref:`DetectionOutput<doxid-classov_1_1op_1_1v8_1_1_detection_output_1a96e4660ac9babf4b458a408e37caa83e>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& box_logits,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& class_preds,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& proposals,
			const :ref:`Attributes<doxid-classov_1_1op_1_1v8_1_1_detection_output_1adf090af90fa382fa70503d8d11d0e58a>`& attrs
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_detection_output_1aa6846f2c33076a189b7fde7ad3a59862>`("DetectionOutput", "opset8", :ref:`op::util::DetectionOutputBase<doxid-classov_1_1op_1_1util_1_1_detection_output_base>`);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_detection_output_1afa6abe70e6472c2f9d4278c56666ff92>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_detection_output_1a4cece9d54e03c3ff32c97fa1e1770691>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-classov_1_1op_1_1v8_1_1_detection_output_1adf090af90fa382fa70503d8d11d0e58a>`& :target:`get_attrs<doxid-classov_1_1op_1_1v8_1_1_detection_output_1aad3119f39f68d3503efe3bde3a3c25e2>`() const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_detection_output_1a16ee4c203c203135f78e31fa2b155f26>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		struct :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1ad97a5eb4e6d0fff91dea3cd9237fa176>`("DetectionOutputBase", "util");
		void :ref:`validate_base<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1ac6cc378ce1dde9a9096c8cbc955f1645>`(const :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`& attrs);
		bool :ref:`visit_attributes_base<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1a8147970e59cccbe71ff988f0c9913234>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor, :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`& attrs);
		:ref:`Dimension<doxid-classov_1_1_dimension>` :ref:`compute_num_classes<doxid-classov_1_1op_1_1util_1_1_detection_output_base_1af5d77cd19842ebe68de5ec3d3c737d51>`(const :ref:`AttributesBase<doxid-structov_1_1op_1_1util_1_1_detection_output_base_1_1_attributes_base>`& attrs);

.. _details-classov_1_1op_1_1v8_1_1_detection_output:
...
.. _doxid-classov_1_1op_1_1v8_1_1_detection_output_1a813a3224186402d211340190203f43da:
.. index:: pair: function; DetectionOutput
...
Constructs a :ref:`DetectionOutput <doxid-classov_1_1op_1_1v8_1_1_detection_output>` operation.
...
.. list-table::
	...
	*
		...
		- Auxilary class predictions

	*
		- aux_box_preds

		- Auxilary box predictions

	*
		- attrs

		- Detection :ref:`Output <doxid-classov_1_1_output>` attributes

.. _doxid-classov_1_1op_1_1v8_1_1_detection_output_1a96e4660ac9babf4b458a408e37caa83e:
.. index:: pair: function; DetectionOutput
...
.. _doxid-classov_1_1op_1_1v8_1_1_detection_output_1afa6abe70e6472c2f9d4278c56666ff92:
