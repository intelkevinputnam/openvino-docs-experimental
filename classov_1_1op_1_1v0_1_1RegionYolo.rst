.. index:: pair: class; ov::op::v0::RegionYolo
.. _doxid-classov_1_1op_1_1v0_1_1_region_yolo:
...
:ref:`RegionYolo <doxid-classov_1_1op_1_1v0_1_1_region_yolo>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_region_yolo>`
...
.. ref-code-block:: cpp
	...
	class RegionYolo: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a14ff317de0dc75c0501e6122d11b5a39>`;

		// construction
	
		:target:`RegionYolo<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1ac8d4a01bc4f389e9101a5b373c5442e9>`();
	
		:ref:`RegionYolo<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1aba039ae4f60834e1eb20a64fc11a85d1>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a9652ab994b201bfb9966dc4b8a2c7325>`("RegionYolo", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1ac54d01151f919473bef1f73ebdd68250>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a2ba0508509924ff916364dafcf88cbb0>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1afef6206c793b0bb996bd5366c3e69e64>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		size_t :target:`get_num_coords<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1ac1fab10cef77e727bc07c34cc8d7051d>`() const;
		size_t :target:`get_num_classes<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a778723ee510523f7b387293b89f50f50>`() const;
		size_t :target:`get_num_regions<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1aad5d869c7f4d37a32bfe3dfe416e18e6>`() const;
		bool :target:`get_do_softmax<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1af5389856e571033a058af6aafcf075ba>`() const;
		const std::vector<int64_t>& :target:`get_mask<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1aa4982a6246f39fc3395d89ce5f0aff0b>`() const;
		const std::vector<float>& :target:`get_anchors<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1af9508f2ba81c5d664062091528ea5f11>`() const;
		int :target:`get_axis<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a7189a7b2f99a20b7c15690d57fb27eef>`() const;
		int :target:`get_end_axis<doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a18bf6659d1a29a99408837f91845ad95>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_region_yolo:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`RegionYolo <doxid-classov_1_1op_1_1v0_1_1_region_yolo>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_region_yolo_1aba039ae4f60834e1eb20a64fc11a85d1:
.. index:: pair: function; RegionYolo
...
Constructs a :ref:`RegionYolo <doxid-classov_1_1op_1_1v0_1_1_region_yolo>` operation.
...
.. list-table::
	...
	*
		...
		- Number of classes for each region
	...
	*
		...
		- Axis to begin softmax on

	*
		- end_axis

		- Axis to end softmax on

	*
		- anchors

		- A flattened list of pairs ``[width, height]`` that describes prior box sizes.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_region_yolo_1a2ba0508509924ff916364dafcf88cbb0:
