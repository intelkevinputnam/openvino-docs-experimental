.. index:: pair: class; ngraph::op::GRUCellIE
.. _doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e:

class ngraph::op::GRUCellIE
===========================
...
.. ref-code-block:: cpp
	...
	#include <gru_cell_ie.hpp>
	
	class GRUCellIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1af3d6165c9a5e85683270373705a5d540>`;

		// construction
	
		:target:`GRUCellIE<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1a82b535aa35be3ff9b4565d63cc2dc8e5>`(
		...
		:target:`GRUCellIE<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1a003ae9e9f979d5f0fd2795f365b6e782>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1aa856b62e2ed1f51d483144a2716a25ce>`("GRUCellIE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1a6bc62f80c446dd98c7429e2c39431175>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1aa59b6c66fa21c856f7b53be6ed485271>`();
		std::size_t :target:`get_hidden_size<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1af131e99e42e94ac2f0b3de608adb97fa>`();
		const std::vector<std::string>& :target:`get_activations<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1a17d514d5a293a948a9903d6949cd0691>`();
		const std::vector<float>& :target:`get_activations_alpha<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1aae3e7ca3fd9c261b4b469614bfdb5f33>`();
		const std::vector<float>& :target:`get_activations_beta<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1aa369187504db3334fcdfd5de793a2cb7>`();
		float :target:`get_clip<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1a7b5df42667d42f0128e05ded640e73fa>`();
		bool :target:`get_linear_before_reset<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1a2e514a6c9fe04798cd61bcceee736a55>`() const;
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1ac6d22c108883a96444e0ad3fad611b7c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_g_r_u_cell_i_e:
...
.. _doxid-classngraph_1_1op_1_1_g_r_u_cell_i_e_1aa59b6c66fa21c856f7b53be6ed485271:
