.. index:: pair: class; ov::pass::AddOldApiMapToParameters
.. _doxid-classov_1_1pass_1_1_add_old_api_map_to_parameters:
...
:ref:`AddOldApiMapToParameters <doxid-classov_1_1pass_1_1_add_old_api_map_to_parameters>` transformation adds OldApiMap to each float input to the model.
...
.. ref-code-block:: cpp
	...
	class AddOldApiMapToParameters: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1_add_old_api_map_to_parameters_1a8b17b0701c85c9fd7e1fedaf2708fca5>`("AddOldApiMapToParameters", "0");
	};
