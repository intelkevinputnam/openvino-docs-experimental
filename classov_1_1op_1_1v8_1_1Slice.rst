.. index:: pair: class; ov::op::v8::Slice
.. _doxid-classov_1_1op_1_1v8_1_1_slice:
...
:ref:`Slice <doxid-classov_1_1op_1_1v8_1_1_slice>` operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_slice>`
...
.. ref-code-block:: cpp
	...
	class Slice: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_slice_1a6313ea9136c27c856d04d80842d46dad>`;

		// construction
	
		:target:`Slice<doxid-classov_1_1op_1_1v8_1_1_slice_1a57fc446c262bbadb2fb13c37940a5c6b>`();
	
		:ref:`Slice<doxid-classov_1_1op_1_1v8_1_1_slice_1a67700b756451fa6d934cbb7fd556d904>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& start,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& stop,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& step
			);
	
		:ref:`Slice<doxid-classov_1_1op_1_1v8_1_1_slice_1a53073014a0fb8a78450af7475df66682>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& start,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& stop,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& step,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_slice_1aeb0af1e6229d4f7dff8c0daa0523bfb2>`("Slice", "opset8");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_slice_1aefdf15be9c3875a058eab6195a70f310>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_slice_1a825ff8134c647a3061d3637ddb18952d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_slice_1acac10b95df9a9b6478b0724168ecefe5>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v8_1_1_slice_1a3381162f8268731bf876b640e8abdcac>`() const;
	
		virtual bool :ref:`evaluate<doxid-classov_1_1op_1_1v8_1_1_slice_1a0f9deb272f8ff6c7a60a3d4ab70657d8>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v8_1_1_slice_1a6638f537ea71462c3281537bc9164b0c>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v8_1_1_slice_1a9503c594d2ebdbdb4a2e643ee7fe42bc>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v8_1_1_slice_1a3f4fcb20cdad5bad6acc73ef094b216e>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
		std::shared_ptr<:ref:`ngraph::op::v0::Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`> :target:`get_default_const_axes<doxid-classov_1_1op_1_1v8_1_1_slice_1a598487645e401ed811e734238c7ede54>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& start) const;
	
		:ref:`PartialShape<doxid-classov_1_1_partial_shape>` :target:`calculate_output_shape<doxid-classov_1_1op_1_1v8_1_1_slice_1a0cc2dcf713bbaf9624f9275bc01c5b4d>`(
...
.. _details-classov_1_1op_1_1v8_1_1_slice:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Slice <doxid-classov_1_1op_1_1v8_1_1_slice>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_slice_1a67700b756451fa6d934cbb7fd556d904:
...
Constructs :ref:`Slice <doxid-classov_1_1op_1_1v8_1_1_slice>` operation (default axes).
...
.. list-table::
	...
	*
		...
		- 1D tensor with start indices of the slice.

	*
		- stop

		- 1D tensor with end indices of the slice.

	*
		- step

		- 1D tensor specifies the increment to use in slicing along corresponding axes.

.. _doxid-classov_1_1op_1_1v8_1_1_slice_1a53073014a0fb8a78450af7475df66682:
.. index:: pair: function; Slice
...
Constructs :ref:`Slice <doxid-classov_1_1op_1_1v8_1_1_slice>` operation.
...
.. list-table::
	...
	*
		...
		- 1D tensor indicating which dimensions the values in the ``start`` and ``stop`` apply to.

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_slice_1aefdf15be9c3875a058eab6195a70f310:
...
.. _doxid-classov_1_1op_1_1v8_1_1_slice_1a3381162f8268731bf876b640e8abdcac:
.. index:: pair: function; has_evaluate

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool has_evaluate() const

Allows to get information about availability of evaluate method for the current operation.

.. _doxid-classov_1_1op_1_1v8_1_1_slice_1a0f9deb272f8ff6c7a60a3d4ab70657d8:
