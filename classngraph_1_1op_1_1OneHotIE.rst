.. index:: pair: class; ngraph::op::OneHotIE
.. _doxid-classngraph_1_1op_1_1_one_hot_i_e:

class ngraph::op::OneHotIE
==========================
...
.. ref-code-block:: cpp
	...
	class OneHotIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a91833d254cae47c5eb7110fc57f57365>`;

		// construction
	
		:target:`OneHotIE<doxid-classngraph_1_1op_1_1_one_hot_i_e_1aaa2f6480d2ecb68ae7fe7af874e58d51>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`ngraph::Node<doxid-classov_1_1_node>`>& input,
			int axis,
			int depth,
			float on_value,
			float off_value,
			:ref:`element::Type<doxid-classov_1_1element_1_1_type>` type
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a579b02eb3424ea2f3cb7795b36a9f9b1>`("OneHotIE", "legacy");
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` size_t :ref:`get_version<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a58a5449c2752b1c5df4dc4bf52a6f692>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a4e6411e8d5d4a5f90e6d0ba7fcb49b35>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a19e3c9dc1e35b69f6be68e0e99ec4ca0>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_one_hot_i_e_1aa4215a1cf022faf3a00eaab13f9d2d17>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		int :target:`get_axis<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a19bf1e9c18ba5f95ea96fcac92fed625>`();
		int :target:`get_depth<doxid-classngraph_1_1op_1_1_one_hot_i_e_1a26a36d725402e0db4d7d750411d85da2>`();
		float :target:`get_on_value<doxid-classngraph_1_1op_1_1_one_hot_i_e_1acbbb774f53d8554b65a13c21d187e123>`();
		float :target:`get_off_value<doxid-classngraph_1_1op_1_1_one_hot_i_e_1ac1ad97411f546891efb6bba147407d94>`();
	};
...
.. _details-classngraph_1_1op_1_1_one_hot_i_e:
...
.. _doxid-classngraph_1_1op_1_1_one_hot_i_e_1a58a5449c2752b1c5df4dc4bf52a6f692:
...
.. _doxid-classngraph_1_1op_1_1_one_hot_i_e_1a4e6411e8d5d4a5f90e6d0ba7fcb49b35:
