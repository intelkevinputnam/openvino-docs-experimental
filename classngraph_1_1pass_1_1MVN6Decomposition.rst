.. index:: pair: class; ngraph::pass::MVN6Decomposition
.. _doxid-classngraph_1_1pass_1_1_m_v_n6_decomposition:
...
:ref:`MVN6Decomposition <doxid-classngraph_1_1pass_1_1_m_v_n6_decomposition>` transformation into sub-graph x - ReduceMean(x, axes) if normalize_variance is false and into sub-graph (x - ReduceMean(x, axes)) / Sqrt(ReduceMean((x - ReduceMean(x, axes)) ^ 2)) if normalize_variance is true.
...
.. ref-code-block:: cpp
	...
	class MVN6Decomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_m_v_n6_decomposition_1ab1cbaa970eabe13f4f4a5e281ee39af0>`("MVN6Decomposition", "0");
	};
