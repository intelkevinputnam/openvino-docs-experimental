.. index:: pair: class; ngraph::op::LSTMSequenceIE
.. _doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e:

class ngraph::op::LSTMSequenceIE
================================
...
.. ref-code-block:: cpp
	...
	#include <lstm_sequence_ie.hpp>
	
	class LSTMSequenceIE: public :ref:`ov::op::util::RNNCellBase<doxid-classov_1_1op_1_1util_1_1_r_n_n_cell_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1a484c49032d4f3645fe407798a518c8a7>`;

		// construction
	
		:target:`LSTMSequenceIE<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1a45229c0979e13c1347683ec779372a86>`();
	
		:target:`LSTMSequenceIE<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1a975dc29d4e6fc9a698804214b1b8aa9d>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1afe9fc69c13fe53bbb13ba21f344e3808>`("LSTMSequenceIE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1a674065f64fbfe0e17563b129accb8d9e>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1aad95e61c4e71cf4d0faf0b62d2990ddd>`();
		ngraph::op::RecurrentSequenceDirection :target:`get_direction<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1acf4cc7494dde01ccf4cdde8d8a8b9ce2>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1a5d6dc6af8cb95a5c7aa408a5f48ba3ad>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e:
...
.. _doxid-classngraph_1_1op_1_1_l_s_t_m_sequence_i_e_1aad95e61c4e71cf4d0faf0b62d2990ddd:
