.. index:: pair: class; InferenceEngine::GRNLayer
.. _doxid-class_inference_engine_1_1_g_r_n_layer:
...
This class represents standard GRN Layer. :ref:`More...<details-class_inference_engine_1_1_g_r_n_layer>`
...
.. ref-code-block:: cpp
	...
	class GRNLayer: public :ref:`InferenceEngine::CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`
	{
	public:
		// fields
	
		float :ref:`bias<doxid-class_inference_engine_1_1_g_r_n_layer_1ad57e99b0b7136a1b4c436be54011e508>` = 0.f;

		// methods
	
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_g_r_n_layer_1a49576b4ff390822c0aa474cf7f542724>`(const :ref:`LayerParams<doxid-struct_inference_engine_1_1_layer_params>`& prms);
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_g_r_n_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa>`(const :ref:`CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`& other);
	};
...
.. _details-class_inference_engine_1_1_g_r_n_layer:
...
.. _doxid-class_inference_engine_1_1_g_r_n_layer_1ad57e99b0b7136a1b4c436be54011e508:
.. index:: pair: variable; bias
...
.. _doxid-class_inference_engine_1_1_g_r_n_layer_1a49576b4ff390822c0aa474cf7f542724:
...
A default constructor. Creates a new :ref:`GRNLayer <doxid-class_inference_engine_1_1_g_r_n_layer>` instance and initializes layer parameters with the given values.

.. _doxid-class_inference_engine_1_1_g_r_n_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa:
.. index:: pair: function; CNNLayer
