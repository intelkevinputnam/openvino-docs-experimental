.. index:: pair: class; ov::op::v0::Tan
.. _doxid-classov_1_1op_1_1v0_1_1_tan:
...
Elementwise tangent operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_tan>`
...
.. ref-code-block:: cpp
	...
	class Tan: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_tan_1ae7f925754d53277690a4d59ec642c7ab>`;

		// construction
	
		:ref:`Tan<doxid-classov_1_1op_1_1v0_1_1_tan_1aaadd2d88d604906c42facc9f5be1f7bf>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:target:`Tan<doxid-classov_1_1op_1_1v0_1_1_tan_1a7e1b046404f58ed40d62b613fc93c997>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_tan_1a11ca958089180fafe2fc58be2f09ece8>`("Tan", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_tan_1af076267359e052764d830f8a42773705>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_tan_1a74966b227ec3aaedcf3ccade4c5edcbc>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_tan_1ae2056f71aec80f44bddc9142fed8643e>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_tan_1aa2fdc42aa5268844d07ad2f3f453a41f>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_tan:
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`N[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \tan(\texttt{arg}[i_1,\dots,i_n])`

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_tan_1aaadd2d88d604906c42facc9f5be1f7bf:
.. index:: pair: function; Tan

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Tan(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_tan_1ae2056f71aec80f44bddc9142fed8643e:
...
.. _doxid-classov_1_1op_1_1v0_1_1_tan_1aa2fdc42aa5268844d07ad2f3f453a41f:
