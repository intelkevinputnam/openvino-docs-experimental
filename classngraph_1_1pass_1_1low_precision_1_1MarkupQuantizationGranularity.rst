.. index:: pair: class; ngraph::pass::low_precision::MarkupQuantizationGranularity
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity:
...
.. toctree::
	...
	PerTensorQuantization <classngraph_1_1pass_1_1low_precision_1_1MarkupQuantizationGranularity_1_1PerTensorQuantization.rst>

Overview
~~~~~~~~

MarkupPerTensorQuantization transformation marks operations as required per-tensor quantization according to the provided restrictions. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity>`
...
.. ref-code-block:: cpp
	...
	class MarkupQuantizationGranularity: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// classes
	
		class :ref:`PerTensorQuantization<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity_1_1_per_tensor_quantization>`;

		// construction
	
		:target:`MarkupQuantizationGranularity<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity_1a00fbe924219b8bca5c37fc584cb7a678>`(const std::vector<:ref:`QuantizationGranularityRestriction<doxid-classngraph_1_1pass_1_1low__precision_1_1_quantization_granularity_restriction>`>& restrictions = {});

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity_1aa6c34169ff2c854d918beb52acb400e2>`("MarkupPerTensorQuantization", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity_1a3c4d034f5549fbd703e94fac79bcc913>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_markup_quantization_granularity:
...
For more details about the transformation, refer to :ref:`MarkupPerTensorQuantization <doxid-openvino_docs__o_v__u_g_lpt__markup_per_tensor_quantization>` page in the Inference Engine Developer Guide.
