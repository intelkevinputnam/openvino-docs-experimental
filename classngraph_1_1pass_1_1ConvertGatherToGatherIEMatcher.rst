.. index:: pair: class; ngraph::pass::ConvertGatherToGatherIEMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_gather_to_gather_i_e_matcher:

class ngraph::pass::ConvertGatherToGatherIEMatcher
==================================================
...
.. ref-code-block:: cpp
	...
	#include <convert_gather_to_gather_ie.hpp>
	
	class ConvertGatherToGatherIEMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_gather_to_gather_i_e_matcher_1ae9df78ef40507a5d57f1fe9eb9e6c72f>`("ConvertGatherToGatherIEMatcher", "0");
	};
