.. index:: pair: class; ngraph::op::NonMaxSuppressionIE2
.. _doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2:

class ngraph::op::NonMaxSuppressionIE2
======================================
...
.. ref-code-block:: cpp
	...
	class NonMaxSuppressionIE2: public :ref:`ngraph::op::NonMaxSuppressionIE<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2_1acd71b47319a7a3529d1a06dd003f19c7>`;

		// construction
	
		:target:`NonMaxSuppressionIE2<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2_1a4ad39b9948a6f6f192a835e9ad7d3f8a>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2_1a5f0946a9327e024318d3a808d53b80a1>`("NonMaxSuppressionIE2", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2_1a9b964422f4a1f09806832906e9b4e9ad>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2_1afd779c722fb62be6797e5660e3e61de7>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ab030b1dc0a58adc29ea08051faf309d4>`;
		int :ref:`m_center_point_box<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ab959eed56f760892dd12cfacf57ec9fb>`;
		bool :ref:`m_sort_result_descending<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a64132405feeffe128bf8a48f77aacf14>` = true;
		:ref:`element::Type<doxid-classov_1_1element_1_1_type>` :ref:`m_output_type<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ac197a2e6f9a208ee54531aa7de71f628>`;
		...
		:ref:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a8fd5c128eb428813b58f75e81c622776>`("NonMaxSuppressionIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1a4511071085f18e2fb8013b442ea5bba2>`();
		virtual bool :ref:`visit_attributes<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1aad304b27c49ad1af27f0a205db12caf8>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_non_max_suppression_i_e_1ab223e54081f6d09091c10c7f35614a3b>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;

.. _details-classngraph_1_1op_1_1_non_max_suppression_i_e2:
...
.. _doxid-classngraph_1_1op_1_1_non_max_suppression_i_e2_1a9b964422f4a1f09806832906e9b4e9ad:
