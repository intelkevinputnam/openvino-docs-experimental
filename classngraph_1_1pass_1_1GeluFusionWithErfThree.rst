.. index:: pair: class; ngraph::pass::GeluFusionWithErfThree
.. _doxid-classngraph_1_1pass_1_1_gelu_fusion_with_erf_three:
...
:ref:`GeluFusion <doxid-classngraph_1_1pass_1_1_gelu_fusion>` transformation replaces a sub-graph x \* (0.5 \* (1 + erf(x / sqrt(2))) with a Gelu op.
...
.. ref-code-block:: cpp
	...
	class GeluFusionWithErfThree: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_gelu_fusion_with_erf_three_1a1689e7c4507421df14f90eff5d3eed1e>`("GeluFusionWithErfThree", "0");
	};
