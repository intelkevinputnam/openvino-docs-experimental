.. index:: pair: class; ngraph::pass::SplitConcatPairToInterpolateFusion
.. _doxid-classngraph_1_1pass_1_1_split_concat_pair_to_interpolate_fusion:
...
:ref:`SplitConcatPairToInterpolateFusion <doxid-classngraph_1_1pass_1_1_split_concat_pair_to_interpolate_fusion>` transformation replaces group of operations: Split -> Concat to Interpolate op.
...
.. ref-code-block:: cpp
	...
	class SplitConcatPairToInterpolateFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// construction
	
		:target:`SplitConcatPairToInterpolateFusion<doxid-classngraph_1_1pass_1_1_split_concat_pair_to_interpolate_fusion_1a658cb3e7da636c8dfab26f4ab80617b1>`(bool use_shape_for_elimination = true);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_split_concat_pair_to_interpolate_fusion_1a9586a9d8ee4ea2b85f1713a12daa5c1c>`("SplitConcatPairToInterpolateFusion", "0");
	};
