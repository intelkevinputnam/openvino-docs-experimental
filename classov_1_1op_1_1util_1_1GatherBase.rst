.. index:: pair: class; ov::op::util::GatherBase
.. _doxid-classov_1_1op_1_1util_1_1_gather_base:

class ov::op::util::GatherBase
==============================
...
:ref:`GatherBase <doxid-classov_1_1op_1_1util_1_1_gather_base>` basic class for Gather :ref:`v1 <doxid-namespaceov_1_1op_1_1v1>` and :ref:`v7 <doxid-namespaceov_1_1op_1_1v7>`. :ref:`More...<details-classov_1_1op_1_1util_1_1_gather_base>`
...
.. ref-code-block:: cpp
	...
	class GatherBase: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_gather_base_1a0f9d750a1b482c6b862b184a1d70aba1>`;

		// construction
	
		:target:`GatherBase<doxid-classov_1_1op_1_1util_1_1_gather_base_1a44ea614be590ec077930bf6c47636ab3>`();
	
		:ref:`GatherBase<doxid-classov_1_1op_1_1util_1_1_gather_base_1ad19c4ae9fb19e2dad5b0ec13a57918e8>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_gather_base_1a0d8fb5abdad3d62562dbe51843526009>`("GatherBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_gather_base_1abf51895771d2ac597e5101de63eba823>`();
		virtual int64_t :target:`get_axis<doxid-classov_1_1op_1_1util_1_1_gather_base_1a66a365202e54bfb4558618229332054e>`() const;
		...
		virtual bool :target:`evaluate_lower<doxid-classov_1_1op_1_1util_1_1_gather_base_1aa897f153c863386f3101ddbbf46f3bee>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1util_1_1_gather_base_1ad94e9ed738fc1fa5daebb998b731a916>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1util_1_1_gather_base_1ab33dab8f2f687d85eae3f3784af1ff94>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1util_1_1_gather_base_1a07159cd5a99d52551f50371d2393f100>`(
		...
		const int64_t& :target:`get_batch_dims<doxid-classov_1_1op_1_1util_1_1_gather_base_1a2cc84eb01e9280c2d240107729cff638>`() const;
	};
...
.. _details-classov_1_1op_1_1util_1_1_gather_base:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`GatherBase <doxid-classov_1_1op_1_1util_1_1_gather_base>` basic class for Gather :ref:`v1 <doxid-namespaceov_1_1op_1_1v1>` and :ref:`v7 <doxid-namespaceov_1_1op_1_1v7>`.

Construction
------------

.. _doxid-classov_1_1op_1_1util_1_1_gather_base_1ad19c4ae9fb19e2dad5b0ec13a57918e8:
.. index:: pair: function; GatherBase
...
.. _doxid-classov_1_1op_1_1util_1_1_gather_base_1abf51895771d2ac597e5101de63eba823:
...
.. _doxid-classov_1_1op_1_1util_1_1_gather_base_1ac328f7e4e2f247aaec8d007191cf2b43:
