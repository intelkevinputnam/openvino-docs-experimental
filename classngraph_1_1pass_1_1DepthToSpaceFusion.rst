.. index:: pair: class; ngraph::pass::DepthToSpaceFusion
.. _doxid-classngraph_1_1pass_1_1_depth_to_space_fusion:
...
:ref:`DepthToSpaceFusion <doxid-classngraph_1_1pass_1_1_depth_to_space_fusion>` transformation detects Reshape-Transpose-Reshape pattern and tries to fuse it into a single DepthToSpace layer. :ref:`More...<details-classngraph_1_1pass_1_1_depth_to_space_fusion>`
...
.. ref-code-block:: cpp
	...
	class DepthToSpaceFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_depth_to_space_fusion_1acca82c6ceb835489e444dae78101a486>`("DepthToSpaceFusion", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_depth_to_space_fusion:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`DepthToSpaceFusion <doxid-classngraph_1_1pass_1_1_depth_to_space_fusion>` transformation detects Reshape-Transpose-Reshape pattern and tries to fuse it into a single DepthToSpace layer.

:ref:`DepthToSpaceFusion <doxid-classngraph_1_1pass_1_1_depth_to_space_fusion>` transformation is optional and disabled by default. The transformation can be enabled with callback using setCallback method. See the example below.
