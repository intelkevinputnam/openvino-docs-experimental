.. index:: pair: class; ngraph::op::SwishIE
.. _doxid-classngraph_1_1op_1_1_swish_i_e:

class ngraph::op::SwishIE
=========================
...
.. ref-code-block:: cpp
	...
	#include <swish_ie.hpp>
	
	class SwishIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_swish_i_e_1a93a2e97f9e4e63a5d9f13d9c75d3bb5b>`;

		// construction
	
		:target:`SwishIE<doxid-classngraph_1_1op_1_1_swish_i_e_1a934d267ba9e815fd3fdf15e8c3b88566>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input, float alpha = 1.0);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_swish_i_e_1acb9c8c32d7da11db26727aa803bfbbf6>`("SwishIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_swish_i_e_1a4cb6bda09e30eefd36c4bf3d5d10bbd0>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_swish_i_e_1a252dd283f5798a5395ec367785c2daff>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_swish_i_e_1a3bf579250a609158476b521baf4d0c8b>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		void :target:`set_alpha<doxid-classngraph_1_1op_1_1_swish_i_e_1adaaeaa1d1ca4e2cd73113dbc7c60baeb>`(float alpha);
		float :target:`get_alpha<doxid-classngraph_1_1op_1_1_swish_i_e_1ab0b170f28d01d643a2996ff57912be38>`() const;
	};
...
.. _details-classngraph_1_1op_1_1_swish_i_e:
...
.. _doxid-classngraph_1_1op_1_1_swish_i_e_1a4cb6bda09e30eefd36c4bf3d5d10bbd0:
