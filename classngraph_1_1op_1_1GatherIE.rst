.. index:: pair: class; ngraph::op::GatherIE
.. _doxid-classngraph_1_1op_1_1_gather_i_e:

class ngraph::op::GatherIE
==========================
...
.. ref-code-block:: cpp
	...
	class GatherIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_gather_i_e_1afb694431c3b78bb6eefddac1f6c52b0e>`;

		// construction
	
		:target:`GatherIE<doxid-classngraph_1_1op_1_1_gather_i_e_1ab5b5429b9aec62e9e6bd0729f6498925>`();
		:target:`GatherIE<doxid-classngraph_1_1op_1_1_gather_i_e_1a12945015af8fc42a27db527ddd968260>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& params, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices, int64_t axis);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_gather_i_e_1a0c9e20df4e4d26c1b4ff60aaf22d54d0>`("GatherIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_gather_i_e_1a5579ee60a6e5571ae8c909c813e46d5b>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_gather_i_e_1a0ced24dd5a4fd0400bde7634166006c2>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		int64_t :target:`get_axis<doxid-classngraph_1_1op_1_1_gather_i_e_1a12b4058b2235f7280283f2f2307bc485>`() const;
		void :target:`set_axis<doxid-classngraph_1_1op_1_1_gather_i_e_1afc29498445d56ed21b25a4fc89156c8f>`(int64_t axis);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_gather_i_e_1a51f97b1bc1a8022c0a2c101e58fb2e7e>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_gather_i_e:
...
.. _doxid-classngraph_1_1op_1_1_gather_i_e_1a5579ee60a6e5571ae8c909c813e46d5b:
