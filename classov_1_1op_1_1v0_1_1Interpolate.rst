.. index:: pair: class; ov::op::v0::Interpolate
.. _doxid-classov_1_1op_1_1v0_1_1_interpolate:
...
.. toctree::
	...
	InterpolateMode <enumov_1_1op_1_1v0_1_1Interpolate_1_1InterpolateMode.rst>
	Attributes <structov_1_1op_1_1v0_1_1Interpolate_1_1Attributes.rst>

Overview
~~~~~~~~

Layer which performs bilinear interpolation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_interpolate>`
...
.. ref-code-block:: cpp
	...
	public:
		...
		enum :ref:`InterpolateMode<doxid-classov_1_1op_1_1v0_1_1_interpolate_1ae6b119b345a7d6cf0e249c5390535581>`;

		// structs
	
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_interpolate_1_1_attributes>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_interpolate_1abe6525fb68ac8699b0f7eb23b3a311b8>`;

		// construction
	
		:target:`Interpolate<doxid-classov_1_1op_1_1v0_1_1_interpolate_1a4ee38ab4f1f2d87b3ae75388039b7c45>`();
	
		:ref:`Interpolate<doxid-classov_1_1op_1_1v0_1_1_interpolate_1a74a4c445599efb5b12719e21029e348f>`(
			...
			const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_interpolate_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_interpolate_1a6455201c35358fd853bf1dee76026e81>`("Interpolate", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_interpolate_1aaf91d0309c59b1c0b5a7a18378602242>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_interpolate_1abfc13509bc7fe3c3440b45ada99d956b>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_interpolate_1a065f05b6b01b9c3efc9956a6310e9e90>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v0_1_1_interpolate_1_1_attributes>`& :target:`get_attrs<doxid-classov_1_1op_1_1v0_1_1_interpolate_1a1f55add5eb08587c568655a6a6617005>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_interpolate:
...
.. _doxid-classov_1_1op_1_1v0_1_1_interpolate_1a74a4c445599efb5b12719e21029e348f:
...
Constructs a :ref:`Interpolate <doxid-classov_1_1op_1_1v0_1_1_interpolate>` operation.
...
.. _doxid-classov_1_1op_1_1v0_1_1_interpolate_1abfc13509bc7fe3c3440b45ada99d956b:
