.. index:: pair: class; ngraph::pass::ReverseInputChannelsFusion
.. _doxid-classngraph_1_1pass_1_1_reverse_input_channels_fusion:
...
:ref:`ReverseInputChannelsFusion <doxid-classngraph_1_1pass_1_1_reverse_input_channels_fusion>`.
...
.. ref-code-block:: cpp
	...
	class ReverseInputChannelsFusion: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_reverse_input_channels_fusion_1a50aa2bba8c150f9c2fa6da0abc83570e>`("ReverseInputChannelsFusion", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_reverse_input_channels_fusion_1ade2087d193774bf3db795064a3366f02>`(const std::shared_ptr<:ref:`ov::Model<doxid-classov_1_1_model>`>&);
	};
