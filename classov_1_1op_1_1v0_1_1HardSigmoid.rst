.. index:: pair: class; ov::op::v0::HardSigmoid
.. _doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid:
...
Parameterized, bounded sigmoid-like, piecewise linear function. min(max(alpha\*x + beta, 0), 1) :ref:`More...<details-classov_1_1op_1_1v0_1_1_hard_sigmoid>`
...
.. ref-code-block:: cpp
	...
	class HardSigmoid: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1a0376221e1137ca4742e0b19aa6b33157>`;

		// construction
	
		:target:`HardSigmoid<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1a3373bd3c66d47f702142de8e9a9d2254>`();
	
		:ref:`HardSigmoid<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1ae769c773b807d6706ded2afa3be5f3b3>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& alpha,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& beta
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1adc8710b4aef00003901d1e465195d915>`("HardSigmoid", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1a144f5c0044d11c61e9c6195e7f85f7aa>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1a0d4b9224ec2bc80745f32bae68e42929>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1a5c712c551d028053ab7934f68432d244>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_hard_sigmoid:
...
.. _doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1ae769c773b807d6706ded2afa3be5f3b3:
.. index:: pair: function; HardSigmoid
...
Constructs a :ref:`HardSigmoid <doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid>` operation.
...
.. _doxid-classov_1_1op_1_1v0_1_1_hard_sigmoid_1a0d4b9224ec2bc80745f32bae68e42929:
