.. index:: pair: class; ngraph::pass::TransposeFQReduction
.. _doxid-classngraph_1_1pass_1_1_transpose_f_q_reduction:
...
:ref:`TransposeFQReduction <doxid-classngraph_1_1pass_1_1_transpose_f_q_reduction>` transformation sinks Transpose through FakeQuantize in case it is followed by reduction or squeeze.
...
.. ref-code-block:: cpp
	...
	class TransposeFQReduction: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_transpose_f_q_reduction_1ab8f91761594584e9754cdefd2bcc123c>`("TransposeFQReduction", "0");
	};
