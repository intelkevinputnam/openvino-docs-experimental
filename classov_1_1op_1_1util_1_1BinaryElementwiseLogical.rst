.. index:: pair: class; ov::op::util::BinaryElementwiseLogical
.. _doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical:
...
.. ref-code-block:: cpp
	...
	class BinaryElementwiseLogical: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical_1a0e681a54fc91939fe1b30a2b46ba1c87>`;

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical_1a85f1a179f45d2c64828f58e45d33208f>`("BinaryElementwiseLogical", "util");
		...
		void :target:`set_autob<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical_1a52e8c3cf933d6c938d6788b639072dd8>`(const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& autob);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical_1a564b95cc518b3404d6c765eb49477c6d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};

	// direct descendants

	class :ref:`Xor<doxid-classov_1_1op_1_1v0_1_1_xor>`;
...
.. _details-classov_1_1op_1_1util_1_1_binary_elementwise_logical:
...
For example, if the underlying operation (determined by the subclass) is :math:`\mathit{op}(x,y)`, the input tensors :math:`[[x_0,y_0],[z_0,w_0]]` and :math:`[[x_1,y_1],[z_1,w_1]]` will be mapped to :math:`[[\mathit{op}(x_0,x_1),\mathit{op}(y_0,y_1)],[\mathit{op}(z_0,z_1),\mathit{op}(w_0,w_1)]]`.
...
.. _doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical_1ad4f804b67b4e8a42a4b574d600d96b2f:
...
.. _doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical_1a12012d64e699c61afd0c2f6817f2c00c:
