.. index:: pair: class; ov::op::v1::Reshape
.. _doxid-classov_1_1op_1_1v1_1_1_reshape:
...
:ref:`Tensor <doxid-classov_1_1_tensor>` dynamic reshape operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_reshape>`
...
.. ref-code-block:: cpp
	...
	class Reshape: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_reshape_1ab4d99842a6b3b4b256b98fe076e5be71>`;

		// construction
	
		:target:`Reshape<doxid-classov_1_1op_1_1v1_1_1_reshape_1aa9d2881ea9f4ea5d66bf8dbf42a2ea86>`();
	
		:ref:`Reshape<doxid-classov_1_1op_1_1v1_1_1_reshape_1a3a34f87936a0f7db604d81db2ae19599>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& shape_pattern,
			bool special_zero
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_reshape_1ae6ed06f2685348ad63068ab2d4fb8883>`("Reshape", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_reshape_1ab763ecf93214c2a68892fa75b3f8e0ec>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_reshape_1afca32c2b1d4ca142cf82cac5406ed2f1>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_reshape_1a3a637053e5bfa6ff037a8dab144437a5>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		bool :target:`get_special_zero<doxid-classov_1_1op_1_1v1_1_1_reshape_1a8c133d15638c856eec38eb291f311938>`() const;
		void :target:`set_special_zero<doxid-classov_1_1op_1_1v1_1_1_reshape_1ad3bdaaa3e22fdcd169274cd8c04e877e>`(bool special_zero);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_reshape_1abefc26a4c8914b9605d56ac50b123dd5>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_reshape_1a347dd9a74b8283c34aef7c810f38814b>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v1_1_1_reshape_1aacc7d1fda8b6092d56d4c5303635d4e8>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v1_1_1_reshape_1afa111f97ede06c9416854aa727cf33e5>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v1_1_1_reshape_1a7b3826089ff9fbfdfbe3ba798d3c2fae>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v1_1_1_reshape_1a03796623eacee0a5bfcd3b29d6cf52c8>`(
...
.. _details-classov_1_1op_1_1v1_1_1_reshape:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Tensor <doxid-classov_1_1_tensor>` dynamic reshape operation.

"Converts" an input tensor into a new shape with the same number of elements. This op does not touch the actual data. If needed, use :ref:`Transpose <doxid-classov_1_1op_1_1v1_1_1_transpose>` for that purpose.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_reshape_1a3a34f87936a0f7db604d81db2ae19599:
...
.. list-table::
	...
	*
		...
		- The node that defines output shape shape_pattern. If the input shape is :math:`(a_0,\dots,a_{k-1})` then the output shape must be of the form :math:`(b_0,\dots,b_{j-1})` where :math:`\Pi(a_i) = \Pi(b_i)`. A value of -1 is allowed for at most one dimension, in which case the dimension size is inferred based on element count of input tensor.

	*
		- special_zero

		- Treats zeros in ``shape_pattern`` as wildcard flags indicating a copy from input shape at the same index.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_reshape_1afca32c2b1d4ca142cf82cac5406ed2f1:
...
.. _doxid-classov_1_1op_1_1v1_1_1_reshape_1abefc26a4c8914b9605d56ac50b123dd5:
...
.. _doxid-classov_1_1op_1_1v1_1_1_reshape_1a347dd9a74b8283c34aef7c810f38814b:
