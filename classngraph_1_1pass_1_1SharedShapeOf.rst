.. index:: pair: class; ngraph::pass::SharedShapeOf
.. _doxid-classngraph_1_1pass_1_1_shared_shape_of:
...
:ref:`SharedShapeOf <doxid-classngraph_1_1pass_1_1_shared_shape_of>` transformation replaces group of ShapeOf operations with the first ShapeOf in this group. All ShapeOfs in this group must be equal and consume the same output port.
...
.. ref-code-block:: cpp
	...
	class SharedShapeOf: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_shared_shape_of_1a5bf68775ea7f1a2f12442c0a6b5033d8>`("SharedShapeOf", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_shared_shape_of_1ad4723b8d886fb0b86519f8f66e39ef44>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
