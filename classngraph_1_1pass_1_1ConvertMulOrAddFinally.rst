.. index:: pair: class; ngraph::pass::ConvertMulOrAddFinally
.. _doxid-classngraph_1_1pass_1_1_convert_mul_or_add_finally:

class ngraph::pass::ConvertMulOrAddFinally
==========================================
...
.. ref-code-block:: cpp
	...
	class ConvertMulOrAddFinally: public :ref:`ov::pass::GraphRewrite<doxid-classov_1_1pass_1_1_graph_rewrite>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_mul_or_add_finally_1ab19de82af05d690ab4225c9e828cc1e3>`("ConvertMulOrAddFinally", "0");
	};
