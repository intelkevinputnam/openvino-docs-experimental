.. index:: pair: class; ov::op::v9::Eye
.. _doxid-classov_1_1op_1_1v9_1_1_eye:
...
:ref:`Tensor <doxid-classov_1_1_tensor>` :ref:`Eye <doxid-classov_1_1op_1_1v9_1_1_eye>` operation. :ref:`More...<details-classov_1_1op_1_1v9_1_1_eye>`
...
.. ref-code-block:: cpp
	...
	class Eye: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// construction
	
		:target:`Eye<doxid-classov_1_1op_1_1v9_1_1_eye_1a72d483b7fae4bc477fe4cd49a96e1ac0>`();
	
		:ref:`Eye<doxid-classov_1_1op_1_1v9_1_1_eye_1ab40b65cab787e862b5a8c2f24d0d3ea3>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_rows,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_columns,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& diagonal_index,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& batch_shape,
			const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& out_type
			);
	
		:ref:`Eye<doxid-classov_1_1op_1_1v9_1_1_eye_1aa902cc844a6dfb0373a3e20cbf3183cb>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_rows,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& num_columns,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& diagonal_index,
			const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& out_type
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v9_1_1_eye_1aa315a58a4c4cacf938c044fb8d5a5fdb>`("Eye", "opset9");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v9_1_1_eye_1a272921d4b1136417d331038eb64411c7>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v9_1_1_eye_1ad3907a8a761b2598c8e87604028d9b13>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v9_1_1_eye_1a81fcb625527545f688e5a45c452bc4f2>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& :ref:`get_out_type<doxid-classov_1_1op_1_1v9_1_1_eye_1adb881d17e65d27668f2a151db1d7ba35>`() const;
		void :target:`set_out_type<doxid-classov_1_1op_1_1v9_1_1_eye_1a0fc50599b359ff7fe1f30198309da9a2>`(const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& output_type);
	};
...
.. _details-classov_1_1op_1_1v9_1_1_eye:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Tensor <doxid-classov_1_1_tensor>` :ref:`Eye <doxid-classov_1_1op_1_1v9_1_1_eye>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v9_1_1_eye_1ab40b65cab787e862b5a8c2f24d0d3ea3:
...
Constructs a :ref:`Eye <doxid-classov_1_1op_1_1v9_1_1_eye>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with row number.

	*
		- num_columns

		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with column number.

	*
		- diagonal_index

		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with the index of diagonal with ones.

	*
		- batch_shape

		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with batch shape.
...
.. _doxid-classov_1_1op_1_1v9_1_1_eye_1aa902cc844a6dfb0373a3e20cbf3183cb:
.. index:: pair: function; Eye
...
Constructs a :ref:`Eye <doxid-classov_1_1op_1_1v9_1_1_eye>` operation without batch_shape.
...
.. _doxid-classov_1_1op_1_1v9_1_1_eye_1a272921d4b1136417d331038eb64411c7:
...
.. _doxid-classov_1_1op_1_1v9_1_1_eye_1adb881d17e65d27668f2a151db1d7ba35:
