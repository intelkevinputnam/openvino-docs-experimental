.. index:: pair: class; ov::op::v1::DeformablePSROIPooling
.. _doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling:
...
:ref:`DeformablePSROIPooling <doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling>` operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling>`
...
.. ref-code-block:: cpp
	...
	class DeformablePSROIPooling: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a5bbd4367e847a44135d45688f295588c>`;

		// construction
	
		:target:`DeformablePSROIPooling<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a1ab34bf08b1235a7e356e3c77440a7f8>`();
	
		:ref:`DeformablePSROIPooling<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a5305f98924f7c93a9c6a04318788ed07>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& coords,
		...
		:target:`DeformablePSROIPooling<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1aa2182e4516afe9173718922d4d6e7587>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& coords,
			const int64_t output_dim,
			const float spatial_scale,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1abc6e6a6668f2b4cde46701e0aba32eb1>`("DeformablePSROIPooling", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1afdde122c4390de948408f0368b8ed290>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a9d8c2ad789d1e5e57296d543f96aa98a>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a0817baeb3c831acbd8dbaf74ad3dd84d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		int64_t :target:`get_output_dim<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a2b991acbc38fd6064e782a52004b58dd>`() const;
		int64_t :target:`get_group_size<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a6a7a7a6581cfd5d98c3c73ff3ff68313>`() const;
		float :target:`get_spatial_scale<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a65082060778c3ca54fbd46f821201205>`() const;
		const std::string& :target:`get_mode<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1acf26f5bd9a07fca2d8a7e585978ec46c>`() const;
		int64_t :target:`get_spatial_bins_x<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1aafcbbbd8bed3ec430e4480e80368f6b0>`() const;
		int64_t :target:`get_spatial_bins_y<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a5380da218a67e85d3e562144ad55d22b>`() const;
		float :target:`get_trans_std<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a82f5766f14bf881dd2147c0e6d6ce1cb>`() const;
		int64_t :target:`get_part_size<doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a26e0a5648a8818620496393ae738b381>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`DeformablePSROIPooling <doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a5305f98924f7c93a9c6a04318788ed07:
.. index:: pair: function; DeformablePSROIPooling
...
Constructs a :ref:`DeformablePSROIPooling <doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` tensor with position sensitive score maps

	*
		- coords

		- :ref:`Input <doxid-classov_1_1_input>` tensor with list of five element tuples describing ROI coordinates

	*
		- offsets

		- :ref:`Input <doxid-classov_1_1_input>` tensor with transformation values
...
.. _doxid-classov_1_1op_1_1v1_1_1_deformable_p_s_r_o_i_pooling_1a9d8c2ad789d1e5e57296d543f96aa98a:
