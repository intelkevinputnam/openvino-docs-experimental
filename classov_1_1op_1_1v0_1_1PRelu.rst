.. index:: pair: class; ov::op::v0::PRelu
.. _doxid-classov_1_1op_1_1v0_1_1_p_relu:
...
Parametrized :ref:`Relu <doxid-classov_1_1op_1_1v0_1_1_relu>` x < 0 => f(x) = x \* slope x >= 0 => f(x) = x. :ref:`More...<details-classov_1_1op_1_1v0_1_1_p_relu>`
...
.. ref-code-block:: cpp
	...
	class PRelu: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_p_relu_1ad3ea0acf7f5a2fcce197e8fb61946128>`;

		// construction
	
		:target:`PRelu<doxid-classov_1_1op_1_1v0_1_1_p_relu_1a4ba71a3bcb4b940c6f2653a2baaf18ec>`();
		:ref:`PRelu<doxid-classov_1_1op_1_1v0_1_1_p_relu_1a64412070f59e153a7c9276480e3dee0c>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& slope);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_p_relu_1ac7eabae6022d455b9c0e74070d95d059>`("PRelu", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_p_relu_1a8cabbd2d7dcbbba012f55561bdebcad5>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_p_relu_1a3fee5395d0b59b1ce55c05ba9381f03c>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_p_relu_1a40b08c3f45c3ae57aa44d6d2e35723d4>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_p_relu_1a11b572d077f15d2bdb15e6436711f324>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_p_relu_1afce29e7eeee0168319ca2e0bda70eb10>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_p_relu:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Parametrized :ref:`Relu <doxid-classov_1_1op_1_1v0_1_1_relu>` x < 0 => f(x) = x \* slope x >= 0 => f(x) = x.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_p_relu_1a64412070f59e153a7c9276480e3dee0c:
.. index:: pair: function; PRelu

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	PRelu(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& slope)

Constructs a :ref:`PRelu <doxid-classov_1_1op_1_1v0_1_1_p_relu>` operation.
...
.. list-table::
	...
	*
		...
		- Multipliers for negative values

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_p_relu_1a40b08c3f45c3ae57aa44d6d2e35723d4:
...
.. _doxid-classov_1_1op_1_1v0_1_1_p_relu_1a11b572d077f15d2bdb15e6436711f324:
...
.. _doxid-classov_1_1op_1_1v0_1_1_p_relu_1afce29e7eeee0168319ca2e0bda70eb10:
