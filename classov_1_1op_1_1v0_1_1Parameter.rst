.. index:: pair: class; ov::op::v0::Parameter
.. _doxid-classov_1_1op_1_1v0_1_1_parameter:
...
A model parameter. :ref:`More...<details-classov_1_1op_1_1v0_1_1_parameter>`
...
.. ref-code-block:: cpp
	...
	class Parameter: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_parameter_1a0267aaa654df9d653f52a6f7a909c945>`;

		// construction
	
		:ref:`Parameter<doxid-classov_1_1op_1_1v0_1_1_parameter_1a83be68cd75837f2c3421902c9a4c2872>`();
		:ref:`Parameter<doxid-classov_1_1op_1_1v0_1_1_parameter_1add34ac2020dfbf76b748d8ed69258f5f>`(const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& element_type, const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& pshape);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_parameter_1a7cc443a68bdbefc1f1535f73f00a847d>`("Parameter", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_parameter_1af16b6f58b730e705a7129c70a44fc00a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_parameter_1a58128cf8629d204c2f3f37ee9e48a36b>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_parameter_1a8856d573ff12ecd9dcdc73253b868b95>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		bool :target:`is_relevant_to_shapes<doxid-classov_1_1op_1_1v0_1_1_parameter_1a486766f6fa29ad18a8c9214fc902f758>`() const;
		void :target:`set_is_relevant_to_shapes<doxid-classov_1_1op_1_1v0_1_1_parameter_1a77253a95629cf67a9debe0efac35c8a9>`(bool is_relevant);
		const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& :target:`get_partial_shape<doxid-classov_1_1op_1_1v0_1_1_parameter_1ab93cb809b127294cef2cd94838604362>`() const;
		:ref:`PartialShape<doxid-classov_1_1_partial_shape>`& :target:`get_partial_shape<doxid-classov_1_1op_1_1v0_1_1_parameter_1a456fe561666db5ed21a603df26732078>`();
		void :target:`set_partial_shape<doxid-classov_1_1op_1_1v0_1_1_parameter_1a262abdfb1d5a76f5f8b2c87344b2aa87>`(const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& partial_shape);
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :target:`get_element_type<doxid-classov_1_1op_1_1v0_1_1_parameter_1a51aa72aeabacf3a92da9d1e6917083da>`() const;
		void :target:`set_element_type<doxid-classov_1_1op_1_1v0_1_1_parameter_1a8cd76c6c04c63279df55b77ff4fd3534>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& element_type);
		:ref:`Layout<doxid-classov_1_1_layout>` :ref:`get_layout<doxid-classov_1_1op_1_1v0_1_1_parameter_1a922890ed0b74fba0a8b7f1a3a7ba5c69>`() const;
		void :ref:`set_layout<doxid-classov_1_1op_1_1v0_1_1_parameter_1adb78140c6df6466fd46db3ca5c4e3fe4>`(const :ref:`Layout<doxid-classov_1_1_layout>`& layout);
	};
...
.. _details-classov_1_1op_1_1v0_1_1_parameter:
...
Parameters are nodes that represent the arguments that will be passed to user-defined models. :ref:`Model <doxid-classov_1_1_model>` creation requires a sequence of parameters. Basic graph operations do not need parameters attached to a model.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_parameter_1a83be68cd75837f2c3421902c9a4c2872:
.. index:: pair: function; Parameter
...
.. _doxid-classov_1_1op_1_1v0_1_1_parameter_1add34ac2020dfbf76b748d8ed69258f5f:
.. index:: pair: function; Parameter

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Parameter(const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& element_type, const :ref:`PartialShape<doxid-classov_1_1_partial_shape>`& pshape)
...
.. list-table::
	...
	*
		...
		- The partial shape of the parameter.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_parameter_1a58128cf8629d204c2f3f37ee9e48a36b:
...
.. _doxid-classov_1_1op_1_1v0_1_1_parameter_1a922890ed0b74fba0a8b7f1a3a7ba5c69:
.. index:: pair: function; get_layout

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`Layout<doxid-classov_1_1_layout>` get_layout() const

Returns current layout, or empty :ref:`Layout <doxid-classov_1_1_layout>` if it is not set.

.. _doxid-classov_1_1op_1_1v0_1_1_parameter_1adb78140c6df6466fd46db3ca5c4e3fe4:
.. index:: pair: function; set_layout

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void set_layout(const :ref:`Layout<doxid-classov_1_1_layout>`& layout)
...
.. list-table::
	...
	*
		...
		- :ref:`Layout <doxid-classov_1_1_layout>` to set. If empty (default constructed), layout runtime information is erased.
