.. index:: pair: class; ov::op::v0::GRN
.. _doxid-classov_1_1op_1_1v0_1_1_g_r_n:
...
Global Response Normalization with L2 norm (across channels only). :ref:`More...<details-classov_1_1op_1_1v0_1_1_g_r_n>`
...
.. ref-code-block:: cpp
	...
	class GRN: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a1a3dded12b9bffac4078e8f3de398748>`;

		// construction
	
		:target:`GRN<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a492d75df8016a1534120b70bd731e20e>`();
		:ref:`GRN<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a3ed54045ff3b97c59ffdb9e6c65dda56>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, float bias);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1ab9a2270157db52fc33c5995db0f59a24>`("GRN", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a9b3cac4838f5b744bf2b155817c64b62>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1af4e02672cd79f7fdde08ae6d98fb1642>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1aa07e8f91fccaae30128fd3dc212bcb62>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		float :target:`get_bias<doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a9be0be6aa35d4b5af344abdffcca7897>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_g_r_n:
...
.. _doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a3ed54045ff3b97c59ffdb9e6c65dda56:
.. index:: pair: function; GRN

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	GRN(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, float bias)

Constructs a :ref:`GRN <doxid-classov_1_1op_1_1v0_1_1_g_r_n>` operation.
...
.. list-table::
	...
	*
		...
		- - The bias added to the variance.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_g_r_n_1a9b3cac4838f5b744bf2b155817c64b62:
