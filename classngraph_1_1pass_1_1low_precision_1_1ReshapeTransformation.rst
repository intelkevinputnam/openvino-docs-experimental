.. index:: pair: class; ngraph::pass::low_precision::ReshapeTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation:
...
:ref:`ReshapeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation>` propagates dequantization operations through Reshape operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation>`
...
.. ref-code-block:: cpp
	...
	class ReshapeTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`ReshapeTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation_1a2591b3354380f53c04a14cdcc650e644>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation_1a731b2121345371d083837d101dd29f25>`("ReshapeTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation_1a157d9f4387e6d867c1c598b4caa58e1d>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation_1aa8dd91c588da141b50df095473dad44f>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation_1a679d071af744888324c33421e7c84f2a>`(
		...
		static bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation_1aa8ea5ab9a6af71c8d455873f8726bc1e>`(
			const :ref:`ngraph::Shape<doxid-classov_1_1_shape>`& subtractShape,
			const :ref:`ngraph::Shape<doxid-classov_1_1_shape>`& multiplyShape,
			const :ref:`ngraph::PartialShape<doxid-classov_1_1_partial_shape>`& inputShape,
			const :ref:`ngraph::PartialShape<doxid-classov_1_1_partial_shape>`& outputShape
			);
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReshapeTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_reshape_transformation>` propagates dequantization operations through Reshape operation.

For more details about the transformation, refer to :ref:`ReshapeTransformation <doxid-openvino_docs__o_v__u_g_lpt__reshape_transformation>` page in the Inference Engine Developer Guide.
