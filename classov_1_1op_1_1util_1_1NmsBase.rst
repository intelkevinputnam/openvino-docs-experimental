.. index:: pair: class; ov::op::util::NmsBase
.. _doxid-classov_1_1op_1_1util_1_1_nms_base:

class ov::op::util::NmsBase
===========================

.. toctree::
	:hidden:

	SortResultType <enumov_1_1op_1_1util_1_1NmsBase_1_1SortResultType.rst>

Overview
~~~~~~~~

Base class for operations :ref:`NmsBase <doxid-classov_1_1op_1_1util_1_1_nms_base>` and MatrixNms. :ref:`More...<details-classov_1_1op_1_1util_1_1_nms_base>`
...
.. ref-code-block:: cpp
	...
	class NmsBase: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
		...
		:target:`NmsBase<doxid-classov_1_1op_1_1util_1_1_nms_base_1adf0309e4c6b15c7d686db59e565a7a58>`();
		:ref:`NmsBase<doxid-classov_1_1op_1_1util_1_1_nms_base_1a665d97f1dfdf95b183095d220996c300>`(:ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type, int& nms_top_k, int& keep_top_k);
	
		:ref:`NmsBase<doxid-classov_1_1op_1_1util_1_1_nms_base_1a69a9865c6147bb3f184108498fab78f4>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_nms_base_1a1fd95a01648a2ed6fcef3519a7cbacad>`("NmsBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_nms_base_1a2bfa92d6910fc70f30da6582d0972d8e>`();
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :target:`get_output_type<doxid-classov_1_1op_1_1util_1_1_nms_base_1ad11f6159bcc44bdac127ead6765112cc>`() const;
		void :target:`set_output_type<doxid-classov_1_1op_1_1util_1_1_nms_base_1a267d478253cff6749e9a0e423a272657>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type);
		int :target:`get_nms_top_k<doxid-classov_1_1op_1_1util_1_1_nms_base_1a8f74f2e5f932b7e45f73ff1dda78991f>`() const;
		int :target:`get_keep_top_k<doxid-classov_1_1op_1_1util_1_1_nms_base_1a0ce53ec386aba31b8fcbcf22aab1b99e>`() const;
	
		void :target:`set_output_type<doxid-classov_1_1op_1_1util_1_1_nms_base_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
...
.. _details-classov_1_1op_1_1util_1_1_nms_base:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Base class for operations :ref:`NmsBase <doxid-classov_1_1op_1_1util_1_1_nms_base>` and MatrixNms.

Construction
------------

.. _doxid-classov_1_1op_1_1util_1_1_nms_base_1a665d97f1dfdf95b183095d220996c300:
.. index:: pair: function; NmsBase

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	NmsBase(:ref:`element::Type<doxid-classov_1_1element_1_1_type>`& output_type, int& nms_top_k, int& keep_top_k)

Constructs a :ref:`NmsBase <doxid-classov_1_1op_1_1util_1_1_nms_base>` operation.
...
.. list-table::
	...
	*
		...
		- Specifies maximum number of boxes to be selected per class, -1 meaning to keep all boxes

	*
		- keep_top_k

		- Specifies maximum number of boxes to be selected per batch element, -1 meaning to keep all boxes

.. _doxid-classov_1_1op_1_1util_1_1_nms_base_1a69a9865c6147bb3f184108498fab78f4:
.. index:: pair: function; NmsBase
...
.. _doxid-classov_1_1op_1_1util_1_1_nms_base_1a2bfa92d6910fc70f30da6582d0972d8e:
