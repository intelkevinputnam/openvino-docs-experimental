.. index:: pair: class; ngraph::pass::low_precision::MoveFakeQuantize
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_move_fake_quantize:

class ngraph::pass::low_precision::MoveFakeQuantize
===================================================
...
.. ref-code-block:: cpp
	...
	class MoveFakeQuantize: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`MoveFakeQuantize<doxid-classngraph_1_1pass_1_1low__precision_1_1_move_fake_quantize_1abcfb34e628a369da0e98afe7b0efef07>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_move_fake_quantize_1a53f4fa29fa78d38129a7364e3a7c3e2d>`("MoveFakeQuantize", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_move_fake_quantize_1a9edc77a79dee322409e3e12d66e90a43>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_move_fake_quantize_1ab100df328832325bcf2e19f9d21b082b>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_move_fake_quantize_1a2d626f7e2fe028097051b2c31542757c>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
