.. index:: pair: class; ngraph::op::TopKIE
.. _doxid-classngraph_1_1op_1_1_top_k_i_e:

class ngraph::op::TopKIE
========================
...
.. ref-code-block:: cpp
	...
	class TopKIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_top_k_i_e_1a4dc4d99d8f085c43285323531dc8f8a3>`;

		// construction
	
		:target:`TopKIE<doxid-classngraph_1_1op_1_1_top_k_i_e_1a864938e8ace76a2b989eb78329dd7b01>`(
			...
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& index_element_type = element::i32
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_top_k_i_e_1a18b22528bfdc29972faa9d109a0e9bfc>`("TopKIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_top_k_i_e_1ac6b75c226bab07390ad01ca2bf8c6ade>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_top_k_i_e_1a69250806c312e659cde438b797d4ce80>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		int64_t :target:`get_axis<doxid-classngraph_1_1op_1_1_top_k_i_e_1afbb2547a93f5faf32bd44e72251ec028>`();
		ngraph::op::TopKMode :target:`get_mode<doxid-classngraph_1_1op_1_1_top_k_i_e_1a288ca689b3ceb0fa6842fbaf94c87678>`();
		ngraph::op::TopKSortType :target:`get_sort_type<doxid-classngraph_1_1op_1_1_top_k_i_e_1a5b01642e79d1f32c9a2582820459aef6>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_top_k_i_e_1a75f654cd4d7bfe66b5939e50ae9f3870>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classngraph_1_1op_1_1_top_k_i_e:
...
.. _doxid-classngraph_1_1op_1_1_top_k_i_e_1ac6b75c226bab07390ad01ca2bf8c6ade:
