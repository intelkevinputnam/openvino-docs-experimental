.. index:: pair: class; ngraph::op::PowerIE
.. _doxid-classngraph_1_1op_1_1_power_i_e:

class ngraph::op::PowerIE
=========================
...
.. ref-code-block:: cpp
	...
	class PowerIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_power_i_e_1a9c96393278fe2cf83d0ae2ef93c1e6c7>`;
		float :target:`scale<doxid-classngraph_1_1op_1_1_power_i_e_1aee321b091fd740e8d015b63cd2208ef6>`;
		float :target:`power<doxid-classngraph_1_1op_1_1_power_i_e_1a556de21ee73c86af971c0351f785dcc8>`;
		float :target:`shift<doxid-classngraph_1_1op_1_1_power_i_e_1a1c089d825fe8d824f61c872e3073dc68>`;

		// construction
	
		:target:`PowerIE<doxid-classngraph_1_1op_1_1_power_i_e_1a85d63a8effe68a114c0309439a0169be>`();
	
		:target:`PowerIE<doxid-classngraph_1_1op_1_1_power_i_e_1a5976e49e69284a866d19ac56ec75392f>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_power_i_e_1a6e082a460bbbe38a88c68a75c1ad747b>`("PowerIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_power_i_e_1ab365b937254cad11bdf701a2156a84a1>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_power_i_e_1a216a660dc5cd089378fd27c8afb83f17>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_power_i_e_1a56904ac9bc3eaeaff71b367f0ebe00de>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_power_i_e:
...
.. _doxid-classngraph_1_1op_1_1_power_i_e_1ab365b937254cad11bdf701a2156a84a1:
