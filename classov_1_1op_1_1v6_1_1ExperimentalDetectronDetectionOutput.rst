.. index:: pair: class; ov::op::v6::ExperimentalDetectronDetectionOutput
.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output:
...
.. toctree::
	...
	Attributes <structov_1_1op_1_1v6_1_1ExperimentalDetectronDetectionOutput_1_1Attributes.rst>

Overview
~~~~~~~~

An operation :ref:`ExperimentalDetectronDetectionOutput <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output>` performs non-maximum suppression to generate the detection output using information on location and score predictions. :ref:`More...<details-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output>`
...
.. ref-code-block:: cpp
	...
	class ExperimentalDetectronDetectionOutput: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// structs
	
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1_1_attributes>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1a8061f8fb539efd0fd3e6cf8e84ad95c9>`;

		// construction
	
		:target:`ExperimentalDetectronDetectionOutput<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1a402dfe3b4fcea69460d29b38d686cbcd>`();
	
		:ref:`ExperimentalDetectronDetectionOutput<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1ae4ee98a890d9c4db70299eeed54cdcfb>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_rois,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_deltas,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_scores,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input_im_info,
			const :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1aed529c213bf1c653d565aa705aa64973>`("ExperimentalDetectronDetectionOutput", "opset6", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 6);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1a108d41647c4f327d2fed86e352afb8b9>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1a14260f75370fddfc9330eecc3c6a8458>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1a94b63d222f3704a99dc1cc9ccb1ab515>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1_1_attributes>`& :ref:`get_attrs<doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1af722f23990068106c6df0d45d38207e1>`() const;
	};
...
.. _details-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

An operation :ref:`ExperimentalDetectronDetectionOutput <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output>` performs non-maximum suppression to generate the detection output using information on location and score predictions.

Construction
------------

.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1ae4ee98a890d9c4db70299eeed54cdcfb:
.. index:: pair: function; ExperimentalDetectronDetectionOutput
...
Constructs a :ref:`ExperimentalDetectronDetectionOutput <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` rois

	*
		- input_deltas

		- :ref:`Input <doxid-classov_1_1_input>` deltas

	*
		- input_scores

		- :ref:`Input <doxid-classov_1_1_input>` scores

	*
		- input_im_info

		- :ref:`Input <doxid-classov_1_1_input>` image info

	*
		- attrs

		- :ref:`Attributes <doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1_1_attributes>` attributes

Methods
-------

.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1a14260f75370fddfc9330eecc3c6a8458:
...
.. _doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1af722f23990068106c6df0d45d38207e1:
.. index:: pair: function; get_attrs

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`Attributes<doxid-structov_1_1op_1_1v6_1_1_experimental_detectron_detection_output_1_1_attributes>`& get_attrs() const

Returns attributes of the operation :ref:`ExperimentalDetectronDetectionOutput <doxid-classov_1_1op_1_1v6_1_1_experimental_detectron_detection_output>`.
