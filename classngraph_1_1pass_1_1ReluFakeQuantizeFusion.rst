.. index:: pair: class; ngraph::pass::ReluFakeQuantizeFusion
.. _doxid-classngraph_1_1pass_1_1_relu_fake_quantize_fusion:
...
:ref:`ReluFakeQuantizeFusion <doxid-classngraph_1_1pass_1_1_relu_fake_quantize_fusion>` transformation replaces following graph: Relu -> FakeQuantize to FakeQuantize under following conditions: :ref:`More...<details-classngraph_1_1pass_1_1_relu_fake_quantize_fusion>`
...
.. ref-code-block:: cpp
	...
	class ReluFakeQuantizeFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_relu_fake_quantize_fusion_1a65198198778194b407b74bca232e6683>`("ReluFakeQuantizeFusion", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_relu_fake_quantize_fusion:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ReluFakeQuantizeFusion <doxid-classngraph_1_1pass_1_1_relu_fake_quantize_fusion>` transformation replaces following graph: Relu -> FakeQuantize to FakeQuantize under following conditions:
