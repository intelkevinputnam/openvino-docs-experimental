.. index:: pair: class; ov::pass::pattern::op::WrapType
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type:

class ov::pass::pattern::op::WrapType
=====================================
...
.. ref-code-block:: cpp
	...
	class WrapType: public :ref:`ov::pass::pattern::op::Pattern<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_pattern>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1a1cbca25f0307a1fa626398261a03146b>`;

		// construction
	
		:target:`WrapType<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1a0dda5730dd17635bc0ed890c8c0eb9f7>`(
			:ref:`NodeTypeInfo<doxid-namespaceov_1a79488905863d76f31e968e3abc04eb62>` wrapped_type,
			const :ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>`& pred = [](const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>&:ref:`output<doxid-classov_1_1_node_1a24dc2a2bac789d34d8e1959249b6347d>`) { return true;},
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& input_values = {}
			);
	
		:target:`WrapType<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1a26a4e233b337b24426e163c010144c26>`(
			std::vector<:ref:`NodeTypeInfo<doxid-namespaceov_1a79488905863d76f31e968e3abc04eb62>`> wrapped_types,
			const :ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>`& pred = [](const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>&:ref:`output<doxid-classov_1_1_node_1a24dc2a2bac789d34d8e1959249b6347d>`) { return true;},
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& input_values = {}
			);
		...
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1abd1668196067dfb7e548db8972c80ca5>`("patternAnyType");
	
		virtual bool :target:`match_value<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1a7fde92d115b094c90b6ef2124952d302>`(
			:ref:`pattern::Matcher<doxid-classov_1_1pass_1_1pattern_1_1_matcher>` \* matcher,
		...
		:ref:`NodeTypeInfo<doxid-namespaceov_1a79488905863d76f31e968e3abc04eb62>` :target:`get_wrapped_type<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1a2c8f8d1a2ebe448e5da07ecc6affe5e5>`() const;
		const std::vector<:ref:`NodeTypeInfo<doxid-namespaceov_1a79488905863d76f31e968e3abc04eb62>`>& :target:`get_wrapped_types<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_wrap_type_1a5571990fe2b887cb91a22c7dc2f811d4>`() const;
	};
