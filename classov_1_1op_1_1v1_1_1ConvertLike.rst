.. index:: pair: class; ov::op::v1::ConvertLike
.. _doxid-classov_1_1op_1_1v1_1_1_convert_like:
...
Elementwise type conversion operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_convert_like>`
...
.. ref-code-block:: cpp
	...
	class ConvertLike: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_convert_like_1aab811a264fd55ac205af288c1cf8ecac>`;

		// construction
	
		:ref:`ConvertLike<doxid-classov_1_1op_1_1v1_1_1_convert_like_1a99e98d1c32d9c999de4dc2d5cf84a7db>`();
		:ref:`ConvertLike<doxid-classov_1_1op_1_1v1_1_1_convert_like_1a4274e0061e1815b099ceb34b3e00a479>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& like);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_convert_like_1ab0e42df354f128365ca7f80091e5f5a5>`("ConvertLike", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_convert_like_1a9f1549df49393b72cc3bd9269a37284c>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_convert_like_1a8b1309c8a5de7001539f472c5d8f1f1d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_convert_like_1ae0f75f875a44695d92deed0fcb1fc78a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v1_1_1_convert_like_1a98dea5fe541527e7dcb323a2fcb8d4a3>`(
...
.. _details-classov_1_1op_1_1v1_1_1_convert_like:
...
.. _doxid-classov_1_1op_1_1v1_1_1_convert_like_1a99e98d1c32d9c999de4dc2d5cf84a7db:
.. index:: pair: function; ConvertLike
...
.. _doxid-classov_1_1op_1_1v1_1_1_convert_like_1a4274e0061e1815b099ceb34b3e00a479:
.. index:: pair: function; ConvertLike

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	ConvertLike(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& like)
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` which provides the target type information for the conversion.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_convert_like_1a9f1549df49393b72cc3bd9269a37284c:
