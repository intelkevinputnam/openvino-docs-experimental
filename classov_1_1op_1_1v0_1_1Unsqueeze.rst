.. index:: pair: class; ov::op::v0::Unsqueeze
.. _doxid-classov_1_1op_1_1v0_1_1_unsqueeze:
...
:ref:`Unsqueeze <doxid-classov_1_1op_1_1v0_1_1_unsqueeze>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_unsqueeze>`
...
.. ref-code-block:: cpp
	...
	class Unsqueeze: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1adbef5b679e19efcbc4f835e5ab828644>`;

		// construction
	
		:target:`Unsqueeze<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1abd4af70a29833826a001157fbac32715>`();
		:target:`Unsqueeze<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a710db5b00ed1d06a0dc972cf9f4191ed>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& axes);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1aaa2f9b959b09996c8c87692c8f8f87e8>`("Unsqueeze", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a827ef99f3d619a1645a92eb1e28cf005>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a4885d9c21a6f40e4538a39063d7fc5f7>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a3bd668066a593479a0e25d29d5e51799>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a1660243e7f88db37b06c9ed845b523b9>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a4456eb9599679babb776eada5636b4c1>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a13c18475b17695131e8634ecc5a2314f>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& output_values) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a67d40f2946a5da130b358b2737d4aadc>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	
		virtual bool :target:`constant_fold<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1add66f8c80c4af532ed1d284c16c5efac>`(
		...
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1aca855969b7c7ff9cc9977e988cada8a4>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_unsqueeze:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Unsqueeze <doxid-classov_1_1op_1_1v0_1_1_unsqueeze>` operation.

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a827ef99f3d619a1645a92eb1e28cf005:
...
.. _doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a3bd668066a593479a0e25d29d5e51799:
...
.. _doxid-classov_1_1op_1_1v0_1_1_unsqueeze_1a1660243e7f88db37b06c9ed845b523b9:
