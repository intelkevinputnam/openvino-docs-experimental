.. index:: pair: class; ngraph::op::HardSigmoid_IE
.. _doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e:

class ngraph::op::HardSigmoid_IE
================================
...
.. ref-code-block:: cpp
	...
	class HardSigmoid_IE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a1407f26a83855395d4c088a2830e7add>`;

		// construction
	
		:target:`HardSigmoid_IE<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a7eecd14777238657691048a98b8bb04f>`();
		:target:`HardSigmoid_IE<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1adf7ea2b111cd1109c509ac98e2fc739a>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, float alpha, float beta);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a222127af6fa809ec142e5407931c04ee>`("HardSigmoid_IE", "legacy");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a72f4e945c00623b0688c9050e7efdd18>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a8918b341e16dd9e80451fcf48fe54f49>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a7d5f16221029427b2d47881d84f59dad>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		float :target:`get_alpha<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a0304c057e34097cd65a0c32bcebde518>`() const;
		void :target:`set_alpha<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a8fed1d8cda8c26aec28886a694f5151b>`(float alpha);
		float :target:`get_beta<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1ae79be9c7eba7167b617c5b4d61198ef6>`() const;
		void :target:`set_beta<doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1ade23657614786fe7c21212bf7a89b6c6>`(float beta);
	};
...
.. _details-classngraph_1_1op_1_1_hard_sigmoid___i_e:
...
.. _doxid-classngraph_1_1op_1_1_hard_sigmoid___i_e_1a8918b341e16dd9e80451fcf48fe54f49:
