.. index:: pair: class; ngraph::op::ProposalIE
.. _doxid-classngraph_1_1op_1_1_proposal_i_e:

class ngraph::op::ProposalIE
============================
...
.. ref-code-block:: cpp
	...
	class ProposalIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_proposal_i_e_1a5d22f6e7a9430a4ab1e806864b63bfec>`;

		// construction
	
		:target:`ProposalIE<doxid-classngraph_1_1op_1_1_proposal_i_e_1ab4c3f9efe9b34c36c977f66a28d79564>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& class_probs,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& class_bbox_deltas,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image_shape,
			const :ref:`ProposalAttrs<doxid-namespacengraph_1_1op_1a4358e1e5587270d7e246c6a9c90b1c51>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_proposal_i_e_1af248bb4d172ebb751311c1cfbd71569c>`("ProposalIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_proposal_i_e_1a2fccdc4227e31390bc1c4e9606e90bc9>`();
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_proposal_i_e_1a96a9e511bd6fc61f018b4148b124a608>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_proposal_i_e_1a5bfc37acb91229f921f29db46deac732>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		const :ref:`ProposalAttrs<doxid-namespacengraph_1_1op_1a4358e1e5587270d7e246c6a9c90b1c51>`& :target:`get_attrs<doxid-classngraph_1_1op_1_1_proposal_i_e_1ab6cd42e42316d5a387635a87b73188e9>`() const;
	};
...
.. _details-classngraph_1_1op_1_1_proposal_i_e:
...
.. _doxid-classngraph_1_1op_1_1_proposal_i_e_1a2fccdc4227e31390bc1c4e9606e90bc9:
