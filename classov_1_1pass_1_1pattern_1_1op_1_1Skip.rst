.. index:: pair: class; ov::pass::pattern::op::Skip
.. _doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip:
...
.. ref-code-block:: cpp
	...
	class Skip: public :ref:`ov::pass::pattern::op::Pattern<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_pattern>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1adb2c560e3cb94747af9dd8548c486f03>`;

		// construction
	
		:target:`Skip<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1a9afc997b93afcfcdb6e1c49e4f268f48>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, :ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>` pred);
		:target:`Skip<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1a8a086d8eaf0892dc3ff99d02f3c6db47>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, :ref:`NodePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a773344323e39ff5d3e25bc79c06dac5d>` pred = nullptr);
		:target:`Skip<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1a9b00436cc5d6319a39b72e3290b64173>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& args, :ref:`ValuePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a1c63e9ca6a1801153d3aa30f857cfbbf>` pred);
		:target:`Skip<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1a1014c211bdc5114a273b67e7d2730d8d>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& args, :ref:`NodePredicate<doxid-namespaceov_1_1pass_1_1pattern_1_1op_1a773344323e39ff5d3e25bc79c06dac5d>` pred = nullptr);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1ac7eb09569249ec6481ac53e5ba29da1e>`("patternSkip");
	
		virtual bool :target:`match_value<doxid-classov_1_1pass_1_1pattern_1_1op_1_1_skip_1ab6055b9d6e9186c5dde1723fde7a2bb0>`(
