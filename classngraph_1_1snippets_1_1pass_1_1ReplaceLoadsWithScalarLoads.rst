.. index:: pair: interface; ngraph::snippets::pass::ReplaceLoadsWithScalarLoads
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_replace_loads_with_scalar_loads:

interface ngraph::snippets::pass::ReplaceLoadsWithScalarLoads
=============================================================



Replaces vector loads with scalar versions. The pass is used to cange element type of function in a canonical form vector to scalar. Used for tail generation.
...
.. ref-code-block:: cpp
	...
	template ReplaceLoadsWithScalarLoads: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	};
