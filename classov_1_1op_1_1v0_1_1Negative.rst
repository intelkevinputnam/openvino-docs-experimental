.. index:: pair: class; ov::op::v0::Negative
.. _doxid-classov_1_1op_1_1v0_1_1_negative:
...
Elementwise negative operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_negative>`
...
.. ref-code-block:: cpp
	...
	class Negative: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_negative_1a1d4f73381d19a224bc78bce4e3567ea2>`;

		// construction
	
		:ref:`Negative<doxid-classov_1_1op_1_1v0_1_1_negative_1a9a0e69920d4f957cb335a12dd98cd6ee>`();
		:ref:`Negative<doxid-classov_1_1op_1_1v0_1_1_negative_1ac9451179e422f49cf34241943095443d>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_negative_1aaa8bacada3db9cf5bd5a26d424492f8c>`("Negative", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_negative_1a0181023e2a6665990584a8282d003a34>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_negative_1afd5a670b8ae00b8df6fafcac3d9360eb>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_negative_1aae616c8ebd1c8b9575c64990882dc6c7>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_negative_1adbb42085ba1014a46d9fae59bf419cbd>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_negative:
...
.. _doxid-classov_1_1op_1_1v0_1_1_negative_1a9a0e69920d4f957cb335a12dd98cd6ee:
.. index:: pair: function; Negative
...
.. _doxid-classov_1_1op_1_1v0_1_1_negative_1ac9451179e422f49cf34241943095443d:
.. index:: pair: function; Negative

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Negative(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_negative_1aae616c8ebd1c8b9575c64990882dc6c7:
...
.. _doxid-classov_1_1op_1_1v0_1_1_negative_1adbb42085ba1014a46d9fae59bf419cbd:
