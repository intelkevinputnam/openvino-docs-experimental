.. index:: pair: class; ngraph::pass::ConvertGather0D
.. _doxid-classngraph_1_1pass_1_1_convert_gather0_d:
...
:ref:`ConvertGather0D <doxid-classngraph_1_1pass_1_1_convert_gather0_d>` decomposes v1::Gather operation into v0::Unsqueeze + v1::Gather + v0::Squeeze pattern when gather indices is scalar.
...
.. ref-code-block:: cpp
	...
	class ConvertGather0D: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_gather0_d_1a2ced89d1b02cae5eec5bb8edcd902b77>`("ConvertGather0D", "0");
	};
