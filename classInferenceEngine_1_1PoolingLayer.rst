.. index:: pair: class; InferenceEngine::PoolingLayer
.. _doxid-class_inference_engine_1_1_pooling_layer:
...
.. toctree::
	...
	PoolType <enumInferenceEngine_1_1PoolingLayer_1_1PoolType.rst>

Overview
~~~~~~~~

This class represents a standard pooling layer. :ref:`More...<details-class_inference_engine_1_1_pooling_layer>`
...
.. ref-code-block:: cpp
	...
	class PoolingLayer: public :ref:`InferenceEngine::CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`
	{
	public:
		// enums
	
		enum :ref:`PoolType<doxid-class_inference_engine_1_1_pooling_layer_1ab43fd40baddc9e43ec9772f2ea20b07d>`;

		// fields
	
		:ref:`PropertyVector<doxid-class_inference_engine_1_1_property_vector>`<unsigned int> :ref:`_kernel<doxid-class_inference_engine_1_1_pooling_layer_1a7d586ea026cfd316508f07cd2b437cf9>`;
		unsigned int& :target:`_kernel_x<doxid-class_inference_engine_1_1_pooling_layer_1a7b826fbdf039e6aefa4fb332ea483c6b>` =  :ref:`_kernel<doxid-class_inference_engine_1_1_pooling_layer_1a7d586ea026cfd316508f07cd2b437cf9>` .at(:ref:`X_AXIS<doxid-namespace_inference_engine_1a699af6f18afedf57e765e099645728f0a123219f421934427910f3c8080f76bcc>`);
		unsigned int& :target:`_kernel_y<doxid-class_inference_engine_1_1_pooling_layer_1a756db6bb076c4525083ff05a103e1b23>` =  :ref:`_kernel<doxid-class_inference_engine_1_1_pooling_layer_1a7d586ea026cfd316508f07cd2b437cf9>` .at(:ref:`Y_AXIS<doxid-namespace_inference_engine_1a699af6f18afedf57e765e099645728f0aa5a4fe3bd008bfa81437359c246b0b24>`);
		:ref:`PropertyVector<doxid-class_inference_engine_1_1_property_vector>`<unsigned int> :ref:`_padding<doxid-class_inference_engine_1_1_pooling_layer_1a4ba1bfa841a9ad87136d1e34581a9eb5>`;
		unsigned int& :target:`_padding_x<doxid-class_inference_engine_1_1_pooling_layer_1af91848f34229d912c4a77f0d8f8edb78>` =  :ref:`_padding<doxid-class_inference_engine_1_1_pooling_layer_1a4ba1bfa841a9ad87136d1e34581a9eb5>` .at(:ref:`X_AXIS<doxid-namespace_inference_engine_1a699af6f18afedf57e765e099645728f0a123219f421934427910f3c8080f76bcc>`);
		unsigned int& :target:`_padding_y<doxid-class_inference_engine_1_1_pooling_layer_1aff92d92b301336814e2fbac5a5ee54ab>` =  :ref:`_padding<doxid-class_inference_engine_1_1_pooling_layer_1a4ba1bfa841a9ad87136d1e34581a9eb5>` .at(:ref:`Y_AXIS<doxid-namespace_inference_engine_1a699af6f18afedf57e765e099645728f0aa5a4fe3bd008bfa81437359c246b0b24>`);
		:ref:`PropertyVector<doxid-class_inference_engine_1_1_property_vector>`<unsigned int> :ref:`_pads_end<doxid-class_inference_engine_1_1_pooling_layer_1a3c8ef9fb227f534e18199b1ab0b89efc>`;
		:ref:`PropertyVector<doxid-class_inference_engine_1_1_property_vector>`<unsigned int> :ref:`_stride<doxid-class_inference_engine_1_1_pooling_layer_1ab628a33c03ca9a27107470bb37f1e358>`;
		unsigned int& :target:`_stride_x<doxid-class_inference_engine_1_1_pooling_layer_1ad5926034411e8b23446b48f1a2260f9c>` =  :ref:`_stride<doxid-class_inference_engine_1_1_pooling_layer_1ab628a33c03ca9a27107470bb37f1e358>` .at(:ref:`X_AXIS<doxid-namespace_inference_engine_1a699af6f18afedf57e765e099645728f0a123219f421934427910f3c8080f76bcc>`);
		unsigned int& :target:`_stride_y<doxid-class_inference_engine_1_1_pooling_layer_1a767e33ae22f3dee51add071a7e775ac5>` =  :ref:`_stride<doxid-class_inference_engine_1_1_pooling_layer_1ab628a33c03ca9a27107470bb37f1e358>` .at(:ref:`Y_AXIS<doxid-namespace_inference_engine_1a699af6f18afedf57e765e099645728f0aa5a4fe3bd008bfa81437359c246b0b24>`);
		:ref:`PoolType<doxid-class_inference_engine_1_1_pooling_layer_1ab43fd40baddc9e43ec9772f2ea20b07d>` :ref:`_type<doxid-class_inference_engine_1_1_pooling_layer_1aa2c92a42fb1b29b233e6796bf1be7bbc>` = :ref:`MAX<doxid-class_inference_engine_1_1_pooling_layer_1ab43fd40baddc9e43ec9772f2ea20b07da51a0d82e953742c83b067e84de5cb258>`;
		bool :ref:`_exclude_pad<doxid-class_inference_engine_1_1_pooling_layer_1a4148b5ef38e70a18bd683f5315578d00>` = false;
		std::string :ref:`_auto_pad<doxid-class_inference_engine_1_1_pooling_layer_1ad2596b104b9dda7bbb9eaeeb82a09ec2>`;

		// construction
	
		:ref:`PoolingLayer<doxid-class_inference_engine_1_1_pooling_layer_1a42040cbe4d6f711d6339d8211bfaa9b0>`(const :ref:`LayerParams<doxid-struct_inference_engine_1_1_layer_params>`& p);
		:ref:`PoolingLayer<doxid-class_inference_engine_1_1_pooling_layer_1ad1a4764e42deacbb4488a622f0a000ba>`(const PoolingLayer& that);
		:ref:`PoolingLayer<doxid-class_inference_engine_1_1_pooling_layer_1aabb1b64cb693dc875ea7471e7b01e311>`(PoolingLayer&&);

		// methods
	
		PoolingLayer& :ref:`operator =<doxid-class_inference_engine_1_1_pooling_layer_1ace6d234fefe8cc91a0dee886d7c1dc57>` (const PoolingLayer& that);
	};
...
.. _details-class_inference_engine_1_1_pooling_layer:
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1a7d586ea026cfd316508f07cd2b437cf9:
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1a4ba1bfa841a9ad87136d1e34581a9eb5:
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1a3c8ef9fb227f534e18199b1ab0b89efc:
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1ab628a33c03ca9a27107470bb37f1e358:
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1aa2c92a42fb1b29b233e6796bf1be7bbc:
.. index:: pair: variable; _type

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	:ref:`PoolType<doxid-class_inference_engine_1_1_pooling_layer_1ab43fd40baddc9e43ec9772f2ea20b07d>` _type = :ref:`MAX<doxid-class_inference_engine_1_1_pooling_layer_1ab43fd40baddc9e43ec9772f2ea20b07da51a0d82e953742c83b067e84de5cb258>`

A pooling type.

.. _doxid-class_inference_engine_1_1_pooling_layer_1a4148b5ef38e70a18bd683f5315578d00:
.. index:: pair: variable; _exclude_pad
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1ad2596b104b9dda7bbb9eaeeb82a09ec2:
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1a42040cbe4d6f711d6339d8211bfaa9b0:
.. index:: pair: function; PoolingLayer

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	PoolingLayer(const :ref:`LayerParams<doxid-struct_inference_engine_1_1_layer_params>`& p)

Creates a new :ref:`PoolingLayer <doxid-class_inference_engine_1_1_pooling_layer>` instance.

.. _doxid-class_inference_engine_1_1_pooling_layer_1ad1a4764e42deacbb4488a622f0a000ba:
.. index:: pair: function; PoolingLayer
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1aabb1b64cb693dc875ea7471e7b01e311:
.. index:: pair: function; PoolingLayer
...
.. _doxid-class_inference_engine_1_1_pooling_layer_1ace6d234fefe8cc91a0dee886d7c1dc57:
