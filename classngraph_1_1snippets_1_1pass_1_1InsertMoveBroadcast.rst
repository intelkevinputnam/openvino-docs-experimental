.. index:: pair: interface; ngraph::snippets::pass::InsertMoveBroadcast
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_insert_move_broadcast:

interface ngraph::snippets::pass::InsertMoveBroadcast
=====================================================



Inserts explicit MoveBroadcast instruction if broadcasting by most warying dimension is needed. The pass is used to convert model to a canonical form for code generation.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <insert_movebroadcast.hpp>
	
	template InsertMoveBroadcast: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	};
