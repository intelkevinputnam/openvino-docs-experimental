.. index:: pair: class; ngraph::pass::GroupedGatherElimination
.. _doxid-classngraph_1_1pass_1_1_grouped_gather_elimination:
...
:ref:`GroupedGatherElimination <doxid-classngraph_1_1pass_1_1_grouped_gather_elimination>` transformation replaces group of Gather operations with the first Gather in this group and updated indices input in case all Gathers in the group are consumed by the same Concat in incremental order.
...
.. ref-code-block:: cpp
	...
	class GroupedGatherElimination: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_grouped_gather_elimination_1a5cdf9d706019d0ed6256aa304cc1a808>`("GroupedGatherElimination", "0");
	};
