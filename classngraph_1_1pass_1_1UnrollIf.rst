.. index:: pair: class; ngraph::pass::UnrollIf
.. _doxid-classngraph_1_1pass_1_1_unroll_if:
...
.. ref-code-block:: cpp
	...
	class UnrollIf: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_unroll_if_1a971f3e32fb1786ed3bcf06fb847a3d28>`("UnrollIf", "0");
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1_unroll_if_1af5b161689aeee77cc3dca34a53f80fe6>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& m);
	};
