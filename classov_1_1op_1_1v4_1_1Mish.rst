.. index:: pair: class; ov::op::v4::Mish
.. _doxid-classov_1_1op_1_1v4_1_1_mish:
...
A Self Regularized Non-Monotonic Neural Activation Function f(x) = x \* tanh(log(exp(x) + 1.)) :ref:`More...<details-classov_1_1op_1_1v4_1_1_mish>`
...
.. ref-code-block:: cpp
	...
	class Mish: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_mish_1ab0477b06f7cf80e54976334ad7c24b5d>`;

		// construction
	
		:target:`Mish<doxid-classov_1_1op_1_1v4_1_1_mish_1afd17eedb37ac2dc27b87ee418775bff5>`();
		:ref:`Mish<doxid-classov_1_1op_1_1v4_1_1_mish_1a868bfa73aa33179e9f197fe67dfd80ec>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_mish_1a9eb08805333540547f3dae8da2fd71a5>`("Mish", "opset4", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 4);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v4_1_1_mish_1a758f2fb26fb70c5554cdb86c9d3caca6>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v4_1_1_mish_1a4a4aeed065c2e357e436f34f92388b8d>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_mish_1aacd00733d352a544d93e8032ef2a30b9>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v4_1_1_mish_1ac3432d63115c277446fc34a60da0b875>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v4_1_1_mish_1a2a4649caad671b80f6301d1ebeb5383a>`() const;
	};
...
.. _details-classov_1_1op_1_1v4_1_1_mish:
...
.. _doxid-classov_1_1op_1_1v4_1_1_mish_1a868bfa73aa33179e9f197fe67dfd80ec:
.. index:: pair: function; Mish

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Mish(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)

Constructs an :ref:`Mish <doxid-classov_1_1op_1_1v4_1_1_mish>` operation.
...
.. _doxid-classov_1_1op_1_1v4_1_1_mish_1a4a4aeed065c2e357e436f34f92388b8d:
...
.. _doxid-classov_1_1op_1_1v4_1_1_mish_1ac3432d63115c277446fc34a60da0b875:
...
.. _doxid-classov_1_1op_1_1v4_1_1_mish_1a2a4649caad671b80f6301d1ebeb5383a:
