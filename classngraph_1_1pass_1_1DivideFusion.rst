.. index:: pair: class; ngraph::pass::DivideFusion
.. _doxid-classngraph_1_1pass_1_1_divide_fusion:
...
:ref:`DivideFusion <doxid-classngraph_1_1pass_1_1_divide_fusion>` transformation replaces a sub-graph Pow(y, -1) \* x or x \* Pow(y, -1) with Divide(x,y)
...
.. ref-code-block:: cpp
	...
	class DivideFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_divide_fusion_1aa5044cc9f8ae8d008659cf8d97f4eac6>`("DivideFusion", "0");
	};
