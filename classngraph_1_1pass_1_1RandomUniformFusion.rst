.. index:: pair: class; ngraph::pass::RandomUniformFusion
.. _doxid-classngraph_1_1pass_1_1_random_uniform_fusion:
...
:ref:`RandomUniformFusion <doxid-classngraph_1_1pass_1_1_random_uniform_fusion>` transformation replaces RandomUniform -> Add or RandomUniform -> Mul subgraph with a RandomUniform and replaces min and max const with corrected values.
...
.. ref-code-block:: cpp
	...
	class RandomUniformFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_random_uniform_fusion_1a7ff68326f69c6652f98bed3616f116a1>`("RandomUniformFusion", "0");
	};
