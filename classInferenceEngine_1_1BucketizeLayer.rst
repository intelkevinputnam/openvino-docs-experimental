.. index:: pair: class; InferenceEngine::BucketizeLayer
.. _doxid-class_inference_engine_1_1_bucketize_layer:
...
This class represents Bucketize layer Bucketize layer bucketizes the input based on the boundaries. :ref:`More...<details-class_inference_engine_1_1_bucketize_layer>`
...
.. ref-code-block:: cpp
	...
	class BucketizeLayer: public :ref:`InferenceEngine::CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`
	{
	public:
		// fields
	
		bool :ref:`with_right_bound<doxid-class_inference_engine_1_1_bucketize_layer_1ae4ff2976880de8d17d678707359a1e26>` = true;

		// methods
	
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_bucketize_layer_1a49576b4ff390822c0aa474cf7f542724>`(const :ref:`LayerParams<doxid-struct_inference_engine_1_1_layer_params>`& prms);
		:ref:`CNNLayer<doxid-class_inference_engine_1_1_bucketize_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa>`(const :ref:`CNNLayer<doxid-class_inference_engine_1_1_c_n_n_layer>`& other);
	};
...
.. _details-class_inference_engine_1_1_bucketize_layer:
...
.. _doxid-class_inference_engine_1_1_bucketize_layer_1ae4ff2976880de8d17d678707359a1e26:
.. index:: pair: variable; with_right_bound
...
.. _doxid-class_inference_engine_1_1_bucketize_layer_1a49576b4ff390822c0aa474cf7f542724:
...
Creates a new :ref:`BucketizeLayer <doxid-class_inference_engine_1_1_bucketize_layer>` instance.

.. _doxid-class_inference_engine_1_1_bucketize_layer_1ad5d08d211ac7bb10a79a1e4dc66551fa:
.. index:: pair: function; CNNLayer
