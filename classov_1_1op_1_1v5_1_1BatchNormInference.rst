.. index:: pair: class; ov::op::v5::BatchNormInference
.. _doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference:
...
:ref:`BatchNormInference <doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference>` operation. :ref:`More...<details-classov_1_1op_1_1v5_1_1_batch_norm_inference>`
...
.. ref-code-block:: cpp
	...
	class BatchNormInference: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1a9f17926fcba12196404a032ced624383>`;

		// construction
	
		:target:`BatchNormInference<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1aed997b746c751ae52447383d6c570fa1>`();
	
		:ref:`BatchNormInference<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1af22cab54b2909000ed2729ab28949fe7>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& input,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& gamma,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& beta,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& mean,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& variance,
			double epsilon
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1ab06d74e052c45b98d9696f10156566ac>`("BatchNormInference", "opset5", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 5);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1abd9119f8779aaf6ec99a5399af85bda8>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1a371b8fb006833c8e1ab1cc630e1257a9>`();
		double :target:`get_eps_value<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1ae1c6732bd45c6bca22f1f18a89778a23>`() const;
		void :target:`set_eps_value<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1a1afeb6c6bc393803c0b77ce00de1d905>`(double epsilon);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1a03dc339d810db912d541a1267c836399>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v5_1_1_batch_norm_inference:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`BatchNormInference <doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1af22cab54b2909000ed2729ab28949fe7:
.. index:: pair: function; BatchNormInference
...
.. _doxid-classov_1_1op_1_1v5_1_1_batch_norm_inference_1a371b8fb006833c8e1ab1cc630e1257a9:
