.. index:: pair: class; ov::op::v8::PriorBox
.. _doxid-classov_1_1op_1_1v8_1_1_prior_box:
...
.. toctree::
	...
	Attributes <structov_1_1op_1_1v8_1_1PriorBox_1_1Attributes.rst>

Overview
~~~~~~~~

Layer which generates prior boxes of specified sizes normalized to input image size. :ref:`More...<details-classov_1_1op_1_1v8_1_1_prior_box>`
...
.. ref-code-block:: cpp
	...
	class PriorBox: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// structs
	
		struct :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_prior_box_1_1_attributes>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_prior_box_1aaf5ba480efb35c7373eb2ab2720f169f>`;

		// construction
	
		:target:`PriorBox<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a464c00809a304d3d48cc485dd26fa93b>`();
	
		:ref:`PriorBox<doxid-classov_1_1op_1_1v8_1_1_prior_box_1ac746c05a4566426310fe1fd31c129b64>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& layer_shape,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image_shape,
			const :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_prior_box_1_1_attributes>`& attrs
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a540a88b58a1a649104fa3134f54e4bea>`("PriorBox", "opset8");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_prior_box_1aeff873b3d4e72b61b80805e348e22e48>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a0675bc9fe79590b503ac1fa499b136e2>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_prior_box_1_1_attributes>`& :target:`get_attrs<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a5a99e09cd1e272858c8fa4a584e52098>`() const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a169a39d4d9d17a5f7e0a7966a8809858>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v8_1_1_prior_box_1ad592e47774f2ab64a6656f1120a2b576>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a8f64356816af18d5cd4bd1942f81ff97>`() const;
		static int64_t :target:`number_of_priors<doxid-classov_1_1op_1_1v8_1_1_prior_box_1a4a75c44cfeb9cce261c46d3849a4ebeb>`(const :ref:`Attributes<doxid-structov_1_1op_1_1v8_1_1_prior_box_1_1_attributes>`& attrs);
	
		static std::vector<float> :target:`normalized_aspect_ratio<doxid-classov_1_1op_1_1v8_1_1_prior_box_1ade772a925292eb3b2b0a72bcf7d0fcc5>`(
...
.. _details-classov_1_1op_1_1v8_1_1_prior_box:
...
.. _doxid-classov_1_1op_1_1v8_1_1_prior_box_1ac746c05a4566426310fe1fd31c129b64:
.. index:: pair: function; PriorBox
...
Constructs a :ref:`PriorBox <doxid-classov_1_1op_1_1v8_1_1_prior_box>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Shape <doxid-classov_1_1_shape>` of layer for which prior boxes are computed

	*
		- image_shape

		- :ref:`Shape <doxid-classov_1_1_shape>` of image to which prior boxes are scaled

	*
		- attrs

		- :ref:`PriorBox <doxid-classov_1_1op_1_1v8_1_1_prior_box>` attributes

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_prior_box_1aeff873b3d4e72b61b80805e348e22e48:
...
.. _doxid-classov_1_1op_1_1v8_1_1_prior_box_1ad592e47774f2ab64a6656f1120a2b576:
...
.. _doxid-classov_1_1op_1_1v8_1_1_prior_box_1a8f64356816af18d5cd4bd1942f81ff97:
