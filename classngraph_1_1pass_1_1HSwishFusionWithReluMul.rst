.. index:: pair: class; ngraph::pass::HSwishFusionWithReluMul
.. _doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_relu_mul:
...
:ref:`HSwishFusion <doxid-classngraph_1_1pass_1_1_h_swish_fusion>` transformation replaces a sub-graph (x \* (min(Relu(x + 3), 6)) \* const(1/6) with a HSwish op.
...
.. ref-code-block:: cpp
	...
	class HSwishFusionWithReluMul: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_swish_fusion_with_relu_mul_1a27dfed1b0bd14a240deb8aca0c3ff9d7>`("HSwishFusionWithReluMul", "0");
	};
