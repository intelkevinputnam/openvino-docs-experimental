.. index:: pair: interface; ngraph::snippets::pass::ConvertConstantsToScalars
.. _doxid-classngraph_1_1snippets_1_1pass_1_1_convert_constants_to_scalars:

interface ngraph::snippets::pass::ConvertConstantsToScalars
===========================================================
...
Replace only constants which are should be represented as scalars during code generation. Only single-value (0D) constants are currently supported. :ref:`More...<details-classngraph_1_1snippets_1_1pass_1_1_convert_constants_to_scalars>`


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <convert_constants_to_scalars.hpp>
	
	template ConvertConstantsToScalars: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	};
...
.. _details-classngraph_1_1snippets_1_1pass_1_1_convert_constants_to_scalars:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Replace only constants which are should be represented as scalars during code generation. Only single-value (0D) constants are currently supported.

Replace Power with a scalar input with :ref:`snippets::op::PowerStatic <doxid-classngraph_1_1snippets_1_1op_1_1_power_static>` for generation of a more optimal code.
