.. index:: pair: interface; ngraph::snippets::op::Tile
.. _doxid-classngraph_1_1snippets_1_1op_1_1_tile:

interface ngraph::snippets::op::Tile
====================================



Generated by Canonicalization and represents Loop in affine notation.
...
.. ref-code-block:: cpp
	...
	template Tile: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
		// fields
	
		std::vector<std::pair<std::shared_ptr<:ref:`ngraph::snippets::Emitter<doxid-classngraph_1_1snippets_1_1_emitter>`>, :ref:`ngraph::snippets::RegInfo<doxid-namespacengraph_1_1snippets_1a3d2700d6955f8b1f9e2fffa540cd5556>`>> :target:`region<doxid-classngraph_1_1snippets_1_1op_1_1_tile_1aa543ddd7da5bfa473dbf3c9aad29ee38>`;
		const void \* :target:`compile_params<doxid-classngraph_1_1snippets_1_1op_1_1_tile_1a564f118967486dc7545c46a38ab72d6f>`;

		// construction
	
		:target:`Tile<doxid-classngraph_1_1snippets_1_1op_1_1_tile_1a32cc8b85544cf912ace4826474139cad>`(const std::vector<std::pair<std::shared_ptr<:ref:`ngraph::snippets::Emitter<doxid-classngraph_1_1snippets_1_1_emitter>`>, :ref:`ngraph::snippets::RegInfo<doxid-namespacengraph_1_1snippets_1a3d2700d6955f8b1f9e2fffa540cd5556>`>>& region);
		:target:`Tile<doxid-classngraph_1_1snippets_1_1op_1_1_tile_1a4469734abfa38d2a151eb1a41f081849>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_tile_1a1499b076f7c82b5652fd9ddab38e06fa>`("Tile", "SnippetsOpset");
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_tile_1adf349e661c5933a3fa5d13be5b3caa61>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& inputs) const;
	};
