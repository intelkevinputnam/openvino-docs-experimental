.. index:: pair: class; ov::op::v0::Sin
.. _doxid-classov_1_1op_1_1v0_1_1_sin:
...
Elementwise sine operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_sin>`
...
.. ref-code-block:: cpp
	...
	class Sin: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_sin_1aacfd31c1923ec0b1fa14ae3a14f1cb75>`;

		// construction
	
		:ref:`Sin<doxid-classov_1_1op_1_1v0_1_1_sin_1a70970c5f7e130984f4ddea0a96b442e3>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);
		:target:`Sin<doxid-classov_1_1op_1_1v0_1_1_sin_1afac06961d1b52eaf8c5c6e2e0271aef3>`();

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_sin_1a265839d850df152a64f46a83efb8dd51>`("Sin", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_sin_1aaf69b0052f1c8a57ca9da44a058f950f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_sin_1a126b2edd03d7a1ada110dbc7b65d2249>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_sin_1ad937e2ce7bf8dcfad5c4b7df1ed4da52>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_sin_1a2709613e6e8d459041463c0c43b60115>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_sin:
...
.. list-table::
    ...
    * - Type
      - Description
    * - :math:`N[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \sin(\texttt{arg}[i_1,\dots,i_n])`

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_sin_1a70970c5f7e130984f4ddea0a96b442e3:
.. index:: pair: function; Sin

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Sin(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)
...
.. _doxid-classov_1_1op_1_1v0_1_1_sin_1ad937e2ce7bf8dcfad5c4b7df1ed4da52:
...
.. _doxid-classov_1_1op_1_1v0_1_1_sin_1a2709613e6e8d459041463c0c43b60115:
