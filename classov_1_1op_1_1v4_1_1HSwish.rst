.. index:: pair: class; ov::op::v4::HSwish
.. _doxid-classov_1_1op_1_1v4_1_1_h_swish:
...
A :ref:`HSwish <doxid-classov_1_1op_1_1v4_1_1_h_swish>` Activation Function f(x) = x \* min(max(x + 3, 0), 6) / 6 or f(x) = x \* min(ReLU(x + 3), 6) / 6. :ref:`More...<details-classov_1_1op_1_1v4_1_1_h_swish>`
...
.. ref-code-block:: cpp
	...
	class HSwish: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a0661803bf8e68fc880cc4e804fbe0486>`;

		// construction
	
		:target:`HSwish<doxid-classov_1_1op_1_1v4_1_1_h_swish_1ad8b42ec7e938fc9e8220752d125c0538>`();
		:ref:`HSwish<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a6ce5d74721f33b1a5507a5df67918fa4>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a74b3e7643a61cb4388740c1ff73c565d>`("HSwish", "opset4", :ref:`op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`, 4);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a770d7ae6d6a6bc76a2a50e823ec854e1>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a9889ae1a0646828c2cc0b4cbc7a8ed2b>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a2b502a28cd5ea852aa6fcf4cd066413f>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v4_1_1_h_swish_1a8abfa5a9f18ad8bd160b216c8266e2cb>`() const;
	};
...
.. _details-classov_1_1op_1_1v4_1_1_h_swish:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

A :ref:`HSwish <doxid-classov_1_1op_1_1v4_1_1_h_swish>` Activation Function f(x) = x \* min(max(x + 3, 0), 6) / 6 or f(x) = x \* min(ReLU(x + 3), 6) / 6.

Construction
------------

.. _doxid-classov_1_1op_1_1v4_1_1_h_swish_1a6ce5d74721f33b1a5507a5df67918fa4:
.. index:: pair: function; HSwish

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	HSwish(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg)

Constructs a :ref:`HSwish <doxid-classov_1_1op_1_1v4_1_1_h_swish>` (hard version of :ref:`Swish <doxid-classov_1_1op_1_1v4_1_1_swish>`) operation.
...
.. _doxid-classov_1_1op_1_1v4_1_1_h_swish_1a2b502a28cd5ea852aa6fcf4cd066413f:
...
.. _doxid-classov_1_1op_1_1v4_1_1_h_swish_1a8abfa5a9f18ad8bd160b216c8266e2cb:
