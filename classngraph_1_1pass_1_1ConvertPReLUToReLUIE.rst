.. index:: pair: class; ngraph::pass::ConvertPReLUToReLUIE
.. _doxid-classngraph_1_1pass_1_1_convert_p_re_l_u_to_re_l_u_i_e:

class ngraph::pass::ConvertPReLUToReLUIE
========================================
...
.. ref-code-block:: cpp
	...
	#include <convert_prelu_to_relu_ie.hpp>
	
	class ConvertPReLUToReLUIE: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_p_re_l_u_to_re_l_u_i_e_1aa46fdd945fe5f7fdc09394237847b307>`("ConvertPReLUToReLUIE", "0");
	};
