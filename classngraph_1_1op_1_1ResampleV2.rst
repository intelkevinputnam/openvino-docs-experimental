.. index:: pair: class; ngraph::op::ResampleV2
.. _doxid-classngraph_1_1op_1_1_resample_v2:

class ngraph::op::ResampleV2
============================
...
.. ref-code-block:: cpp
	...
	class ResampleV2: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_resample_v2_1a15e127d5ff4cc823376fae33402ecdd0>`;

		// construction
	
		:target:`ResampleV2<doxid-classngraph_1_1op_1_1_resample_v2_1acfa7b2f4e712411689e6ba13e570af52>`(
			...
			const :ref:`ResampleIEAttrs<doxid-structngraph_1_1op_1_1_resample_i_e_attrs>`& attrs
			);
	
		:target:`ResampleV2<doxid-classngraph_1_1op_1_1_resample_v2_1a93df080d0c0d24ee2414c007955e7ccb>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& image, const :ref:`ResampleIEAttrs<doxid-structngraph_1_1op_1_1_resample_i_e_attrs>`& attrs);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_resample_v2_1ae2ee7656027c1974531229e6bab04593>`("ResampleV2", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_resample_v2_1a37f1f3b70d24a0635ddab1225b37d632>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_resample_v2_1ada97cc6bfad272d208c76aa6cf813622>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_resample_v2_1a6cc3126b52fe519e0ce18e04fff4980a>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		:ref:`ResampleIEAttrs<doxid-structngraph_1_1op_1_1_resample_i_e_attrs>` :target:`get_attrs<doxid-classngraph_1_1op_1_1_resample_v2_1a4645dadd75f28d463ca8be30a2e2e3d3>`();
	};
...
.. _details-classngraph_1_1op_1_1_resample_v2:
...
.. _doxid-classngraph_1_1op_1_1_resample_v2_1a37f1f3b70d24a0635ddab1225b37d632:
