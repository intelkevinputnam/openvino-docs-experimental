.. index:: pair: class; ov::op::v0::Convert
.. _doxid-classov_1_1op_1_1v0_1_1_convert:
...
Elementwise type conversion operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_convert>`
...
.. ref-code-block:: cpp
	...
	class Convert: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_convert_1a2061554fcf3b4e24859a8aff55f9d56b>`;

		// construction
	
		:ref:`Convert<doxid-classov_1_1op_1_1v0_1_1_convert_1a63101a29c91fbb86f76f2b0d5fef7421>`();
		:ref:`Convert<doxid-classov_1_1op_1_1v0_1_1_convert_1ad98ef7fd689feb7d04748fb06a8714af>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& destination_type);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_convert_1af30665f91d478952e8b4da0b18820faf>`("Convert", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_convert_1a72e3b00e1e475df802ced1bf438b5f41>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_convert_1a0bb8528a3f2eaba8ed039468b1686f28>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_convert_1a19d9bc5ff37f98b292aa04d04e6e8837>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :target:`get_destination_type<doxid-classov_1_1op_1_1v0_1_1_convert_1a9cf4a51f74787da58aa035e1a1bde68f>`() const;
		void :target:`set_destination_type<doxid-classov_1_1op_1_1v0_1_1_convert_1acbf71b8210c55725eca01d8a9a8451af>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& destination_type);
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :target:`get_convert_element_type<doxid-classov_1_1op_1_1v0_1_1_convert_1a23ed2b95cd91ce34842bd6365a3bbdb0>`() const;
		void :target:`set_convert_element_type<doxid-classov_1_1op_1_1v0_1_1_convert_1abdb046dcbacb76169dc48985f896461b>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& destination_type);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_convert_1ac5de15542cfb92fc8512b258e1942d41>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_convert_1a56fa682bcef907fcf92cbf42babbb7bd>`() const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :target:`evaluate_lower<doxid-classov_1_1op_1_1v0_1_1_convert_1a8e6de073ffc167107be14a4fe5e8b6e1>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :target:`evaluate_upper<doxid-classov_1_1op_1_1v0_1_1_convert_1a1f8732c4b47bfddcbffda6a69e22e1d1>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :target:`evaluate_label<doxid-classov_1_1op_1_1v0_1_1_convert_1a885488ebda30e3295d9e365bf8b2e33f>`(:ref:`TensorLabelVector<doxid-namespaceov_1aa5b856e58283417ceeace7343237b623>`& output_labels) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_convert:
...
.. _doxid-classov_1_1op_1_1v0_1_1_convert_1a63101a29c91fbb86f76f2b0d5fef7421:
...
.. _doxid-classov_1_1op_1_1v0_1_1_convert_1ad98ef7fd689feb7d04748fb06a8714af:
.. index:: pair: function; Convert

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Convert(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& destination_type)
...
.. _doxid-classov_1_1op_1_1v0_1_1_convert_1a72e3b00e1e475df802ced1bf438b5f41:
...
.. _doxid-classov_1_1op_1_1v0_1_1_convert_1ac5de15542cfb92fc8512b258e1942d41:
...
.. _doxid-classov_1_1op_1_1v0_1_1_convert_1a56fa682bcef907fcf92cbf42babbb7bd:
