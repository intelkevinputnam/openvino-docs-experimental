.. index:: pair: class; ov::op::v0::Tile
.. _doxid-classov_1_1op_1_1v0_1_1_tile:
...
Dynamic Tiling operation which repeats a tensor multiple times along each dimension. :ref:`More...<details-classov_1_1op_1_1v0_1_1_tile>`
...
.. ref-code-block:: cpp
	...
	class Tile: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_tile_1adf8e9148d47270c5f42d9ef564473c81>`;

		// construction
	
		:target:`Tile<doxid-classov_1_1op_1_1v0_1_1_tile_1acc0d37bebfece91a92e8330fe8216dac>`();
		:ref:`Tile<doxid-classov_1_1op_1_1v0_1_1_tile_1a24092b83c951a2372cf7ee655aee24f4>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& repeats);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_tile_1aed4146337ad9aeeec7d59cd60216327b>`("Tile", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_tile_1a318106afdcd89905ef2eea23b7991a37>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_tile_1a452a794f938b547e0fcf4068fd48395e>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_tile_1afdd53795a4a86d5e1babb8893938ff38>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_tile_1a7ae24cc2e4b4de166fd0724162638046>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_tile_1a21415c791ee5ad3112421feb4cab0e0c>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_tile:
...
.. _doxid-classov_1_1op_1_1v0_1_1_tile_1a24092b83c951a2372cf7ee655aee24f4:
.. index:: pair: function; Tile

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Tile(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& repeats)
...
.. list-table::
	...
	*
		...
		- The node producing input tensor to be padded.

	*
		- repeats

		- The node producing the per-dimension replication factor

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_tile_1a452a794f938b547e0fcf4068fd48395e:
...
.. _doxid-classov_1_1op_1_1v0_1_1_tile_1a7ae24cc2e4b4de166fd0724162638046:
...
.. _doxid-classov_1_1op_1_1v0_1_1_tile_1a21415c791ee5ad3112421feb4cab0e0c:
