.. index:: pair: class; ngraph::pass::MishFusion
.. _doxid-classngraph_1_1pass_1_1_mish_fusion:
...
:ref:`MishFusion <doxid-classngraph_1_1pass_1_1_mish_fusion>` transformation replaces group of operations: x \* tanh(log(exp(x) + 1)) to Mish op.
...
.. ref-code-block:: cpp
	...
	class MishFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_mish_fusion_1a8209fee3191b3ec147a534e9222009e1>`("MishFusion", "0");
	};
