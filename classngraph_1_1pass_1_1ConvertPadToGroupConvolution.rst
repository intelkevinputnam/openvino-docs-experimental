.. index:: pair: class; ngraph::pass::ConvertPadToGroupConvolution
.. _doxid-classngraph_1_1pass_1_1_convert_pad_to_group_convolution:
...
:ref:`ConvertPadToGroupConvolution <doxid-classngraph_1_1pass_1_1_convert_pad_to_group_convolution>` transformation replaces Pad operation with GroupConvolution but has some restrictions on Pad parameters: :ref:`More...<details-classngraph_1_1pass_1_1_convert_pad_to_group_convolution>`
...
.. ref-code-block:: cpp
	...
	class ConvertPadToGroupConvolution: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_pad_to_group_convolution_1aadccafbc512634084746a0ef9e6a375f>`("ConvertPadToGroupConvolution", "0");
	};
...
.. _details-classngraph_1_1pass_1_1_convert_pad_to_group_convolution:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ConvertPadToGroupConvolution <doxid-classngraph_1_1pass_1_1_convert_pad_to_group_convolution>` transformation replaces Pad operation with GroupConvolution but has some restrictions on Pad parameters:
