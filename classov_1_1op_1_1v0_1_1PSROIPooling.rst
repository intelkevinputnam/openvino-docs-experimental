.. index:: pair: class; ov::op::v0::PSROIPooling
.. _doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling:
...
:ref:`PSROIPooling <doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling>`
...
.. ref-code-block:: cpp
	...
	class PSROIPooling: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a1fd9191d67bfff8deb4a53ce81a9db34>`;

		// construction
	
		:target:`PSROIPooling<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a6b1197166ed201f81912a598a98fb804>`();
	
		:ref:`PSROIPooling<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a175a86f3932ac7a344c5c6c5aa9d8dde>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a786cd17467f306e2a705244c2ea122d8>`("PSROIPooling", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a26acb4a2f568bb04ed2f3c67ca3d6362>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a12ead4b518b672beb745c514d617199e>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1aa706537345cacab8fb19b4e1f3712888>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		size_t :target:`get_output_dim<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a3acbe64bb936ec34af04431a87d1a1a7>`() const;
		size_t :target:`get_group_size<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1aba199113ae3a2a2149720807ab2047e8>`() const;
		float :target:`get_spatial_scale<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1adab2bf62593a9e65be12da35af460ccf>`() const;
		int :target:`get_spatial_bins_x<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1ae3b6ba6085b4095ddf4d49b2c0612ed6>`() const;
		int :target:`get_spatial_bins_y<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a1f919d46f575a226de65255ced9efee3>`() const;
		const std::string& :target:`get_mode<doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1aca2e77e6d4656025825ed6f59c92d913>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`PSROIPooling <doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a175a86f3932ac7a344c5c6c5aa9d8dde:
.. index:: pair: function; PSROIPooling
...
Constructs a :ref:`PSROIPooling <doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` feature map {N, C, ...}
	...
	*
		...
		- :ref:`Output <doxid-classov_1_1_output>` channel number

	*
		- group_size

		- Number of groups to encode position-sensitive scores

	*
		- spatial_scale

		- Ratio of input feature map over input image size

	*
		- spatial_bins_x

		- Numbers of bins to divide the input feature maps over width

	*
		- spatial_bins_y

		- Numbers of bins to divide the input feature maps over height

	*
		- mode

		- Mode of pooling - Avg or Bilinear

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_p_s_r_o_i_pooling_1a12ead4b518b672beb745c514d617199e:
