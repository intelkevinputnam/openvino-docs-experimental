.. index:: pair: class; ov::op::v1::BatchToSpace
.. _doxid-classov_1_1op_1_1v1_1_1_batch_to_space:
...
:ref:`BatchToSpace <doxid-classov_1_1op_1_1v1_1_1_batch_to_space>` permutes data from the batch dimension of the data tensor into spatial dimensions. :ref:`More...<details-classov_1_1op_1_1v1_1_1_batch_to_space>`
...
.. ref-code-block:: cpp
	...
	class BatchToSpace: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a8543625330d1ea51e6dae912537251b0>`;

		// construction
	
		:target:`BatchToSpace<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1ab25f1ffa3af694048e5febf0a3078b5f>`();
	
		:ref:`BatchToSpace<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a3d2237a109c947a07af35961c8515786>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& block_shape,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& crops_begin,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& crops_end
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a65b4cc6f033505257d58837146f46be8>`("BatchToSpace", "opset2", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1ac1fd18dc7891ac1f5e7aa1a141635306>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a650a646fa1991071fbcce20b0a0a714e>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1ada546383e6d74e8889bb74937d0fa027>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1acc3489ec6536a9d27e01324af512046a>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a161beefd84776508b247ec7cb1e5c598>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classov_1_1op_1_1v1_1_1_batch_to_space:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`BatchToSpace <doxid-classov_1_1op_1_1v1_1_1_batch_to_space>` permutes data from the batch dimension of the data tensor into spatial dimensions.
...
.. _doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a3d2237a109c947a07af35961c8515786:
.. index:: pair: function; BatchToSpace
...
Constructs a :ref:`BatchToSpace <doxid-classov_1_1op_1_1v1_1_1_batch_to_space>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the data tensor

	*
		- block_shape

		- The sizes of the block of values to be moved

	*
		- crops_begin

		- Specifies the amount to crop from the beginning along each axis of ``data`` input

	*
		- crops_end

		- Specifies the amount to crop from the ending along each axis of ``data`` input.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1ac1fd18dc7891ac1f5e7aa1a141635306:
...
.. _doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1a650a646fa1991071fbcce20b0a0a714e:
...
.. _doxid-classov_1_1op_1_1v1_1_1_batch_to_space_1ada546383e6d74e8889bb74937d0fa027:
