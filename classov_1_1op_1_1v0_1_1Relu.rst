.. index:: pair: class; ov::op::v0::Relu
.. _doxid-classov_1_1op_1_1v0_1_1_relu:
...
Elementwise :ref:`Relu <doxid-classov_1_1op_1_1v0_1_1_relu>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_relu>`
...
.. ref-code-block:: cpp
	...
	class Relu: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_relu_1a2c22bdaf6e31724836b11479dd358c9d>`;

		// construction
	
		:target:`Relu<doxid-classov_1_1op_1_1v0_1_1_relu_1a631a74e39493399126fe6d617202bd5a>`();
		:ref:`Relu<doxid-classov_1_1op_1_1v0_1_1_relu_1a76ebc7b2ff08137863aebbc15777b43e>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`ov::Node<doxid-classov_1_1_node>`>& arg);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_relu_1a1deeb88599df674a59e51200db0d70c7>`("Relu", "opset1", :ref:`util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_relu_1a2e787cb016695e50eb6331a403a9ff43>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_relu_1aa9451d61433d046af0b55a378bb290d9>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_relu_1ab17820d3a6b7adb791a839f4c39dc31f>`() const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_relu_1a3f77dbe425295f5408e8f8ea36e1accd>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classov_1_1op_1_1v0_1_1_relu:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Elementwise :ref:`Relu <doxid-classov_1_1op_1_1v0_1_1_relu>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_relu_1a76ebc7b2ff08137863aebbc15777b43e:
.. index:: pair: function; Relu

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Relu(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`ov::Node<doxid-classov_1_1_node>`>& arg)

Constructs a :ref:`Relu <doxid-classov_1_1op_1_1v0_1_1_relu>` operation.
...
.. _doxid-classov_1_1op_1_1v0_1_1_relu_1aa9451d61433d046af0b55a378bb290d9:
...
.. _doxid-classov_1_1op_1_1v0_1_1_relu_1ab17820d3a6b7adb791a839f4c39dc31f:
