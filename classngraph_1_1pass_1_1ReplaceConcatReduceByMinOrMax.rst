.. index:: pair: class; ngraph::pass::ReplaceConcatReduceByMinOrMax
.. _doxid-classngraph_1_1pass_1_1_replace_concat_reduce_by_min_or_max:
...
:ref:`ReplaceConcatReduceByMinOrMax <doxid-classngraph_1_1pass_1_1_replace_concat_reduce_by_min_or_max>` transformation replaces Concat with 2 inputs and ReduceMin/Max by a single Minimum/Maximum with 2 inputs and inserts squeeze in case when Reduce has keep_dims = false.
...
.. ref-code-block:: cpp
	...
	class ReplaceConcatReduceByMinOrMax: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_replace_concat_reduce_by_min_or_max_1a7907f83bf1e2e9af0fd0dc927cc3613e>`("ReplaceConcatReduceByMinOrMax", "0");
	};
