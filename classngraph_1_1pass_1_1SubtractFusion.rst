.. index:: pair: class; ngraph::pass::SubtractFusion
.. _doxid-classngraph_1_1pass_1_1_subtract_fusion:
...
:ref:`SubtractFusion <doxid-classngraph_1_1pass_1_1_subtract_fusion>` transformation replaces a sub-graph Mul(y, -1) + x or x + Mul(y, -1) with Subtract(x,y)
...
.. ref-code-block:: cpp
	...
	class SubtractFusion: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_subtract_fusion_1a06c2c20d5a687253cb033a5575685ee6>`("SubtractFusion", "0");
	};
