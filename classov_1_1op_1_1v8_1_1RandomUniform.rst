.. index:: pair: class; ov::op::v8::RandomUniform
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform:
...
:ref:`Tensor <doxid-classov_1_1_tensor>` :ref:`RandomUniform <doxid-classov_1_1op_1_1v8_1_1_random_uniform>` operation. :ref:`More...<details-classov_1_1op_1_1v8_1_1_random_uniform>`
...
.. ref-code-block:: cpp
	...
	class RandomUniform: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a98512db86142d2740278bf41496dc5d1>`;

		// construction
	
		:target:`RandomUniform<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a95efa4994f6e81636e82eb78f7b2a971>`();
	
		:ref:`RandomUniform<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a431b9f78e81e7ebb72fb6b345a6fed04>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& out_shape,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& min_val,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& max_val,
			const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& out_type,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1aa24cbc594b9791577c22947fe47ed37a>`("RandomUniform", "opset8");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ab6ffc56a6e36401e9f15f7af964f92a8>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1af068f4ea3fb0ce25b28a98e351b241d7>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a50c877802c2188d1be2f68d0db79a895>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual bool :ref:`constant_fold<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ada1dd457d97c6ff8a09044f0ee199a27>`(
		...
		const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& :ref:`get_out_type<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1abc3f4a94a0f683ffe4aefc53c7d2d8a0>`() const;
		void :target:`set_out_type<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1adffa0a091efef26dfa0f3aa3afd8ec6e>`(const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& output_type);
		uint64_t :ref:`get_global_seed<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a02b3d482a5133d223dd64dc01dfc552a>`() const;
		void :target:`set_global_seed<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a55c6c1141b80a4915fcb21749597a103>`(uint64_t seed);
		uint64_t :ref:`get_op_seed<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a246549297f61a23d931f1c8250329583>`() const;
		void :target:`set_op_seed<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ad5c280c19b4fa33e820348ddedc33e30>`(uint64_t seed2);
		std::pair<uint64_t, uint64_t> :ref:`get_state<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ae53658a64fa97bb348b891c8efe8a304>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a37260b428260e88a45f16aa215974874>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v8_1_1_random_uniform_1aaa109856b0cb42ce5ea3c8aa9de21359>`() const;
	};
...
.. _details-classov_1_1op_1_1v8_1_1_random_uniform:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Tensor <doxid-classov_1_1_tensor>` :ref:`RandomUniform <doxid-classov_1_1op_1_1v8_1_1_random_uniform>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a431b9f78e81e7ebb72fb6b345a6fed04:
.. index:: pair: function; RandomUniform
...
Constructs a :ref:`RandomUniform <doxid-classov_1_1op_1_1v8_1_1_random_uniform>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with output shape.

	*
		- min_val

		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with minimum value.

	*
		- max_val

		- :ref:`Node <doxid-classov_1_1_node>` producing the tensor with maximum value.

	*
		- out_type

		- :ref:`Output <doxid-classov_1_1_output>` type of the tensor.
	...
	*
		...
		- Operational seed value.

Methods
-------

.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ab6ffc56a6e36401e9f15f7af964f92a8:
...
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ada1dd457d97c6ff8a09044f0ee199a27:
.. index:: pair: function; constant_fold
...
Turns off constant folding for :ref:`RandomUniform <doxid-classov_1_1op_1_1v8_1_1_random_uniform>` operation.

.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1abc3f4a94a0f683ffe4aefc53c7d2d8a0:
.. index:: pair: function; get_out_type

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	const :ref:`ov::element::Type<doxid-classov_1_1element_1_1_type>`& get_out_type() const
...
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a02b3d482a5133d223dd64dc01dfc552a:
.. index:: pair: function; get_global_seed
...
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a246549297f61a23d931f1c8250329583:
.. index:: pair: function; get_op_seed
...
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1ae53658a64fa97bb348b891c8efe8a304:
...
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1a37260b428260e88a45f16aa215974874:
...
.. _doxid-classov_1_1op_1_1v8_1_1_random_uniform_1aaa109856b0cb42ce5ea3c8aa9de21359:
