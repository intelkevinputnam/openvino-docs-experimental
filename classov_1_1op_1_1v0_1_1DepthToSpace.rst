.. index:: pair: class; ov::op::v0::DepthToSpace
.. _doxid-classov_1_1op_1_1v0_1_1_depth_to_space:
...
.. toctree::
	...
	DepthToSpaceMode <enumov_1_1op_1_1v0_1_1DepthToSpace_1_1DepthToSpaceMode.rst>

Overview
~~~~~~~~

:ref:`DepthToSpace <doxid-classov_1_1op_1_1v0_1_1_depth_to_space>` permutes data from the depth dimension of the input blob into spatial dimensions. :ref:`More...<details-classov_1_1op_1_1v0_1_1_depth_to_space>`
...
.. ref-code-block:: cpp
	...
	class DepthToSpace: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`DepthToSpaceMode<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1adf46d7cb205c4a8b94bafa9d4c34c303>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a870308e4dddbcd21e57ea77e930f78c9>`;

		// construction
	
		:target:`DepthToSpace<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a6fba46ab7ef3c51f91f2b8a6eb2398c2>`();
	
		:ref:`DepthToSpace<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a8e3ee02f9e87370842ab66dd79005943>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`DepthToSpaceMode<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1adf46d7cb205c4a8b94bafa9d4c34c303>`& mode,
			std::size_t block_size = 1
			);
	
		:target:`DepthToSpace<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1af94a770abf6d18acdc29037a74d416a8>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1ade6dbe19d090632433842c5e3800cc99>`("DepthToSpace", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a47426ea29d09b99d79d2ceb482350498>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		const std::size_t& :target:`get_block_size<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1af94f786e7b71a4729c25b1ce962419ee>`() const;
		:ref:`DepthToSpaceMode<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1adf46d7cb205c4a8b94bafa9d4c34c303>` :target:`get_mode<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1aca2e69f3c321385f227ef17c92699346>`() const;
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a585e3bc38f96e281e3da98dd4e0cabc7>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a66697e258ee634ba251dc8eaef29f3b5>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1af4b7a596d5ec29a57461eece56301e27>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1ae83b4b4886097d094f773bca1a316c09>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_depth_to_space:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`DepthToSpace <doxid-classov_1_1op_1_1v0_1_1_depth_to_space>` permutes data from the depth dimension of the input blob into spatial dimensions.

Values from the depth dimension (assuming NCHW layout) are moved in spatial blocks to the height and width dimensions.

:ref:`Output <doxid-classov_1_1_output>` node produces a tensor with shape: [N, C/(blocksize \* blocksize), H \* blocksize, W \* blocksize]

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a8e3ee02f9e87370842ab66dd79005943:
.. index:: pair: function; DepthToSpace
...
Constructs a :ref:`DepthToSpace <doxid-classov_1_1op_1_1v0_1_1_depth_to_space>` operation.
...
.. list-table::
	...
	*
		...
		- :ref:`Node <doxid-classov_1_1_node>` producing the input tensor
	...
	*
		...
		- The size of the block of values to be moved

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1a66697e258ee634ba251dc8eaef29f3b5:
...
.. _doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1af4b7a596d5ec29a57461eece56301e27:
...
.. _doxid-classov_1_1op_1_1v0_1_1_depth_to_space_1ae83b4b4886097d094f773bca1a316c09:
