.. index:: pair: class; ov::op::v1::SpaceToBatch
.. _doxid-classov_1_1op_1_1v1_1_1_space_to_batch:
...
:ref:`SpaceToBatch <doxid-classov_1_1op_1_1v1_1_1_space_to_batch>` permutes data tensor blocks of spatial data into batch dimension. :ref:`More...<details-classov_1_1op_1_1v1_1_1_space_to_batch>`
...
.. ref-code-block:: cpp
	...
	class SpaceToBatch: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1ac38d5416bfec33843daebe0cca59263c>`;

		// construction
	
		:target:`SpaceToBatch<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1aec3b12ed22e13d36082c24950bf2cec7>`();
	
		:ref:`SpaceToBatch<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1ad705773969b4e0bacbaa1a06332a11d2>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`ov::Node<doxid-classov_1_1_node>`>& pads_begin,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`ov::Node<doxid-classov_1_1_node>`>& pads_end
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1a969b98dc66ed668440ad38f7710011a7>`("SpaceToBatch", "opset2", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1ae11f6fd574678b949c3dc73d84d7a178>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1a31ff8d698439c618d12c389792d49a85>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1aa1207b793907bcddb09a73b24d32ad5d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1a0ef3613aa9d3699e1b4580be63f87df7>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1a50df00920d7845503404a2e714331bae>`() const;
	};
...
.. _details-classov_1_1op_1_1v1_1_1_space_to_batch:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`SpaceToBatch <doxid-classov_1_1op_1_1v1_1_1_space_to_batch>` permutes data tensor blocks of spatial data into batch dimension.
...
.. _doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1ad705773969b4e0bacbaa1a06332a11d2:
.. index:: pair: function; SpaceToBatch
...
Constructs a :ref:`SpaceToBatch <doxid-classov_1_1op_1_1v1_1_1_space_to_batch>` operation.
...
.. list-table::
	...
	*
		...
		- Specifies the padding for the beginning along each axis of ``data`` input

	*
		- pads_end

		- Specifies the padding for the ending along each axis of ``data`` input.

Methods
-------

.. _doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1ae11f6fd574678b949c3dc73d84d7a178:
...
.. _doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1a0ef3613aa9d3699e1b4580be63f87df7:
...
.. _doxid-classov_1_1op_1_1v1_1_1_space_to_batch_1a50df00920d7845503404a2e714331bae:
