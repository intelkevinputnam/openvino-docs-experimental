.. index:: pair: class; ov::op::v0::Clamp
.. _doxid-classov_1_1op_1_1v0_1_1_clamp:
...
Performs a clipping operation on all elements of the input node. :ref:`More...<details-classov_1_1op_1_1v0_1_1_clamp>`
...
.. ref-code-block:: cpp
	...
	class Clamp: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_clamp_1a07808fef572cee82b61e9eb749365b6f>`;

		// construction
	
		:target:`Clamp<doxid-classov_1_1op_1_1v0_1_1_clamp_1acb25b78aeb2401d3b513fef9331b789f>`();
		:ref:`Clamp<doxid-classov_1_1op_1_1v0_1_1_clamp_1a476116720c0f2272a0821c5f8687510a>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const double min, const double max);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_clamp_1a66e667f6132ef2f1f1eb31b7ccaa34d4>`("Clamp", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_clamp_1a9742b848358b2aa98cc05fce1fc5aaa1>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_clamp_1af8203575c1982483d9118d95cf9280da>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_clamp_1a0392d6d38df28bf9b08a21126b60f86e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		double :target:`get_min<doxid-classov_1_1op_1_1v0_1_1_clamp_1a17cd4684639abffd206dd42cbb092e53>`() const;
		double :target:`get_max<doxid-classov_1_1op_1_1v0_1_1_clamp_1a91c0a39d99a01a4252caf422ffbe4ccd>`() const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_clamp_1aa845f507b183757ae318015c34a99c81>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_clamp_1a614db2be1e7d831251cf0fc279c1b1c7>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_clamp:
...
.. _doxid-classov_1_1op_1_1v0_1_1_clamp_1a476116720c0f2272a0821c5f8687510a:
.. index:: pair: function; Clamp

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	Clamp(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data, const double min, const double max)

Constructs a :ref:`Clamp <doxid-classov_1_1op_1_1v0_1_1_clamp>` node.
...
.. list-table::
	...
	*
		...
		- - the lower bound of the <min;max> range

	*
		- max

		- - the upper bound of the <min;max> range

Methods
-------

.. _doxid-classov_1_1op_1_1v0_1_1_clamp_1a9742b848358b2aa98cc05fce1fc5aaa1:
...
.. _doxid-classov_1_1op_1_1v0_1_1_clamp_1aa845f507b183757ae318015c34a99c81:
...
.. _doxid-classov_1_1op_1_1v0_1_1_clamp_1a614db2be1e7d831251cf0fc279c1b1c7:
