.. index:: pair: class; ngraph::pass::low_precision::DepthToSpaceTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation:
...
:ref:`DepthToSpaceTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation>` propagates dequantization operations through DepthToSpace operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation>`
...
.. ref-code-block:: cpp
	...
	class DepthToSpaceTransformation: public :ref:`ngraph::pass::low_precision::TransparentBaseTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation>`
	{
	public:
		// construction
	
		:target:`DepthToSpaceTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation_1a7d0ac4832c56241d58194b8089d13c3a>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation_1a0422875d9cd74a2b34c56a00b8d2ef02>`("DepthToSpaceTransformation", "0");
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation_1a8a5f38c22c9cc7d870cfc3ea44740a8e>`(
...
.. ref-code-block:: cpp
	...
	public:
		...
		virtual bool :ref:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1a24337ef218d2b131044f6bc31963c010>`(
			:ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context,
			:ref:`ngraph::pattern::Matcher<doxid-classov_1_1pass_1_1pattern_1_1_matcher>`& m
			);
	
		virtual bool :ref:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1aaa6a526f978db199bda48f3a47d51eb5>`(
			const :ref:`TransformationContext<doxid-classngraph_1_1pass_1_1low__precision_1_1_transformation_context>`& context,
			std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer
			) const;
	
		virtual bool :ref:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_transparent_base_transformation_1a1a8bbc92aeb03f8e4b003599c924f5f4>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;

.. _details-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`DepthToSpaceTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_depth_to_space_transformation>` propagates dequantization operations through DepthToSpace operation.

For more details about the transformation, refer to :ref:`DepthToSpaceTransformation <doxid-openvino_docs__o_v__u_g_lpt__depth_to_space_transformation>` page in the Inference Engine Developer Guide.
