.. index:: pair: class; ngraph::op::GatherTreeIE
.. _doxid-classngraph_1_1op_1_1_gather_tree_i_e:

class ngraph::op::GatherTreeIE
==============================
...
.. ref-code-block:: cpp
	...
	class GatherTreeIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1a3b59657e84c39443faa4fe572b265f45>`;

		// construction
	
		:target:`GatherTreeIE<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1a9c289efd2c4c193b24810d20377d55c5>`();
	
		:ref:`GatherTreeIE<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1a4912c16a8f779cbd5db5b3fd96186ee9>`(
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1a2821c59d42ce148a1d4730144e68040c>`("GatherTreeIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1abfeac92dd707a9d82067e833a8e4a678>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1adebeed5aefc2692addbed302ace1836c>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_gather_tree_i_e_1afd192713bb82edcc55d52c406286f10b>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_gather_tree_i_e:
...
.. _doxid-classngraph_1_1op_1_1_gather_tree_i_e_1a4912c16a8f779cbd5db5b3fd96186ee9:
.. index:: pair: function; GatherTreeIE
...
.. list-table::
	...
	*
		...
		- Tensor of shape [MAX_TIME, BATCH_SIZE, BEAM_WIDTH] with indices from per each step

	*
		- parent_idx

		- Tensor of shape [MAX_TIME, BATCH_SIZE, BEAM_WIDTH] with parent beam indices

	*
		- max_seq_len

		- Tensor of shape [BATCH_SIZE] with maximum lengths for each sequence in the batch

	*
		- end_token

		- Tensor of shape [MAX_TIME, BATCH_SIZE, BEAM_WIDTH]

Methods
-------

.. _doxid-classngraph_1_1op_1_1_gather_tree_i_e_1abfeac92dd707a9d82067e833a8e4a678:
