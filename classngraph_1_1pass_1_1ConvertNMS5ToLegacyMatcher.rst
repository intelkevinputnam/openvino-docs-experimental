.. index:: pair: class; ngraph::pass::ConvertNMS5ToLegacyMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_n_m_s5_to_legacy_matcher:

class ngraph::pass::ConvertNMS5ToLegacyMatcher
==============================================
...
.. ref-code-block:: cpp
	...
	#include <convert_nms_5_to_legacy.hpp>
	
	class ConvertNMS5ToLegacyMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// construction
	
		:target:`ConvertNMS5ToLegacyMatcher<doxid-classngraph_1_1pass_1_1_convert_n_m_s5_to_legacy_matcher_1af5984a6ab467ce6438b5b8a38e6c38f3>`(bool force_i32_output_type = true);

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_n_m_s5_to_legacy_matcher_1a7940acb228e24d1b8aad7e0b0d02373a>`("ConvertNMS5ToLegacyMatcher", "0");
	};
