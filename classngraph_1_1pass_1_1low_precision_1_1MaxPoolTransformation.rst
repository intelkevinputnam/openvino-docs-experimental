.. index:: pair: class; ngraph::pass::low_precision::MaxPoolTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation:
...
:ref:`MaxPoolTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation>` propagates dequantization operations through MaxPool operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation>`
...
.. ref-code-block:: cpp
	...
	class MaxPoolTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`MaxPoolTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation_1a44adbae4260e32eb37d870fe7a32f9d2>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation_1a8bf377d9057dae100ceccaa76b47ce1c>`("MaxPoolTransformation", "0");
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation_1a163e1102a2e2c29f26bf826f06a8eb23>`(
		...
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation_1a0743dbc58145fa6caaf8c31fb8e774ff>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation_1a6e0e830645f657d97d934d12db3044b8>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`MaxPoolTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_max_pool_transformation>` propagates dequantization operations through MaxPool operation.

For more details about the transformation, refer to :ref:`MaxPoolTransformation <doxid-openvino_docs__o_v__u_g_lpt__max_pool_transformation>` page in the Inference Engine Developer Guide.
