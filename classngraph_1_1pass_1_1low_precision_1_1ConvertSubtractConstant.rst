.. index:: pair: class; ngraph::pass::low_precision::ConvertSubtractConstant
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant:
...
:ref:`ConvertSubtractConstant <doxid-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant>` marks Convert operations on constant subgraph by DISABLED_CONSTANT_FOLDING attribute to prevent constant folding. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant>`
...
.. ref-code-block:: cpp
	...
	class ConvertSubtractConstant: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// construction
	
		:target:`ConvertSubtractConstant<doxid-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant_1a874d0fa35d022b766ec5cf9b1576c4cc>`(const std::vector<:ref:`ngraph::element::Type<doxid-classov_1_1element_1_1_type>`>& constantPrecisions = {});

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant_1a378007d94045baa7518b79c74962c164>`("ConvertSubtractConstant", "0");
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`ConvertSubtractConstant <doxid-classngraph_1_1pass_1_1low__precision_1_1_convert_subtract_constant>` marks Convert operations on constant subgraph by DISABLED_CONSTANT_FOLDING attribute to prevent constant folding.

For more details about the transformation, refer to :ref:`ConvertSubtractConstant <doxid-openvino_docs__o_v__u_g_lpt__convert_subtract_constant>` page in the Inference Engine Developer Guide.
