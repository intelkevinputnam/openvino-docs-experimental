.. index:: pair: class; ov::op::v0::Selu
.. _doxid-classov_1_1op_1_1v0_1_1_selu:
...
Performs a SELU activation function on all elements of the input node. :ref:`More...<details-classov_1_1op_1_1v0_1_1_selu>`
...
.. ref-code-block:: cpp
	...
	class Selu: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_selu_1a8a486604174a331368e5119eae34cbe5>`;

		// construction
	
		:target:`Selu<doxid-classov_1_1op_1_1v0_1_1_selu_1a26b7461fa0284f99dc37581b2b77eadd>`();
	
		:ref:`Selu<doxid-classov_1_1op_1_1v0_1_1_selu_1a56f7e5e636dc995f7ece4192e3b5b100>`(
			...
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& lambda
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_selu_1ac32149f31d0b97f139011a951a6066c4>`("Selu", "opset1");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_selu_1adee225a4141dbb5259465aaa172f74ea>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_selu_1a5ad300845129ffe4da15edf6455e0b5d>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_selu_1af5c474e1c373f41ab1614131506e2694>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_selu:
...
.. _doxid-classov_1_1op_1_1v0_1_1_selu_1a56f7e5e636dc995f7ece4192e3b5b100:
.. index:: pair: function; Selu
...
Constructs a :ref:`Selu <doxid-classov_1_1op_1_1v0_1_1_selu>` node.
...
.. _doxid-classov_1_1op_1_1v0_1_1_selu_1adee225a4141dbb5259465aaa172f74ea:
