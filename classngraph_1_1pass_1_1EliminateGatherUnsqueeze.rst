.. index:: pair: class; ngraph::pass::EliminateGatherUnsqueeze
.. _doxid-classngraph_1_1pass_1_1_eliminate_gather_unsqueeze:
...
Remove Gather -> Unsqueeze pair, if Gather takes a scalar and Unsqueeze makes it a 1D tensor.
...
.. ref-code-block:: cpp
	...
	class EliminateGatherUnsqueeze: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_eliminate_gather_unsqueeze_1a8df5fa0277867f9fe421c4aca8e10074>`("EliminateGatherUnsqueeze", "0");
	};
