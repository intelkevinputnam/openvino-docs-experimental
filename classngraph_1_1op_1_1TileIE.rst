.. index:: pair: class; ngraph::op::TileIE
.. _doxid-classngraph_1_1op_1_1_tile_i_e:

class ngraph::op::TileIE
========================
...
.. ref-code-block:: cpp
	...
	class TileIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_tile_i_e_1a9278c41b3aa9e3503894492e08363b71>`;
		int64_t :target:`axis<doxid-classngraph_1_1op_1_1_tile_i_e_1a3d4d0d95e1df4f619a642f3528bd13b0>`;
		int64_t :target:`tiles<doxid-classngraph_1_1op_1_1_tile_i_e_1a0ea6500641f413fa7c7b6c5a19aa25d2>`;

		// construction
	
		:target:`TileIE<doxid-classngraph_1_1op_1_1_tile_i_e_1a88b29332758fc89416eb3e6c904217e0>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data1, const int64_t axis, const int64_t tiles);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_tile_i_e_1a084f31a643b101279b5bc2a66d11fbf6>`("TileIE", "legacy");
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_tile_i_e_1aedd5b1ba667510fb0d42a59aaeeca387>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_tile_i_e_1ac78c6bfd8d3d79dcd5b2b79e4fcfad7f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_tile_i_e_1a97ce50ae6685f549ca20b452f03cfb4a>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_tile_i_e:
...
.. _doxid-classngraph_1_1op_1_1_tile_i_e_1aedd5b1ba667510fb0d42a59aaeeca387:
