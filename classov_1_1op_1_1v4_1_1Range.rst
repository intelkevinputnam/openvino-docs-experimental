.. index:: pair: class; ov::op::v4::Range
.. _doxid-classov_1_1op_1_1v4_1_1_range:
...
:ref:`Range <doxid-classov_1_1op_1_1v4_1_1_range>` operation, analogous to ``arange()`` in Numpy. :ref:`More...<details-classov_1_1op_1_1v4_1_1_range>`
...
.. ref-code-block:: cpp
	...
	class Range: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v4_1_1_range_1ab00ab9113f5baaafc30b39e798a86d69>`;

		// construction
	
		:ref:`Range<doxid-classov_1_1op_1_1v4_1_1_range_1aba659ecf9e083a9ce184f02f11dee7af>`();
	
		:ref:`Range<doxid-classov_1_1op_1_1v4_1_1_range_1af5e61dc6cc9bc48423e0d40b786bfba8>`(
			...
			:ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v4_1_1_range_1a747808b4b446c993404e555f61dc5c20>`("Range", "opset4", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 4);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v4_1_1_range_1a3a9f0d1984cf7569dcc4f68ccc78e98f>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v4_1_1_range_1aedcd0439720bf0ffd815cb1701014c25>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v4_1_1_range_1ab5823d6f3c2fcc3e8ab1506660c5e015>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v4_1_1_range_1a761068de4fa9d196655f6aed69f332fa>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v4_1_1_range_1acc04a37b22076137802b305730175c7e>`() const;
		void :target:`set_output_type<doxid-classov_1_1op_1_1v4_1_1_range_1abe8afec40b4ae0df83966efefbd94f46>`(:ref:`element::Type<doxid-classov_1_1element_1_1_type>` output_type);
		const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& :target:`get_output_type<doxid-classov_1_1op_1_1v4_1_1_range_1afac44f01daee0748e517d4dd4f64ce34>`() const;
	
		void :target:`set_output_type<doxid-classov_1_1op_1_1v4_1_1_range_1affde9025d41a4b200d726bee750b20e4>`(
			size_t i,
...
.. _details-classov_1_1op_1_1v4_1_1_range:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`Range <doxid-classov_1_1op_1_1v4_1_1_range>` operation, analogous to ``arange()`` in Numpy.

Construction
------------

.. _doxid-classov_1_1op_1_1v4_1_1_range_1aba659ecf9e083a9ce184f02f11dee7af:
.. index:: pair: function; Range
...
.. _doxid-classov_1_1op_1_1v4_1_1_range_1af5e61dc6cc9bc48423e0d40b786bfba8:
.. index:: pair: function; Range
...
.. list-table::
	...
	*
		...
		- The tensor producing the start value. Must be a scalar of numeric element type.

	*
		- stop

		- The tensor producing the stop value. Must be a scalar of numeric element type.

	*
		- step

		- The tensor producing the step value. Must be a scalar of numeric element type.
...
.. _doxid-classov_1_1op_1_1v4_1_1_range_1aedcd0439720bf0ffd815cb1701014c25:
...
.. _doxid-classov_1_1op_1_1v4_1_1_range_1a761068de4fa9d196655f6aed69f332fa:
...
.. _doxid-classov_1_1op_1_1v4_1_1_range_1acc04a37b22076137802b305730175c7e:
