.. index:: pair: class; ngraph::pass::low_precision::PropagateSharedValue
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_propagate_shared_value:
...
:ref:`PropagateSharedValue <doxid-classngraph_1_1pass_1_1low__precision_1_1_propagate_shared_value>` transformation propagates shared value AttributeType attribute instances through precision preserved operations. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_propagate_shared_value>`
...
.. ref-code-block:: cpp
	...
	class PropagateSharedValue: public :ref:`ov::pass::ModelPass<doxid-classov_1_1pass_1_1_model_pass>`
	{
	public:
		// methods
	
		bool :target:`run_on_model<doxid-classngraph_1_1pass_1_1low__precision_1_1_propagate_shared_value_1a6167ff01a424324948050b30767484f0>`(const std::shared_ptr<:ref:`ngraph::Function<doxid-classngraph_1a14d7fe7c605267b52c145579e12d2a5f>`>& f);
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_propagate_shared_value:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`PropagateSharedValue <doxid-classngraph_1_1pass_1_1low__precision_1_1_propagate_shared_value>` transformation propagates shared value AttributeType attribute instances through precision preserved operations.

For more details about the transformation, refer to :ref:`PropagateSharedValue <doxid-openvino_docs__o_v__u_g_lpt__propagate_shared_value>` page in the Inference Engine Developer Guide.
