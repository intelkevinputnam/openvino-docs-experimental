.. index:: pair: class; ov::op::util::DeformableConvolutionBase
.. _doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base:
...
Base class for operations DeformableConvolution :ref:`v1 <doxid-namespaceov_1_1op_1_1v1>` and DeformableConvolution :ref:`v8 <doxid-namespaceov_1_1op_1_1v8>`. :ref:`More...<details-classov_1_1op_1_1util_1_1_deformable_convolution_base>`
...
.. ref-code-block:: cpp
	...
	class DeformableConvolutionBase: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1adb7ff4e38c7ac14ef8d27c057914825d>`;

		// construction
	
		:ref:`DeformableConvolutionBase<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a370d798f84f1f79d843389bc3b471048>`();
	
		:ref:`DeformableConvolutionBase<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ab24165e12eb653b828be73ab1c4d69ab>`(
			const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& arguments,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a8b60b3b39afeae83c191df19a868b91a>`("DeformableConvolutionBase", "util");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a8036d698271b7ed96a2891408cee467a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		...
		const :ref:`Strides<doxid-classov_1_1_strides>`& :target:`get_strides<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1aceb3750e47c4112ddd36a14d8b15383f>`() const;
		void :target:`set_strides<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1aa84f1d5080e721bb1197b27b7e911cd3>`(const :ref:`Strides<doxid-classov_1_1_strides>`& strides);
		const :ref:`Strides<doxid-classov_1_1_strides>`& :target:`get_dilations<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1adf04daed3f9841e99cb68f656ba85c3a>`() const;
		void :target:`set_dilations<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a20efae81190ef069a3ae4671f5186422>`(const :ref:`Strides<doxid-classov_1_1_strides>`& dilations);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :target:`get_pads_begin<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a80b733c07ca2384f26b7a3c3e342ab92>`() const;
		void :target:`set_pads_begin<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a9966f3ef2a0a98d9f19930314b10813c>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_begin);
		const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& :target:`get_pads_end<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a96019bd26c1d0a63d34eb1874b9da8d4>`() const;
		void :target:`set_pads_end<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a78e95974d91b6401c920cfecef88a172>`(const :ref:`CoordinateDiff<doxid-classov_1_1_coordinate_diff>`& pads_end);
		const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& :target:`get_auto_pad<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ad1153a28704f8cfbfe282ea32bbba60a>`() const;
		void :target:`set_auto_pad<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ade732cb979bc776373d45c07ab6f8291>`(const :ref:`PadType<doxid-namespaceov_1_1op_1a287af03f211ecac2b876d35a1130e50d>`& auto_pad);
		int64_t :target:`get_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a58e52a9ea08c4b71620f071ccf308399>`() const;
		void :target:`set_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ae783a6525d82fed72c44a1010b8c6e38>`(const int64_t group);
		int64_t :target:`get_deformable_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a066a91e31c04c032df7444d901959fe8>`() const;
		void :target:`set_deformable_group<doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1aa84fd973ad123eb3bfde482e157b8a15>`(const int64_t deformable_group);
	};
...
.. _details-classov_1_1op_1_1util_1_1_deformable_convolution_base:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Base class for operations DeformableConvolution :ref:`v1 <doxid-namespaceov_1_1op_1_1v1>` and DeformableConvolution :ref:`v8 <doxid-namespaceov_1_1op_1_1v8>`.

Construction
------------

.. _doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1a370d798f84f1f79d843389bc3b471048:
.. index:: pair: function; DeformableConvolutionBase
...
.. _doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ab24165e12eb653b828be73ab1c4d69ab:
.. index:: pair: function; DeformableConvolutionBase
...
.. _doxid-classov_1_1op_1_1util_1_1_deformable_convolution_base_1ac7b4d39f3a55aae3da250ec633ccdead:
