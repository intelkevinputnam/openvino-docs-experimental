.. index:: pair: class; ov::op::util::BinaryElementwiseComparison
.. _doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison:

class ov::op::util::BinaryElementwiseComparison
===============================================
...
.. ref-code-block:: cpp
	...
	class BinaryElementwiseComparison: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison_1a1c96dfac28e2a5718b0f1989ef925880>`;

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison_1a0274320f9b711d6756ad9d6fd4c4be8d>`("BinaryElementwiseComparison", "util");
		...
		void :target:`set_autob<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison_1a1144eb36bd0d4d90e249d34bf4fe783a>`(const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& autob);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison_1aa8747a39338a1a3af5fbfacfbf55c6f4>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
	};
...
.. _details-classov_1_1op_1_1util_1_1_binary_elementwise_comparison:
...
For example, if the underlying comparison operation (determined by the subclass) is :math:`\mathit{op}(x,y)`, the input tensors :math:`[[x_0,y_0],[z_0,w_0]]` and :math:`[[x_1,y_1],[z_1,w_1]]` will be mapped to :math:`[[\mathit{op}(x_0,x_1),\mathit{op}(y_0,y_1)],[\mathit{op}(z_0,z_1),\mathit{op}(w_0,w_1)]]`.
...
.. list-table::
    ...
    * - :math:`\texttt{bool}[d_1,\dots,d_n]`
      - The tensor :math:`T` , where :math:`T[i_1,\dots,i_n] = \mathit{op}(\texttt{arg0}[i_1,\dots,i_n],\texttt{arg1}[i_1,\dots,i_n])` . This will always have the same shape as the input tensors, and the element type ``bool`` .

Methods
-------

.. _doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison_1a8f8b491c0a89f2bb5fa439243b14f826:
...
.. _doxid-classov_1_1op_1_1util_1_1_binary_elementwise_comparison_1a62fb7bcb02ff7bac2adf8f30564b0d20:
