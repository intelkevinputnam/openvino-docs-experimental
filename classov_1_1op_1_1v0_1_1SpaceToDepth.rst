.. index:: pair: class; ov::op::v0::SpaceToDepth
.. _doxid-classov_1_1op_1_1v0_1_1_space_to_depth:
...
.. toctree::
	...
	SpaceToDepthMode <enumov_1_1op_1_1v0_1_1SpaceToDepth_1_1SpaceToDepthMode.rst>

Overview
~~~~~~~~

:ref:`SpaceToDepth <doxid-classov_1_1op_1_1v0_1_1_space_to_depth>` permutes input tensor blocks of spatial data into depth dimension. :ref:`More...<details-classov_1_1op_1_1v0_1_1_space_to_depth>`
...
.. ref-code-block:: cpp
	...
	class SpaceToDepth: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// enums
	
		enum :ref:`SpaceToDepthMode<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ad6b782e0cfede20e971e2ff658d80957>`;

		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1aaea49017f515fba38a90cd5b3d9dd2c8>`;

		// construction
	
		:target:`SpaceToDepth<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a42d8607268afa079a00886ec70aad6b4>`();
	
		:ref:`SpaceToDepth<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ace72fcf1e126d3f62d0d34f3603cec89>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`SpaceToDepthMode<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ad6b782e0cfede20e971e2ff658d80957>`& mode,
			std::size_t block_size = 1
			);
	
		:target:`SpaceToDepth<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ab7a7e56c3ecb34f7b6805b8b3c3308bb>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a974b80893734c0d0e87ff3690601c91f>`("SpaceToDepth", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a9be775582015ac988df99f2e05927812>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		const std::size_t& :target:`get_block_size<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a04a0b441cb89295c9b413fc37d90cb4b>`() const;
		:ref:`SpaceToDepthMode<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ad6b782e0cfede20e971e2ff658d80957>` :target:`get_mode<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a1dd534f354f81ffda243b71bfacac352>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a85fca478ef0616fd2c5269a31ef725ab>`();
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ad76af38fad509a01a58ec0a4baa9c1cb>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a75a71c7e5d5d86e607ed7d7e8f677109>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a06b768723226733cbf9040137e3d339f>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_space_to_depth:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`SpaceToDepth <doxid-classov_1_1op_1_1v0_1_1_space_to_depth>` permutes input tensor blocks of spatial data into depth dimension.
...
.. _doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1ace72fcf1e126d3f62d0d34f3603cec89:
.. index:: pair: function; SpaceToDepth
...
Constructs a :ref:`SpaceToDepth <doxid-classov_1_1op_1_1v0_1_1_space_to_depth>` operation.
...
.. list-table::
	...
	*
		...
		- Specifies how the output depth dimension is gathered from block coordinates and the old depth dimension.
...
.. _doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a85fca478ef0616fd2c5269a31ef725ab:
...
.. _doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a75a71c7e5d5d86e607ed7d7e8f677109:
...
.. _doxid-classov_1_1op_1_1v0_1_1_space_to_depth_1a06b768723226733cbf9040137e3d339f:
