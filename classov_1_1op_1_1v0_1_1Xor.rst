.. index:: pair: class; ov::op::v0::Xor
.. _doxid-classov_1_1op_1_1v0_1_1_xor:
...
Elementwise logical-xor operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_xor>`
...
.. ref-code-block:: cpp
	...
	class Xor: public :ref:`ov::op::util::BinaryElementwiseLogical<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_xor_1a0834d79448d8165c6f27426d50dac10d>`;

		// construction
	
		:target:`Xor<doxid-classov_1_1op_1_1v0_1_1_xor_1a123d0296a3e2a7b8d9a9b07998426146>`();
	
		:ref:`Xor<doxid-classov_1_1op_1_1v0_1_1_xor_1a33e66cdf9ad8b645e32e5ff74cbf2b50>`(
			...
			const :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`& auto_broadcast = :ref:`AutoBroadcastSpec<doxid-structov_1_1op_1_1_auto_broadcast_spec>`()
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_xor_1affb52b04e77167a2aad606f8afdc9adb>`("Xor", "opset1", :ref:`util::BinaryElementwiseLogical<doxid-classov_1_1op_1_1util_1_1_binary_elementwise_logical>`);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_xor_1a1508a2a3a98df28c5e5e7b90e7c74f13>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v0_1_1_xor_1ae4f85f18fc739d24aba4ec09a3c38430>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v0_1_1_xor_1a62c2a2d67c1796e65c427a00c740fd1d>`() const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_xor:
...
.. _doxid-classov_1_1op_1_1v0_1_1_xor_1a33e66cdf9ad8b645e32e5ff74cbf2b50:
.. index:: pair: function; Xor
...
.. _doxid-classov_1_1op_1_1v0_1_1_xor_1ae4f85f18fc739d24aba4ec09a3c38430:
...
.. _doxid-classov_1_1op_1_1v0_1_1_xor_1a62c2a2d67c1796e65c427a00c740fd1d:
