.. index:: pair: class; ngraph::pass::HSigmoidFusionWithClampDiv
.. _doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_clamp_div:
...
:ref:`HSigmoidFusion <doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion>` transformation replaces a sub-graph (Clamp(x + 3, 0, 6) \* / 6) with a HSigmoid op.
...
.. ref-code-block:: cpp
	...
	class HSigmoidFusionWithClampDiv: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_with_clamp_div_1a403b55734748ac3f377f26949c0e8f80>`("HSigmoidFusionWithClampDiv", "0");
	};
