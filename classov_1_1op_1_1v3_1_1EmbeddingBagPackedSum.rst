.. index:: pair: class; ov::op::v3::EmbeddingBagPackedSum
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum:
...
Returns embeddings for given indices. :ref:`More...<details-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum>`
...
.. ref-code-block:: cpp
	...
	class EmbeddingBagPackedSum: public :ref:`ov::op::util::EmbeddingBagPackedBase<doxid-classov_1_1op_1_1util_1_1_embedding_bag_packed_base>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a2d6d6243b4d91a56e7ee2ece5bc49257>`;

		// construction
	
		:ref:`EmbeddingBagPackedSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a2e70c54625207a634515ebde1bd0a7d9>`();
	
		:ref:`EmbeddingBagPackedSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a73853aba8e36aebe1eba0813a30320f5>`(
		...
		:target:`EmbeddingBagPackedSum<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a9a916d90369515bc0799b31bbd4f97e3>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& emb_table,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices
			);
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1aeb7b4d8dc9240d2f940727044e68717d>`("EmbeddingBagPackedSum", "opset3", :ref:`util::EmbeddingBagPackedBase<doxid-classov_1_1op_1_1util_1_1_embedding_bag_packed_base>`, 3);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a72440c5cf0bf0d5e1c864523513696c4>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_embedding_bag_packed_base_1aa3eb9b3bc60320de558205dd889b96e7>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_embedding_bag_packed_base_1a9243add1ad756ff326026caa2d0977f3>`("EmbeddingBagPackedBase", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_embedding_bag_packed_base_1a4750b1b8cf7f94c4a9225e8b1144238a>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_embedding_bag_packed_base_1aa4e7f44da26013446911c05c2333a5c4>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);

.. _details-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum:
...
.. _doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a2e70c54625207a634515ebde1bd0a7d9:
.. index:: pair: function; EmbeddingBagPackedSum
...
Constructs a :ref:`EmbeddingBagPackedSum <doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum>` operation.

.. _doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum_1a73853aba8e36aebe1eba0813a30320f5:
.. index:: pair: function; EmbeddingBagPackedSum
...
:ref:`EmbeddingBagPackedSum <doxid-classov_1_1op_1_1v3_1_1_embedding_bag_packed_sum>` constructs an output tensor by replacing every index in a given input tensor with a row (from the weights matrix) at that index
...
.. list-table::
	...
	*
		...
		- :ref:`Tensor <doxid-classov_1_1_tensor>` containing the embedding lookup table of the module of shape [num_emb, emb_dim1, emb_dim2, ...] and of type T

	*
		- indices

		- :ref:`Tensor <doxid-classov_1_1_tensor>` of shape ``[batch, indices_per_bag]`` and of type *T_IND*. Required.
