.. index:: pair: class; ngraph::pass::low_precision::MatMulTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation:
...
:ref:`MatMulTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation>` propagates dequantization operations through MatMul operation. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation>`
...
.. ref-code-block:: cpp
	...
	class MatMulTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`MatMulTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation_1a51595792abddc533f6d0559a5e6280b2>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation_1ad5b360afac827e9e86d8059d3ffe1171>`("MatMulTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation_1a25c6b04ba974fad8a0bf59c1932f68e9>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation_1ad03986b28e6a6d011a429927cf35aca6>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation_1ae21c81f20b68e62f48d3e9150f615cfa>`(
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`MatMulTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_mat_mul_transformation>` propagates dequantization operations through MatMul operation.

For more details about the transformation, refer to :ref:`MatMulTransformation <doxid-openvino_docs__o_v__u_g_lpt__mat_mul_transformation>` page in the Inference Engine Developer Guide.
