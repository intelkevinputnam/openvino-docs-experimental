.. index:: pair: interface; ngraph::snippets::op::PowerStatic
.. _doxid-classngraph_1_1snippets_1_1op_1_1_power_static:

interface ngraph::snippets::op::PowerStatic
===========================================



Generated by Canonicalization for a spasical case of power innstruction which has constant power value.


.. ref-code-block:: cpp
	:class: doxyrest-overview-code-block

	#include <powerstatic.hpp>
	
	template PowerStatic: public :ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
	{
		// construction
	
		:target:`PowerStatic<doxid-classngraph_1_1snippets_1_1op_1_1_power_static_1acd4799191234cb60c6c05e6fe8ce750a>`();
		:target:`PowerStatic<doxid-classngraph_1_1snippets_1_1op_1_1_power_static_1a6c8c337f68a81baf16223c2516538277>`(const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& arg, float power);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_power_static_1a2fb8b1ff2069cc6bfd1b33aab65fb5ef>`(
			"PowerStatic",
			"SnippetsOpset",
			:ref:`ov::op::util::UnaryElementwiseArithmetic<doxid-classov_1_1op_1_1util_1_1_unary_elementwise_arithmetic>`
			);
	
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_power_static_1adc8c8242580428fede5548b41c8a1eb4>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1snippets_1_1op_1_1_power_static_1a89c14db9a47d01ab752ed7ca6d3284c0>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		float :target:`get_power<doxid-classngraph_1_1snippets_1_1op_1_1_power_static_1a883f82cb2c66cc3caee925cf4306ed86>`() const;
	};
