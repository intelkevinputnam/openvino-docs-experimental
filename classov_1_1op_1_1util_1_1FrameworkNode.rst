.. index:: pair: class; ov::op::util::FrameworkNode
.. _doxid-classov_1_1op_1_1util_1_1_framework_node:

class ov::op::util::FrameworkNode
=================================
...
.. ref-code-block:: cpp
	...
	class FrameworkNode: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1util_1_1_framework_node_1aa3f6051b4acb407ebc7fd3a420a92500>`;

		// construction
	
		:target:`FrameworkNode<doxid-classov_1_1op_1_1util_1_1_framework_node_1a479c46a8181ae7ae034bccf2d0dce39d>`();
		:target:`FrameworkNode<doxid-classov_1_1op_1_1util_1_1_framework_node_1a8030174628b9bea7f554c697c91e03f6>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& inputs, size_t output_size = 1);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1util_1_1_framework_node_1a759707d4ff6da608a723eb822172b92f>`("FrameworkNode", "util");
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1util_1_1_framework_node_1a73e1f674dc3368a808b2b8da316c9fa0>`();
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1util_1_1_framework_node_1a4ab5b4905fa8554145cbd45115f2430a>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		const :ref:`FrameworkNodeAttrs<doxid-classov_1_1op_1_1util_1_1_framework_node_attrs>`& :target:`get_attrs<doxid-classov_1_1op_1_1util_1_1_framework_node_1ab3c9313dad7d4ea4b8c969467512c592>`() const;
		void :target:`set_attrs<doxid-classov_1_1op_1_1util_1_1_framework_node_1a1c7c5f8ff40883f0eb92ab7c8484c8fb>`(const :ref:`FrameworkNodeAttrs<doxid-classov_1_1op_1_1util_1_1_framework_node_attrs>`& attrs);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1util_1_1_framework_node_1aeaa145361d66362a78bb2f76df61e9dc>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		void :target:`cache_output_descriptor<doxid-classov_1_1op_1_1util_1_1_framework_node_1af24335d236acb62bc5e669e7af1109e1>`();
	};
...
.. _details-classov_1_1op_1_1util_1_1_framework_node:
...
.. _doxid-classov_1_1op_1_1util_1_1_framework_node_1a73e1f674dc3368a808b2b8da316c9fa0:
