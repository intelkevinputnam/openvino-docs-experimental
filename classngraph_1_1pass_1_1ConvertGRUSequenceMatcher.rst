.. index:: pair: class; ngraph::pass::ConvertGRUSequenceMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_g_r_u_sequence_matcher:
...
Converts GRUSequence to legacy GRUSequenceIE. SequenceIE op doesn't use seq_length input and num_direction (direction) attribute. We squeeze num_direction dimension for all corresponding inputs and unsqueeze them after the SequenceIE op.
...
.. ref-code-block:: cpp
	...
	class ConvertGRUSequenceMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_g_r_u_sequence_matcher_1a1d40b7abba43d6b670dd7135752c074e>`("ConvertGRUSequenceMatcher", "0");
	};
