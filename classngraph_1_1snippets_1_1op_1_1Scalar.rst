.. index:: pair: interface; ngraph::snippets::op::Scalar
.. _doxid-classngraph_1_1snippets_1_1op_1_1_scalar:

interface ngraph::snippets::op::Scalar
======================================
...
Generated by Canonicalization for a scalar constant Shape() == {1}. :ref:`More...<details-classngraph_1_1snippets_1_1op_1_1_scalar>`
...
.. ref-code-block:: cpp
	...
	template Scalar: public :ref:`ov::op::v0::Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`
	{
		// construction
	
		template <class T, class = typename std::enable_if<std::is_fundamental<T>::value>::type>
		:target:`Scalar<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1ac308240c0bb6c070382e3cbb6a5eb330>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
			:ref:`Shape<doxid-classov_1_1_shape>` shape,
			T value
			);
	
		:target:`Scalar<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1a27955822c67aee8d6e8d19e5ab871185>`(const :ref:`Constant<doxid-classov_1_1op_1_1v0_1_1_constant_1a5c88dbfc494539a5d20c60877d29adc6>`& other);
		:target:`Scalar<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1a9eddd28fe9969c14e293be60b7e8bbc7>`(const Scalar& other);

		// methods
	
		:target:`OPENVINO_OP<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1a986fd176132ffd106b8403d531653e44>`("Scalar", "SnippetsOpset", :ref:`ov::op::v0::Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`);
		Scalar& :target:`operator =<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1adf1751d0a2529ebcdb9d9eb1580c8abc>` (const Scalar&);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1a4733d877ca90fc84c94793c40bc2be19>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1a47517e41017c164aa3798544b03477fb>`();
	};
...
.. ref-code-block:: cpp
	...
	public:
		...
		// fields
		 ...
		 :ref:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_constant_1a9c14cdd2b72875812e1cecdac8164250>`;
		...
		:ref:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_constant_1a859f2b8379adde92ee3f176562727f47>`("Constant", "opset1");
	
		template <typename T>
		void :ref:`fill_data<doxid-classov_1_1op_1_1v0_1_1_constant_1a8c240ba07ca1fd58eb69987e3b84b4ad>`(const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type, T value);
	
		:ref:`Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`& :ref:`operator =<doxid-classov_1_1op_1_1v0_1_1_constant_1aeab3dd9bdeba09495ba075bd569508f7>` (const :ref:`Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`&);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_constant_1a55dd482843c7b4717624dae96d6c1956>`();
		virtual bool :ref:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_constant_1ac0b40a12bbc39c64dae2fdcf3b9de261>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate_lower<doxid-classov_1_1op_1_1v0_1_1_constant_1af7183cea7907c5333db9f13869364d71>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
		virtual bool :ref:`evaluate_upper<doxid-classov_1_1op_1_1v0_1_1_constant_1afe7adf6d5412402edb75aca4df4023e2>`(const :ref:`HostTensorVector<doxid-namespaceov_1a2e5bf6dcca008b0147e825595f57c03b>`& outputs) const;
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`constant_fold<doxid-classov_1_1op_1_1v0_1_1_constant_1a67547e6a872d6b0aaa04d679cbe36046>`(
		...
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :ref:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_constant_1a5459a42c8b48c705f7f101de4b253b4e>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		...
		template <typename T>
		std::vector<T> :ref:`get_vector<doxid-classov_1_1op_1_1v0_1_1_constant_1ad7df5f4de69d05d168e12b0df79d3ed9>`() const;
	
		template <typename T>
		std::vector<T> :ref:`cast_vector<doxid-classov_1_1op_1_1v0_1_1_constant_1abd4d166d19ef4f7204abb53ec5247ce3>`() const;
	
		const void \* :ref:`get_data_ptr<doxid-classov_1_1op_1_1v0_1_1_constant_1a79fa84a4d8fb977708e1f64aaf94d2de>`() const;
	
		template <typename T>
		const T \* :ref:`get_data_ptr<doxid-classov_1_1op_1_1v0_1_1_constant_1ac6c73d901e4ae8368c6ef18bb373bf20>`() const;
	
		template <element::Type_t ET>
		const :ref:`element_type_traits<doxid-structov_1_1element__type__traits>`<ET>::value_type \* :ref:`get_data_ptr<doxid-classov_1_1op_1_1v0_1_1_constant_1aa69b554075f081322f9c89019ff8fbf4>`() const;
	
		bool :ref:`get_all_data_elements_bitwise_identical<doxid-classov_1_1op_1_1v0_1_1_constant_1a53e90c24ef5334a632b634773528d04b>`() const;
		std::string :ref:`convert_value_to_string<doxid-classov_1_1op_1_1v0_1_1_constant_1af4c13a4e2115b2031384c8bcc1f73ea9>`(size_t index) const;
	
		template <typename T>
		static std::shared_ptr<:ref:`Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`> :ref:`create<doxid-classov_1_1op_1_1v0_1_1_constant_1aded3f3d661b74d480aa1e20c81a66c09>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
		...
		template <typename T>
		static std::shared_ptr<:ref:`Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`> :ref:`create<doxid-classov_1_1op_1_1v0_1_1_constant_1ab834a9774972682a5b9d718c6bb21899>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
			const :ref:`Shape<doxid-classov_1_1_shape>`& shape,
			std::initializer_list<T> values
			);
	
		static std::shared_ptr<:ref:`Constant<doxid-classov_1_1op_1_1v0_1_1_constant>`> :ref:`create<doxid-classov_1_1op_1_1v0_1_1_constant_1a4b02934a0557311027edfd7c81821669>`(
			const :ref:`element::Type<doxid-classov_1_1element_1_1_type>`& type,
			const :ref:`Shape<doxid-classov_1_1_shape>`& shape,
			const void \* memory
			);

.. _details-classngraph_1_1snippets_1_1op_1_1_scalar:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

Generated by Canonicalization for a scalar constant Shape() == {1}.

Methods
-------

.. _doxid-classngraph_1_1snippets_1_1op_1_1_scalar_1a47517e41017c164aa3798544b03477fb:
