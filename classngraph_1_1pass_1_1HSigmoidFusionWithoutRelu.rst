.. index:: pair: class; ngraph::pass::HSigmoidFusionWithoutRelu
.. _doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_without_relu:
...
:ref:`HSigmoidFusion <doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion>` transformation replaces a sub-graph (min(max(x + 3, 0), 6) / 6) with a HSigmoid op.
...
.. ref-code-block:: cpp
	...
	class HSigmoidFusionWithoutRelu: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_h_sigmoid_fusion_without_relu_1aaf484fdbe0c58dcd3d56c2cba3ed012e>`("HSigmoidFusionWithoutRelu", "0");
	};
