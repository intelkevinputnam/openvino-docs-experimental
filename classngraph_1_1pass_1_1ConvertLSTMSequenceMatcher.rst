.. index:: pair: class; ngraph::pass::ConvertLSTMSequenceMatcher
.. _doxid-classngraph_1_1pass_1_1_convert_l_s_t_m_sequence_matcher:
...
Converts LSTMSequence to legacy LSTMSequenceIE. SequenceIE op doesn't use seq_length input and num_direction (direction) attribute. We squeeze num_direction dimension for all corresponding inputs and unsqueeze them after the SequenceIE op.
...
.. ref-code-block:: cpp
	...
	class ConvertLSTMSequenceMatcher: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_convert_l_s_t_m_sequence_matcher_1a93a97ba6c8ac760e85601ed5050a00d2>`("ConvertLSTMSequenceMatcher", "0");
	};
