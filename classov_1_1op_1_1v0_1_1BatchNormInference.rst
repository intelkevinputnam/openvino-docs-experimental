.. index:: pair: class; ov::op::v0::BatchNormInference
.. _doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference:
...
:ref:`BatchNormInference <doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference>` operation. :ref:`More...<details-classov_1_1op_1_1v0_1_1_batch_norm_inference>`
...
.. ref-code-block:: cpp
	...
	public:
		// fields
		 ...
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1af67231c377c40806a6685dbf2753698d>`;

		// construction
	
		:target:`BatchNormInference<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1a5b2084722e7e47d7b5e6a9fcd9fd693c>`();
	
		:ref:`BatchNormInference<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1a68f24bbedd398fca29d573c82f941c15>`(
		...
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1a08377dd4ab426549f900960d4e2e3b8d>`("BatchNormInference", "opset1");
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1aa395c6b311586399b6ca456ef483d772>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1ac9650284a0f325c0f2d325d72861e35e>`();
		double :target:`get_eps_value<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1ad040b27124a386dde4c1a17df1cc05cd>`() const;
		void :target:`set_eps_value<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1a18a0acadbfc45daf42e042ea93525b20>`(double epsilon);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1a0b34af639155fe9499a0c44fe4f87090>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
	};
...
.. _details-classov_1_1op_1_1v0_1_1_batch_norm_inference:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`BatchNormInference <doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1a68f24bbedd398fca29d573c82f941c15:
...
.. _doxid-classov_1_1op_1_1v0_1_1_batch_norm_inference_1ac9650284a0f325c0f2d325d72861e35e:
