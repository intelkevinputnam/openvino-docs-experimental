.. index:: pair: class; ngraph::pass::low_precision::FuseConvertTransformation
.. _doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation:
...
:ref:`FuseConvertTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation>` fuses Convert operation with Multiply, Subtract or Add operations. :ref:`More...<details-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation>`
...
.. ref-code-block:: cpp
	...
	class FuseConvertTransformation: public :ref:`ngraph::pass::low_precision::LayerTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation>`
	{
	public:
		// construction
	
		:target:`FuseConvertTransformation<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation_1a4df79efacfba1e9b4d8f2d53fa68964c>`(const :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`& params = :ref:`Params<doxid-classngraph_1_1pass_1_1low__precision_1_1_layer_transformation_1_1_params>`());

		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation_1aa51fa74d435137e0b245f5e7d16f83d2>`("FuseConvertTransformation", "0");
	
		virtual bool :target:`transform<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation_1a668f8cc38f5084a05b762d5a8aedac0e>`(
		...
		virtual bool :target:`canBeTransformed<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation_1a8f6127339a95e6f00e2a900ee8bcc40e>`(
		...
		virtual bool :target:`isPrecisionPreserved<doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation_1a922dbc71c3812dc3b25430f6bc2457b2>`(std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> layer) const;
	};
...
.. _details-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`FuseConvertTransformation <doxid-classngraph_1_1pass_1_1low__precision_1_1_fuse_convert_transformation>` fuses Convert operation with Multiply, Subtract or Add operations.

For more details about the transformation, refer to :ref:`FuseConvertTransformation <doxid-openvino_docs__o_v__u_g_lpt__fuse_convert_transformation>` page in the Inference Engine Developer Guide.
