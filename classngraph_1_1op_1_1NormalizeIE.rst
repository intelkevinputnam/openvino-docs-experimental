.. index:: pair: class; ngraph::op::NormalizeIE
.. _doxid-classngraph_1_1op_1_1_normalize_i_e:

class ngraph::op::NormalizeIE
=============================
...
.. ref-code-block:: cpp
	...
	class NormalizeIE: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classngraph_1_1op_1_1_normalize_i_e_1ae3c39e666d1aebe5c3e4ff2843627404>`;

		// construction
	
		:target:`NormalizeIE<doxid-classngraph_1_1op_1_1_normalize_i_e_1a40506c1a00e4efc221515a19dbe15bb8>`();
	
		:target:`NormalizeIE<doxid-classngraph_1_1op_1_1_normalize_i_e_1af862bbb55d41b374cd8f80a079f4a4a0>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& data,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& weights,
			float eps,
			bool across_spatial,
			bool channel_shared,
		...
		:target:`OPENVINO_OP<doxid-classngraph_1_1op_1_1_normalize_i_e_1aa9fbb29903fca21bd22ad166e2ceda40>`("NormalizeIE", "legacy");
		float :target:`get_eps<doxid-classngraph_1_1op_1_1_normalize_i_e_1a756c70c3325ad3fb43cac0a85cb7ea3c>`() const;
		bool :target:`get_channel_shared<doxid-classngraph_1_1op_1_1_normalize_i_e_1a50754ca71635da7e597102965cf4aca5>`() const;
		bool :target:`get_across_spatial<doxid-classngraph_1_1op_1_1_normalize_i_e_1a6f46619ede2adad6f90aca7055c85a3c>`() const;
		virtual void :ref:`validate_and_infer_types<doxid-classngraph_1_1op_1_1_normalize_i_e_1ad2b734d26f95f8ef419b0f8fd8165fb3>`();
		virtual bool :target:`visit_attributes<doxid-classngraph_1_1op_1_1_normalize_i_e_1a99044c0ce474ecdea00291ccd95bef76>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classngraph_1_1op_1_1_normalize_i_e_1ab7ac93e1505ff868d755d66046905a7a>`(const :ref:`OutputVector<doxid-classngraph_1a161d36c81df2d1949272f525a8d73605>`& new_args) const;
	};
...
.. _details-classngraph_1_1op_1_1_normalize_i_e:
...
.. _doxid-classngraph_1_1op_1_1_normalize_i_e_1ad2b734d26f95f8ef419b0f8fd8165fb3:
