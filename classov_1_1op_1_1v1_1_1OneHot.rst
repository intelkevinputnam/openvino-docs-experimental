.. index:: pair: class; ov::op::v1::OneHot
.. _doxid-classov_1_1op_1_1v1_1_1_one_hot:
...
:ref:`OneHot <doxid-classov_1_1op_1_1v1_1_1_one_hot>` operation. :ref:`More...<details-classov_1_1op_1_1v1_1_1_one_hot>`
...
.. ref-code-block:: cpp
	...
	class OneHot: public :ref:`ov::op::Op<doxid-classov_1_1op_1_1_op>`
	{
	public:
		// fields
	
		 :target:`BWDCMP_RTTI_DECLARATION<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a559e4956991ccf766100f4b7ca63beb3>`;

		// construction
	
		:ref:`OneHot<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a5362b393d1fee17a8b70c77bcda8093d>`();
	
		:ref:`OneHot<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a204f09c6685a9956514c80ccd83bef43>`(
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& indices,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& depth,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& on_value,
			const :ref:`Output<doxid-classov_1_1_output>`<:ref:`Node<doxid-classov_1_1_node>`>& off_value,
			int64_t axis
			);

		// methods
	
		:target:`OPENVINO_OP<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a75ac60a2bd4657b5b1cda43c1a4096e9>`("OneHot", "opset1", :ref:`op::Op<doxid-classov_1_1op_1_1_op>`, 1);
		virtual bool :target:`visit_attributes<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a5341e00d06e4f473f7b6d0ce2beebb3e>`(:ref:`AttributeVisitor<doxid-classov_1_1_attribute_visitor>`& visitor);
		virtual std::shared_ptr<:ref:`Node<doxid-classov_1_1_node>`> :target:`clone_with_new_inputs<doxid-classov_1_1op_1_1v1_1_1_one_hot_1afa45d0e9e4ae964f7d76c58a3886be34>`(const :ref:`OutputVector<doxid-namespaceov_1a0a3841455b82c164b1b04b61a9c7c560>`& new_args) const;
		virtual void :ref:`validate_and_infer_types<doxid-classov_1_1op_1_1v1_1_1_one_hot_1ab439c2a9c7c5a58eb0d9c353225d7d60>`();
	
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_START<doxid-openvino_2core_2deprecated_8hpp_1a80720d314461cf6f3098efd1719f54c5>` bool :ref:`evaluate<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a32acebaa45caa9e63dcaa13cd575880f>`(
		...
		virtual :ref:`OPENVINO_SUPPRESS_DEPRECATED_END<doxid-openvino_2core_2deprecated_8hpp_1ac8c3082fae0849f6d58b442d540b5767>` bool :ref:`has_evaluate<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a5137b5961a19947a6293c1d7b0b6a886>`() const;
		const int64_t& :ref:`get_axis<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a08e3dfd9b63de3c54b92223071c48ead>`() const;
		void :target:`set_axis<doxid-classov_1_1op_1_1v1_1_1_one_hot_1a53e1f30f6c8631b45c2b810c4f2c07ca>`(int64_t axis);
	};
...
.. _details-classov_1_1op_1_1v1_1_1_one_hot:

Detailed Documentation
~~~~~~~~~~~~~~~~~~~~~~

:ref:`OneHot <doxid-classov_1_1op_1_1v1_1_1_one_hot>` operation.

Construction
------------

.. _doxid-classov_1_1op_1_1v1_1_1_one_hot_1a5362b393d1fee17a8b70c77bcda8093d:
.. index:: pair: function; OneHot
...
.. _doxid-classov_1_1op_1_1v1_1_1_one_hot_1a204f09c6685a9956514c80ccd83bef43:
.. index:: pair: function; OneHot
...
.. list-table::
	...
	*
		...
		- :ref:`Input <doxid-classov_1_1_input>` tensor containing indices.

	*
		- depth

		- Specifies number of classes and the size of one-hot dimension.

	*
		- on_value

		- Specifies value that the locations in output tensor represented by indices in input take.

	*
		- off_value

		- Specifies value that the locations in output tensor not represented by indices in input take.
...
.. _doxid-classov_1_1op_1_1v1_1_1_one_hot_1ab439c2a9c7c5a58eb0d9c353225d7d60:
...
.. _doxid-classov_1_1op_1_1v1_1_1_one_hot_1a32acebaa45caa9e63dcaa13cd575880f:
...
.. _doxid-classov_1_1op_1_1v1_1_1_one_hot_1a5137b5961a19947a6293c1d7b0b6a886:
...
.. _doxid-classov_1_1op_1_1v1_1_1_one_hot_1a08e3dfd9b63de3c54b92223071c48ead:
