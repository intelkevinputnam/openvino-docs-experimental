.. index:: pair: class; ngraph::pass::SoftPlusDecomposition
.. _doxid-classngraph_1_1pass_1_1_soft_plus_decomposition:
...
:ref:`SoftPlusDecomposition <doxid-classngraph_1_1pass_1_1_soft_plus_decomposition>` transformation replaces SoftPlus op to group of operations: log(exp(x) + 1).
...
.. ref-code-block:: cpp
	...
	class SoftPlusDecomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_soft_plus_decomposition_1a23c7c26e82c71afb00a885f8a5a27ed6>`("SoftPlusDecomposition", "0");
	};
