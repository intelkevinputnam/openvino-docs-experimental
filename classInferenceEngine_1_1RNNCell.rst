.. index:: pair: class; InferenceEngine::RNNCell
.. _doxid-class_inference_engine_1_1_r_n_n_cell:
...
RNN Cell layer. :ref:`More...<details-class_inference_engine_1_1_r_n_n_cell>`
...
.. ref-code-block:: cpp
	...
	class RNNCell: public :ref:`InferenceEngine::RNNCellBase<doxid-class_inference_engine_1_1_r_n_n_cell_base>`
	{
	public:
	};
...
.. _details-class_inference_engine_1_1_r_n_n_cell:
...
:ref:`G <doxid-namespace_inference_engine_1_1_g>` - number of gates (=1) N - batch size S - state size (=hidden_size)
...
* biases [:ref:`G <doxid-namespace_inference_engine_1_1_g>`,S]
