.. index:: pair: class; ngraph::pass::EinsumDecomposition
.. _doxid-classngraph_1_1pass_1_1_einsum_decomposition:
...
:ref:`EinsumDecomposition <doxid-classngraph_1_1pass_1_1_einsum_decomposition>` transformation decomposes Einsum-7 operation into a sub-graph with more simple operations: Transpose, Reshape, MatMul, ReduceSum, Unsqueeze, ShapeOf, ReduceProd, StridedSlice, and Concat.
...
.. ref-code-block:: cpp
	...
	class EinsumDecomposition: public :ref:`ov::pass::MatcherPass<doxid-classov_1_1pass_1_1_matcher_pass>`
	{
	public:
		// methods
	
		:target:`OPENVINO_RTTI<doxid-classngraph_1_1pass_1_1_einsum_decomposition_1a2ef89cac9412e3e1f3d27ede8e4349ad>`("EinsumDecomposition", "0");
	};
